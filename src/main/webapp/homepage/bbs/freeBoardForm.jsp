		...
		<div id="dvwh">
			...
			<div id="middle">			
				...
				<div id="subContentArear">
					...
					<!-- title/location -->
					<div id="top_title">
						<h1 id="title_"><img src="/images/<%= skinDir %>/title/tit_0301.gif" alt="열린광장" /></h1>
						<div id="location">
						<ul> 
					...
					<div id="contents">
						...
						<tr>
							...
							<td width="200"><input type="text" name="username" value="<%=requestMap.getString("guest") %>" class="input02 w160" readonly="readonly" /></td>
							<th width="75">비밀번호</th>
