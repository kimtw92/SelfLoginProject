...
//리스트
function fnList(){
	pform.action = "/homepage/support.do?mode=educationDataList";
	pform.submit();
}
//검색
function goSearch(){
...
function onView(form){
	if(<%=loginInfo.isLogin()%> == true) {
		...
		$("boardId").value = "EDU_DATA";
		pform.action = "/homepage/support.do?mode=educationDataView&seq="+form;
		pform.submit();
	} else {
...
function goWrite(){
	...
	$("boardId").value = "EDU_DATA";
	pform.action = "/homepage/support.do?mode=educationDataView";
	pform.submit();
}
//-->
</script>
      ...
      <jsp:include page="/homepage_new/inc/left5.jsp" flush="true" ></jsp:include>
        ...
        <div id="contnets_area">
          <div class="sub_visual"><img src="/homepage_new/images/common/sub_visual5.jpg" alt="인재원 소개 인천광역시 인재개발원에 대한 소개 및 시설정보를 제공합니다."></div>
            <div class="local">
              <h2>자료실</h2>
                <div class="navi"><img src="/homepage_new/images/common/icon_home.gif" alt="home"> &gt; 교육지원 &gt; 자료실 &gt; <span>교육자료</span></div>
            </div>
            <div class="contnets">
            <!-- contnet -->
...
<input type="hidden" id="currPage" name="currPage"	value="<%= requestMap.getString("currPage")%>">
				...
				<h3>교육자료</h3>
           			...
           			<jsp:include page="/homepage_new/inc/admin_info.jsp" flush="true" ><jsp:param name="menucode" value="M100023" /></jsp:include>
					<div class="h80"></div>
            <!-- //contnet -->
          </div>
        </div>
