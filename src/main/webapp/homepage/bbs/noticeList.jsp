...
function onView(form){
	...
	$("boardId").value = "NOTICE";
	pform.action = "/homepage/support.do?mode=noticeView&seq="+form;
	pform.submit();
}
/*
...
<input type="hidden" id="currPage" name="currPage"	value="<%= requestMap.getString("currPage")%>">
			...
			<jsp:include page="/homepage_new/inc/admin_info.jsp" flush="true" ><jsp:param name="menucode" value="M100036" /></jsp:include>
			<div class="h80"></div>
            <!-- //contnet -->
          </div>
        </div>
