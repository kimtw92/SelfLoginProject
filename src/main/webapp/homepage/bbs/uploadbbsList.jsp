...
function onView(form){
	...
	pform.action = "/homepage/support.do?mode=uploadView&seq="+form;
	pform.submit();
}
//글쓰기
function goWrite(){
	...
	$("boardId").value = "UPLOAD";
	pform.action = "/homepage/support.do?mode=uploadWrite";
	pform.submit();
}
...
<input type="hidden" id="currPage" name="currPage"	value="<%= requestMap.getString("currPage")%>">
			...
			<div class="point_box">
				...
				<div class="list">
					...
					신임인재양성과정 <strong>교육담당자</strong>(인재양성과) : <strong>440-7674</strong><br /><br />
