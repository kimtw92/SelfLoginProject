...
<%
	...
	// 리스트
	DataMap listMap = (DataMap)request.getAttribute("USER_NOTICE_VIEW");
	...
	<div id="subContentArear">
		...
		<div id="content">
			...
			<tr>
				...
				<%
					String group = "";
					if(!listMap.getString("notiGubun", 0).equals("")){
						if(listMap.getString("notiGubun", 0).equals("G")) {
							group = "그룹";
						}else if(listMap.getString("notiGubun", 0).equals("P")) {
							group = "개인";
						}
					}
				%>
			...
			<!-- button -->
			<div class="btnRbtt">			
				<a href="/mypage/myclass.do?mode=personalnotice"><img src="/images/skin1/button/btn_list02.gif" alt="리스트" />
			</div>
			<!-- //button -->
			<div class="space"></div>
		</div>
