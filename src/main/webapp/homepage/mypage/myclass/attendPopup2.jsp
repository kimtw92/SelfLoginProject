...
<div class="contents">
	...
	<div class="InDeta02">
		...
		<dl>
			...
			<dd>:
				...
				<a href="javascript:findJik();"><img src="/images/skin4/button/btn_search05.gif" class="vm3" alt="직급검색" /></a>
		...
		<!-- dl>
				...
				<dd>:
					<input type="text" title="현직급임용일" name="UPSDATE" id="UPSDATE" class="input01 w100" readonly="readonly"/>
		...
		<dl>
			...
			<dd>:
				<input type="text" value="<%=email%>" name="email" id="email" class="input01 w159" />
			</dd>
		</dl>		
	</div>
	<!-- //data -->
	...
	<div class="btnC">
		...
		<a href="javascript:on_apply();"><img src="/images/skin4/button/btn_yes01.gif" alt="예" /></a>
		<a href="javascript:window.close();"><img src="/images/skin4/button/btn_close01.gif" alt="닫기" /></a>
	</div>	
