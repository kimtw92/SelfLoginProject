...
System.out.println("innerHtml >>> " + innerHtml.toString());
*/
...
function setReWrite(){
	$("qu").value = "insertReplyDiscuss";
	pform.action = "/mypage/myclass.do?mode=discussWrite";
	pform.submit();
}

function setDelete(){
	$("qu").value = "deleteDiscuss";
	pform.action = "/mypage/myclass.do?mode=discussExec";
	pform.submit();
}

function setModify(){
	$("qu").value = "modifyDiscuss";
	pform.action = "/mypage/myclass.do?mode=discussModify";
	pform.submit();
}
//-->
</script>
...
<input type="hidden" name="currPage"	value="<%= requestMap.getString("currPage")%>">
					<div id="contents">
						...
						<!-- button -->
						<div class="btnRbtt">
							<a href="javascript:setReWrite();"><img src="/images/<%= skinDir %>/button/btn_write01.gif" alt="글쓰기" /></a>			
