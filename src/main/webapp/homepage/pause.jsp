...
<div>
	...
	<table border="1" style="border:1px solid #cccccc;" width="500" height="300";>
	<tr>
	<td> 
	<br/>  
	<span style = "font-weight:bold; font-size :1.8em;">독서실 정상운영 안내</span>
	<br/><br/><br/><br/><br/>
	<font style = "font-size:1.3em;">○ 시  설 : 인재개발원 독서실</font>
	<br/>
	<span style = "font-size :1.3em;">○ 날  짜 : 2021. 11. 16.(화) ~ 
	<br/>
	○ 시  간 : (평일) 09:00~20:00 (토요일, 공휴일) 09:00~17:00
	<br/>
	</td>
	</tr>
	</table>
  ...
  <p class="p_id_box3" style="float:right;">
