...
<%
	...
	StringBuffer sbListHtml1 = new StringBuffer();
	DataMap listMap = (DataMap)request.getAttribute("LIST_MAN_DATA");
	DataMap listMap1 = (DataMap)request.getAttribute("LIST_WOMAN_DATA");
	...
	if(listMap.keySize("subj") > 0){		
		for(int i=0; i < 5; i++){
			...
			sbListHtml.append("	<td style=\"text-align: cneter\">" + (i+1) + "</td>");	
	...
	if(listMap1.keySize("subj") > 0){		
		for(int i=0; i < 5; i++){
			
			sbListHtml1.append("<tr " + bgColor + " >");
			sbListHtml1.append("	<td style=\"text-align: cneter\">" + (i+1) + "</td>");	
			sbListHtml1.append("	<td style=\"text-align: left\">&nbsp;&nbsp;&nbsp;&nbsp;" + listMap1.getString("subj", i) + "</td>");			
			
			sbListHtml1.append("</tr>");
		}
	}
      ...
      <jsp:include page="/homepage_new/inc/left3.jsp" flush="true" ></jsp:include>
         ...
         <div id="contnets_area">
          <div class="sub_visual3">교육신청</div>
            ...
            <li class="TabOn"><a href="javascript:fnGoMenu('4','genderBest');">남여별 추천</a></li>
            <li><a href="javascript:fnGoMenu('4','languageBest');">외국어 교육</a></li>
          	</ol>
          	<p><BR><p>
          	
			  <font size="3px"><b>◇  여자별 추천과정  </b></font>
			  <p><BR><p>
	          	<table class="dataH07"> 
	            <colgroup>
	            <col width="100" />
	            ...
	            <tbody>
							...
							<%= sbListHtml1.toString() %>
				 </tbody>
	            </table>
	            
          	     	<p><BR><p>
          	
			  <font size="3px"><b>◇  남자별 추천과정  </b></font>
			  <p><BR><p>
	            ...
	            <form id="pform" name="pform" method="post">
	          	<input type="hidden" id="mode" name="mode"	value="genderBest">
				<!-- contnet -->
