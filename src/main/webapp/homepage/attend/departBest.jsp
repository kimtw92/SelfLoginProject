...
<%
	...
	if(listMap.keySize("lownm") > 0){		
		for(int i=0; i < listMap.keySize("lownm"); i++){
			...
			sbListHtml.append("	<td style=\"text-align: center\">" + listMap.getString("lownm", i) + "</td>");
      ...
      <jsp:include page="/homepage_new/inc/left3.jsp" flush="true" ></jsp:include>
       ...
       <div id="contnets_area">
          <div class="sub_visual3">교육신청</div>
            ...
            <li class="TabOn"><a href="javascript:fnGoMenu('4','departBest');">기관별 추천</a></li>
            ...
            <li><a href="javascript:fnGoMenu('4','languageBest');">외국어 교육</a></li>			
	            ...
	            <tbody>
	             ...
	             <form id="pform" name="pform" method="post">
	          	<input type="hidden" id="mode" name="mode"	value="departBest">
				<!-- contnet -->
	              ...
	              <select name="key" id="key">
	                	<option value="201601" <%if(requestMap.getString("key").equals("201601")){out.print("selected");} %>>2016년 2월</option>
	               		...
	               		<option value="201703" <%if(requestMap.getString("key").equals("201703") ){out.print("selected");} %>>2017년 04월</option> 
