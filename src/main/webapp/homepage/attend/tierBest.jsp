...
<%
	...
	if(listMap.keySize("codenm") > 0){		
		for(int i=0; i < listMap.keySize("codenm"); i++){
			...
			sbListHtml.append("	<td style=\"text-align: center\">" + listMap.getString("codenm", i) + "</td>");
      ...
      <jsp:include page="/homepage_new/inc/left3.jsp" flush="true" ></jsp:include>
        ...
        <div id="contnets_area">
          <div class="sub_visual3">교육신청</div>
            ...
            <li class="TabOn"><a href="javascript:fnGoMenu('4','tierBest');">직급별 추천</a></li>
