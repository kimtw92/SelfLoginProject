...
<%
	...
	// 리스트
	DataMap listMap = (DataMap)request.getAttribute("SPECIAL_COURSE_DATA");
	...
	if(listMap.keySize("grcode") > 0){
		...
		// 리스트가 없을때
		sbListHtml.append("<tr><td colspan=\"5\">교육과정이 없습니다.</td></tr>");
	}
%>
...
<div id="wrapper">
	<div id="dvwhset">
		...
		<!-- content s ===================== -->
		<div id="content">
			<h2 class="h2L"><img src="/images/skin1/title/tit_r000105.gif" alt="특별교육" /></h2>
			<div class="h9"></div>
			<!-- data -->
			<table class="bList01">	
			<colgroup>
