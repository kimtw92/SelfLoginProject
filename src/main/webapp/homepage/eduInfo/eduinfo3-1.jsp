...
<%
	...
	// 리스트
	DataMap listMap = (DataMap)request.getAttribute("BASIC_COURSE_DATA");
      ...
      <jsp:include page="/homepage_new/inc/left2.jsp" flush="true" ></jsp:include>
        ...
        <div id="contnets_area">
          <div class="sub_visual2">교육과정</div>
            <div class="local">
              <h2>집합교육</h2>
                <div class="navi"><img src="/homepage_new/images/common/icon_home.gif" alt="home"> &gt; 교육과정 &gt; 집합교육 &gt; <span>기본교육</span></div>
            </div>
            <div class="contnets">
            <!-- contnet -->
            <div id="content">
			...
			<jsp:include page="/homepage_new/inc/admin_info.jsp" flush="true" ><jsp:param name="menucode" value="M100003" /></jsp:include>
			<!--//[s] 페이징 -->
			<div class="h80"></div>
		</div>
            <!-- //contnet -->
