...
<%
	...
	if(listMap.keySize("menucode") > 0){
		...
		for(int i =0; i < listMap.keySize("menucode"); i++){
			...
			html.append("\n	<td align='center'><input onclick=\"menuScoreList('"+listMap.getString("menucode", i)+"')\" style='width:100%;' type='text' value='"+listMap.getString("cnt", i)+"' /></td>");
			html.append("\n	<td align='center'><input style='width:100%;' type='text' value='"+listMap.getString("age", i)+"' /></td>");
			html.append("\n	<td align='center'><select style='width:100%;' type='text' id='menuscoreUseyn_"+i+"' name='menuscoreUseyn_"+i+"'>");	
...
function menuScoreList(menucode) {
	window.open('/homepageMgr/menuScore.do?mode=menuTotalScoreList&menucode='+menucode,'menuScoreList','scrollbars=yes,toolbar=yes,location=yes,resizable=yes,status=yes,menubar=yes,resizable=yes,width=550,height=700,left=0,top=0').focus();
}
//리스트
function go_list(){
	pform.action = "/homepageMgr/menuScore.do?mode=list&menuId=1-5-7";
	pform.submit();
}
...
function goSave(menucode, num) {
	...
	if(confirm(menucode + "보임여부를 수정 하시겠습니까?")) {
		var url = "/homepageMgr/menuScore.do";
		var pars = "mode=ajaxUpdateMenuScoreUseyn";
		pars += "&menucode="+menucode;
		pars += "&menuscoreUseyn="+$F("menuscoreUseyn_"+num);
    ...
    <tr>
        ...
        <td colspan="2" valign="top" class="leftMenuBg">
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0" class="contentsSubTitleTable">			
				<tr>
					<td height="20">
						<img src="/images/bullet003.gif"  align="bottom">&nbsp;<strong>페이지별 만족도관리</strong>
					</td>
				</tr>
			</table>
			<!--[e] subTitle -->
					...
					<table width="100%" border="0" cellpadding="0" cellspacing="0">
						...
						<tr bgcolor="#5071B4">
						  ...
						  <td class="tableline11 white" align="center" width="12%"><strong>담당부서</strong></td>
  						  <td class="tableline11 white" align="center" width="15%"><strong>평가자수</strong></td>
  						  <td class="tableline11 white" align="center" width="15%"><strong>평균점수</strong></td>
