...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body onload="encodeName('<%=getSession(session, "realName")%>'); goPage();">
	<form id="pform" name="pform" method="post" action="/homepage/lecturer.do">
		<input type="hidden" name="mode"		value='lecturer3' />
	</form>

		<form method="post" id="authform" name="authform" action="/homepage/index.do">
			<input type="hidden" id="mode" name="mode" value="lecturer3"/>
