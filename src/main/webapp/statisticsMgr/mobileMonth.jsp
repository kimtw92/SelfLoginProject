...
<%
	...
	if(listMap.keySize("logdate") > 0){
		for(int i = 0; i < listMap.keySize("logdate"); i++){
			html.append("\n	<tr>");
			html.append("\n		<td>"+listMap.getString("logdate", i)+"</td>");
    ...
    <tr>
        ...
        <td colspan="2" valign="top" class="leftMenuBg">
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0" class="contentsSubTitleTable">			
				<tr>
					<td height="20">
						<img src="/images/bullet003.gif"  align="bottom">&nbsp;<strong>모바일 월별 통계 리스트</strong>
					</td>
				</tr>
			</table>
			<!--[e] subTitle -->
				...
				<tr>
					<td>
						...
						<table class="search01">
                            <tr>
								<th class="bl0" width="200">
									검색기간 <br /> <font color="red">[검색시 (일)은 절삭됩니다.]</font>
								</th>
								<td colspan="3">
