...
<%
	...
	if(listMap.keySize("regdate") > 0){
		for(int i = 0; i < listMap.keySize("regdate"); i++){
			...
			html.append("\n		<td>"+listMap.getString("countGrsuggestion", i)+"건</td>");
			html.append("\n		<td>"+listMap.getString("countGrnotice", i)+"건</td>");
			html.append("\n		<td>"+listMap.getString("countMail", i)+"건</td>");
			html.append("\n		<td>"+listMap.getString("countReply", i)+"건</td>");
			html.append("\n		<td class=\"br0\">"+listMap.getString("countLogin", i)+"건</td>");
			html.append("\n	</tr>");
...
function go_serach(){
	...
	}else if(Number(eYear) - Number(sYear) >= 2){
		alert("검색 기간은 최대 1년입니다. 다시 입력하여 주십시오.");
		return false;
    ...
    <tr>
        ...
        <td colspan="2" valign="top" class="leftMenuBg">
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0" class="contentsSubTitleTable">			
				<tr>
					<td height="20">
						<img src="/images/bullet003.gif"  align="bottom">&nbsp;<strong>강사 개인별 활동 내역</strong>
					</td>
				</tr>
			</table>
			<!--[e] subTitle -->
                   	...
                   	<!-- tab -->						
						...
						<table class="search01">
							<tr>
								...
								<td>
									일별 : <input type="radio" name="gubun" onclick="go_chk('date');" value="date" <%= !requestMap.getString("gubun").equals("month") ? "checked" : "" %>>
									월별 : <input type="radio" name="gubun" onclick="go_chk('month');" value="month" <%= requestMap.getString("gubun").equals("month") ? "checked" : "" %>>
								</td>
							...
							<tr>
								...
								<td colspan="3">
									<input type="text" maxlength="10" onkeypress="if(event.keyCode==13){go_search();return false;}" name="name" class="textfield" value="<%=requestMap.getString("name") %>">
								</td>
							</tr>
						</table>
	                    <!-- search[e] -->
...
<script language="JavaScript" type="text/JavaScript">
	try{
		cellMergeChk(document.all.tableData, 2, 1);
	}catch(e){}
</script>
