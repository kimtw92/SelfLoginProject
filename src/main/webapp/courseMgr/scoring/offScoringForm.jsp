...
function createSubSelectBox(pmode){
	...
	if(pmode == "grcode"){
		...
		var pars = "mode=grseqInfoAjax&year="+$F("year")+"&grcode="+$F("grcode")+"&grseq="+$F("grseq");
		var divId = "divEnd";
		var myAjax = new Ajax.Updater(
			{success:divId},
			url, 
...
function saveAnsForm(grcode, grseq, subj, subjnm){
	var url = "/courseMgr/offScoring.do";
	var queryString = "mode=saveAnsForm&grcode="+grcode+"&grseq="+grseq+"&subj="+subj+"&subjnm="+subjnm;
	window.open(url + "?" +queryString,"saveAnsForm");
}
...
<form id="pform" name="pform" method="post" target="hiddenFrame" enctype="multipart/form-data" action="/courseMgr/offScoring.do?mode=saveAns">
    ...
    <tr>
        ...
        <td colspan="2" valign="top" class="leftMenuBg">
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0" class="contentsSubTitleTable">			
				<tr>
					<td height="20">
						<img src="/images/bullet003.gif"  align="bottom">&nbsp;<strong>	과정 기수 과목</strong>
					</td>
				</tr>
			</table> 
			<div class="h10"></div>
