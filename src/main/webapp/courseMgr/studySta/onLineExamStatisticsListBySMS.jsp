...
<%
	...
	String textAreaStr = "{name}님 {grname}과정 평가에 응시하시기 바랍니다.";
	String tmpStr = "";
...
<input type="hidden" name="qu"					value='online_sms'>
...
<input type="hidden" name="examId"				value='<%=requestMap.getString("commExam")%>'>
