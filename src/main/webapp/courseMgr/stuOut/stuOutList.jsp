...
<%
	...
	for(int i=0; i < listMap.keySize("userno"); i++){
		...
		//퇴교처리일
		listStr.append("\n	<td align='center'>" + listMap.getString("cancelDate", i) + "</td>");

		//퇴교구분
		listStr.append("\n	<td align='center'>" + listMap.getString("ckindnm", i) + "</td>");

		//퇴교사유
		listStr.append("\n	<td align='center' class='br0'>" + listMap.getString("reason", i) + "</td>");
				...
				<tr>
					<td>
						...
						<div class="datatbl01">
							...
							<ul class="coment01">
							  <li>자세한 내용을 보고자 하면, 해당 퇴교자의 이름을 클릭하세요 </li>
							</ul>
