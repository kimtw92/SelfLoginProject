...
<%  
// prgnm : 강의기록입력에서 사용하는 SelectBox 만들기 , 멀티
// date  : 2008-07-07
// auth  : kang
%>
...
<%!
	...
	public String createSelectBox(DataMap dm, 
		...
		if(ptype.equals("grCode")){
			// 과정
			onchange = "onchange=\"fnGrSeq();\"";
			
		}else if(ptype.equals("grSeq")){
			onchange = "onchange=\"fnSubj();\"";
		}
		
		sbHtml.append("<select name=\"" + objId + "\" " + paramWidth + " " + onchange + "  >");
...
<%
	...
	if(listMap != null){
		...
		retData = createSelectBox(listMap, objId, code, codeNm, findCode, width, isOneData, ptype);	
	}
