...
<table class="pop01">
	<tr>
		<td class="titarea">
			<!-- 타이틀영역 -->
			<div class="tit">
				<h1 class="h1"><img src="../images/bullet_pop.gif" /> 집합강사수당관리</h1>
			</div>
			<!--// 타이틀영역 -->
		</td>
	</tr>
		...
		<td class="con">
			...
			<table class="datah01" border="0" cellspacing="0" cellpadding="0">
				...
				<tr>
					...
					<td>
						<input type="text" class="textfield" maxlength="9" required="true!기본수당을 입력하십시오." dataform="num!숫자만 입력해야 합니다." name="cDefaultAmt" value="<%=rowMap.getString("gDefaultAmt", i) %>" style="width:60px;" />
						<input type="hidden" name="tlevel" value="<%=rowMap.getString("tlevel",i) %>">
					</td>
					<td class="br0">
						<input type="text" class="textfield" maxlength="9" required="true!기본수당을 입력하십시오." dataform="num!숫자만 입력해야 합니다."  name="cOverAmt" value="<%=rowMap.getString("gOverAmt", i) %>" style="width:60px;" />
					</td>
				</tr>
				<%} %>
				<tr>
					<td colspan="100%" class="br0">
					* 단위는 집합강의 경우에는 시간단위임
					</td>
				</tr>
				</tbody>
