 ...
 */
   ...
   function changeAreaList(idx, obj){	
	...
	function normalSearch(currentPage){
		...
		url = "/newAddr/AjaxRequestXML.jsp?getUrl="+escape("http://www.juso.go.kr/link/search.do?extend=true&mode=road_search&searchType=location_buld&topTab=1&engineCtpNm="+encodeURI(cityText)+"&engineSigNm="+encodeURI(countyText)+"&engineEmdNm="+encodeURI(townText)+"&engineBdNm="+encodeURI(trim(form.bdnm.value))+"&currentPage="+currentPage);
	...
	function normalSearch2(currentPage){
		...
		url = "/newAddr/AjaxRequestXML.jsp?getUrl="+escape("http://www.juso.go.kr/link/search.do?extend=true&mode=road_search&searchType=location_buld&topTab=1&engineCtpNm="+encodeURI(form.engineCtpNm.value)+"&engineSigNm="+encodeURI(form.engineSigNm.value)+"&engineEmdNm="+encodeURI(form.engineEmdNm.value)+"&engineBdNm="+encodeURI(trim(form.engineBdNm.value))+"&currentPage="+currentPage);
				...
				<div class="form" id="formbox">
					<fieldset>
						...
						<p class="input" >
							...
							<input type="text" name="bdnm" value="" id="bdnm" class="text" style="width:185px;ime-mode:active" onkeypress="checkKeyASearch();"/>
						 </p>
						</div>
						<div class="btn">
