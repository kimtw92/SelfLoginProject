...
class ReportHandler{
	...
	private void initSQLConst(){
		...
		sql_Query = sql_Query + "			 , sum(decode(substr(subj,1,3),'BON',nvl(avlcount,0))) bonpoint ";
		sql_Query = sql_Query + "			 , sum(decode(substr(subj,1,3),'MIS',nvl(avlcount,0))) mispoint ";
		sql_Query = sql_Query + "			 , sum(decode(substr(subj,1,3),'BUN',nvl(avlcount,0))) bunpoint ";
		sql_Query = sql_Query + "			 , sum(decode(substr(subj,1,3),'SIL',nvl(avlcount,0))) silpoint ";
		sql_Query = sql_Query + "			 , sum(decode(substr(subj,1,3),'GUN',nvl(avcourse,0))) gunpoint ";
		sql_Query = sql_Query + "			 , sum(decode(substr(subj,1,3),'GUN', 0, nvl(avcourse,0))) coursepoint ";
		...
		sql_Query = sql_Query + " order by decode('" + p_order_Param + "', 'seqno', gr.seqno , 'disadd', -(gr.paccept-nvl(sm.addpoint,0)) , gr.eduno ), gr.seqno ";
		...
		sql_totAvg = sql_totAvg + "			 , sum(decode(substr(subj,1,3),'BON',nvl(avlcount,0))) bonpoint ";
		sql_totAvg = sql_totAvg + "			 , sum(decode(substr(subj,1,3),'MIS',nvl(avlcount,0))) mispoint ";
		sql_totAvg = sql_totAvg + "			 , sum(decode(substr(subj,1,3),'BUN',nvl(avlcount,0))) bunpoint ";
		sql_totAvg = sql_totAvg + "			 , sum(decode(substr(subj,1,3),'SIL',nvl(avlcount,0))) silpoint ";
		sql_totAvg = sql_totAvg + "			 , sum(decode(substr(subj,1,3),'GUN',nvl(avcourse,0))) gunpoint ";
		sql_totAvg = sql_totAvg + "			 , sum(decode(substr(subj,1,3),'GUN', 0, nvl(avcourse,0))) coursepoint ";
		sql_totAvg = sql_totAvg + "			 , sum(decode(subj,'NUS0000001',nvl(avlcount,0))) tchevpoint ";
