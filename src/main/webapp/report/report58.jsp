...
class ReportHandler{
	...
	private void getScriptFromloop(boolean bIsPrint) throws Exception{
		...
		while(Query.next()){   //자동으로 생성되는 반복 밴드의 루프문
			...
			nHeightTmp=getPrintHeight(sheet10_A5, charWidth, 10, 73, 40, nAutoHeight_loop[0]);
	...
	private void writeScripttitle( ) throws Exception{
		//스크립트문 생성
		out.print("^PRINT(41,38,511,1,16,0/,돋움체,RGB[0,0,0],BOLD, , ,NONE,38,1)");
	...
	private void writeScriptfoot( ) throws Exception{
		//스크립트문 생성
		out.print("^PRINT(41,778,511,1,11,0/,굴림체,RGB[0,0,0], , , ,NONE,20,1)");
	...
	private void writeScriptheader( ) throws Exception{
		//스크립트문 생성
		out.println("^CELLBG("+(nXCurPos)+","+(nYCurPos)+",73,20,1,RGB[230,230,250],RGB[230,230,250],0)\r");
		out.println("^CELLLINE("+(nXCurPos)+","+(nYCurPos)+",73,20,0,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos)+","+(nYCurPos)+",73,20,0,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos)+","+(nYCurPos)+",73,20,0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos)+","+(nYCurPos)+",73,20,0,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos)+","+(nYCurPos)+",73,1,10,0/,돋움체,RGB[0,0,0], , , ,NONE,20,1)");
		out.println(sheet10_A4+"\r");
		out.println("^CELLBG("+(nXCurPos+73)+","+(nYCurPos)+",73,20,1,RGB[230,230,250],RGB[230,230,250],0)\r");
		out.println("^CELLLINE("+(nXCurPos+73)+","+(nYCurPos)+",73,20,0,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos+73)+","+(nYCurPos)+",73,20,0,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos+73)+","+(nYCurPos)+",73,20,0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos+73)+","+(nYCurPos)+",73,20,0,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos+73)+","+(nYCurPos)+",73,1,10,0/,돋움체,RGB[0,0,0], , , ,NONE,20,1)");
		out.println(sheet10_B4+"\r");
		out.println("^CELLBG("+(nXCurPos+146)+","+(nYCurPos)+",73,20,1,RGB[230,230,250],RGB[230,230,250],0)\r");
		out.println("^CELLLINE("+(nXCurPos+146)+","+(nYCurPos)+",73,20,0,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos+146)+","+(nYCurPos)+",73,20,0,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos+146)+","+(nYCurPos)+",73,20,0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos+146)+","+(nYCurPos)+",73,20,0,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos+146)+","+(nYCurPos)+",73,1,10,0/,돋움체,RGB[0,0,0], , , ,NONE,20,1)");
		out.println(sheet10_C4+"\r");
		out.println("^CELLBG("+(nXCurPos+219)+","+(nYCurPos)+",73,20,1,RGB[230,230,250],RGB[230,230,250],0)\r");
		out.println("^CELLLINE("+(nXCurPos+219)+","+(nYCurPos)+",73,20,0,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos+219)+","+(nYCurPos)+",73,20,0,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos+219)+","+(nYCurPos)+",73,20,0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos+219)+","+(nYCurPos)+",73,20,0,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos+219)+","+(nYCurPos)+",73,1,10,0/,돋움체,RGB[0,0,0], , , ,NONE,20,1)");
		out.println(sheet10_D4+"\r");
		out.println("^CELLBG("+(nXCurPos+292)+","+(nYCurPos)+",73,20,1,RGB[230,230,250],RGB[230,230,250],0)\r");
		out.println("^CELLLINE("+(nXCurPos+292)+","+(nYCurPos)+",73,20,0,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos+292)+","+(nYCurPos)+",73,20,0,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos+292)+","+(nYCurPos)+",73,20,0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos+292)+","+(nYCurPos)+",73,20,0,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos+292)+","+(nYCurPos)+",73,1,10,0/,돋움체,RGB[0,0,0], , , ,NONE,20,1)");
		out.println(sheet10_E4+"\r");
		out.println("^CELLBG("+(nXCurPos+365)+","+(nYCurPos)+",73,20,1,RGB[230,230,250],RGB[230,230,250],0)\r");
		out.println("^CELLLINE("+(nXCurPos+365)+","+(nYCurPos)+",73,20,0,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos+365)+","+(nYCurPos)+",73,20,0,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos+365)+","+(nYCurPos)+",73,20,0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos+365)+","+(nYCurPos)+",73,20,0,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos+365)+","+(nYCurPos)+",73,1,10,0/,돋움체,RGB[0,0,0], , , ,NONE,20,1)");
		out.println(sheet10_F4+"\r");
		out.println("^CELLBG("+(nXCurPos+438)+","+(nYCurPos)+",73,20,1,RGB[230,230,250],RGB[230,230,250],0)\r");
		out.println("^CELLLINE("+(nXCurPos+438)+","+(nYCurPos)+",73,20,0,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos+438)+","+(nYCurPos)+",73,20,0,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos+438)+","+(nYCurPos)+",73,20,0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos+438)+","+(nYCurPos)+",73,20,0,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos+438)+","+(nYCurPos)+",73,1,10,0/,돋움체,RGB[0,0,0], , , ,NONE,20,1)");
	...
	private void writeScriptloop( ) throws Exception{
		//스크립트문 생성
		out.println("^CELLLINE("+(nXCurPos)+","+(nYCurPos)+",73,"+(nAutoHeight_loop[1])+",0,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos)+","+(nYCurPos)+",73,"+(nAutoHeight_loop[1])+",0,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos)+","+(nYCurPos)+",73,"+(nAutoHeight_loop[1])+",0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos)+","+(nYCurPos)+",73,"+(nAutoHeight_loop[1])+",0,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos)+","+(nYCurPos)+",73,0,10,0/,돋움체,RGB[0,0,0], , , ,XL,"+(nAutoHeight_loop[1])+",1)");
		out.println(sheet10_A5+"\r");
		out.println("^CELLLINE("+(nXCurPos+73)+","+(nYCurPos)+",73,"+(nAutoHeight_loop[0])+",0,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos+73)+","+(nYCurPos)+",73,"+(nAutoHeight_loop[0])+",0,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos+73)+","+(nYCurPos)+",73,"+(nAutoHeight_loop[0])+",0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos+73)+","+(nYCurPos)+",73,"+(nAutoHeight_loop[0])+",0,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos+73)+","+(nYCurPos)+",73,2,10,5/### \"명\"*,돋움체,RGB[0,0,0], , , ,NONE,"+(nAutoHeight_loop[0])+",1)");
		out.println(sheet10_B5+"\r");
		out.println("^CELLLINE("+(nXCurPos+146)+","+(nYCurPos)+",73,"+(nAutoHeight_loop[0])+",0,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos+146)+","+(nYCurPos)+",73,"+(nAutoHeight_loop[0])+",0,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos+146)+","+(nYCurPos)+",73,"+(nAutoHeight_loop[0])+",0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos+146)+","+(nYCurPos)+",73,"+(nAutoHeight_loop[0])+",0,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos+146)+","+(nYCurPos)+",73,2,10,5/### \"명\"*,돋움체,RGB[0,0,0], , , ,NONE,"+(nAutoHeight_loop[0])+",1)");
		out.println(sheet10_C5+"\r");
		out.println("^CELLLINE("+(nXCurPos+219)+","+(nYCurPos)+",73,"+(nAutoHeight_loop[0])+",0,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos+219)+","+(nYCurPos)+",73,"+(nAutoHeight_loop[0])+",0,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos+219)+","+(nYCurPos)+",73,"+(nAutoHeight_loop[0])+",0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos+219)+","+(nYCurPos)+",73,"+(nAutoHeight_loop[0])+",0,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos+219)+","+(nYCurPos)+",73,2,10,5/### \"명\"*,돋움체,RGB[0,0,0], , , ,NONE,"+(nAutoHeight_loop[0])+",1)");
		out.println(sheet10_D5+"\r");
		out.println("^CELLLINE("+(nXCurPos+292)+","+(nYCurPos)+",73,"+(nAutoHeight_loop[0])+",0,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos+292)+","+(nYCurPos)+",73,"+(nAutoHeight_loop[0])+",0,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos+292)+","+(nYCurPos)+",73,"+(nAutoHeight_loop[0])+",0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos+292)+","+(nYCurPos)+",73,"+(nAutoHeight_loop[0])+",0,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos+292)+","+(nYCurPos)+",73,2,10,5/### \"명\"*,돋움체,RGB[0,0,0], , , ,NONE,"+(nAutoHeight_loop[0])+",1)");
		out.println(sheet10_E5+"\r");
		out.println("^CELLLINE("+(nXCurPos+365)+","+(nYCurPos)+",73,"+(nAutoHeight_loop[0])+",0,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos+365)+","+(nYCurPos)+",73,"+(nAutoHeight_loop[0])+",0,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos+365)+","+(nYCurPos)+",73,"+(nAutoHeight_loop[0])+",0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos+365)+","+(nYCurPos)+",73,"+(nAutoHeight_loop[0])+",0,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos+365)+","+(nYCurPos)+",73,2,10,5/### \"명\"*,돋움체,RGB[0,0,0], , , ,NONE,"+(nAutoHeight_loop[0])+",1)");
		out.println(sheet10_F5+"\r");
		out.println("^CELLLINE("+(nXCurPos+438)+","+(nYCurPos)+",73,"+(nAutoHeight_loop[0])+",0,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos+438)+","+(nYCurPos)+",73,"+(nAutoHeight_loop[0])+",0,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos+438)+","+(nYCurPos)+",73,"+(nAutoHeight_loop[0])+",0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos+438)+","+(nYCurPos)+",73,"+(nAutoHeight_loop[0])+",0,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos+438)+","+(nYCurPos)+",73,2,10,5/### \"명\"*,돋움체,RGB[0,0,0], , , ,NONE,"+(nAutoHeight_loop[0])+",1)");
		out.println(sheet10_G5+"\r");
		out.println("^CELLLINE("+(nXCurPos+73)+","+(nYCurPos+nAutoHeight_loop[0])+",73,"+(nAutoHeight_loop[1]-nAutoHeight_loop[0])+",0,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos+73)+","+(nYCurPos+nAutoHeight_loop[0])+",73,"+(nAutoHeight_loop[1]-nAutoHeight_loop[0])+",0,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos+73)+","+(nYCurPos+nAutoHeight_loop[0])+",73,"+(nAutoHeight_loop[1]-nAutoHeight_loop[0])+",0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos+73)+","+(nYCurPos+nAutoHeight_loop[0])+",73,"+(nAutoHeight_loop[1]-nAutoHeight_loop[0])+",0,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos+73)+","+(nYCurPos+nAutoHeight_loop[0])+",73,2,10,5/##0.00 \"%\"*,돋움체,RGB[0,0,0], , , ,NONE,"+(nAutoHeight_loop[1]-nAutoHeight_loop[0])+",1)");
		out.println(sheet10_B6+"\r");
		out.println("^CELLLINE("+(nXCurPos+146)+","+(nYCurPos+nAutoHeight_loop[0])+",73,"+(nAutoHeight_loop[1]-nAutoHeight_loop[0])+",0,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos+146)+","+(nYCurPos+nAutoHeight_loop[0])+",73,"+(nAutoHeight_loop[1]-nAutoHeight_loop[0])+",0,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos+146)+","+(nYCurPos+nAutoHeight_loop[0])+",73,"+(nAutoHeight_loop[1]-nAutoHeight_loop[0])+",0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos+146)+","+(nYCurPos+nAutoHeight_loop[0])+",73,"+(nAutoHeight_loop[1]-nAutoHeight_loop[0])+",0,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos+146)+","+(nYCurPos+nAutoHeight_loop[0])+",73,2,10,5/##0.00 \"%\"*,돋움체,RGB[0,0,0], , , ,NONE,"+(nAutoHeight_loop[1]-nAutoHeight_loop[0])+",1)");
		out.println(sheet10_C6+"\r");
		out.println("^CELLLINE("+(nXCurPos+219)+","+(nYCurPos+nAutoHeight_loop[0])+",73,"+(nAutoHeight_loop[1]-nAutoHeight_loop[0])+",0,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos+219)+","+(nYCurPos+nAutoHeight_loop[0])+",73,"+(nAutoHeight_loop[1]-nAutoHeight_loop[0])+",0,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos+219)+","+(nYCurPos+nAutoHeight_loop[0])+",73,"+(nAutoHeight_loop[1]-nAutoHeight_loop[0])+",0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos+219)+","+(nYCurPos+nAutoHeight_loop[0])+",73,"+(nAutoHeight_loop[1]-nAutoHeight_loop[0])+",0,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos+219)+","+(nYCurPos+nAutoHeight_loop[0])+",73,2,10,5/##0.00 \"%\"*,돋움체,RGB[0,0,0], , , ,NONE,"+(nAutoHeight_loop[1]-nAutoHeight_loop[0])+",1)");
		out.println(sheet10_D6+"\r");
		out.println("^CELLLINE("+(nXCurPos+292)+","+(nYCurPos+nAutoHeight_loop[0])+",73,"+(nAutoHeight_loop[1]-nAutoHeight_loop[0])+",0,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos+292)+","+(nYCurPos+nAutoHeight_loop[0])+",73,"+(nAutoHeight_loop[1]-nAutoHeight_loop[0])+",0,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos+292)+","+(nYCurPos+nAutoHeight_loop[0])+",73,"+(nAutoHeight_loop[1]-nAutoHeight_loop[0])+",0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos+292)+","+(nYCurPos+nAutoHeight_loop[0])+",73,"+(nAutoHeight_loop[1]-nAutoHeight_loop[0])+",0,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos+292)+","+(nYCurPos+nAutoHeight_loop[0])+",73,2,10,5/##0.00 \"%\"*,돋움체,RGB[0,0,0], , , ,NONE,"+(nAutoHeight_loop[1]-nAutoHeight_loop[0])+",1)");
		out.println(sheet10_E6+"\r");
		out.println("^CELLLINE("+(nXCurPos+365)+","+(nYCurPos+nAutoHeight_loop[0])+",73,"+(nAutoHeight_loop[1]-nAutoHeight_loop[0])+",0,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos+365)+","+(nYCurPos+nAutoHeight_loop[0])+",73,"+(nAutoHeight_loop[1]-nAutoHeight_loop[0])+",0,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos+365)+","+(nYCurPos+nAutoHeight_loop[0])+",73,"+(nAutoHeight_loop[1]-nAutoHeight_loop[0])+",0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos+365)+","+(nYCurPos+nAutoHeight_loop[0])+",73,"+(nAutoHeight_loop[1]-nAutoHeight_loop[0])+",0,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos+365)+","+(nYCurPos+nAutoHeight_loop[0])+",73,2,10,5/##0.00 \"%\"*,돋움체,RGB[0,0,0], , , ,NONE,"+(nAutoHeight_loop[1]-nAutoHeight_loop[0])+",1)");
		out.println(sheet10_F6+"\r");
		out.println("^CELLLINE("+(nXCurPos+438)+","+(nYCurPos+nAutoHeight_loop[0])+",73,"+(nAutoHeight_loop[1]-nAutoHeight_loop[0])+",0,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos+438)+","+(nYCurPos+nAutoHeight_loop[0])+",73,"+(nAutoHeight_loop[1]-nAutoHeight_loop[0])+",0,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos+438)+","+(nYCurPos+nAutoHeight_loop[0])+",73,"+(nAutoHeight_loop[1]-nAutoHeight_loop[0])+",0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos+438)+","+(nYCurPos+nAutoHeight_loop[0])+",73,"+(nAutoHeight_loop[1]-nAutoHeight_loop[0])+",0,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos+438)+","+(nYCurPos+nAutoHeight_loop[0])+",73,2,10,5/##0.00 \"%\"*,돋움체,RGB[0,0,0], , , ,NONE,"+(nAutoHeight_loop[1]-nAutoHeight_loop[0])+",1)");
	...
	private void writeScriptVoidBand101( ) throws Exception{
		//스크립트문 생성
		out.println("^CHART(" + (nXCurPos+3) + "," + (nYCurPos+24) + ",507,190,report58!000.cht)\r");
