...
class ReportHandler{
	...
	private void getScriptFromquestion_list(boolean bIsPrint) throws Exception{
		...
		while(QUESTION_LIST.next()){   //자동으로 생성되는 반복 밴드의 루프문
			...
			sheet30_D6=QUESTION_LIST_ANSCNT3_RAT;
			sheet30_E6=QUESTION_LIST_ANSCNT2_RAT;
			sheet30_F6=QUESTION_LIST_ANSCNT1_RAT;
	...
	private void getScriptFromlist(boolean bIsPrint) throws Exception{
		...
		while(LIST.next()){   //자동으로 생성되는 반복 밴드의 루프문
			...
			sheet40_C6=LIST_TOTAL_AVG;
			sheet40_D6=LIST_SUBJ_ANS33_RAT;
			sheet40_E6=LIST_SUBJ_ANS22_RAT;
			sheet40_F6=LIST_SUBJ_ANS11_RAT;
			sheet40_G6=LIST_SUBJ_ANS_AVG;
			sheet40_H6=LIST_STIME_ANS33_RAT;
			sheet40_I6=LIST_STIME_ANS22_RAT;
			sheet40_J6=LIST_STIME_ANS11_RAT;
			sheet40_K6=LIST_STIME_ANS_AVG;
			sheet40_L6=LIST_TUTOR_ANS33_RAT;
			sheet40_M6=LIST_TUTOR_ANS22_RAT;
			sheet40_N6=LIST_TUTOR_ANS11_RAT;
			sheet40_O6=LIST_TUTOR_ANS_AVG;

			//Auto Size Code
			int nHeightTmp;
			nAutoHeight_list[0]=0;
			nAutoHeight_list[1]=0;
			nHeightTmp=getPrintHeight(sheet40_A6, charWidth, 10, 69, 56, nAutoHeight_list[0]);
			...
			nAutoHeight_list[1]=nAutoHeight_list[0]+nAutoHeight_list[1]+36;
	...
	private void writeScriptpage1( ) throws Exception{
		...
		out.print("^PRINT("+(nXCurPos+28)+","+(nYCurPos+369)+",448,0,20,0/,돋움,RGB[0,0,255],BOLD, , ,NONE,30,1)");
		...
		out.println("^CELLBG("+(nXCurPos+127)+","+(nYCurPos+419)+",62,40,1,RGB[247,89,251],RGB[247,89,251],0)\r");
		out.println("^CELLLINE("+(nXCurPos+127)+","+(nYCurPos+419)+",62,40,1,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos+127)+","+(nYCurPos+419)+",62,40,0,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos+127)+","+(nYCurPos+419)+",62,40,0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos+127)+","+(nYCurPos+419)+",62,40,0,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos+127)+","+(nYCurPos+419)+",62,1,11,0/,바탕,RGB[0,0,0],BOLD, , ,NONE,40,1)");
		out.println(sheet10_E18+"\r");
		out.println("^CELLBG("+(nXCurPos+189)+","+(nYCurPos+419)+",224,20,1,RGB[247,89,251],RGB[247,89,251],0)\r");
		out.println("^CELLLINE("+(nXCurPos+189)+","+(nYCurPos+419)+",224,20,1,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos+189)+","+(nYCurPos+419)+",224,20,0,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos+189)+","+(nYCurPos+419)+",224,20,0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos+189)+","+(nYCurPos+419)+",224,20,0,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos+189)+","+(nYCurPos+419)+",224,1,11,0/,바탕,RGB[0,0,0],BOLD, , ,NONE,20,1)");
		out.println(sheet10_F18+"\r");
		out.println("^CELLBG("+(nXCurPos+413)+","+(nYCurPos+419)+",63,40,1,RGB[247,89,251],RGB[247,89,251],0)\r");
		out.println("^CELLLINE("+(nXCurPos+413)+","+(nYCurPos+419)+",63,40,1,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos+413)+","+(nYCurPos+419)+",63,40,0,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos+413)+","+(nYCurPos+419)+",63,40,0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos+413)+","+(nYCurPos+419)+",63,40,1,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos+413)+","+(nYCurPos+419)+",63,1,11,0/,바탕,RGB[0,0,0],BOLD, , ,NONE,40,1)");
		out.println(sheet10_K18+"\r");
		out.println("^CELLBG("+(nXCurPos+189)+","+(nYCurPos+439)+",54,20,1,RGB[247,89,251],RGB[247,89,251],0)\r");
		out.println("^CELLLINE("+(nXCurPos+189)+","+(nYCurPos+439)+",54,20,0,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos+189)+","+(nYCurPos+439)+",54,20,0,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos+189)+","+(nYCurPos+439)+",54,20,0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos+189)+","+(nYCurPos+439)+",54,20,0,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos+189)+","+(nYCurPos+439)+",54,1,11,0/,바탕,RGB[0,0,0],BOLD, , ,NONE,20,1)");
		out.println(sheet10_F19+"\r");
		out.println("^CELLBG("+(nXCurPos+243)+","+(nYCurPos+439)+",54,20,1,RGB[247,89,251],RGB[247,89,251],0)\r");
		out.println("^CELLLINE("+(nXCurPos+243)+","+(nYCurPos+439)+",54,20,0,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos+243)+","+(nYCurPos+439)+",54,20,0,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos+243)+","+(nYCurPos+439)+",54,20,0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos+243)+","+(nYCurPos+439)+",54,20,0,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos+243)+","+(nYCurPos+439)+",54,1,11,0/,바탕,RGB[0,0,0],BOLD, , ,NONE,20,1)");
		out.println(sheet10_G19+"\r");
		out.println("^CELLBG("+(nXCurPos+297)+","+(nYCurPos+439)+",54,20,1,RGB[247,89,251],RGB[247,89,251],0)\r");
		out.println("^CELLLINE("+(nXCurPos+297)+","+(nYCurPos+439)+",54,20,0,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos+297)+","+(nYCurPos+439)+",54,20,0,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos+297)+","+(nYCurPos+439)+",54,20,0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos+297)+","+(nYCurPos+439)+",54,20,0,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos+297)+","+(nYCurPos+439)+",54,1,11,0/,바탕,RGB[0,0,0],BOLD, , ,NONE,20,1)");
		out.println(sheet10_H19+"\r");
		out.println("^CELLBG("+(nXCurPos+351)+","+(nYCurPos+439)+",62,20,1,RGB[247,89,251],RGB[247,89,251],0)\r");
		out.print("^PRINT("+(nXCurPos+351)+","+(nYCurPos+439)+",62,1,11,0/,바탕,RGB[0,0,0],BOLD, , ,NONE,20,1)");
		...
		out.println("^CELLLINE("+(nXCurPos+127)+","+(nYCurPos+459)+",62,20,0,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos+127)+","+(nYCurPos+459)+",62,20,0,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos+127)+","+(nYCurPos+459)+",62,20,0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos+127)+","+(nYCurPos+459)+",62,20,0,RGB[0,0,0],3)\r");
		out.println("^CELLLINE("+(nXCurPos+189)+","+(nYCurPos+459)+",54,20,0,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos+189)+","+(nYCurPos+459)+",54,20,0,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos+189)+","+(nYCurPos+459)+",54,20,0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos+189)+","+(nYCurPos+459)+",54,20,0,RGB[0,0,0],3)\r");
		out.println("^CELLLINE("+(nXCurPos+243)+","+(nYCurPos+459)+",54,20,0,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos+243)+","+(nYCurPos+459)+",54,20,0,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos+243)+","+(nYCurPos+459)+",54,20,0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos+243)+","+(nYCurPos+459)+",54,20,0,RGB[0,0,0],3)\r");
		out.println("^CELLLINE("+(nXCurPos+297)+","+(nYCurPos+459)+",54,20,0,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos+297)+","+(nYCurPos+459)+",54,20,0,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos+297)+","+(nYCurPos+459)+",54,20,0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos+297)+","+(nYCurPos+459)+",54,20,0,RGB[0,0,0],3)\r");
		out.println("^CELLLINE("+(nXCurPos+351)+","+(nYCurPos+459)+",62,20,0,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos+351)+","+(nYCurPos+459)+",62,20,0,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos+351)+","+(nYCurPos+459)+",62,20,0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos+351)+","+(nYCurPos+459)+",62,20,0,RGB[0,0,0],3)\r");
		out.println("^CELLLINE("+(nXCurPos+413)+","+(nYCurPos+459)+",63,20,0,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos+413)+","+(nYCurPos+459)+",63,20,0,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos+413)+","+(nYCurPos+459)+",63,20,0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos+413)+","+(nYCurPos+459)+",63,20,1,RGB[0,0,0],3)\r");
		...
		out.println("^CELLLINE("+(nXCurPos+127)+","+(nYCurPos+479)+",62,20,0,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos+127)+","+(nYCurPos+479)+",62,20,1,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos+127)+","+(nYCurPos+479)+",62,20,0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos+127)+","+(nYCurPos+479)+",62,20,0,RGB[0,0,0],3)\r");
		out.println("^CELLLINE("+(nXCurPos+189)+","+(nYCurPos+479)+",54,20,0,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos+189)+","+(nYCurPos+479)+",54,20,1,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos+189)+","+(nYCurPos+479)+",54,20,0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos+189)+","+(nYCurPos+479)+",54,20,0,RGB[0,0,0],3)\r");
		out.println("^CELLLINE("+(nXCurPos+243)+","+(nYCurPos+479)+",54,20,0,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos+243)+","+(nYCurPos+479)+",54,20,1,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos+243)+","+(nYCurPos+479)+",54,20,0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos+243)+","+(nYCurPos+479)+",54,20,0,RGB[0,0,0],3)\r");
		out.println("^CELLLINE("+(nXCurPos+297)+","+(nYCurPos+479)+",54,20,0,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos+297)+","+(nYCurPos+479)+",54,20,1,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos+297)+","+(nYCurPos+479)+",54,20,0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos+297)+","+(nYCurPos+479)+",54,20,0,RGB[0,0,0],3)\r");
		out.println("^CELLLINE("+(nXCurPos+351)+","+(nYCurPos+479)+",62,20,0,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos+351)+","+(nYCurPos+479)+",62,20,1,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos+351)+","+(nYCurPos+479)+",62,20,0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos+351)+","+(nYCurPos+479)+",62,20,0,RGB[0,0,0],3)\r");
		out.println("^CELLLINE("+(nXCurPos+413)+","+(nYCurPos+479)+",63,20,0,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos+413)+","+(nYCurPos+479)+",63,20,1,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos+413)+","+(nYCurPos+479)+",63,20,0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos+413)+","+(nYCurPos+479)+",63,20,1,RGB[0,0,0],3)\r");
		...
		out.print("^PRINT("+(nXCurPos+28)+","+(nYCurPos+527)+",448,0,20,0/,돋움,RGB[0,0,255],BOLD, , ,NONE,35,1)");
		...
		out.println("^CELLBG("+(nXCurPos+108)+","+(nYCurPos+572)+",81,20,1,RGB[247,89,251],RGB[247,89,251],0)\r");
		out.println("^CELLLINE("+(nXCurPos+108)+","+(nYCurPos+572)+",81,20,1,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos+108)+","+(nYCurPos+572)+",81,20,0,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos+108)+","+(nYCurPos+572)+",81,20,0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos+108)+","+(nYCurPos+572)+",81,20,0,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos+108)+","+(nYCurPos+572)+",81,1,11,0/,바탕,RGB[0,0,0],BOLD, , ,NONE,20,1)");
		out.println(sheet10_D25+"\r");
		out.println("^CELLBG("+(nXCurPos+189)+","+(nYCurPos+572)+",108,20,1,RGB[247,89,251],RGB[247,89,251],0)\r");
		out.println("^CELLLINE("+(nXCurPos+189)+","+(nYCurPos+572)+",108,20,1,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos+189)+","+(nYCurPos+572)+",108,20,0,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos+189)+","+(nYCurPos+572)+",108,20,0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos+189)+","+(nYCurPos+572)+",108,20,0,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos+189)+","+(nYCurPos+572)+",108,1,11,0/,바탕,RGB[0,0,0],BOLD, , ,NONE,20,1)");
		out.println(sheet10_F25+"\r");
		out.println("^CELLBG("+(nXCurPos+297)+","+(nYCurPos+572)+",83,20,1,RGB[247,89,251],RGB[247,89,251],0)\r");
		out.println("^CELLLINE("+(nXCurPos+297)+","+(nYCurPos+572)+",83,20,1,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos+297)+","+(nYCurPos+572)+",83,20,0,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos+297)+","+(nYCurPos+572)+",83,20,0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos+297)+","+(nYCurPos+572)+",83,20,0,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos+297)+","+(nYCurPos+572)+",83,1,11,0/,바탕,RGB[0,0,0],BOLD, , ,NONE,20,1)");
		out.println(sheet10_H25+"\r");
		out.println("^CELLBG("+(nXCurPos+380)+","+(nYCurPos+572)+",96,20,1,RGB[247,89,251],RGB[247,89,251],0)\r");
		out.println("^CELLLINE("+(nXCurPos+380)+","+(nYCurPos+572)+",96,20,1,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos+380)+","+(nYCurPos+572)+",96,20,0,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos+380)+","+(nYCurPos+572)+",96,20,0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos+380)+","+(nYCurPos+572)+",96,20,1,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos+380)+","+(nYCurPos+572)+",96,1,11,0/,바탕,RGB[0,0,0],BOLD, , ,NONE,20,1)");
	...
	private void writeScripttitle04( ) throws Exception{
		//스크립트문 생성
		out.println("^CELLLINE("+(nXCurPos)+","+(nYCurPos)+",33,28,0,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos)+","+(nYCurPos)+",33,28,0,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos)+","+(nYCurPos)+",33,28,0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos)+","+(nYCurPos)+",33,28,0,RGB[0,0,0],3)\r");
	...
	private void writeScriptquestion_list( ) throws Exception{
		...
		out.print("^PRINT("+(nXCurPos+188)+","+(nYCurPos)+",37,1,10,1/0/0,바탕,RGB[255,0,0], , , ,NONE,"+(nAutoHeight_question_list[1])+",1)");
		...
		out.print("^PRINT("+(nXCurPos+225)+","+(nYCurPos)+",45,1,10,1/0/0,바탕,RGB[255,0,0], , , ,NONE,"+(nAutoHeight_question_list[0])+",1)");
		...
		out.print("^PRINT("+(nXCurPos+270)+","+(nYCurPos)+",45,1,10,1/0/0,바탕,RGB[255,0,0], , , ,NONE,"+(nAutoHeight_question_list[0])+",1)");
		...
		out.print("^PRINT("+(nXCurPos+315)+","+(nYCurPos)+",45,1,10,1/0/0,바탕,RGB[255,0,0], , , ,NONE,"+(nAutoHeight_question_list[0])+",1)");
		...
		out.print("^PRINT("+(nXCurPos+360)+","+(nYCurPos)+",49,1,10,0/,바탕,RGB[0,0,0], , , ,NONE,"+(nAutoHeight_question_list[1])+",1)");
		...
		out.print("^PRINT("+(nXCurPos+409)+","+(nYCurPos)+",58,1,10,0/,바탕,RGB[0,0,255], , , ,NONE,"+(nAutoHeight_question_list[1])+",1)");
	...
	private void writeScriptlist( ) throws Exception{
		...
		out.print("^PRINT("+(nXCurPos+108)+","+(nYCurPos)+",31,1,10,0/,바탕,RGB[0,0,255], , , ,NONE,"+(nAutoHeight_list[1])+",1)");
		...
		out.print("^PRINT("+(nXCurPos+223)+","+(nYCurPos)+",28,1,9,0/,바탕,RGB[0,0,0], , , ,NONE,"+(nAutoHeight_list[1])+",1)");
		...
		out.print("^PRINT("+(nXCurPos+335)+","+(nYCurPos)+",28,1,9,0/,바탕,RGB[0,0,0], , , ,NONE,"+(nAutoHeight_list[1])+",1)");
		...
		out.print("^PRINT("+(nXCurPos+447)+","+(nYCurPos)+",28,1,9,0/,바탕,RGB[0,0,0], , , ,NONE,"+(nAutoHeight_list[1])+",1)");
	...
	private void initSQLConst(){
		...
		sql_LIST = sql_LIST + "    CASE WHEN SUBJ_ANS_TOTAL > 0 THEN ROUND((SUBJ_ANS1 * 1 +  SUBJ_ANS2 * 2 + SUBJ_ANS3 * 3 + SUBJ_ANS4 * 4 + SUBJ_ANS5 * 5) / SUBJ_ANS_TOTAL,1)  ELSE 0 END || '점' AS SUBJ_ANS_AVG, ";
		sql_LIST = sql_LIST + "    CASE WHEN STIME_ANS_TOTAL > 0 THEN ROUND((STIME_ANS1 * 1 + STIME_ANS2 * 2 + STIME_ANS3 * 3 + STIME_ANS4 * 4 + STIME_ANS5 * 5) / STIME_ANS_TOTAL,1) ELSE 0 END || '점'  AS STIME_ANS_AVG, ";
		sql_LIST = sql_LIST + "    CASE WHEN TUTOR_ANS_TOTAL > 0 THEN ROUND((TUTOR_ANS1 * 1 + TUTOR_ANS2 * 2 + TUTOR_ANS3 * 3 + TUTOR_ANS4 * 4 + TUTOR_ANS5 * 5) / TUTOR_ANS_TOTAL,1) ELSE 0 END || '점' AS TUTOR_ANS_AVG, ";
		...
		sql_LIST = sql_LIST + "    CASE WHEN TUTOR_ANS_TOTAL > 0 THEN ROUND((TUTOR_ANS1 * 1 + TUTOR_ANS2 * 2 + TUTOR_ANS3 * 3 + TUTOR_ANS4 * 4 + TUTOR_ANS5 * 5) / TUTOR_ANS_TOTAL * 20,1) ELSE 0 END) / 3,1) || '점' AS TOTAL_AVG     ";
		...
		sql_QUESTION_LIST = sql_QUESTION_LIST + "        round((anscnt1 * 1 +  anscnt2 * 2 + anscnt3 * 3 + anscnt4 * 4 + anscnt5 * 5) / total_cnt,1) || '점'  as rat_cnt, ";
		sql_QUESTION_LIST = sql_QUESTION_LIST + "        round((anscnt1 * 1 +  anscnt2 * 2 + anscnt3 * 3 + anscnt4 * 4 + anscnt5 * 5) / total_cnt *20,1) || '점'  as rat ";
	...
	private void setFieldVariableFromLIST() throws Exception{
		...
		LIST_SUBJ_ANS11_RAT=GetB(LIST.getString(17));
		LIST_SUBJ_ANS22_RAT=GetB(LIST.getString(18));
		LIST_SUBJ_ANS33_RAT=GetB(LIST.getString(19));
		LIST_STIME_ANS11_RAT=GetB(LIST.getString(20));
		LIST_STIME_ANS22_RAT=GetB(LIST.getString(21));
		LIST_STIME_ANS33_RAT=GetB(LIST.getString(22));
		LIST_TUTOR_ANS11_RAT=GetB(LIST.getString(23));
		LIST_TUTOR_ANS22_RAT=GetB(LIST.getString(24));
		LIST_TUTOR_ANS33_RAT=GetB(LIST.getString(25));
		LIST_SUBJ_ANS_AVG=GetB(LIST.getString(26));
		LIST_STIME_ANS_AVG=GetB(LIST.getString(27));
		LIST_TUTOR_ANS_AVG=GetB(LIST.getString(28));
		LIST_TOTAL_AVG=GetB(LIST.getString(29));
	}
	...
	private void initConstVarient(){
		...
		sheet20_A1="4";
		sheet20_B1="설문세부내용";
		sheet20_A3="   1. 교육생 기본사항";
		sheet30_A1="   2. 과정운영 만족도 분석";
		sheet30_A3="구    분";
		sheet30_C3="응답자수";
		sheet30_D3="만족율(%)";
		sheet30_G3="만족도(5점척도)";
		...
		sheet50_A1=5;
		sheet50_B1=" 주관식 답변";
		sheet50_B2="① 교육과정운영 관련";
		sheet50_B6="② 교과목이나 강사에 대한 기타 의견";
		sheet50_A10=6;
		sheet50_B10=" 과정장 의견";
	}
