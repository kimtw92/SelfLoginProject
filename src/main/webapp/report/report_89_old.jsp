...
class ReportHandler{
	...
	String sheet20_G4;
	String sheet20_A6;
	int[] nAutoHeight_QUESTION2=new int[1];
	String sheet20_A7;
	double sheet20_D7;
	String sheet20_E7;
	String sheet20_F7;
	String sheet20_G7;
	String sheet20_A9;
	int[] nAutoHeight_QUESTION3=new int[1];
	String sheet20_A10;
	double sheet20_D10;
	String sheet20_E10;
	String sheet20_F10;
	String sheet20_G10;
	String sheet20_A12;
	int[] nAutoHeight_QUESTION4=new int[1];
	String sheet20_A13;
	double sheet20_D13;
	String sheet20_E13;
	String sheet20_F13;
	String sheet20_G13;
	String sheet20_A15;
	int[] nAutoHeight_QUESTION5_1=new int[1];
	String sheet20_A16;
	double sheet20_D16;
	String sheet20_E16;
	String sheet20_F16;
	String sheet20_G16;
	int[] nAutoHeight_QUESTION5_2=new int[1];
	String sheet20_A17;
	String sheet20_D17;
	String sheet20_E17;
	String sheet20_F17;
	int[] nAutoHeight_QUESTION5_3=new int[1];
	String sheet20_A18;
	String sheet20_D18;
	String sheet20_E18;
	String sheet20_F18;
	...
	private double QUESTION_LIST_ANSCNT1;
	private double QUESTION_LIST_ANSCNT1_RAT;
	private double QUESTION_LIST_ANSCNT2;
	private double QUESTION_LIST_ANSCNT2_RAT;
	private double QUESTION_LIST_ANSCNT3;
	private double QUESTION_LIST_ANSCNT3_RAT;
	private double QUESTION_LIST_ANSCNT4;
	private double QUESTION_LIST_ANSCNT4_RAT;
	private double QUESTION_LIST_ANSCNT5;
	...
	private void executeSheet20( ) throws Exception{
		//쉬트 초기화 함수 호출
		initSheetVariant(41, 41, 555, 801, true);

		//시작 페이지 번호 출력
		out.print("-- " + nPageNum + " PAGE --\r");

		//밴드 함수 호출
		getScriptFrompage2_1(true, true);    //Void 밴드 호출
		getScriptFromHEADER_QUESTION1(true, true);    //Void 밴드 호출
		getScriptFromQUESTION1(true);    //반복 밴드 호출
		getScriptFromHEADER_QUESTION2(true, true);    //Void 밴드 호출
		getScriptFromQUESTION2(true, true);    //Void 밴드 호출
		getScriptFromHEADER_QUESTION3(true, true);    //Void 밴드 호출
		getScriptFromQUESTION3(true);    //반복 밴드 호출
		getScriptFromHEADER_QUESTION4(true, true);    //Void 밴드 호출
		getScriptFromQUESTION4(true);    //반복 밴드 호출
		getScriptFromHEADER_QUESTION5(true, true);    //Void 밴드 호출
		getScriptFromQUESTION5_1(true);    //반복 밴드 호출
		getScriptFromQUESTION5_2(true);    //반복 밴드 호출
		getScriptFromQUESTION5_3(true);    //반복 밴드 호출
		getScriptFromNON_QUESTION(true, true);    //Void 밴드 호출
	...
	//----bIsPrint : 감추기 속성 설정 여부. true면 출력, false면 AI 스크립트를 생성하지 않음.
	//----nRepeatCnt : 부모 반복 밴드 수행 횟수와 연동 옵션 설정시 void 밴드가 수행할 반복 횟수 전달
	private void getScriptFrompage2_1(boolean bIsFirst, boolean bIsPrint) throws Exception{
		//지역 변수 선언 및 초기화
	...
	//----HEADER_QUESTION1 VoidBand Start----
	//----소속 쉬트 : SHEET=Sheet2    FRAME=Frame0
	//----밴드 이름 : HEADER_QUESTION1
	//----밴드 종류 : Void 밴드
	//----bIsFrist : 부모 밴드 함수나 쉬트 함수에서 최초로 호출될 때 true, 그 이후 호출될 때 false
	//----bIsPrint : 감추기 속성 설정 여부. true면 출력, false면 AI 스크립트를 생성하지 않음.
	//----nRepeatCnt : 부모 반복 밴드 수행 횟수와 연동 옵션 설정시 void 밴드가 수행할 반복 횟수 전달
	private void getScriptFromHEADER_QUESTION1(boolean bIsFirst, boolean bIsPrint) throws Exception{
		//지역 변수 선언 및 초기화
	...
	private void getScriptFromQUESTION1(boolean bIsPrint) throws Exception{
		...
		//DataSet 객체 생성
		//ResultSet QUESTION1 객체의 생성
		if(QUESTION1==null){
			QUESTION1 = stat_QUESTION1.executeQuery(sql_QUESTION1);
		}else{
			QUESTION1.beforeFirst();
		}

		while(QUESTION1.next()){   //자동으로 생성되는 반복 밴드의 루프문
			//데이터 fetch
			setFieldVariableFromQUESTION1();	//RecordSet QUESTION1에서 필드 값 설정

			if(bIsFirst){   //밴드 호출 후 루프 내에서 한번 만 실행되는 코드
			}   //end if(bIsFirst)

			//데이터 변수 할당
			sheet20_A4= (long)QUESTION1_QUESTION_NO + ". " + QUESTION1_QUESTION + " : " + QUESTION1_ENOUGH_RAT + " " + QUESTION1_REGULAR_RAT;
			sheet20_D4=QUESTION1_QUESTION_NO;
			sheet20_E4=QUESTION1_QUESTION;
			sheet20_F4=QUESTION1_ENOUGH_RAT;
			sheet20_G4=QUESTION1_REGULAR_RAT;

			//Auto Size Code
			nAutoHeight_QUESTION1[0]=0;
			nAutoHeight_QUESTION1[0]=getPrintHeight(sheet20_A4, charWidth, 11, 512, 22, nAutoHeight_QUESTION1[0]);
			nAutoHeight_QUESTION1[0]=nAutoHeight_QUESTION1[0]+22;
	...
	//----HEADER_QUESTION2 VoidBand Start----
	//----소속 쉬트 : SHEET=Sheet2    FRAME=Frame0
	//----밴드 이름 : HEADER_QUESTION2
	//----밴드 종류 : Void 밴드
	//----bIsFrist : 부모 밴드 함수나 쉬트 함수에서 최초로 호출될 때 true, 그 이후 호출될 때 false
	//----bIsPrint : 감추기 속성 설정 여부. true면 출력, false면 AI 스크립트를 생성하지 않음.
	//----nRepeatCnt : 부모 반복 밴드 수행 횟수와 연동 옵션 설정시 void 밴드가 수행할 반복 횟수 전달
	private void getScriptFromHEADER_QUESTION2(boolean bIsFirst, boolean bIsPrint) throws Exception{
		//지역 변수 선언 및 초기화
		int nBandHeight=44;    //밴드 출력 높이
	...
	//----bIsPrint : 감추기 속성 설정 여부. true면 출력, false면 AI 스크립트를 생성하지 않음.
	//----nRepeatCnt : 부모 반복 밴드 수행 횟수와 연동 옵션 설정시 void 밴드가 수행할 반복 횟수 전달
	private void getScriptFromQUESTION2(boolean bIsFirst, boolean bIsPrint) throws Exception{
		//지역 변수 선언 및 초기화
		int nBandHeight=22;    //밴드 출력 높이
		//폰트명 : 바탕체
		//폰트 사이즈 : 11
		...
		if(bIsFirst){   //밴드 최초 호출 시에만 실행되는 코드
			...
			//데이터 fetch
			if(QUESTION2.next()){
				setFieldVariableFromQUESTION2();	//ResultSet QUESTION2에서 필드 값 설정
			}else{
				setFieldInitFromQUESTION2();	//ResultSet QUESTION2의 필드 값 초기화
			}
			...
			//데이터 변수 할당
			sheet20_A7= (long)QUESTION2_QUESTION_NO + ". " + QUESTION2_QUESTION + " : " + QUESTION2_ENOUGH_RAT + " " + QUESTION2_REGULAR_RAT;
			sheet20_D7=QUESTION2_QUESTION_NO;
			sheet20_E7=QUESTION2_QUESTION;
			sheet20_F7=QUESTION2_ENOUGH_RAT;
			sheet20_G7=QUESTION2_REGULAR_RAT;

			//Auto Size Code
			nAutoHeight_QUESTION2[0]=0;
			nAutoHeight_QUESTION2[0]=getPrintHeight(sheet20_A7, charWidth, 11, 512, 22, nAutoHeight_QUESTION2[0]);
			nAutoHeight_QUESTION2[0]=nAutoHeight_QUESTION2[0]+22;
		}    //end if(bIsFirst)

		//AI 스크립트 출력
		if(bIsPrint){   //감추기 속성이 지정되지 않으면 bIsPrint는 true
			//스크립트 출력 영역 검사
			nBandHeight=nAutoHeight_QUESTION2[0];
			if(isPageSkip(nYCurPos+nBandHeight)){
				pageSkip(20);
			}

			//스크립트 출력 함수 호출
			writeScriptQUESTION2();
	...
	//----HEADER_QUESTION3 VoidBand Start----
	//----소속 쉬트 : SHEET=Sheet2    FRAME=Frame0
	//----밴드 이름 : HEADER_QUESTION3
	//----밴드 종류 : Void 밴드
	//----bIsFrist : 부모 밴드 함수나 쉬트 함수에서 최초로 호출될 때 true, 그 이후 호출될 때 false
	//----bIsPrint : 감추기 속성 설정 여부. true면 출력, false면 AI 스크립트를 생성하지 않음.
	//----nRepeatCnt : 부모 반복 밴드 수행 횟수와 연동 옵션 설정시 void 밴드가 수행할 반복 횟수 전달
	private void getScriptFromHEADER_QUESTION3(boolean bIsFirst, boolean bIsPrint) throws Exception{
		//지역 변수 선언 및 초기화
		int nBandHeight=44;    //밴드 출력 높이
	...
	//-----QUESTION3 RepeatBand Start-----
	//-----소속 쉬트 : SHEET=Sheet2   FRAME=Frame0
	//-----밴드 이름 : QUESTION3
	//-----밴드 종류 : 반복 밴드
	//-----bIsPrint : 감추기 속성 설정 여부 true면 출력, false면 스크립트를 생성하지 않음
	private void getScriptFromQUESTION3(boolean bIsPrint) throws Exception{
		//지역 변수 선언 및 초기화
		int nBandHeight=22;    //밴드 출력 높이
		boolean bIsFirst=true;
		//폰트명 : 바탕체
		...
		//DataSet 객체 생성
		//ResultSet QUESTION3 객체의 생성
		if(QUESTION3==null){
			QUESTION3 = stat_QUESTION3.executeQuery(sql_QUESTION3);
		}else{
			QUESTION3.beforeFirst();
		}

		while(QUESTION3.next()){   //자동으로 생성되는 반복 밴드의 루프문
			//데이터 fetch
			setFieldVariableFromQUESTION3();	//RecordSet QUESTION3에서 필드 값 설정

			if(bIsFirst){   //밴드 호출 후 루프 내에서 한번 만 실행되는 코드
			}   //end if(bIsFirst)

			//데이터 변수 할당
			sheet20_A10= (long)QUESTION3_QUESTION_NO + ". " + QUESTION3_QUESTION + " : " + QUESTION3_ENOUGH_RAT + " " + QUESTION3_REGULAR_RAT;
			sheet20_D10=QUESTION3_QUESTION_NO;
			sheet20_E10=QUESTION3_QUESTION;
			sheet20_F10=QUESTION3_ENOUGH_RAT;
			sheet20_G10=QUESTION3_REGULAR_RAT;

			//Auto Size Code
			nAutoHeight_QUESTION3[0]=0;
			nAutoHeight_QUESTION3[0]=getPrintHeight(sheet20_A10, charWidth, 11, 512, 22, nAutoHeight_QUESTION3[0]);
			nAutoHeight_QUESTION3[0]=nAutoHeight_QUESTION3[0]+22;
			nBandHeight=nAutoHeight_QUESTION3[0];   //밴드 출력 높이 설정
	...
	//----HEADER_QUESTION4 VoidBand Start----
	//----소속 쉬트 : SHEET=Sheet2    FRAME=Frame0
	//----밴드 이름 : HEADER_QUESTION4
	//----밴드 종류 : Void 밴드
	//----bIsFrist : 부모 밴드 함수나 쉬트 함수에서 최초로 호출될 때 true, 그 이후 호출될 때 false
	//----bIsPrint : 감추기 속성 설정 여부. true면 출력, false면 AI 스크립트를 생성하지 않음.
	//----nRepeatCnt : 부모 반복 밴드 수행 횟수와 연동 옵션 설정시 void 밴드가 수행할 반복 횟수 전달
	private void getScriptFromHEADER_QUESTION4(boolean bIsFirst, boolean bIsPrint) throws Exception{
		//지역 변수 선언 및 초기화
		int nBandHeight=44;    //밴드 출력 높이
	...
	//-----QUESTION4 RepeatBand Start-----
	//-----소속 쉬트 : SHEET=Sheet2   FRAME=Frame0
	//-----밴드 이름 : QUESTION4
	//-----밴드 종류 : 반복 밴드
	//-----bIsPrint : 감추기 속성 설정 여부 true면 출력, false면 스크립트를 생성하지 않음
	private void getScriptFromQUESTION4(boolean bIsPrint) throws Exception{
		//지역 변수 선언 및 초기화
		int nBandHeight=22;    //밴드 출력 높이
		boolean bIsFirst=true;
		//폰트명 : 바탕체
		...
		//DataSet 객체 생성
		//ResultSet QUESTION4 객체의 생성
		if(QUESTION4==null){
			QUESTION4 = stat_QUESTION4.executeQuery(sql_QUESTION4);
		}else{
			QUESTION4.beforeFirst();
		}

		while(QUESTION4.next()){   //자동으로 생성되는 반복 밴드의 루프문
			//데이터 fetch
			setFieldVariableFromQUESTION4();	//RecordSet QUESTION4에서 필드 값 설정

			if(bIsFirst){   //밴드 호출 후 루프 내에서 한번 만 실행되는 코드
			}   //end if(bIsFirst)

			//데이터 변수 할당
			sheet20_A13= (long)QUESTION4_QUESTION_NO + ". " + QUESTION4_QUESTION + " : " + QUESTION4_ENOUGH_RAT + " " + QUESTION4_REGULAR_RAT;
			sheet20_D13=QUESTION4_QUESTION_NO;
			sheet20_E13=QUESTION4_QUESTION;
			sheet20_F13=QUESTION4_ENOUGH_RAT;
			sheet20_G13=QUESTION4_REGULAR_RAT;

			//Auto Size Code
			nAutoHeight_QUESTION4[0]=0;
			nAutoHeight_QUESTION4[0]=getPrintHeight(sheet20_A13, charWidth, 11, 512, 22, nAutoHeight_QUESTION4[0]);
			nAutoHeight_QUESTION4[0]=nAutoHeight_QUESTION4[0]+22;
			nBandHeight=nAutoHeight_QUESTION4[0];   //밴드 출력 높이 설정
	...
	//----HEADER_QUESTION5 VoidBand Start----
	//----소속 쉬트 : SHEET=Sheet2    FRAME=Frame0
	//----밴드 이름 : HEADER_QUESTION5
	//----밴드 종류 : Void 밴드
	//----bIsFrist : 부모 밴드 함수나 쉬트 함수에서 최초로 호출될 때 true, 그 이후 호출될 때 false
	//----bIsPrint : 감추기 속성 설정 여부. true면 출력, false면 AI 스크립트를 생성하지 않음.
	//----nRepeatCnt : 부모 반복 밴드 수행 횟수와 연동 옵션 설정시 void 밴드가 수행할 반복 횟수 전달
	private void getScriptFromHEADER_QUESTION5(boolean bIsFirst, boolean bIsPrint) throws Exception{
		//지역 변수 선언 및 초기화
		int nBandHeight=44;    //밴드 출력 높이
	...
	//-----QUESTION5_1 RepeatBand Start-----
	//-----소속 쉬트 : SHEET=Sheet2   FRAME=Frame0
	//-----밴드 이름 : QUESTION5_1
	//-----밴드 종류 : 반복 밴드
	//-----bIsPrint : 감추기 속성 설정 여부 true면 출력, false면 스크립트를 생성하지 않음
	private void getScriptFromQUESTION5_1(boolean bIsPrint) throws Exception{
		//지역 변수 선언 및 초기화
		int nBandHeight=22;    //밴드 출력 높이
		boolean bIsFirst=true;
		//폰트명 : 바탕체
		...
		//DataSet 객체 생성
		//ResultSet QUESTION5_1 객체의 생성
		if(QUESTION5_1==null){
			QUESTION5_1 = stat_QUESTION5_1.executeQuery(sql_QUESTION5_1);
		}else{
			QUESTION5_1.beforeFirst();
		}

		while(QUESTION5_1.next()){   //자동으로 생성되는 반복 밴드의 루프문
			//데이터 fetch
			setFieldVariableFromQUESTION5_1();	//RecordSet QUESTION5_1에서 필드 값 설정

			if(bIsFirst){   //밴드 호출 후 루프 내에서 한번 만 실행되는 코드
			}   //end if(bIsFirst)

			//데이터 변수 할당
			sheet20_A16= (long)QUESTION5_1_QUESTION_NO + ". " + QUESTION5_1_QUESTION + " : " + QUESTION5_1_ENOUGH_RAT + " " + QUESTION5_1_REGULAR_RAT;
			sheet20_D16=QUESTION5_1_QUESTION_NO;
			sheet20_E16=QUESTION5_1_QUESTION;
			sheet20_F16=QUESTION5_1_ENOUGH_RAT;
			sheet20_G16=QUESTION5_1_REGULAR_RAT;

			//Auto Size Code
			nAutoHeight_QUESTION5_1[0]=0;
			nAutoHeight_QUESTION5_1[0]=getPrintHeight(sheet20_A16, charWidth, 11, 512, 22, nAutoHeight_QUESTION5_1[0]);
			nAutoHeight_QUESTION5_1[0]=nAutoHeight_QUESTION5_1[0]+22;
			nBandHeight=nAutoHeight_QUESTION5_1[0];   //밴드 출력 높이 설정
	...
	//-----QUESTION5_2 RepeatBand Start-----
	//-----소속 쉬트 : SHEET=Sheet2   FRAME=Frame0
	//-----밴드 이름 : QUESTION5_2
	//-----밴드 종류 : 반복 밴드
	//-----bIsPrint : 감추기 속성 설정 여부 true면 출력, false면 스크립트를 생성하지 않음
	private void getScriptFromQUESTION5_2(boolean bIsPrint) throws Exception{
		//지역 변수 선언 및 초기화
		int nBandHeight=22;    //밴드 출력 높이
		boolean bIsFirst=true;
		//폰트명 : 바탕체
		...
		//DataSet 객체 생성
		//ResultSet QUESTION5_2 객체의 생성
		if(QUESTION5_2==null){
			QUESTION5_2 = stat_QUESTION5_2.executeQuery(sql_QUESTION5_2);
		}else{
			QUESTION5_2.beforeFirst();
		}

		while(QUESTION5_2.next()){   //자동으로 생성되는 반복 밴드의 루프문
			//데이터 fetch
			setFieldVariableFromQUESTION5_2();	//RecordSet QUESTION5_2에서 필드 값 설정

			if(bIsFirst){   //밴드 호출 후 루프 내에서 한번 만 실행되는 코드
			}   //end if(bIsFirst)

			//데이터 변수 할당
			sheet20_A17= QUESTION5_2_NAME + " : " + QUESTION5_2_SUBJNM + " : " + QUESTION5_2_TUTOR_RAT;
			sheet20_D17=QUESTION5_2_NAME;
			sheet20_E17=QUESTION5_2_SUBJNM;
			sheet20_F17=QUESTION5_2_TUTOR_RAT;

			//Auto Size Code
			nAutoHeight_QUESTION5_2[0]=0;
			nAutoHeight_QUESTION5_2[0]=getPrintHeight(sheet20_A17, charWidth, 11, 512, 22, nAutoHeight_QUESTION5_2[0]);
			nAutoHeight_QUESTION5_2[0]=nAutoHeight_QUESTION5_2[0]+22;
			nBandHeight=nAutoHeight_QUESTION5_2[0];   //밴드 출력 높이 설정
	...
	//-----QUESTION5_3 RepeatBand Start-----
	//-----소속 쉬트 : SHEET=Sheet2   FRAME=Frame0
	//-----밴드 이름 : QUESTION5_3
	//-----밴드 종류 : 반복 밴드
	//-----bIsPrint : 감추기 속성 설정 여부 true면 출력, false면 스크립트를 생성하지 않음
	private void getScriptFromQUESTION5_3(boolean bIsPrint) throws Exception{
		//지역 변수 선언 및 초기화
		int nBandHeight=22;    //밴드 출력 높이
		boolean bIsFirst=true;
		//폰트명 : 바탕체
		...
		//DataSet 객체 생성
		//ResultSet QUESTION5_3 객체의 생성
		if(QUESTION5_3==null){
			QUESTION5_3 = stat_QUESTION5_3.executeQuery(sql_QUESTION5_3);
		}else{
			QUESTION5_3.beforeFirst();
		}

		while(QUESTION5_3.next()){   //자동으로 생성되는 반복 밴드의 루프문
			//데이터 fetch
			setFieldVariableFromQUESTION5_3();	//RecordSet QUESTION5_3에서 필드 값 설정

			if(bIsFirst){   //밴드 호출 후 루프 내에서 한번 만 실행되는 코드
			}   //end if(bIsFirst)

			//데이터 변수 할당
			sheet20_A18= QUESTION5_3_NAME + " : " + QUESTION5_3_SUBJNM + " : " + QUESTION5_3_TUTOR_RAT;
			sheet20_D18=QUESTION5_3_NAME;
			sheet20_E18=QUESTION5_3_SUBJNM;
			sheet20_F18=QUESTION5_3_TUTOR_RAT;

			//Auto Size Code
			nAutoHeight_QUESTION5_3[0]=0;
			nAutoHeight_QUESTION5_3[0]=getPrintHeight(sheet20_A18, charWidth, 11, 512, 22, nAutoHeight_QUESTION5_3[0]);
			nAutoHeight_QUESTION5_3[0]=nAutoHeight_QUESTION5_3[0]+22;
			nBandHeight=nAutoHeight_QUESTION5_3[0];   //밴드 출력 높이 설정
	...
	//----bIsPrint : 감추기 속성 설정 여부. true면 출력, false면 AI 스크립트를 생성하지 않음.
	//----nRepeatCnt : 부모 반복 밴드 수행 횟수와 연동 옵션 설정시 void 밴드가 수행할 반복 횟수 전달
	private void getScriptFromNON_QUESTION(boolean bIsFirst, boolean bIsPrint) throws Exception{
		//지역 변수 선언 및 초기화
		int nBandHeight=132;    //밴드 출력 높이
	...
	private void getScriptFromans(boolean bIsPrint) throws Exception{
		...
		while(ANS.next()){   //자동으로 생성되는 반복 밴드의 루프문
			...
			//데이터 변수 할당
			sheet20_C27=ANS_CONTENT;

			//Auto Size Code
			nAutoHeight_ans[0]=0;
			nAutoHeight_ans[0]=getPrintHeight(sheet20_C27, charWidth, 11, 457, 20, nAutoHeight_ans[0]);
	...
	private void getScriptFromquest(boolean bIsPrint) throws Exception{
		...
		while(QUEST.next()){   //자동으로 생성되는 반복 밴드의 루프문
			...
			//데이터 변수 할당
			sheet20_B26=COUNT(sheet20_B26);
			sheet20_C26=QUEST_CONTENT;

			//Auto Size Code
			nAutoHeight_quest[0]=0;
			nAutoHeight_quest[0]=getPrintHeight(sheet20_C26, charWidth, 11, 457, 20, nAutoHeight_quest[0]);
	...
	private void getScriptFromquestion_list(boolean bIsPrint) throws Exception{
		...
		//폰트 사이즈 : 10
		//각 문자별 폭을 할당할 배열 선언
		int[] charWidth = {3,3,4,6,6,9,8,3,4,4,5,8,3,6,3,4,6,6,6,6,6,6,6,6,6,6,3,3,6,6,6,5,10,7,7,7,7,7,6,7,8,3,4,7,6,9,8,7,7,7,7,6,8,8,8,9,7,7,6,5,10,5,10,5,6,5,6,5,6,6,4,6,6,3,3,6,3,8,6,6,6,6,4,5,4,6,6,8,6,6,5,5,6,5,8,10};
		...
		while(QUESTION_LIST.next()){   //자동으로 생성되는 반복 밴드의 루프문
			...
			//데이터 변수 할당
			sheet30_A6=QUESTION_LIST_QUESTION_NO;
			sheet30_B6=QUESTION_LIST_QUESTION;
			sheet30_C6=QUESTION_LIST_ANSCNT1;
			sheet30_D6=QUESTION_LIST_ANSCNT2;
			sheet30_E6=QUESTION_LIST_ANSCNT3;
			sheet30_F6=QUESTION_LIST_ANSCNT4;
			sheet30_G6=QUESTION_LIST_ANSCNT5;
			sheet30_H6=QUESTION_LIST_RAT;
			sheet30_C7=String.valueOf(QUESTION_LIST_ANSCNT1_RAT);
			sheet30_D7=String.valueOf(QUESTION_LIST_ANSCNT2_RAT);
			sheet30_E7=String.valueOf(QUESTION_LIST_ANSCNT3_RAT);
			sheet30_F7=String.valueOf(QUESTION_LIST_ANSCNT4_RAT);
			sheet30_G7=String.valueOf(QUESTION_LIST_ANSCNT5_RAT);

			//Auto Size Code
			int nHeightTmp;
			nAutoHeight_question_list[0]=0;
			nAutoHeight_question_list[1]=0;
			nHeightTmp=getPrintHeight(sheet30_B6, charWidth, 10, 266, 40, nAutoHeight_question_list[0]);
	...
	private void getScriptFromlist(boolean bIsPrint) throws Exception{
		...
		while(LIST.next()){   //자동으로 생성되는 반복 밴드의 루프문
			...
			sheet40_C5=LIST_SUBJ_ANS1;
			sheet40_D5=LIST_SUBJ_ANS2;
			sheet40_E5=LIST_SUBJ_ANS3;
			sheet40_F5=LIST_SUBJ_ANS4;
			sheet40_G5=LIST_STIME_ANS1;
			sheet40_H5=LIST_STIME_ANS2;
			sheet40_I5=LIST_STIME_ANS3;
			sheet40_J5=LIST_TUTOR_ANS1;
			sheet40_K5=LIST_TUTOR_ANS2;
			sheet40_L5=LIST_TUTOR_ANS3;
			sheet40_M5=LIST_TUTOR_ANS4;
			sheet40_N5=LIST_TUTOR_RAT;
			sheet40_C6=String.valueOf(LIST_SUBJ_ANS1_RAT);
			sheet40_D6=String.valueOf(LIST_SUBJ_ANS2_RAT);
			sheet40_E6=String.valueOf(LIST_SUBJ_ANS3_RAT);
			sheet40_F6=String.valueOf(LIST_SUBJ_ANS4_RAT);
			sheet40_G6=String.valueOf(LIST_STIME_ANS1_RAT);
			sheet40_H6=String.valueOf(LIST_STIME_ANS2_RAT);
			sheet40_I6=String.valueOf(LIST_STIME_ANS3_RAT);
			sheet40_J6=String.valueOf(LIST_TUTOR_ANS1_RAT);
			sheet40_K6=String.valueOf(LIST_TUTOR_ANS2_RAT);
			sheet40_L6=String.valueOf(LIST_TUTOR_ANS3_RAT);
			sheet40_M6=String.valueOf(LIST_TUTOR_ANS4_RAT);

			//Auto Size Code
			int nHeightTmp;
			nAutoHeight_list[0]=0;
			nAutoHeight_list[1]=0;
			nHeightTmp=getPrintHeight(sheet40_A5, charWidth, 10, 99, 40, nAutoHeight_list[0]);
	...
	private void writeScriptpage1( ) throws Exception{
		...
		out.print("^PRINT("+(nXCurPos)+","+(nYCurPos+39)+",476,1,24,0/,바탕체,RGB[0,0,0],BOLD, , ,NONE,38,1)");
		...
		out.print("^PRINT("+(nXCurPos+28)+","+(nYCurPos+186)+",448,0,20,0/,바탕체,RGB[0,0,255],BOLD, , ,NONE,30,1)");
		...
		out.print("^PRINT("+(nXCurPos+28)+","+(nYCurPos+381)+",448,0,20,0/,바탕체,RGB[0,0,255],BOLD, , ,NONE,30,1)");
		...
		out.println("^CELLBG("+(nXCurPos+189)+","+(nYCurPos+431)+",162,20,1,RGB[247,89,251],RGB[247,89,251],0)\r");
		out.println("^CELLLINE("+(nXCurPos+189)+","+(nYCurPos+431)+",162,20,1,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos+189)+","+(nYCurPos+431)+",162,20,0,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos+189)+","+(nYCurPos+431)+",162,20,0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos+189)+","+(nYCurPos+431)+",162,20,0,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos+189)+","+(nYCurPos+431)+",162,1,11,0/,바탕,RGB[0,0,0],BOLD, , ,NONE,20,1)");
		out.println(sheet10_F18+"\r");
		out.println("^CELLBG("+(nXCurPos+351)+","+(nYCurPos+431)+",62,40,1,RGB[247,89,251],RGB[247,89,251],0)\r");
		out.println("^CELLLINE("+(nXCurPos+351)+","+(nYCurPos+431)+",62,40,1,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos+351)+","+(nYCurPos+431)+",62,40,0,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos+351)+","+(nYCurPos+431)+",62,40,0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos+351)+","+(nYCurPos+431)+",62,40,0,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos+351)+","+(nYCurPos+431)+",62,1,11,0/,바탕,RGB[0,0,0],BOLD, , ,NONE,40,1)");
		out.println(sheet10_I18+"\r");
		...
		out.print("^PRINT("+(nXCurPos+28)+","+(nYCurPos+551)+",448,0,20,0/,바탕체,RGB[0,0,255],BOLD, , ,NONE,35,1)");
	...
	//----page2_1 스크립트 문 출력 함수----
	private void writeScriptpage2_1( ) throws Exception{
		//스크립트문 생성
		out.println("^CELLLINE("+(nXCurPos)+","+(nYCurPos)+",28,30,0,RGB[0,0,255],0)\r");
		out.println("^CELLLINE("+(nXCurPos)+","+(nYCurPos)+",28,30,0,RGB[0,0,255],1)\r");
		out.println("^CELLLINE("+(nXCurPos)+","+(nYCurPos)+",28,30,0,RGB[0,0,255],2)\r");
		out.println("^CELLLINE("+(nXCurPos)+","+(nYCurPos)+",28,30,0,RGB[0,0,255],3)\r");
		out.print("^PRINT("+(nXCurPos)+","+(nYCurPos)+",28,1,20,1/0/0,바탕체,RGB[0,0,255],BOLD, , ,NONE,30,1)");
		out.println(sheet20_A1+"\r");
		out.print("^PRINT("+(nXCurPos+28)+","+(nYCurPos)+",484,0,20,0/,바탕체,RGB[0,0,255],BOLD, , ,NONE,30,1)");
		out.println(sheet20_B1+"\r");
	}

	//----HEADER_QUESTION1 스크립트 문 출력 함수----
	private void writeScriptHEADER_QUESTION1( ) throws Exception{
		//스크립트문 생성
		out.print("^PRINT("+(nXCurPos)+","+(nYCurPos)+",512,0,15,0/,바탕체,RGB[0,0,255],BOLD, , ,NONE,22,1)");
	...
	private void writeScriptQUESTION1( ) throws Exception{
		//스크립트문 생성
		out.print("^PRINT("+(nXCurPos)+","+(nYCurPos)+",512,0,11,0/,바탕체,RGB[0,0,0], , , ,XL,"+(nAutoHeight_QUESTION1[0])+",1)");
		out.println(sheet20_A4+"\r");
	}

	//----HEADER_QUESTION2 스크립트 문 출력 함수----
	private void writeScriptHEADER_QUESTION2( ) throws Exception{
		//스크립트문 생성
		out.print("^PRINT("+(nXCurPos)+","+(nYCurPos+22)+",512,0,15,0/,바탕체,RGB[0,0,255],BOLD, , ,NONE,22,1)");
		out.println(sheet20_A6+"\r");
	}

	//----QUESTION2 스크립트 문 출력 함수----
	private void writeScriptQUESTION2( ) throws Exception{
		//스크립트문 생성
		out.print("^PRINT("+(nXCurPos)+","+(nYCurPos)+",512,0,11,0/,바탕체,RGB[0,0,0], , , ,XL,"+(nAutoHeight_QUESTION2[0])+",1)");
		out.println(sheet20_A7+"\r");
	}

	//----HEADER_QUESTION3 스크립트 문 출력 함수----
	private void writeScriptHEADER_QUESTION3( ) throws Exception{
		//스크립트문 생성
		out.print("^PRINT("+(nXCurPos)+","+(nYCurPos+22)+",512,0,15,0/,바탕체,RGB[0,0,255],BOLD, , ,NONE,22,1)");
		out.println(sheet20_A9+"\r");
	}

	//----QUESTION3 스크립트 문 출력 함수----
	private void writeScriptQUESTION3( ) throws Exception{
		//스크립트문 생성
		out.print("^PRINT("+(nXCurPos)+","+(nYCurPos)+",512,0,11,0/,바탕체,RGB[0,0,0], , , ,XL,"+(nAutoHeight_QUESTION3[0])+",1)");
		out.println(sheet20_A10+"\r");
	}

	//----HEADER_QUESTION4 스크립트 문 출력 함수----
	private void writeScriptHEADER_QUESTION4( ) throws Exception{
		//스크립트문 생성
		out.print("^PRINT("+(nXCurPos)+","+(nYCurPos+22)+",512,0,15,0/,바탕체,RGB[0,0,255],BOLD, , ,NONE,22,1)");
		out.println(sheet20_A12+"\r");
	}

	//----QUESTION4 스크립트 문 출력 함수----
	private void writeScriptQUESTION4( ) throws Exception{
		//스크립트문 생성
		out.print("^PRINT("+(nXCurPos)+","+(nYCurPos)+",512,0,11,0/,바탕체,RGB[0,0,0], , , ,XL,"+(nAutoHeight_QUESTION4[0])+",1)");
		out.println(sheet20_A13+"\r");
	}

	//----HEADER_QUESTION5 스크립트 문 출력 함수----
	private void writeScriptHEADER_QUESTION5( ) throws Exception{
		//스크립트문 생성
		out.print("^PRINT("+(nXCurPos)+","+(nYCurPos+22)+",512,0,15,0/,바탕체,RGB[0,0,255],BOLD, , ,NONE,22,1)");
		out.println(sheet20_A15+"\r");
	}

	//----QUESTION5_1 스크립트 문 출력 함수----
	private void writeScriptQUESTION5_1( ) throws Exception{
		//스크립트문 생성
		out.print("^PRINT("+(nXCurPos)+","+(nYCurPos)+",512,0,11,0/,바탕체,RGB[0,0,0], , , ,XL,"+(nAutoHeight_QUESTION5_1[0])+",1)");
		out.println(sheet20_A16+"\r");
	}

	//----QUESTION5_2 스크립트 문 출력 함수----
	private void writeScriptQUESTION5_2( ) throws Exception{
		//스크립트문 생성
		out.print("^PRINT("+(nXCurPos)+","+(nYCurPos)+",512,0,11,0/,바탕체,RGB[0,0,0], , , ,XL,"+(nAutoHeight_QUESTION5_2[0])+",1)");
		out.println(sheet20_A17+"\r");
	}

	//----QUESTION5_3 스크립트 문 출력 함수----
	private void writeScriptQUESTION5_3( ) throws Exception{
		//스크립트문 생성
		out.print("^PRINT("+(nXCurPos)+","+(nYCurPos)+",512,0,11,0/,바탕체,RGB[0,0,0], , , ,XL,"+(nAutoHeight_QUESTION5_3[0])+",1)");
		out.println(sheet20_A18+"\r");
	}

	//----NON_QUESTION 스크립트 문 출력 함수----
	private void writeScriptNON_QUESTION( ) throws Exception{
		//스크립트문 생성
		out.print("^PRINT("+(nXCurPos)+","+(nYCurPos+22)+",512,0,15,0/,바탕체,RGB[0,0,255],BOLD, , ,NONE,22,1)");
		out.println(sheet20_A20+"\r");
		out.print("^PRINT("+(nXCurPos)+","+(nYCurPos+66)+",512,0,15,0/,바탕체,RGB[0,0,255],BOLD, , ,NONE,22,1)");
		out.println(sheet20_A22+"\r");
		out.print("^PRINT("+(nXCurPos)+","+(nYCurPos+110)+",512,0,15,0/,바탕체,RGB[0,0,255],BOLD, , ,NONE,22,1)");
		out.println(sheet20_A24+"\r");
	}

	//----ans 스크립트 문 출력 함수----
	private void writeScriptans( ) throws Exception{
		//스크립트문 생성
		out.print("^PRINT("+(nXCurPos)+","+(nYCurPos)+",55,2,11,0/,바탕체,RGB[0,0,0], , , ,NONE,"+(nAutoHeight_ans[0])+",1)");
		out.println(sheet20_A27+"\r");
		out.print("^PRINT("+(nXCurPos+55)+","+(nYCurPos)+",457,0,11,0/,바탕체,RGB[0,0,0], , , ,XL,"+(nAutoHeight_ans[0])+",1)");
		out.println(sheet20_C27+"\r");
	}

	//----quest 스크립트 문 출력 함수----
	private void writeScriptquest( ) throws Exception{
		//스크립트문 생성
		out.print("^PRINT("+(nXCurPos+28)+","+(nYCurPos)+",27,0,11,5/###,### \") \"*,바탕체,RGB[0,0,0], , , ,XL,"+(nAutoHeight_quest[0])+",1)");
		out.println(sheet20_B26+"\r");
		out.print("^PRINT("+(nXCurPos+55)+","+(nYCurPos)+",457,0,11,0/,굴림체,RGB[0,0,0], , , ,XL,"+(nAutoHeight_quest[0])+",1)");
		out.println(sheet20_C26+"\r");
	}

	//----category 스크립트 문 출력 함수----
	private void writeScriptcategory( ) throws Exception{
		//스크립트문 생성
		out.print("^PRINT("+(nXCurPos+28)+","+(nYCurPos)+",484,0,12,0/,바탕체,RGB[0,0,255],BOLD, , ,NONE,20,1)");
		out.println(sheet20_B25+"\r");
	}

	//----VoidBand306 스크립트 문 출력 함수----
	private void writeScriptVoidBand306( ) throws Exception{
		//스크립트문 생성
		out.print("^PRINT("+(nXCurPos)+","+(nYCurPos)+",294,0,16,0/,바탕체,RGB[0,0,0], , , ,NONE,31,1)");
		out.println(sheet30_A1+"\r");
		out.print("^PRINT("+(nXCurPos)+","+(nYCurPos+31)+",294,0,16,0/,바탕체,RGB[0,0,255],BOLD, , ,NONE,31,1)");
		out.println(sheet30_A2+"\r");
		out.print("^PRINT("+(nXCurPos+294)+","+(nYCurPos+62)+",181,2,11,0/,굴림체,RGB[0,0,0], , , ,NONE,31,1)");
	...
	private void writeScriptquestion_list_header( ) throws Exception{
		...
		out.println("^CELLBG("+(nXCurPos+294)+","+(nYCurPos)+",150,20,1,RGB[255,192,203],RGB[255,192,203],0)\r");
		out.println("^CELLLINE("+(nXCurPos+294)+","+(nYCurPos)+",150,20,0,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos+294)+","+(nYCurPos)+",150,20,0,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos+294)+","+(nYCurPos)+",150,20,0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos+294)+","+(nYCurPos)+",150,20,0,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos+294)+","+(nYCurPos)+",150,1,11,0/,굴림체,RGB[0,0,0], , , ,NONE,20,1)");
		out.println(sheet30_C4+"\r");
		out.println("^CELLBG("+(nXCurPos+444)+","+(nYCurPos)+",31,40,1,RGB[255,192,203],RGB[255,192,203],0)\r");
		out.println("^CELLLINE("+(nXCurPos+444)+","+(nYCurPos)+",31,40,0,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos+444)+","+(nYCurPos)+",31,40,0,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos+444)+","+(nYCurPos)+",31,40,0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos+444)+","+(nYCurPos)+",31,40,0,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos+444)+","+(nYCurPos)+",31,1,12,0/,바탕,RGB[0,0,0],BOLD, , ,NONE,40,1)");
		out.println(sheet30_H4+"\r");
		out.println("^CELLBG("+(nXCurPos+294)+","+(nYCurPos+20)+",30,20,1,RGB[255,192,203],RGB[255,192,203],0)\r");
		out.println("^CELLLINE("+(nXCurPos+294)+","+(nYCurPos+20)+",30,20,0,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos+294)+","+(nYCurPos+20)+",30,20,0,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos+294)+","+(nYCurPos+20)+",30,20,0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos+294)+","+(nYCurPos+20)+",30,20,0,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos+294)+","+(nYCurPos+20)+",30,1,12,0/,바탕,RGB[0,0,0],BOLD, , ,NONE,20,1)");
		out.println(sheet30_C5+"\r");
		out.println("^CELLBG("+(nXCurPos+324)+","+(nYCurPos+20)+",30,20,1,RGB[255,192,203],RGB[255,192,203],0)\r");
		out.println("^CELLLINE("+(nXCurPos+324)+","+(nYCurPos+20)+",30,20,0,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos+324)+","+(nYCurPos+20)+",30,20,0,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos+324)+","+(nYCurPos+20)+",30,20,0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos+324)+","+(nYCurPos+20)+",30,20,0,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos+324)+","+(nYCurPos+20)+",30,1,12,0/,바탕,RGB[0,0,0],BOLD, , ,NONE,20,1)");
		out.println(sheet30_D5+"\r");
		out.println("^CELLBG("+(nXCurPos+354)+","+(nYCurPos+20)+",30,20,1,RGB[255,192,203],RGB[255,192,203],0)\r");
		out.println("^CELLLINE("+(nXCurPos+354)+","+(nYCurPos+20)+",30,20,0,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos+354)+","+(nYCurPos+20)+",30,20,0,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos+354)+","+(nYCurPos+20)+",30,20,0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos+354)+","+(nYCurPos+20)+",30,20,0,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos+354)+","+(nYCurPos+20)+",30,1,12,0/,바탕,RGB[0,0,0],BOLD, , ,NONE,20,1)");
		out.println(sheet30_E5+"\r");
		out.println("^CELLBG("+(nXCurPos+384)+","+(nYCurPos+20)+",30,20,1,RGB[255,192,203],RGB[255,192,203],0)\r");
		out.println("^CELLLINE("+(nXCurPos+384)+","+(nYCurPos+20)+",30,20,0,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos+384)+","+(nYCurPos+20)+",30,20,0,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos+384)+","+(nYCurPos+20)+",30,20,0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos+384)+","+(nYCurPos+20)+",30,20,0,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos+384)+","+(nYCurPos+20)+",30,1,12,0/,바탕,RGB[0,0,0],BOLD, , ,NONE,20,1)");
		out.println(sheet30_F5+"\r");
		out.println("^CELLBG("+(nXCurPos+414)+","+(nYCurPos+20)+",30,20,1,RGB[255,192,203],RGB[255,192,203],0)\r");
		out.println("^CELLLINE("+(nXCurPos+414)+","+(nYCurPos+20)+",30,20,0,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos+414)+","+(nYCurPos+20)+",30,20,0,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos+414)+","+(nYCurPos+20)+",30,20,0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos+414)+","+(nYCurPos+20)+",30,20,0,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos+414)+","+(nYCurPos+20)+",30,1,12,0/,바탕,RGB[0,0,0],BOLD, , ,NONE,20,1)");
	...
	private void writeScriptquestion_list( ) throws Exception{
		...
		out.println("^CELLLINE("+(nXCurPos+294)+","+(nYCurPos)+",30,"+(nAutoHeight_question_list[0])+",0,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos+294)+","+(nYCurPos)+",30,"+(nAutoHeight_question_list[0])+",0,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos+294)+","+(nYCurPos)+",30,"+(nAutoHeight_question_list[0])+",0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos+294)+","+(nYCurPos)+",30,"+(nAutoHeight_question_list[0])+",0,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos+294)+","+(nYCurPos)+",30,1,10,1/0/0,바탕,RGB[0,0,0], , , ,NONE,"+(nAutoHeight_question_list[0])+",1)");
		out.println(sheet30_C6+"\r");
		out.println("^CELLLINE("+(nXCurPos+324)+","+(nYCurPos)+",30,"+(nAutoHeight_question_list[0])+",0,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos+324)+","+(nYCurPos)+",30,"+(nAutoHeight_question_list[0])+",0,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos+324)+","+(nYCurPos)+",30,"+(nAutoHeight_question_list[0])+",0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos+324)+","+(nYCurPos)+",30,"+(nAutoHeight_question_list[0])+",0,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos+324)+","+(nYCurPos)+",30,1,10,1/0/0,바탕,RGB[0,0,0], , , ,NONE,"+(nAutoHeight_question_list[0])+",1)");
		out.println(sheet30_D6+"\r");
		out.println("^CELLLINE("+(nXCurPos+354)+","+(nYCurPos)+",30,"+(nAutoHeight_question_list[0])+",0,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos+354)+","+(nYCurPos)+",30,"+(nAutoHeight_question_list[0])+",0,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos+354)+","+(nYCurPos)+",30,"+(nAutoHeight_question_list[0])+",0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos+354)+","+(nYCurPos)+",30,"+(nAutoHeight_question_list[0])+",0,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos+354)+","+(nYCurPos)+",30,1,10,1/0/0,바탕,RGB[0,0,0], , , ,NONE,"+(nAutoHeight_question_list[0])+",1)");
		out.println(sheet30_E6+"\r");
		out.println("^CELLLINE("+(nXCurPos+384)+","+(nYCurPos)+",30,"+(nAutoHeight_question_list[0])+",0,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos+384)+","+(nYCurPos)+",30,"+(nAutoHeight_question_list[0])+",0,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos+384)+","+(nYCurPos)+",30,"+(nAutoHeight_question_list[0])+",0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos+384)+","+(nYCurPos)+",30,"+(nAutoHeight_question_list[0])+",0,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos+384)+","+(nYCurPos)+",30,1,10,1/0/0,바탕,RGB[0,0,0], , , ,NONE,"+(nAutoHeight_question_list[0])+",1)");
		out.println(sheet30_F6+"\r");
		out.println("^CELLLINE("+(nXCurPos+414)+","+(nYCurPos)+",30,"+(nAutoHeight_question_list[0])+",0,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos+414)+","+(nYCurPos)+",30,"+(nAutoHeight_question_list[0])+",0,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos+414)+","+(nYCurPos)+",30,"+(nAutoHeight_question_list[0])+",0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos+414)+","+(nYCurPos)+",30,"+(nAutoHeight_question_list[0])+",0,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos+414)+","+(nYCurPos)+",30,1,10,1/0/0,바탕,RGB[0,0,0], , , ,NONE,"+(nAutoHeight_question_list[0])+",1)");
		out.println(sheet30_G6+"\r");
		out.println("^CELLLINE("+(nXCurPos+444)+","+(nYCurPos)+",31,"+(nAutoHeight_question_list[1])+",0,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos+444)+","+(nYCurPos)+",31,"+(nAutoHeight_question_list[1])+",0,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos+444)+","+(nYCurPos)+",31,"+(nAutoHeight_question_list[1])+",0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos+444)+","+(nYCurPos)+",31,"+(nAutoHeight_question_list[1])+",0,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos+444)+","+(nYCurPos)+",31,1,10,0/,바탕,RGB[0,0,255], , , ,NONE,"+(nAutoHeight_question_list[1])+",1)");
		out.println(sheet30_H6+"\r");
		out.println("^CELLLINE("+(nXCurPos+294)+","+(nYCurPos+nAutoHeight_question_list[0])+",30,"+(nAutoHeight_question_list[1]-nAutoHeight_question_list[0])+",0,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos+294)+","+(nYCurPos+nAutoHeight_question_list[0])+",30,"+(nAutoHeight_question_list[1]-nAutoHeight_question_list[0])+",0,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos+294)+","+(nYCurPos+nAutoHeight_question_list[0])+",30,"+(nAutoHeight_question_list[1]-nAutoHeight_question_list[0])+",0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos+294)+","+(nYCurPos+nAutoHeight_question_list[0])+",30,"+(nAutoHeight_question_list[1]-nAutoHeight_question_list[0])+",0,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos+294)+","+(nYCurPos+nAutoHeight_question_list[0])+",30,1,10,0/,바탕,RGB[0,0,0], , , ,NONE,"+(nAutoHeight_question_list[1]-nAutoHeight_question_list[0])+",1)");
		out.println(sheet30_C7+"\r");
		out.println("^CELLLINE("+(nXCurPos+324)+","+(nYCurPos+nAutoHeight_question_list[0])+",30,"+(nAutoHeight_question_list[1]-nAutoHeight_question_list[0])+",0,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos+324)+","+(nYCurPos+nAutoHeight_question_list[0])+",30,"+(nAutoHeight_question_list[1]-nAutoHeight_question_list[0])+",0,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos+324)+","+(nYCurPos+nAutoHeight_question_list[0])+",30,"+(nAutoHeight_question_list[1]-nAutoHeight_question_list[0])+",0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos+324)+","+(nYCurPos+nAutoHeight_question_list[0])+",30,"+(nAutoHeight_question_list[1]-nAutoHeight_question_list[0])+",0,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos+324)+","+(nYCurPos+nAutoHeight_question_list[0])+",30,1,10,0/,바탕,RGB[0,0,0], , , ,NONE,"+(nAutoHeight_question_list[1]-nAutoHeight_question_list[0])+",1)");
		out.println(sheet30_D7+"\r");
		out.println("^CELLLINE("+(nXCurPos+354)+","+(nYCurPos+nAutoHeight_question_list[0])+",30,"+(nAutoHeight_question_list[1]-nAutoHeight_question_list[0])+",0,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos+354)+","+(nYCurPos+nAutoHeight_question_list[0])+",30,"+(nAutoHeight_question_list[1]-nAutoHeight_question_list[0])+",0,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos+354)+","+(nYCurPos+nAutoHeight_question_list[0])+",30,"+(nAutoHeight_question_list[1]-nAutoHeight_question_list[0])+",0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos+354)+","+(nYCurPos+nAutoHeight_question_list[0])+",30,"+(nAutoHeight_question_list[1]-nAutoHeight_question_list[0])+",0,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos+354)+","+(nYCurPos+nAutoHeight_question_list[0])+",30,1,10,0/,바탕,RGB[0,0,0], , , ,NONE,"+(nAutoHeight_question_list[1]-nAutoHeight_question_list[0])+",1)");
		out.println(sheet30_E7+"\r");
		out.println("^CELLLINE("+(nXCurPos+384)+","+(nYCurPos+nAutoHeight_question_list[0])+",30,"+(nAutoHeight_question_list[1]-nAutoHeight_question_list[0])+",0,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos+384)+","+(nYCurPos+nAutoHeight_question_list[0])+",30,"+(nAutoHeight_question_list[1]-nAutoHeight_question_list[0])+",0,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos+384)+","+(nYCurPos+nAutoHeight_question_list[0])+",30,"+(nAutoHeight_question_list[1]-nAutoHeight_question_list[0])+",0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos+384)+","+(nYCurPos+nAutoHeight_question_list[0])+",30,"+(nAutoHeight_question_list[1]-nAutoHeight_question_list[0])+",0,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos+384)+","+(nYCurPos+nAutoHeight_question_list[0])+",30,1,10,0/,바탕,RGB[0,0,0], , , ,NONE,"+(nAutoHeight_question_list[1]-nAutoHeight_question_list[0])+",1)");
		out.println(sheet30_F7+"\r");
		out.println("^CELLLINE("+(nXCurPos+414)+","+(nYCurPos+nAutoHeight_question_list[0])+",30,"+(nAutoHeight_question_list[1]-nAutoHeight_question_list[0])+",0,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos+414)+","+(nYCurPos+nAutoHeight_question_list[0])+",30,"+(nAutoHeight_question_list[1]-nAutoHeight_question_list[0])+",0,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos+414)+","+(nYCurPos+nAutoHeight_question_list[0])+",30,"+(nAutoHeight_question_list[1]-nAutoHeight_question_list[0])+",0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos+414)+","+(nYCurPos+nAutoHeight_question_list[0])+",30,"+(nAutoHeight_question_list[1]-nAutoHeight_question_list[0])+",0,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos+414)+","+(nYCurPos+nAutoHeight_question_list[0])+",30,1,10,0/,바탕,RGB[0,0,0], , , ,NONE,"+(nAutoHeight_question_list[1]-nAutoHeight_question_list[0])+",1)");
		out.println(sheet30_G7+"\r");
	}

	//----VoidBand407 스크립트 문 출력 함수----
	private void writeScriptVoidBand407( ) throws Exception{
		//스크립트문 생성
		out.print("^PRINT("+(nXCurPos)+","+(nYCurPos)+",362,0,16,0/,바탕체,RGB[0,0,255],BOLD, , ,NONE,37,1)");
		out.println(sheet40_A1+"\r");
		out.print("^PRINT("+(nXCurPos+334)+","+(nYCurPos+37)+",143,2,11,0/,굴림체,RGB[0,0,0], , , ,NONE,20,1)");
		out.println(sheet40_J2+"\r");
	}

	//----list_header 스크립트 문 출력 함수----
	private void writeScriptlist_header( ) throws Exception{
		//스크립트문 생성
		out.println("^CELLBG("+(nXCurPos)+","+(nYCurPos)+",99,88,1,RGB[230,230,250],RGB[230,230,250],0)\r");
		out.println("^CELLLINE("+(nXCurPos)+","+(nYCurPos)+",99,88,0,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos)+","+(nYCurPos)+",99,88,0,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos)+","+(nYCurPos)+",99,88,0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos)+","+(nYCurPos)+",99,88,0,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos)+","+(nYCurPos)+",99,1,10,0/,바탕,RGB[0,0,0], , , ,NONE,88,1)");
		out.println(sheet40_A3+"\r");
		out.println("^CELLBG("+(nXCurPos+99)+","+(nYCurPos)+",39,88,1,RGB[230,230,250],RGB[230,230,250],0)\r");
		out.println("^CELLLINE("+(nXCurPos+99)+","+(nYCurPos)+",39,88,0,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos+99)+","+(nYCurPos)+",39,88,0,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos+99)+","+(nYCurPos)+",39,88,0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos+99)+","+(nYCurPos)+",39,88,0,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos+99)+","+(nYCurPos)+",39,1,10,0/,바탕,RGB[0,0,0], , , ,NONE,88,1)");
		out.println(sheet40_B3+"\r");
		out.println("^CELLBG("+(nXCurPos+138)+","+(nYCurPos)+",112,20,1,RGB[230,230,250],RGB[230,230,250],0)\r");
		out.println("^CELLLINE("+(nXCurPos+138)+","+(nYCurPos)+",112,20,0,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos+138)+","+(nYCurPos)+",112,20,0,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos+138)+","+(nYCurPos)+",112,20,0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos+138)+","+(nYCurPos)+",112,20,0,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos+138)+","+(nYCurPos)+",112,1,10,0/,바탕,RGB[0,0,0], , , ,NONE,20,1)");
		out.println(sheet40_C3+"\r");
		out.println("^CELLBG("+(nXCurPos+250)+","+(nYCurPos)+",84,20,1,RGB[230,230,250],RGB[230,230,250],0)\r");
		out.println("^CELLLINE("+(nXCurPos+250)+","+(nYCurPos)+",84,20,0,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos+250)+","+(nYCurPos)+",84,20,0,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos+250)+","+(nYCurPos)+",84,20,0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos+250)+","+(nYCurPos)+",84,20,0,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos+250)+","+(nYCurPos)+",84,1,10,0/,바탕,RGB[0,0,0], , , ,NONE,20,1)");
		out.println(sheet40_G3+"\r");
		out.println("^CELLBG("+(nXCurPos+334)+","+(nYCurPos)+",143,20,1,RGB[230,230,250],RGB[230,230,250],0)\r");
		out.println("^CELLLINE("+(nXCurPos+334)+","+(nYCurPos)+",143,20,0,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos+334)+","+(nYCurPos)+",143,20,0,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos+334)+","+(nYCurPos)+",143,20,0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos+334)+","+(nYCurPos)+",143,20,0,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos+334)+","+(nYCurPos)+",143,1,10,0/,바탕,RGB[0,0,0], , , ,NONE,20,1)");
		out.println(sheet40_J3+"\r");
		out.println("^CELLBG("+(nXCurPos+138)+","+(nYCurPos+20)+",28,68,1,RGB[230,230,250],RGB[230,230,250],0)\r");
		out.println("^CELLLINE("+(nXCurPos+138)+","+(nYCurPos+20)+",28,68,0,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos+138)+","+(nYCurPos+20)+",28,68,0,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos+138)+","+(nYCurPos+20)+",28,68,0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos+138)+","+(nYCurPos+20)+",28,68,0,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos+138)+","+(nYCurPos+20)+",28,1,10,0/,바탕,RGB[0,0,0], , , ,NONE,68,1)");
		out.println(sheet40_C4+"\r");
		out.println("^CELLBG("+(nXCurPos+166)+","+(nYCurPos+20)+",28,68,1,RGB[230,230,250],RGB[230,230,250],0)\r");
		out.println("^CELLLINE("+(nXCurPos+166)+","+(nYCurPos+20)+",28,68,0,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos+166)+","+(nYCurPos+20)+",28,68,0,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos+166)+","+(nYCurPos+20)+",28,68,0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos+166)+","+(nYCurPos+20)+",28,68,0,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos+166)+","+(nYCurPos+20)+",28,1,10,0/,바탕,RGB[0,0,0], , , ,NONE,68,1)");
		out.println(sheet40_D4+"\r");
		out.println("^CELLBG("+(nXCurPos+194)+","+(nYCurPos+20)+",28,68,1,RGB[230,230,250],RGB[230,230,250],0)\r");
		out.println("^CELLLINE("+(nXCurPos+194)+","+(nYCurPos+20)+",28,68,0,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos+194)+","+(nYCurPos+20)+",28,68,0,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos+194)+","+(nYCurPos+20)+",28,68,0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos+194)+","+(nYCurPos+20)+",28,68,0,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos+194)+","+(nYCurPos+20)+",28,1,10,0/,바탕,RGB[0,0,0], , , ,NONE,68,1)");
		out.println(sheet40_E4+"\r");
		out.println("^CELLBG("+(nXCurPos+222)+","+(nYCurPos+20)+",28,68,1,RGB[230,230,250],RGB[230,230,250],0)\r");
		out.println("^CELLLINE("+(nXCurPos+222)+","+(nYCurPos+20)+",28,68,0,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos+222)+","+(nYCurPos+20)+",28,68,0,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos+222)+","+(nYCurPos+20)+",28,68,0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos+222)+","+(nYCurPos+20)+",28,68,0,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos+222)+","+(nYCurPos+20)+",28,1,10,0/,바탕,RGB[0,0,0], , , ,NONE,68,1)");
		out.println(sheet40_F4+"\r");
		out.println("^CELLBG("+(nXCurPos+250)+","+(nYCurPos+20)+",28,68,1,RGB[230,230,250],RGB[230,230,250],0)\r");
		out.println("^CELLLINE("+(nXCurPos+250)+","+(nYCurPos+20)+",28,68,0,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos+250)+","+(nYCurPos+20)+",28,68,0,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos+250)+","+(nYCurPos+20)+",28,68,0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos+250)+","+(nYCurPos+20)+",28,68,0,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos+250)+","+(nYCurPos+20)+",28,1,10,0/,바탕,RGB[0,0,0], , , ,NONE,68,1)");
		out.println(sheet40_G4+"\r");
		out.println("^CELLBG("+(nXCurPos+278)+","+(nYCurPos+20)+",28,68,1,RGB[230,230,250],RGB[230,230,250],0)\r");
		out.println("^CELLLINE("+(nXCurPos+278)+","+(nYCurPos+20)+",28,68,0,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos+278)+","+(nYCurPos+20)+",28,68,0,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos+278)+","+(nYCurPos+20)+",28,68,0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos+278)+","+(nYCurPos+20)+",28,68,0,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos+278)+","+(nYCurPos+20)+",28,1,10,0/,바탕,RGB[0,0,0], , , ,NONE,68,1)");
		out.println(sheet40_H4+"\r");
		out.println("^CELLBG("+(nXCurPos+306)+","+(nYCurPos+20)+",28,68,1,RGB[230,230,250],RGB[230,230,250],0)\r");
		out.println("^CELLLINE("+(nXCurPos+306)+","+(nYCurPos+20)+",28,68,0,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos+306)+","+(nYCurPos+20)+",28,68,0,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos+306)+","+(nYCurPos+20)+",28,68,0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos+306)+","+(nYCurPos+20)+",28,68,0,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos+306)+","+(nYCurPos+20)+",28,1,10,0/,바탕,RGB[0,0,0], , , ,NONE,68,1)");
		out.println(sheet40_I4+"\r");
		out.println("^CELLBG("+(nXCurPos+334)+","+(nYCurPos+20)+",28,68,1,RGB[230,230,250],RGB[230,230,250],0)\r");
		out.println("^CELLLINE("+(nXCurPos+334)+","+(nYCurPos+20)+",28,68,0,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos+334)+","+(nYCurPos+20)+",28,68,0,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos+334)+","+(nYCurPos+20)+",28,68,0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos+334)+","+(nYCurPos+20)+",28,68,0,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos+334)+","+(nYCurPos+20)+",28,1,10,0/,바탕,RGB[0,0,0], , , ,NONE,68,1)");
		out.println(sheet40_J4+"\r");
		out.println("^CELLBG("+(nXCurPos+362)+","+(nYCurPos+20)+",28,68,1,RGB[230,230,250],RGB[230,230,250],0)\r");
		out.println("^CELLLINE("+(nXCurPos+362)+","+(nYCurPos+20)+",28,68,0,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos+362)+","+(nYCurPos+20)+",28,68,0,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos+362)+","+(nYCurPos+20)+",28,68,0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos+362)+","+(nYCurPos+20)+",28,68,0,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos+362)+","+(nYCurPos+20)+",28,1,10,0/,바탕,RGB[0,0,0], , , ,NONE,68,1)");
		out.println(sheet40_K4+"\r");
		out.println("^CELLBG("+(nXCurPos+390)+","+(nYCurPos+20)+",28,68,1,RGB[230,230,250],RGB[230,230,250],0)\r");
		out.println("^CELLLINE("+(nXCurPos+390)+","+(nYCurPos+20)+",28,68,0,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos+390)+","+(nYCurPos+20)+",28,68,0,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos+390)+","+(nYCurPos+20)+",28,68,0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos+390)+","+(nYCurPos+20)+",28,68,0,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos+390)+","+(nYCurPos+20)+",28,1,10,0/,바탕,RGB[0,0,0], , , ,NONE,68,1)");
		out.println(sheet40_L4+"\r");
		out.println("^CELLBG("+(nXCurPos+418)+","+(nYCurPos+20)+",28,68,1,RGB[230,230,250],RGB[230,230,250],0)\r");
		out.println("^CELLLINE("+(nXCurPos+418)+","+(nYCurPos+20)+",28,68,0,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos+418)+","+(nYCurPos+20)+",28,68,0,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos+418)+","+(nYCurPos+20)+",28,68,0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos+418)+","+(nYCurPos+20)+",28,68,0,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos+418)+","+(nYCurPos+20)+",28,1,10,0/,바탕,RGB[0,0,0], , , ,NONE,68,1)");
		out.println(sheet40_M4+"\r");
		out.println("^CELLBG("+(nXCurPos+446)+","+(nYCurPos+20)+",31,68,1,RGB[230,230,250],RGB[230,230,250],0)\r");
		out.println("^CELLLINE("+(nXCurPos+446)+","+(nYCurPos+20)+",31,68,0,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos+446)+","+(nYCurPos+20)+",31,68,0,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos+446)+","+(nYCurPos+20)+",31,68,0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos+446)+","+(nYCurPos+20)+",31,68,0,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos+446)+","+(nYCurPos+20)+",31,1,10,0/,바탕,RGB[0,0,0], , , ,NONE,68,1)");
	...
	private void writeScriptlist( ) throws Exception{
		//스크립트문 생성
		out.println("^CELLLINE("+(nXCurPos)+","+(nYCurPos)+",99,"+(nAutoHeight_list[1])+",0,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos)+","+(nYCurPos)+",99,"+(nAutoHeight_list[1])+",0,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos)+","+(nYCurPos)+",99,"+(nAutoHeight_list[1])+",0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos)+","+(nYCurPos)+",99,"+(nAutoHeight_list[1])+",0,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos)+","+(nYCurPos)+",99,0,10,0/,바탕,RGB[0,0,0], , , ,XL,"+(nAutoHeight_list[1])+",1)");
		out.println(sheet40_A5+"\r");
		out.println("^CELLLINE("+(nXCurPos+99)+","+(nYCurPos)+",39,"+(nAutoHeight_list[1])+",0,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos+99)+","+(nYCurPos)+",39,"+(nAutoHeight_list[1])+",0,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos+99)+","+(nYCurPos)+",39,"+(nAutoHeight_list[1])+",0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos+99)+","+(nYCurPos)+",39,"+(nAutoHeight_list[1])+",0,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos+99)+","+(nYCurPos)+",39,1,10,0/,바탕,RGB[0,0,0], , , ,NONE,"+(nAutoHeight_list[1])+",1)");
		out.println(sheet40_B5+"\r");
		out.println("^CELLLINE("+(nXCurPos+138)+","+(nYCurPos)+",28,"+(nAutoHeight_list[0])+",0,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos+138)+","+(nYCurPos)+",28,"+(nAutoHeight_list[0])+",0,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos+138)+","+(nYCurPos)+",28,"+(nAutoHeight_list[0])+",0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos+138)+","+(nYCurPos)+",28,"+(nAutoHeight_list[0])+",0,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos+138)+","+(nYCurPos)+",28,1,10,1/0/0,바탕,RGB[0,0,0], , , ,NONE,"+(nAutoHeight_list[0])+",1)");
		out.println(sheet40_C5+"\r");
		out.println("^CELLLINE("+(nXCurPos+166)+","+(nYCurPos)+",28,"+(nAutoHeight_list[0])+",0,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos+166)+","+(nYCurPos)+",28,"+(nAutoHeight_list[0])+",0,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos+166)+","+(nYCurPos)+",28,"+(nAutoHeight_list[0])+",0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos+166)+","+(nYCurPos)+",28,"+(nAutoHeight_list[0])+",0,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos+166)+","+(nYCurPos)+",28,1,10,1/0/0,바탕,RGB[0,0,0], , , ,NONE,"+(nAutoHeight_list[0])+",1)");
		out.println(sheet40_D5+"\r");
		out.println("^CELLLINE("+(nXCurPos+194)+","+(nYCurPos)+",28,"+(nAutoHeight_list[0])+",0,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos+194)+","+(nYCurPos)+",28,"+(nAutoHeight_list[0])+",0,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos+194)+","+(nYCurPos)+",28,"+(nAutoHeight_list[0])+",0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos+194)+","+(nYCurPos)+",28,"+(nAutoHeight_list[0])+",0,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos+194)+","+(nYCurPos)+",28,1,10,1/0/0,바탕,RGB[0,0,0], , , ,NONE,"+(nAutoHeight_list[0])+",1)");
		out.println(sheet40_E5+"\r");
		out.println("^CELLLINE("+(nXCurPos+222)+","+(nYCurPos)+",28,"+(nAutoHeight_list[0])+",0,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos+222)+","+(nYCurPos)+",28,"+(nAutoHeight_list[0])+",0,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos+222)+","+(nYCurPos)+",28,"+(nAutoHeight_list[0])+",0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos+222)+","+(nYCurPos)+",28,"+(nAutoHeight_list[0])+",0,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos+222)+","+(nYCurPos)+",28,1,10,1/0/0,바탕,RGB[0,0,0], , , ,NONE,"+(nAutoHeight_list[0])+",1)");
		out.println(sheet40_F5+"\r");
		out.println("^CELLLINE("+(nXCurPos+250)+","+(nYCurPos)+",28,"+(nAutoHeight_list[0])+",0,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos+250)+","+(nYCurPos)+",28,"+(nAutoHeight_list[0])+",0,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos+250)+","+(nYCurPos)+",28,"+(nAutoHeight_list[0])+",0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos+250)+","+(nYCurPos)+",28,"+(nAutoHeight_list[0])+",0,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos+250)+","+(nYCurPos)+",28,1,10,1/0/0,바탕,RGB[0,0,0], , , ,NONE,"+(nAutoHeight_list[0])+",1)");
		out.println(sheet40_G5+"\r");
		out.println("^CELLLINE("+(nXCurPos+278)+","+(nYCurPos)+",28,"+(nAutoHeight_list[0])+",0,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos+278)+","+(nYCurPos)+",28,"+(nAutoHeight_list[0])+",0,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos+278)+","+(nYCurPos)+",28,"+(nAutoHeight_list[0])+",0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos+278)+","+(nYCurPos)+",28,"+(nAutoHeight_list[0])+",0,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos+278)+","+(nYCurPos)+",28,1,10,1/0/0,바탕,RGB[0,0,0], , , ,NONE,"+(nAutoHeight_list[0])+",1)");
		out.println(sheet40_H5+"\r");
		out.println("^CELLLINE("+(nXCurPos+306)+","+(nYCurPos)+",28,"+(nAutoHeight_list[0])+",0,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos+306)+","+(nYCurPos)+",28,"+(nAutoHeight_list[0])+",0,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos+306)+","+(nYCurPos)+",28,"+(nAutoHeight_list[0])+",0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos+306)+","+(nYCurPos)+",28,"+(nAutoHeight_list[0])+",0,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos+306)+","+(nYCurPos)+",28,1,10,1/0/0,바탕,RGB[0,0,0], , , ,NONE,"+(nAutoHeight_list[0])+",1)");
		out.println(sheet40_I5+"\r");
		out.println("^CELLLINE("+(nXCurPos+334)+","+(nYCurPos)+",28,"+(nAutoHeight_list[0])+",0,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos+334)+","+(nYCurPos)+",28,"+(nAutoHeight_list[0])+",0,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos+334)+","+(nYCurPos)+",28,"+(nAutoHeight_list[0])+",0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos+334)+","+(nYCurPos)+",28,"+(nAutoHeight_list[0])+",0,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos+334)+","+(nYCurPos)+",28,1,10,1/0/0,바탕,RGB[0,0,0], , , ,NONE,"+(nAutoHeight_list[0])+",1)");
		out.println(sheet40_J5+"\r");
		out.println("^CELLLINE("+(nXCurPos+362)+","+(nYCurPos)+",28,"+(nAutoHeight_list[0])+",0,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos+362)+","+(nYCurPos)+",28,"+(nAutoHeight_list[0])+",0,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos+362)+","+(nYCurPos)+",28,"+(nAutoHeight_list[0])+",0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos+362)+","+(nYCurPos)+",28,"+(nAutoHeight_list[0])+",0,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos+362)+","+(nYCurPos)+",28,1,10,1/0/0,바탕,RGB[0,0,0], , , ,NONE,"+(nAutoHeight_list[0])+",1)");
		out.println(sheet40_K5+"\r");
		out.println("^CELLLINE("+(nXCurPos+390)+","+(nYCurPos)+",28,"+(nAutoHeight_list[0])+",0,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos+390)+","+(nYCurPos)+",28,"+(nAutoHeight_list[0])+",0,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos+390)+","+(nYCurPos)+",28,"+(nAutoHeight_list[0])+",0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos+390)+","+(nYCurPos)+",28,"+(nAutoHeight_list[0])+",0,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos+390)+","+(nYCurPos)+",28,1,10,1/0/0,바탕,RGB[0,0,0], , , ,NONE,"+(nAutoHeight_list[0])+",1)");
		out.println(sheet40_L5+"\r");
		out.println("^CELLLINE("+(nXCurPos+418)+","+(nYCurPos)+",28,"+(nAutoHeight_list[0])+",0,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos+418)+","+(nYCurPos)+",28,"+(nAutoHeight_list[0])+",0,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos+418)+","+(nYCurPos)+",28,"+(nAutoHeight_list[0])+",0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos+418)+","+(nYCurPos)+",28,"+(nAutoHeight_list[0])+",0,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos+418)+","+(nYCurPos)+",28,1,10,1/0/0,바탕,RGB[0,0,0], , , ,NONE,"+(nAutoHeight_list[0])+",1)");
		out.println(sheet40_M5+"\r");
		out.println("^CELLLINE("+(nXCurPos+446)+","+(nYCurPos)+",31,"+(nAutoHeight_list[1])+",0,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos+446)+","+(nYCurPos)+",31,"+(nAutoHeight_list[1])+",0,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos+446)+","+(nYCurPos)+",31,"+(nAutoHeight_list[1])+",0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos+446)+","+(nYCurPos)+",31,"+(nAutoHeight_list[1])+",0,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos+446)+","+(nYCurPos)+",31,1,10,0/,바탕,RGB[0,0,0], , , ,NONE,"+(nAutoHeight_list[1])+",1)");
		out.println(sheet40_N5+"\r");
		out.println("^CELLLINE("+(nXCurPos+138)+","+(nYCurPos+nAutoHeight_list[0])+",28,"+(nAutoHeight_list[1]-nAutoHeight_list[0])+",0,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos+138)+","+(nYCurPos+nAutoHeight_list[0])+",28,"+(nAutoHeight_list[1]-nAutoHeight_list[0])+",0,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos+138)+","+(nYCurPos+nAutoHeight_list[0])+",28,"+(nAutoHeight_list[1]-nAutoHeight_list[0])+",0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos+138)+","+(nYCurPos+nAutoHeight_list[0])+",28,"+(nAutoHeight_list[1]-nAutoHeight_list[0])+",0,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos+138)+","+(nYCurPos+nAutoHeight_list[0])+",28,1,10,0/,바탕,RGB[0,0,0], , , ,NONE,"+(nAutoHeight_list[1]-nAutoHeight_list[0])+",1)");
		out.println(sheet40_C6+"\r");
		out.println("^CELLLINE("+(nXCurPos+166)+","+(nYCurPos+nAutoHeight_list[0])+",28,"+(nAutoHeight_list[1]-nAutoHeight_list[0])+",0,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos+166)+","+(nYCurPos+nAutoHeight_list[0])+",28,"+(nAutoHeight_list[1]-nAutoHeight_list[0])+",0,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos+166)+","+(nYCurPos+nAutoHeight_list[0])+",28,"+(nAutoHeight_list[1]-nAutoHeight_list[0])+",0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos+166)+","+(nYCurPos+nAutoHeight_list[0])+",28,"+(nAutoHeight_list[1]-nAutoHeight_list[0])+",0,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos+166)+","+(nYCurPos+nAutoHeight_list[0])+",28,1,10,0/,바탕,RGB[0,0,0], , , ,NONE,"+(nAutoHeight_list[1]-nAutoHeight_list[0])+",1)");
		out.println(sheet40_D6+"\r");
		out.println("^CELLLINE("+(nXCurPos+194)+","+(nYCurPos+nAutoHeight_list[0])+",28,"+(nAutoHeight_list[1]-nAutoHeight_list[0])+",0,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos+194)+","+(nYCurPos+nAutoHeight_list[0])+",28,"+(nAutoHeight_list[1]-nAutoHeight_list[0])+",0,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos+194)+","+(nYCurPos+nAutoHeight_list[0])+",28,"+(nAutoHeight_list[1]-nAutoHeight_list[0])+",0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos+194)+","+(nYCurPos+nAutoHeight_list[0])+",28,"+(nAutoHeight_list[1]-nAutoHeight_list[0])+",0,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos+194)+","+(nYCurPos+nAutoHeight_list[0])+",28,1,10,0/,바탕,RGB[0,0,0], , , ,NONE,"+(nAutoHeight_list[1]-nAutoHeight_list[0])+",1)");
		out.println(sheet40_E6+"\r");
		out.println("^CELLLINE("+(nXCurPos+222)+","+(nYCurPos+nAutoHeight_list[0])+",28,"+(nAutoHeight_list[1]-nAutoHeight_list[0])+",0,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos+222)+","+(nYCurPos+nAutoHeight_list[0])+",28,"+(nAutoHeight_list[1]-nAutoHeight_list[0])+",0,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos+222)+","+(nYCurPos+nAutoHeight_list[0])+",28,"+(nAutoHeight_list[1]-nAutoHeight_list[0])+",0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos+222)+","+(nYCurPos+nAutoHeight_list[0])+",28,"+(nAutoHeight_list[1]-nAutoHeight_list[0])+",0,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos+222)+","+(nYCurPos+nAutoHeight_list[0])+",28,1,10,0/,바탕,RGB[0,0,0], , , ,NONE,"+(nAutoHeight_list[1]-nAutoHeight_list[0])+",1)");
		out.println(sheet40_F6+"\r");
		out.println("^CELLLINE("+(nXCurPos+250)+","+(nYCurPos+nAutoHeight_list[0])+",28,"+(nAutoHeight_list[1]-nAutoHeight_list[0])+",0,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos+250)+","+(nYCurPos+nAutoHeight_list[0])+",28,"+(nAutoHeight_list[1]-nAutoHeight_list[0])+",0,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos+250)+","+(nYCurPos+nAutoHeight_list[0])+",28,"+(nAutoHeight_list[1]-nAutoHeight_list[0])+",0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos+250)+","+(nYCurPos+nAutoHeight_list[0])+",28,"+(nAutoHeight_list[1]-nAutoHeight_list[0])+",0,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos+250)+","+(nYCurPos+nAutoHeight_list[0])+",28,1,10,0/,바탕,RGB[0,0,0], , , ,NONE,"+(nAutoHeight_list[1]-nAutoHeight_list[0])+",1)");
		out.println(sheet40_G6+"\r");
		out.println("^CELLLINE("+(nXCurPos+278)+","+(nYCurPos+nAutoHeight_list[0])+",28,"+(nAutoHeight_list[1]-nAutoHeight_list[0])+",0,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos+278)+","+(nYCurPos+nAutoHeight_list[0])+",28,"+(nAutoHeight_list[1]-nAutoHeight_list[0])+",0,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos+278)+","+(nYCurPos+nAutoHeight_list[0])+",28,"+(nAutoHeight_list[1]-nAutoHeight_list[0])+",0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos+278)+","+(nYCurPos+nAutoHeight_list[0])+",28,"+(nAutoHeight_list[1]-nAutoHeight_list[0])+",0,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos+278)+","+(nYCurPos+nAutoHeight_list[0])+",28,1,10,0/,바탕,RGB[0,0,0], , , ,NONE,"+(nAutoHeight_list[1]-nAutoHeight_list[0])+",1)");
		out.println(sheet40_H6+"\r");
		out.println("^CELLLINE("+(nXCurPos+306)+","+(nYCurPos+nAutoHeight_list[0])+",28,"+(nAutoHeight_list[1]-nAutoHeight_list[0])+",0,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos+306)+","+(nYCurPos+nAutoHeight_list[0])+",28,"+(nAutoHeight_list[1]-nAutoHeight_list[0])+",0,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos+306)+","+(nYCurPos+nAutoHeight_list[0])+",28,"+(nAutoHeight_list[1]-nAutoHeight_list[0])+",0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos+306)+","+(nYCurPos+nAutoHeight_list[0])+",28,"+(nAutoHeight_list[1]-nAutoHeight_list[0])+",0,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos+306)+","+(nYCurPos+nAutoHeight_list[0])+",28,1,10,0/,바탕,RGB[0,0,0], , , ,NONE,"+(nAutoHeight_list[1]-nAutoHeight_list[0])+",1)");
		out.println(sheet40_I6+"\r");
		out.println("^CELLLINE("+(nXCurPos+334)+","+(nYCurPos+nAutoHeight_list[0])+",28,"+(nAutoHeight_list[1]-nAutoHeight_list[0])+",0,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos+334)+","+(nYCurPos+nAutoHeight_list[0])+",28,"+(nAutoHeight_list[1]-nAutoHeight_list[0])+",0,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos+334)+","+(nYCurPos+nAutoHeight_list[0])+",28,"+(nAutoHeight_list[1]-nAutoHeight_list[0])+",0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos+334)+","+(nYCurPos+nAutoHeight_list[0])+",28,"+(nAutoHeight_list[1]-nAutoHeight_list[0])+",0,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos+334)+","+(nYCurPos+nAutoHeight_list[0])+",28,1,10,0/,바탕,RGB[0,0,0], , , ,NONE,"+(nAutoHeight_list[1]-nAutoHeight_list[0])+",1)");
		out.println(sheet40_J6+"\r");
		out.println("^CELLLINE("+(nXCurPos+362)+","+(nYCurPos+nAutoHeight_list[0])+",28,"+(nAutoHeight_list[1]-nAutoHeight_list[0])+",0,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos+362)+","+(nYCurPos+nAutoHeight_list[0])+",28,"+(nAutoHeight_list[1]-nAutoHeight_list[0])+",0,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos+362)+","+(nYCurPos+nAutoHeight_list[0])+",28,"+(nAutoHeight_list[1]-nAutoHeight_list[0])+",0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos+362)+","+(nYCurPos+nAutoHeight_list[0])+",28,"+(nAutoHeight_list[1]-nAutoHeight_list[0])+",0,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos+362)+","+(nYCurPos+nAutoHeight_list[0])+",28,1,10,0/,바탕,RGB[0,0,0], , , ,NONE,"+(nAutoHeight_list[1]-nAutoHeight_list[0])+",1)");
		out.println(sheet40_K6+"\r");
		out.println("^CELLLINE("+(nXCurPos+390)+","+(nYCurPos+nAutoHeight_list[0])+",28,"+(nAutoHeight_list[1]-nAutoHeight_list[0])+",0,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos+390)+","+(nYCurPos+nAutoHeight_list[0])+",28,"+(nAutoHeight_list[1]-nAutoHeight_list[0])+",0,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos+390)+","+(nYCurPos+nAutoHeight_list[0])+",28,"+(nAutoHeight_list[1]-nAutoHeight_list[0])+",0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos+390)+","+(nYCurPos+nAutoHeight_list[0])+",28,"+(nAutoHeight_list[1]-nAutoHeight_list[0])+",0,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos+390)+","+(nYCurPos+nAutoHeight_list[0])+",28,1,10,0/,바탕,RGB[0,0,0], , , ,NONE,"+(nAutoHeight_list[1]-nAutoHeight_list[0])+",1)");
		out.println(sheet40_L6+"\r");
		out.println("^CELLLINE("+(nXCurPos+418)+","+(nYCurPos+nAutoHeight_list[0])+",28,"+(nAutoHeight_list[1]-nAutoHeight_list[0])+",0,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos+418)+","+(nYCurPos+nAutoHeight_list[0])+",28,"+(nAutoHeight_list[1]-nAutoHeight_list[0])+",0,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos+418)+","+(nYCurPos+nAutoHeight_list[0])+",28,"+(nAutoHeight_list[1]-nAutoHeight_list[0])+",0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos+418)+","+(nYCurPos+nAutoHeight_list[0])+",28,"+(nAutoHeight_list[1]-nAutoHeight_list[0])+",0,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos+418)+","+(nYCurPos+nAutoHeight_list[0])+",28,1,10,0/,바탕,RGB[0,0,0], , , ,NONE,"+(nAutoHeight_list[1]-nAutoHeight_list[0])+",1)");
	...
	private void createConnAndStateObject() throws Exception{
		...
		conn_DUNET=DriverManager.getConnection("jdbc:oracle:thin:@121.172.140.9:1521:LOTI","inchlms","fhxl21");stat_GR_INFO=conn_DUNET.createStatement(ResultSet.TYPE_SCROLL_INSENSITIVE,ResultSet.CONCUR_READ_ONLY);
	...
	private void initSQLConst(){
		...
		sql_GR_DETAIL_INFO = "SELECT TO_CHAR(A.STARTED,'YYYY.MM.DD') || ' ' || DECODE(TO_CHAR(A.STARTED, 'D'),'1','(일)','2','(월)','3','(화)','4','(수)','5','(목)', '6', '(금)', '7', '(토)')   ";
		sql_GR_DETAIL_INFO = sql_GR_DETAIL_INFO + "|| ' ~ ' || TO_CHAR(A.ENDDATE,'MM.DD') || ' ' || DECODE(TO_CHAR(A.ENDDATE, 'D'), '1','(일)','2','(월)','3','(화)','4','(수)','5','(목)', '6', '(금)', '7', '(토)')  ";
		sql_GR_DETAIL_INFO = sql_GR_DETAIL_INFO + "PERIOD, B.CLASSROOM_NAME || ' (' || B.CLASSROOM_PLACE || ' ' || B.CLASSROOM_FLOOR || ')' AS CLASSROOM , SEARCHNAME(A.GRSEQMAN_USERNO) AS GRSEQMAN_NAME ";
		sql_GR_DETAIL_INFO = sql_GR_DETAIL_INFO + "FROM TB_GRSEQ A, TB_CLASSROOM B ";
		sql_GR_DETAIL_INFO = sql_GR_DETAIL_INFO + "WHERE A.CLASSROOM_NO = B.CLASSROOM_NO(+) AND A.GRCODE = '" + p_grcode_Param + "' AND A.GRSEQ = '" + p_grseq_Param + "'";
		...
		sql_grgubun_info = "select  ";
		sql_grgubun_info = sql_grgubun_info + "sbgubun01, decode(nvl(sbgubun01+sbgubun02+sbgubun03, 0), 0, 0, round(sbgubun01/(sbgubun01+sbgubun02+sbgubun03)*100,2)) sbgubunpe01, ";
		sql_grgubun_info = sql_grgubun_info + "sbgubun02, decode(nvl(sbgubun01+sbgubun02+sbgubun03, 0), 0, 0, round(sbgubun02/(sbgubun01+sbgubun02+sbgubun03)*100,2)) sbgubunpe02, ";
		sql_grgubun_info = sql_grgubun_info + "sbgubun02_1, decode(nvl(sbgubun01+sbgubun02+sbgubun03, 0), 0, 0, round(sbgubun02_1/(sbgubun01+sbgubun02+sbgubun03)*100,2)) sbgubunpe02_1, ";
		sql_grgubun_info = sql_grgubun_info + "sbgubun02_2, decode(nvl(sbgubun01+sbgubun02+sbgubun03, 0), 0, 0, round(sbgubun02_2/(sbgubun01+sbgubun02+sbgubun03)*100,2)) sbgubunpe02_2, ";
		sql_grgubun_info = sql_grgubun_info + "sbgubun03, decode(nvl(sbgubun01+sbgubun02+sbgubun03, 0), 0, 0, round(sbgubun03/(sbgubun01+sbgubun02+sbgubun03)*100,2)) sbgubunpe03 ";
		sql_grgubun_info = sql_grgubun_info + "from ";
		sql_grgubun_info = sql_grgubun_info + "( ";
		sql_grgubun_info = sql_grgubun_info + "SELECT  ";
		sql_grgubun_info = sql_grgubun_info + "sum(decode(nvl(b.subjgubun,'03'), '01' , decode(b.subj, 'SUB1000026', 0.5, 1), 0)) sbgubun01,  ";
		sql_grgubun_info = sql_grgubun_info + "sum(decode(nvl(b.subjgubun,'03'), '02' , decode(b.subj, 'SUB1000026', 0.5, 1), 0)) sbgubun02, ";
		sql_grgubun_info = sql_grgubun_info + "sum(case when nvl(b.subjgubun,'03')='02' and b.subjtype <> 'Y' then decode(b.subj, 'SUB1000026', 0.5, 1) else 0 end) sbgubun02_1, ";
		sql_grgubun_info = sql_grgubun_info + "sum(case when nvl(b.subjgubun,'03')='02' and b.subjtype = 'Y' then decode(b.subj, 'SUB1000026', 0.5, 1) else 0 end) sbgubun02_2, ";
		...
		sql_grgubun_info = sql_grgubun_info + "WHERE a.grcode='" + p_grcode_Param + "' and a.grseq='" + p_grseq_Param + "'  ";
		sql_grgubun_info = sql_grgubun_info + "and a.subj=b.subj and a.subj=d.subj(+) and a.grcode=d.grcode(+) and a.grseq=d.grseq(+)  ";
		...
		sql_QUESTION_LIST = sql_QUESTION_LIST + "    round((nvl(sum(decode(ans_no, 1, 1, 0)),0)+nvl(sum(decode(ans_no, 2, 1, 0)),0))/decode(count(ans_no),0,1,count(ans_no))*100,2) ";
		sql_QUESTION_LIST = sql_QUESTION_LIST + "	||'%' ";
		sql_QUESTION_LIST = sql_QUESTION_LIST + "	as rat ";
		...
		sql_LIST = sql_LIST + "  (select round((nvl(sum(decode(ans_no,1,1,0)),0)+nvl(sum(decode(ans_no,2,1,0)),0))/decode(count(ans_no),0,1,count(ans_no))*100,2) from tb_grinq_answer where question_no = a.question_no and title_no = a.title_no and set_no = a.set_no and ans_no !=0)||'%' as tutor_rat ";
		...
		sql_QUESTION1 = sql_QUESTION1 + "    AND a.question_no <= (decode(c.question_comm_gubun,5,6,3,4,6)) ";
		sql_QUESTION1 = sql_QUESTION1 + "    AND a.question_no != (decode(c.question_comm_gubun,5,4,3,3,4)) ";
		...
		sql_QUESTION2 = sql_QUESTION2 + "    between (decode(c.question_comm_gubun,5,7,3,5,7))  ";
		sql_QUESTION2 = sql_QUESTION2 + "    and (decode(c.question_comm_gubun,5,11,3,8,11)) ";
	...
	private void initSQLQUESTVarient(){
		...
		sql_QUEST = sql_QUEST + ", nvl(to_char(upper(dbms_lob.substr(content, 4000,1))),'')  AS CONTENT FROM TB_GRSUGGESTION  ";
	...
	private void setFieldVariableFromgrgubun_info() throws Exception{
		...
		grgubun_info_SBGUBUN03=grgubun_info.getDouble(9);
		grgubun_info_SBGUBUNPE03=grgubun_info.getDouble(10);
	}
	...
	private void setFieldVariableFromQUESTION_LIST() throws Exception{
		...
		QUESTION_LIST_ANSCNT1=QUESTION_LIST.getDouble(5);
		QUESTION_LIST_ANSCNT1_RAT=QUESTION_LIST.getDouble(6);
		QUESTION_LIST_ANSCNT2=QUESTION_LIST.getDouble(7);
		QUESTION_LIST_ANSCNT2_RAT=QUESTION_LIST.getDouble(8);
		QUESTION_LIST_ANSCNT3=QUESTION_LIST.getDouble(9);
		QUESTION_LIST_ANSCNT3_RAT=QUESTION_LIST.getDouble(10);
		QUESTION_LIST_ANSCNT4=QUESTION_LIST.getDouble(11);
		QUESTION_LIST_ANSCNT4_RAT=QUESTION_LIST.getDouble(12);
		QUESTION_LIST_ANSCNT5=QUESTION_LIST.getDouble(13);
		QUESTION_LIST_ANSCNT5_RAT=QUESTION_LIST.getDouble(14);
		QUESTION_LIST_RAT=GetB(QUESTION_LIST.getString(15));
	}
	...
	private void setFieldInitFromQUESTION_LIST(){
		...
		QUESTION_LIST_ANSCNT1=0;
		QUESTION_LIST_ANSCNT1_RAT=0;
		QUESTION_LIST_ANSCNT2=0;
		QUESTION_LIST_ANSCNT2_RAT=0;
		QUESTION_LIST_ANSCNT3=0;
		QUESTION_LIST_ANSCNT3_RAT=0;
		QUESTION_LIST_ANSCNT4=0;
		QUESTION_LIST_ANSCNT4_RAT=0;
		QUESTION_LIST_ANSCNT5=0;
	...
	private void setFieldVariableFromLIST() throws Exception{
		...
		LIST_SUBJ_ANS1_RAT=LIST.getDouble(4);
		LIST_SUBJ_ANS2=LIST.getDouble(5);
		LIST_SUBJ_ANS2_RAT=LIST.getDouble(6);
		LIST_SUBJ_ANS3=LIST.getDouble(7);
		LIST_SUBJ_ANS3_RAT=LIST.getDouble(8);
		LIST_SUBJ_ANS4=LIST.getDouble(9);
		LIST_SUBJ_ANS4_RAT=LIST.getDouble(10);
		LIST_STIME_ANS1=LIST.getDouble(11);
		LIST_STIME_ANS1_RAT=LIST.getDouble(12);
		LIST_STIME_ANS2=LIST.getDouble(13);
		LIST_STIME_ANS2_RAT=LIST.getDouble(14);
		LIST_STIME_ANS3=LIST.getDouble(15);
		LIST_STIME_ANS3_RAT=LIST.getDouble(16);
		LIST_TUTOR_ANS1=LIST.getDouble(17);
		LIST_TUTOR_ANS1_RAT=LIST.getDouble(18);
		LIST_TUTOR_ANS2=LIST.getDouble(19);
		LIST_TUTOR_ANS2_RAT=LIST.getDouble(20);
		LIST_TUTOR_ANS3=LIST.getDouble(21);
		LIST_TUTOR_ANS3_RAT=LIST.getDouble(22);
		LIST_TUTOR_ANS4=LIST.getDouble(23);
		LIST_TUTOR_ANS4_RAT=LIST.getDouble(24);
		LIST_TUTOR_RAT=GetB(LIST.getString(25));
	}
	...
	private void setFieldVariableFromQUESTION2() throws Exception{
		...
		QUESTION2_ENOUGH_RAT=GetB(QUESTION2.getString(3));
		QUESTION2_REGULAR_RAT=GetB(QUESTION2.getString(4));
	}
	...
	private void initConstVarient(){
		...
		sheet10_A26="계";
		sheet20_A1=4;
		sheet20_B1=" 敎育 運營 評價 結果";
		sheet20_A3=" ① 교육운영 및 시설에 대한 평가";
		sheet20_A6=" ② 교육시설 및 생활지도에 대한 평가";
		sheet20_A9=" ③ 교육평가 및 구성운영에 대한 평가";
		sheet20_A12=" ④ 강의 교과목 내용 및 배정시간에 대한 평가";
		sheet20_A15=" ⑤ 강사 평가";
		sheet20_A20=" ⑥ 폐지 및 신설 희망과목";
		sheet20_A22=" ⑦ 추천하고 싶은 강사";
		sheet20_A24=" ⑧ 기타 건의 사항";
		sheet20_A27="->";
		sheet30_A1="<첨부자료>";
		sheet30_A2="   1. 세부 항목별 설문 결과";
		sheet30_C3="(단위:명)";
		sheet30_A4="<교육총괄 >";
		sheet30_C4="매우높다← →매우낮다";
		sheet30_H4="평균";
		sheet30_C5="5점";
		sheet30_D5="4점";
		sheet30_E5="3점";
