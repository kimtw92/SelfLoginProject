...
class ReportHandler{
	...
	private void getScriptFromquestion_list(boolean bIsPrint) throws Exception{
		...
		while(QUESTION_LIST.next()){   //자동으로 생성되는 반복 밴드의 루프문
			...
			nHeightTmp=getPrintHeight(sheet30_B5, charWidth, 10, 156, 38, nAutoHeight_question_list[0]);
	...
	private void writeScriptquestion_list_header( ) throws Exception{
		//스크립트문 생성
		out.println("^CELLBG("+(nXCurPos)+","+(nYCurPos)+",188,51,1,RGB[255,192,203],RGB[255,192,203],0)\r");
		out.println("^CELLLINE("+(nXCurPos)+","+(nYCurPos)+",188,51,0,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos)+","+(nYCurPos)+",188,51,0,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos)+","+(nYCurPos)+",188,51,0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos)+","+(nYCurPos)+",188,51,0,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos)+","+(nYCurPos)+",188,1,12,0/,바탕,RGB[0,0,0],BOLD, , ,NONE,51,1)");
		out.println(sheet30_A3+"\r");
		out.println("^CELLBG("+(nXCurPos+188)+","+(nYCurPos)+",221,20,1,RGB[255,192,203],RGB[255,192,203],0)\r");
		out.println("^CELLLINE("+(nXCurPos+188)+","+(nYCurPos)+",221,20,0,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos+188)+","+(nYCurPos)+",221,20,0,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos+188)+","+(nYCurPos)+",221,20,0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos+188)+","+(nYCurPos)+",221,20,0,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos+188)+","+(nYCurPos)+",221,1,11,0/,굴림체,RGB[0,0,0], , , ,NONE,20,1)");
		out.println(sheet30_C3+"\r");
		out.println("^CELLBG("+(nXCurPos+409)+","+(nYCurPos)+",58,51,1,RGB[255,192,203],RGB[255,192,203],0)\r");
		out.println("^CELLLINE("+(nXCurPos+409)+","+(nYCurPos)+",58,51,0,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos+409)+","+(nYCurPos)+",58,51,0,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos+409)+","+(nYCurPos)+",58,51,0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos+409)+","+(nYCurPos)+",58,51,0,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos+409)+","+(nYCurPos)+",58,1,10,0/,바탕,RGB[0,0,0],BOLD, , ,NONE,51,1)");
		out.println(sheet30_H3+"\r");
		out.println("^CELLBG("+(nXCurPos+188)+","+(nYCurPos+20)+",37,31,1,RGB[255,192,203],RGB[255,192,203],0)\r");
		out.println("^CELLLINE("+(nXCurPos+188)+","+(nYCurPos+20)+",37,31,0,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos+188)+","+(nYCurPos+20)+",37,31,0,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos+188)+","+(nYCurPos+20)+",37,31,0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos+188)+","+(nYCurPos+20)+",37,31,0,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos+188)+","+(nYCurPos+20)+",37,1,11,0/,굴림체,RGB[0,0,0], , , ,NONE,31,1)");
		out.println(sheet30_C4+"\r");
		out.println("^CELLBG("+(nXCurPos+225)+","+(nYCurPos+20)+",45,31,1,RGB[255,192,203],RGB[255,192,203],0)\r");
		out.println("^CELLLINE("+(nXCurPos+225)+","+(nYCurPos+20)+",45,31,0,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos+225)+","+(nYCurPos+20)+",45,31,0,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos+225)+","+(nYCurPos+20)+",45,31,0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos+225)+","+(nYCurPos+20)+",45,31,0,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos+225)+","+(nYCurPos+20)+",45,1,11,0/,굴림체,RGB[0,0,0], , , ,NONE,31,1)");
		out.println(sheet30_D4+"\r");
		out.println("^CELLBG("+(nXCurPos+270)+","+(nYCurPos+20)+",45,31,1,RGB[255,192,203],RGB[255,192,203],0)\r");
		out.println("^CELLLINE("+(nXCurPos+270)+","+(nYCurPos+20)+",45,31,0,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos+270)+","+(nYCurPos+20)+",45,31,0,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos+270)+","+(nYCurPos+20)+",45,31,0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos+270)+","+(nYCurPos+20)+",45,31,0,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos+270)+","+(nYCurPos+20)+",45,1,11,0/,굴림체,RGB[0,0,0], , , ,NONE,31,1)");
		out.println(sheet30_E4+"\r");
		out.println("^CELLBG("+(nXCurPos+315)+","+(nYCurPos+20)+",45,31,1,RGB[255,192,203],RGB[255,192,203],0)\r");
		out.println("^CELLLINE("+(nXCurPos+315)+","+(nYCurPos+20)+",45,31,0,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos+315)+","+(nYCurPos+20)+",45,31,0,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos+315)+","+(nYCurPos+20)+",45,31,0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos+315)+","+(nYCurPos+20)+",45,31,0,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos+315)+","+(nYCurPos+20)+",45,1,11,0/,굴림체,RGB[0,0,0], , , ,NONE,31,1)");
		out.println(sheet30_F4+"\r");
		out.println("^CELLBG("+(nXCurPos+360)+","+(nYCurPos+20)+",49,31,1,RGB[255,192,203],RGB[255,192,203],0)\r");
		out.println("^CELLLINE("+(nXCurPos+360)+","+(nYCurPos+20)+",49,31,0,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos+360)+","+(nYCurPos+20)+",49,31,0,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos+360)+","+(nYCurPos+20)+",49,31,0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos+360)+","+(nYCurPos+20)+",49,31,0,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos+360)+","+(nYCurPos+20)+",49,1,11,0/,굴림체,RGB[0,0,0], , , ,NONE,31,1)");
	...
	private void writeScriptquestion_list( ) throws Exception{
		...
		out.println("^CELLLINE("+(nXCurPos+225)+","+(nYCurPos)+",45,"+(nAutoHeight_question_list[1])+",0,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos+225)+","+(nYCurPos)+",45,"+(nAutoHeight_question_list[1])+",0,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos+225)+","+(nYCurPos)+",45,"+(nAutoHeight_question_list[1])+",0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos+225)+","+(nYCurPos)+",45,"+(nAutoHeight_question_list[1])+",0,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos+225)+","+(nYCurPos)+",45,1,10,1/0/0,바탕,RGB[0,0,0], , , ,NONE,"+(nAutoHeight_question_list[1])+",1)");
		out.println(sheet30_D5+"\r");
		out.println("^CELLLINE("+(nXCurPos+270)+","+(nYCurPos)+",45,"+(nAutoHeight_question_list[1])+",0,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos+270)+","+(nYCurPos)+",45,"+(nAutoHeight_question_list[1])+",0,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos+270)+","+(nYCurPos)+",45,"+(nAutoHeight_question_list[1])+",0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos+270)+","+(nYCurPos)+",45,"+(nAutoHeight_question_list[1])+",0,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos+270)+","+(nYCurPos)+",45,1,10,1/0/0,바탕,RGB[0,0,0], , , ,NONE,"+(nAutoHeight_question_list[1])+",1)");
		out.println(sheet30_E5+"\r");
		out.println("^CELLLINE("+(nXCurPos+315)+","+(nYCurPos)+",45,"+(nAutoHeight_question_list[1])+",0,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos+315)+","+(nYCurPos)+",45,"+(nAutoHeight_question_list[1])+",0,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos+315)+","+(nYCurPos)+",45,"+(nAutoHeight_question_list[1])+",0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos+315)+","+(nYCurPos)+",45,"+(nAutoHeight_question_list[1])+",0,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos+315)+","+(nYCurPos)+",45,1,10,1/0/0,바탕,RGB[0,0,0], , , ,NONE,"+(nAutoHeight_question_list[1])+",1)");
		...
		out.print("^PRINT("+(nXCurPos+360)+","+(nYCurPos)+",49,1,10,1/0/0,바탕,RGB[0,0,0], , , ,NONE,"+(nAutoHeight_question_list[1])+",1)");
		out.println(sheet30_G5+"\r");
		out.println("^CELLLINE("+(nXCurPos+409)+","+(nYCurPos)+",58,"+(nAutoHeight_question_list[0])+",0,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos+409)+","+(nYCurPos)+",58,"+(nAutoHeight_question_list[0])+",0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos+409)+","+(nYCurPos)+",58,"+(nAutoHeight_question_list[0])+",0,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos+409)+","+(nYCurPos)+",58,1,10,0/,바탕,RGB[255,0,0], , , ,NONE,"+(nAutoHeight_question_list[0])+",1)");
		out.println(sheet30_H5+"\r");
		out.println("^CELLLINE("+(nXCurPos+409)+","+(nYCurPos+nAutoHeight_question_list[0])+",58,"+(nAutoHeight_question_list[1]-nAutoHeight_question_list[0])+",0,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos+409)+","+(nYCurPos+nAutoHeight_question_list[0])+",58,"+(nAutoHeight_question_list[1]-nAutoHeight_question_list[0])+",0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos+409)+","+(nYCurPos+nAutoHeight_question_list[0])+",58,"+(nAutoHeight_question_list[1]-nAutoHeight_question_list[0])+",0,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos+409)+","+(nYCurPos+nAutoHeight_question_list[0])+",58,0,11,0/,굴림체,RGB[0,0,0], , , ,NONE,"+(nAutoHeight_question_list[1]-nAutoHeight_question_list[0])+",1)");
