...
class ReportHandler{
	...
	private void executeSheet10( ) throws Exception{
		//쉬트 초기화 함수 호출
		initSheetVariant(38, 99, 543, 781, true);
	...
	private void getScriptFromtitle(boolean bIsFirst, boolean bIsPrint) throws Exception{
		if(bIsFirst){   //밴드 최초 호출 시에만 실행되는 코드
			...
			//데이터 변수 할당
			sheet10_C2= p_strdate_Param.substring(0,4) + "." + p_strdate_Param.substring(4,6) + "." + p_strdate_Param.substring(6,8) + " ~ "  + p_enddate_Param.substring(0,4) + "." + p_enddate_Param.substring(4,6) + "." + p_enddate_Param.substring(6,8);
		}   //end if(bIsFirst)
	...
	private void getScriptFromLIST(boolean bIsPrint) throws Exception{
		...
		while(LIST.next()){   //자동으로 생성되는 반복 밴드의 루프문
			...
			sheet10_B5=LIST_NAME;
			sheet10_C5=LIST_IDATE;
			sheet10_D5=LIST_CDATE;
			sheet10_E5=LIST_LNAME;
	...
	private void writeScripttitle( ) throws Exception{
		//스크립트문 생성
		out.print("^PRINT(38,41,504,1,16,0/,돋움체,RGB[0,0,0],BOLD, , ,NONE,38,1)");
		out.println(sheet10_A1+"\r");
		out.print("^PRINT(167,79,375,2,11,0/,돋움체,RGB[0,0,0], , , ,NONE,20,1)");
	...
	private void writeScriptfoot( ) throws Exception{
		//스크립트문 생성
		out.print("^PRINT(38,781,504,1,11,0/,돋움체,RGB[0,0,0], , , ,NONE,20,1)");
	...
	private void writeScriptheader( ) throws Exception{
		//스크립트문 생성
		out.println("^CELLBG("+(nXCurPos)+","+(nYCurPos)+",45,20,1,RGB[230,230,250],RGB[230,230,250],0)\r");
		out.println("^CELLLINE("+(nXCurPos)+","+(nYCurPos)+",45,20,0,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos)+","+(nYCurPos)+",45,20,0,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos)+","+(nYCurPos)+",45,20,0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos)+","+(nYCurPos)+",45,20,0,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos)+","+(nYCurPos)+",45,1,11,0/,돋움체,RGB[0,0,0], , , ,NONE,20,1)");
		out.println(sheet10_A4+"\r");
		out.println("^CELLBG("+(nXCurPos+45)+","+(nYCurPos)+",84,20,1,RGB[230,230,250],RGB[230,230,250],0)\r");
		out.println("^CELLLINE("+(nXCurPos+45)+","+(nYCurPos)+",84,20,0,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos+45)+","+(nYCurPos)+",84,20,0,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos+45)+","+(nYCurPos)+",84,20,0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos+45)+","+(nYCurPos)+",84,20,0,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos+45)+","+(nYCurPos)+",84,1,11,0/,돋움체,RGB[0,0,0], , , ,NONE,20,1)");
		out.println(sheet10_B4+"\r");
		out.println("^CELLBG("+(nXCurPos+129)+","+(nYCurPos)+",147,20,1,RGB[230,230,250],RGB[230,230,250],0)\r");
		out.println("^CELLLINE("+(nXCurPos+129)+","+(nYCurPos)+",147,20,0,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos+129)+","+(nYCurPos)+",147,20,0,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos+129)+","+(nYCurPos)+",147,20,0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos+129)+","+(nYCurPos)+",147,20,0,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos+129)+","+(nYCurPos)+",147,1,11,0/,돋움체,RGB[0,0,0], , , ,NONE,20,1)");
		out.println(sheet10_C4+"\r");
		out.println("^CELLBG("+(nXCurPos+276)+","+(nYCurPos)+",147,20,1,RGB[230,230,250],RGB[230,230,250],0)\r");
		out.println("^CELLLINE("+(nXCurPos+276)+","+(nYCurPos)+",147,20,0,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos+276)+","+(nYCurPos)+",147,20,0,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos+276)+","+(nYCurPos)+",147,20,0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos+276)+","+(nYCurPos)+",147,20,0,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos+276)+","+(nYCurPos)+",147,1,11,0/,돋움체,RGB[0,0,0], , , ,NONE,20,1)");
		out.println(sheet10_D4+"\r");
		out.println("^CELLBG("+(nXCurPos+423)+","+(nYCurPos)+",81,20,1,RGB[230,230,250],RGB[230,230,250],0)\r");
		out.println("^CELLLINE("+(nXCurPos+423)+","+(nYCurPos)+",81,20,0,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos+423)+","+(nYCurPos)+",81,20,0,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos+423)+","+(nYCurPos)+",81,20,0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos+423)+","+(nYCurPos)+",81,20,0,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos+423)+","+(nYCurPos)+",81,1,11,0/,돋움체,RGB[0,0,0], , , ,NONE,20,1)");
	...
	private void writeScriptLIST( ) throws Exception{
		...
		out.println("^CELLLINE("+(nXCurPos)+","+(nYCurPos)+",45,20,0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos)+","+(nYCurPos)+",45,20,0,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos)+","+(nYCurPos)+",45,1,11,1/0/0,돋움체,RGB[0,0,0], , , ,NONE,20,1)");
	...
	private void setParam(){
		p_strdate_Param=toKor(GetB(request.getParameter("p_strdate")));
		p_enddate_Param=toKor(GetB(request.getParameter("p_enddate")));
	}
	...
	private void initSQLConst(){
		...
		sql_LIST = sql_LIST + ",(select name from tb_member where userno = a.luserno) as lname ";
		sql_LIST = sql_LIST + "from tb_gadmin_history a  ";
		sql_LIST = sql_LIST + "where cdate  ";
		sql_LIST = sql_LIST + "between to_date(decode('" + p_strdate_Param + "','','1900-01-01'," + p_strdate_Param + "), 'yyyy-mm-dd') and  ";
		sql_LIST = sql_LIST + "to_date(decode('" + p_enddate_Param + "','',to_char(sysdate,'yyyy-mm-dd'),'" + p_enddate_Param + "'), 'yyyy-mm-dd') ";
		sql_LIST = sql_LIST + "order by cdate desc";
	}
	...
	private void setFieldVariableFromLIST() throws Exception{
		...
		LIST_JIKNM=GetB(LIST.getString(4));
