...
class ReportHandler{
	...
	private void getScriptFromquestion_list_header(boolean bIsFirst, boolean bIsPrint) throws Exception{
		...
		if(bIsFirst){   //밴드 최초 호출 시에만 실행되는 코드
			...
			//데이터 변수 할당
			sheet30_A3="구      분(응답자수:"+GR_CNT_CNT+"명)";
		}   //end if(bIsFirst)
	...
	private void writeScriptquestion_list( ) throws Exception{
		...
		out.print("^PRINT("+(nXCurPos+409)+","+(nYCurPos+nAutoHeight_question_list[0])+",58,1,11,0/,굴림체,RGB[0,0,0], , , ,NONE,"+(nAutoHeight_question_list[1]-nAutoHeight_question_list[0])+",1)");
