...
class ReportHandler{
	...
	private double master_TOT_TSEAT;
	...
	private double totSum_TOT_TSEAT;
	...
	private void initSQLConst(){
		...
		sql_master = sql_master + "  sum(tseat) as tot_tseat , ";
		...
		sql_master = sql_master + "      (select count('X') totno from TB_GRRESULT where rgrayn='Y' and grcode=hh.grcode and grseq between '" + p_startyear_Param + "' || '00' AND '" + p_endyear_Param + "' || '99') tseat , ";
//		sql_master = sql_master + "		 totno as tseat , ";
//		sql_master = sql_master + "      (select nvl(sum(tseat),0) from tb_grseq mx where mx.grcode = hh.grcode and mx.grseq between '" + p_startyear_Param + "' || '00' AND '" + p_endyear_Param + "' || '99') as tseat , ";
		...
		sql_master = sql_master + "    FROM ( ";
		sql_master = sql_master + "        SELECT (c.grtype || c.grsubcd) as gubun, ";
		...
		sql_master = sql_master + "        GROUP BY (c.grtype || c.grsubcd), (mc.mcode_name || sc.scode_name || '교육') , c.grcode, c.grcodenm ";
		sql_master = sql_master + "        ORDER BY gubun, gubunnm, grcode, grcodenm) hh)";
		...
		sql_totSum = sql_totSum + "  sum(tseat) as tot_tseat , ";
		...
		sql_totSum = sql_totSum + "      (select count('X') totno from TB_GRRESULT where rgrayn='Y' and grcode=hh.grcode and grseq between '" + p_startyear_Param + "' || '00' AND '" + p_endyear_Param + "' || '99') tseat , ";
/*		sql_totSum = sql_totSum + "      ( ";
		sql_totSum = sql_totSum + "        select nvl(sum(tseat), 0) ";
		sql_totSum = sql_totSum + "        from tb_grseq mx ";
		sql_totSum = sql_totSum + "        where mx.grcode = hh.grcode ";
		sql_totSum = sql_totSum + "          and mx.grseq between '" + p_startyear_Param + "' || '00' AND '" + p_endyear_Param + "' || '99') as tseat , ";
*/
		...
		sql_totSum = sql_totSum + "    FROM ( ";
		sql_totSum = sql_totSum + "        SELECT (c.grtype || c.grsubcd) as gubun, ";
		...
		sql_totSum = sql_totSum + "          nvl(sum(b.tseat), 0) tseat , ";
		...
		sql_totSum = sql_totSum + "        GROUP BY (c.grtype || c.grsubcd), (mc.mcode_name || sc.scode_name || '교육') , c.grcode , c.grcodenm ";
		sql_totSum = sql_totSum + "        ORDER BY gubun, gubunnm, grcode, grcodenm) hh)";
	}
	...
	private void initSQLdetailVarient(){
		...
		sql_detail = sql_detail + "      (select count('X') totno from TB_GRRESULT where rgrayn='Y' and grcode=hh.grcode and grseq between '" + p_startyear_Param + "' || '00' AND '" + p_endyear_Param + "' || '99') tseat , ";
/*		sql_detail = sql_detail + "  ( ";
		sql_detail = sql_detail + "    select nvl(sum(tseat), 0) ";
		sql_detail = sql_detail + "    from tb_grseq mx ";
		sql_detail = sql_detail + "    where mx.grcode = hh.grcode ";
		sql_detail = sql_detail + "      and mx.grseq between '" + p_startyear_Param + "' || '00' AND '" + p_endyear_Param + "' || '99') as tseat ,   ";
*/		sql_detail = sql_detail + "  lessontime , ";
		...
		sql_detail = sql_detail + "    SELECT (c.grtype || c.grsubcd) as gubun, ";
		...
		sql_detail = sql_detail + "      nvl(sum(b.tseat), 0) tseat , ";
		...
		sql_detail = sql_detail + "      tb_grseq b, ";
		sql_detail = sql_detail + "      tb_grcode c, ";
		sql_detail = sql_detail + "      tb_subjseq d ";
		...
		sql_detail = sql_detail + "      AND (mc.cd_gubun(+)='G' ";
		...
		sql_detail = sql_detail + "    GROUP BY (c.grtype || c.grsubcd), (mc.mcode_name || sc.scode_name || '교육') , c.grcode , c.grcodenm ";
		sql_detail = sql_detail + "    ORDER BY gubun, gubunnm, grcode, grcodenm) hh";
	}
	...
	private void setFieldVariableFrommaster() throws Exception{
		...
		master_TOT_TSEAT=master.getDouble(5);
		master_TOT_LESSONTIME=master.getDouble(6);
		master_TOT_TLECTURETIME=master.getDouble(7);
		master_TOT_SUMTIME=master.getDouble(8);
		master_TOT_SILGITIME=master.getDouble(9);
		master_TOT_TORONTIME=master.getDouble(10);
		master_TOT_HYUNTIME=master.getDouble(11);
		master_TOT_MULTITIME=master.getDouble(12);
		master_TOT_ETCTIME=master.getDouble(13);
	}
	...
	private void setFieldVariableFromdetail() throws Exception{
		...
		detail_TSEAT=detail.getDouble(7);
		detail_LESSONTIME=detail.getDouble(8);
		detail_TLECTURETIME=detail.getDouble(9);
		detail_SUMTIME=detail.getDouble(10);
		detail_SILGITIME=detail.getDouble(11);
		detail_TORONTIME=detail.getDouble(12);
		detail_HYUNTIME=detail.getDouble(13);
		detail_MULTITIME=detail.getDouble(14);
		detail_ETCTIME=detail.getDouble(15);
	}
	...
	private void setFieldVariableFromtotSum() throws Exception{
		...
		totSum_TOT_TSEAT=totSum.getDouble(3);
		totSum_TOT_LESSONTIME=totSum.getDouble(4);
		totSum_TOT_TLECTURETIME=totSum.getDouble(5);
		totSum_TOT_SUMTIME=totSum.getDouble(6);
		totSum_TOT_SILGITIME=totSum.getDouble(7);
		totSum_TOT_TORONTIME=totSum.getDouble(8);
		totSum_TOT_HYUNTIME=totSum.getDouble(9);
		totSum_TOT_MULTITIME=totSum.getDouble(10);
		totSum_TOT_ETCTIME=totSum.getDouble(11);
	}
