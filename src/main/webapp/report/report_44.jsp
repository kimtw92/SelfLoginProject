...
class ReportHandler{
	...
	private void getScriptFromloop(boolean bIsPrint) throws Exception{
		...
		while(AWARD_LIST.next()){   //자동으로 생성되는 반복 밴드의 루프문
			...
			//데이터 변수 할당
			sheet10_A1="제 " + AWARD_LIST_RAWARDNO + " 호";
			sheet10_F1=AWARD_LIST_TITLE;
			sheet10_B4=AWARD_LIST_SEQNO;
			sheet10_C4="  "+AWARD_LIST_DEPTNM+" "+AWARD_LIST_DEPTSUB;
			sheet10_A6="  "+AWARD_LIST_JIKNM+" ";
			sheet10_D6=AWARD_LIST_NAME;
	...
	private void writeScriptloop( ) throws Exception{
		//스크립트문 생성
		out.print("^PRINT("+(nXCurPos)+","+(nYCurPos)+",433,0,18,0/,궁서체,RGB[0,0,0],BOLD, , ,NONE,34,1)");
		...
		out.print("^PRINT("+(nXCurPos+11)+","+(nYCurPos+160)+",98,0,16,0/,궁서체,RGB[0,0,0], , , ,NONE,25,1)");
		out.println(sheet10_B4+"\r");
		out.print("^PRINT("+(nXCurPos+109)+","+(nYCurPos+160)+",324,2,16,0/,궁서체,RGB[0,0,0], , , ,NONE,25,1)");
		out.println(sheet10_C4+"\r");
		out.print("^PRINT("+(nXCurPos)+","+(nYCurPos+195)+",341,2,16,0/,궁서체,RGB[0,0,0], , , ,NONE,28,1)");
		out.println(sheet10_A6+"\r");
		out.print("^PRINT("+(nXCurPos+341)+","+(nYCurPos+195)+",92,1,18,0/,궁서체,RGB[0,0,0],BOLD, , ,NONE,28,1)");
		...
		out.print("^PRINT("+(nXCurPos)+","+(nYCurPos+561)+",341,2,17,0/,바탕체,RGB[0,0,0],BOLD, , ,NONE,36,1)");
		out.println(sheet10_A15+"\r");
		out.print("^PRINT("+(nXCurPos+341)+","+(nYCurPos+561)+",92,0,22,0/,바탕체,RGB[0,0,0],BOLD, , ,NONE,36,1)");
	...
	private void initSQLConst(){
		sql_AWARD_LIST = "SELECT SUBSTR(B.GRSEQ,1,4) ||'년도 ' || decode(substr('" + p_grseq_Param + "',5,2), '01', decode((select count(*) from tb_grseq where grcode=A.grcode and grseq like substr('" + p_grseq_Param + "', 1,4) ||'__' and use_yn='Y'), 0, null, 1, null, '제' || to_number(SUBSTR(A.grseq, 5,2)) ||'기 ' )) || SEARCHGRCODENM(A.GRCODE,A.GRSEQ)   ";
		sql_AWARD_LIST = sql_AWARD_LIST + " AS TITLE ";
		...
		sql_AWARD_LIST = sql_AWARD_LIST + "             , A. RAWARDNO ";
		...
		sql_AWARD_LIST = sql_AWARD_LIST + "             , to_char(seqno) || '등' as seqno ";
	...
	private void setFieldVariableFromAWARD_LIST() throws Exception{
		...
		AWARD_LIST_RAWARDNO=GetB(AWARD_LIST.getString(7));
		...
		AWARD_LIST_SEQNO=GetB(AWARD_LIST.getString(11));
	}
	...
	private void initConstVarient(){
		sheet10_A2="상    장";
		sheet10_B9="교육훈련과정을 우수한 성적으로";
		sheet10_B10="이수하여 타의 모범이 되므로 이";
		sheet10_B11="상장을 드립니다.";
		sheet10_A13="" + toDate() + "";
		sheet10_A15="인천광역시지방공무원교육원장";
		sheet10_D15="" + p_name_Param + "";
	}
