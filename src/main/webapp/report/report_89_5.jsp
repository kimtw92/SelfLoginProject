...
class ReportHandler{
	...
	private void executeSheet40( ) throws Exception{
		...
		getScriptFromsheet5_end(true, true);    //Void 밴드 호출
	...
	private void getScriptFromlist_header(boolean bIsFirst, boolean bIsPrint) throws Exception{
		...
		if(bIsFirst){   //밴드 최초 호출 시에만 실행되는 코드
			...
			if(LIST.next()){
				setFieldVariableFromLIST();	//ResultSet LIST에서 필드 값 설정
			}else{
				setFieldInitFromLIST();	//ResultSet LIST의 필드 값 초기화
			}
			...
			sheet40_D5=String.valueOf(LIST_SUBJ_ANS33_RAT);
			sheet40_F5=String.valueOf(LIST_SUBJ_ANS33_RAT);
			sheet40_H5=String.valueOf(LIST_SUBJ_ANS33_RAT);
			sheet40_J5=String.valueOf(LIST_SUBJ_ANS33_RAT);
			sheet40_L5=String.valueOf(LIST_SUBJ_ANS33_RAT);
	...
	private void getScriptFromlist(boolean bIsPrint) throws Exception{
		...
		while(LIST.next()){   //자동으로 생성되는 반복 밴드의 루프문
			...
			//데이터 변수 할당
			sheet40_D6=String.valueOf(LIST_STIME_ANS33_RAT);
			sheet40_F6=String.valueOf(LIST_STIME_ANS33_RAT);
			sheet40_H6=String.valueOf(LIST_STIME_ANS33_RAT);
			sheet40_J6=String.valueOf(LIST_STIME_ANS33_RAT);
			sheet40_L6=String.valueOf(LIST_STIME_ANS33_RAT);
			sheet40_N6=String.valueOf(LIST_STIME_ANS_AVG);
			sheet40_O6=String.valueOf(LIST_TUTOR_ANS_AVG);
			sheet40_D7=String.valueOf(LIST_TUTOR_ANS33_RAT);
			sheet40_F7=String.valueOf(LIST_TUTOR_ANS33_RAT);
			sheet40_H7=String.valueOf(LIST_TUTOR_ANS33_RAT);
			sheet40_J7=String.valueOf(LIST_TUTOR_ANS33_RAT);
			sheet40_L7=String.valueOf(LIST_TUTOR_ANS33_RAT);
	...
	//----bIsPrint : 감추기 속성 설정 여부. true면 출력, false면 AI 스크립트를 생성하지 않음.
	//----nRepeatCnt : 부모 반복 밴드 수행 횟수와 연동 옵션 설정시 void 밴드가 수행할 반복 횟수 전달
	private void getScriptFromsheet5_end(boolean bIsFirst, boolean bIsPrint) throws Exception{
		//지역 변수 선언 및 초기화
		int nBandHeight=20;    //밴드 출력 높이
	...
	private void writeScriptpage_3( ) throws Exception{
		//스크립트문 생성
		out.print("^PRINT("+(nXCurPos)+","+(nYCurPos)+",367,0,16,0/,바탕체,RGB[0,0,255],BOLD, , ,NONE,31,1)");
	...
	private void writeScriptlist_header( ) throws Exception{
		//스크립트문 생성
		out.println("^CELLBG("+(nXCurPos)+","+(nYCurPos)+",69,20,1,RGB[230,230,250],RGB[230,230,250],0)\r");
		out.println("^CELLLINE("+(nXCurPos)+","+(nYCurPos)+",69,20,0,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos)+","+(nYCurPos)+",69,20,0,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos)+","+(nYCurPos)+",69,20,0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos)+","+(nYCurPos)+",69,20,0,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos)+","+(nYCurPos)+",69,1,10,0/,바탕,RGB[0,0,0], , , ,NONE,20,1)");
		out.println(sheet40_A3+"\r");
		out.println("^CELLBG("+(nXCurPos+69)+","+(nYCurPos)+",39,40,1,RGB[230,230,250],RGB[230,230,250],0)\r");
		out.println("^CELLLINE("+(nXCurPos+69)+","+(nYCurPos)+",39,40,0,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos+69)+","+(nYCurPos)+",39,40,0,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos+69)+","+(nYCurPos)+",39,40,0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos+69)+","+(nYCurPos)+",39,40,0,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos+69)+","+(nYCurPos)+",39,1,11,0/,바탕,RGB[0,0,0], , , ,NONE,40,1)");
		out.println(sheet40_B3+"\r");
		out.println("^CELLBG("+(nXCurPos+108)+","+(nYCurPos)+",44,40,1,RGB[230,230,250],RGB[230,230,250],0)\r");
		out.println("^CELLLINE("+(nXCurPos+108)+","+(nYCurPos)+",44,40,0,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos+108)+","+(nYCurPos)+",44,40,0,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos+108)+","+(nYCurPos)+",44,40,0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos+108)+","+(nYCurPos)+",44,40,0,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos+108)+","+(nYCurPos)+",44,1,11,0/,바탕,RGB[0,0,0], , , ,NONE,40,1)");
		out.println(sheet40_C3+"\r");
		out.println("^CELLBG("+(nXCurPos+152)+","+(nYCurPos)+",243,20,1,RGB[230,230,250],RGB[230,230,250],0)\r");
		out.println("^CELLLINE("+(nXCurPos+152)+","+(nYCurPos)+",243,20,0,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos+152)+","+(nYCurPos)+",243,20,0,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos+152)+","+(nYCurPos)+",243,20,0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos+152)+","+(nYCurPos)+",243,20,0,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos+152)+","+(nYCurPos)+",243,1,11,0/,바탕,RGB[0,0,0], , , ,NONE,20,1)");
		out.println(sheet40_D3+"\r");
		out.println("^CELLBG("+(nXCurPos+395)+","+(nYCurPos)+",79,20,1,RGB[230,230,250],RGB[230,230,250],0)\r");
		out.println("^CELLLINE("+(nXCurPos+395)+","+(nYCurPos)+",79,20,0,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos+395)+","+(nYCurPos)+",79,20,0,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos+395)+","+(nYCurPos)+",79,20,0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos+395)+","+(nYCurPos)+",79,20,0,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos+395)+","+(nYCurPos)+",79,1,11,0/,바탕,RGB[0,0,0], , , ,NONE,20,1)");
		out.println(sheet40_N3+"\r");
		out.println("^CELLBG("+(nXCurPos)+","+(nYCurPos+20)+",69,20,1,RGB[230,230,250],RGB[230,230,250],0)\r");
		out.println("^CELLLINE("+(nXCurPos)+","+(nYCurPos+20)+",69,20,0,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos)+","+(nYCurPos+20)+",69,20,0,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos)+","+(nYCurPos+20)+",69,20,0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos)+","+(nYCurPos+20)+",69,20,0,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos)+","+(nYCurPos+20)+",69,1,10,1/0/0,바탕,RGB[0,0,0], , , ,NONE,20,1)");
		out.println(sheet40_A4+"\r");
		out.println("^CELLBG("+(nXCurPos+152)+","+(nYCurPos+20)+",56,20,1,RGB[230,230,250],RGB[230,230,250],0)\r");
		out.println("^CELLLINE("+(nXCurPos+152)+","+(nYCurPos+20)+",56,20,0,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos+152)+","+(nYCurPos+20)+",56,20,0,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos+152)+","+(nYCurPos+20)+",56,20,0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos+152)+","+(nYCurPos+20)+",56,20,0,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos+152)+","+(nYCurPos+20)+",56,1,11,0/,바탕,RGB[0,0,0], , , ,NONE,20,1)");
		out.println(sheet40_D4+"\r");
		out.println("^CELLBG("+(nXCurPos+208)+","+(nYCurPos+20)+",47,20,1,RGB[230,230,250],RGB[230,230,250],0)\r");
		out.println("^CELLLINE("+(nXCurPos+208)+","+(nYCurPos+20)+",47,20,0,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos+208)+","+(nYCurPos+20)+",47,20,0,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos+208)+","+(nYCurPos+20)+",47,20,0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos+208)+","+(nYCurPos+20)+",47,20,0,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos+208)+","+(nYCurPos+20)+",47,1,11,0/,바탕,RGB[0,0,0], , , ,NONE,20,1)");
		out.println(sheet40_F4+"\r");
		out.println("^CELLBG("+(nXCurPos+255)+","+(nYCurPos+20)+",45,20,1,RGB[230,230,250],RGB[230,230,250],0)\r");
		out.println("^CELLLINE("+(nXCurPos+255)+","+(nYCurPos+20)+",45,20,0,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos+255)+","+(nYCurPos+20)+",45,20,0,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos+255)+","+(nYCurPos+20)+",45,20,0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos+255)+","+(nYCurPos+20)+",45,20,0,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos+255)+","+(nYCurPos+20)+",45,1,11,0/,바탕,RGB[0,0,0], , , ,NONE,20,1)");
		out.println(sheet40_H4+"\r");
		out.println("^CELLBG("+(nXCurPos+300)+","+(nYCurPos+20)+",39,20,1,RGB[230,230,250],RGB[230,230,250],0)\r");
		out.println("^CELLLINE("+(nXCurPos+300)+","+(nYCurPos+20)+",39,20,0,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos+300)+","+(nYCurPos+20)+",39,20,0,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos+300)+","+(nYCurPos+20)+",39,20,0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos+300)+","+(nYCurPos+20)+",39,20,0,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos+300)+","+(nYCurPos+20)+",39,1,11,0/,바탕,RGB[0,0,0], , , ,NONE,20,1)");
		out.println(sheet40_J4+"\r");
		out.println("^CELLBG("+(nXCurPos+339)+","+(nYCurPos+20)+",56,20,1,RGB[230,230,250],RGB[230,230,250],0)\r");
		out.println("^CELLLINE("+(nXCurPos+339)+","+(nYCurPos+20)+",56,20,0,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos+339)+","+(nYCurPos+20)+",56,20,0,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos+339)+","+(nYCurPos+20)+",56,20,0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos+339)+","+(nYCurPos+20)+",56,20,0,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos+339)+","+(nYCurPos+20)+",56,1,11,0/,바탕,RGB[0,0,0], , , ,NONE,20,1)");
		out.println(sheet40_L4+"\r");
		out.println("^CELLBG("+(nXCurPos+395)+","+(nYCurPos+20)+",41,20,1,RGB[255,255,255],RGB[255,255,255],0)\r");
		out.print("^PRINT("+(nXCurPos+395)+","+(nYCurPos+20)+",41,1,11,0/,굴림체,RGB[0,0,0], , , ,NONE,20,1)");
		out.println(sheet40_N4+"\r");
		out.println("^CELLBG("+(nXCurPos+436)+","+(nYCurPos+20)+",38,20,1,RGB[230,230,250],RGB[230,230,250],0)\r");
		out.println("^CELLLINE("+(nXCurPos+436)+","+(nYCurPos+20)+",38,20,0,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos+436)+","+(nYCurPos+20)+",38,20,0,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos+436)+","+(nYCurPos+20)+",38,20,0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos+436)+","+(nYCurPos+20)+",38,20,0,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos+436)+","+(nYCurPos+20)+",38,1,11,0/,바탕,RGB[0,0,0], , , ,NONE,20,1)");
		out.println(sheet40_O4+"\r");
		out.println("^CELLLINE("+(nXCurPos)+","+(nYCurPos+40)+",69,61,0,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos)+","+(nYCurPos+40)+",69,61,0,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos)+","+(nYCurPos+40)+",69,61,0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos)+","+(nYCurPos+40)+",69,61,0,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos)+","+(nYCurPos+40)+",69,0,10,0/,바탕,RGB[0,0,0], , , ,NONE,61,1)");
		out.println(sheet40_A5+"\r");
		out.println("^CELLLINE("+(nXCurPos+69)+","+(nYCurPos+40)+",39,61,0,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos+69)+","+(nYCurPos+40)+",39,61,0,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos+69)+","+(nYCurPos+40)+",39,61,0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos+69)+","+(nYCurPos+40)+",39,61,0,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos+69)+","+(nYCurPos+40)+",39,1,10,0/,바탕,RGB[0,0,0], , , ,NONE,61,1)");
		out.println(sheet40_B5+"\r");
		out.print("^PRINT("+(nXCurPos+108)+","+(nYCurPos+40)+",44,1,10,0/,굴림체,RGB[0,0,0], , , ,NONE,21,1)");
		out.println(sheet40_C5+"\r");
		out.println("^CELLLINE("+(nXCurPos+152)+","+(nYCurPos+40)+",56,21,0,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos+152)+","+(nYCurPos+40)+",56,21,0,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos+152)+","+(nYCurPos+40)+",56,21,0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos+152)+","+(nYCurPos+40)+",56,21,0,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos+152)+","+(nYCurPos+40)+",56,1,10,0/,바탕,RGB[0,0,0], , , ,NONE,21,1)");
		out.println(sheet40_D5+"\r");
		out.println("^CELLLINE("+(nXCurPos+208)+","+(nYCurPos+40)+",47,21,0,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos+208)+","+(nYCurPos+40)+",47,21,0,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos+208)+","+(nYCurPos+40)+",47,21,0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos+208)+","+(nYCurPos+40)+",47,21,0,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos+208)+","+(nYCurPos+40)+",47,1,10,0/,바탕,RGB[0,0,0], , , ,NONE,21,1)");
		out.println(sheet40_F5+"\r");
		out.println("^CELLLINE("+(nXCurPos+255)+","+(nYCurPos+40)+",45,21,0,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos+255)+","+(nYCurPos+40)+",45,21,0,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos+255)+","+(nYCurPos+40)+",45,21,0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos+255)+","+(nYCurPos+40)+",45,21,0,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos+255)+","+(nYCurPos+40)+",45,1,10,0/,바탕,RGB[0,0,0], , , ,NONE,21,1)");
		out.println(sheet40_H5+"\r");
		out.println("^CELLLINE("+(nXCurPos+300)+","+(nYCurPos+40)+",39,21,0,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos+300)+","+(nYCurPos+40)+",39,21,0,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos+300)+","+(nYCurPos+40)+",39,21,0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos+300)+","+(nYCurPos+40)+",39,21,0,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos+300)+","+(nYCurPos+40)+",39,1,10,0/,바탕,RGB[0,0,0], , , ,NONE,21,1)");
		out.println(sheet40_J5+"\r");
		out.println("^CELLLINE("+(nXCurPos+339)+","+(nYCurPos+40)+",56,21,0,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos+339)+","+(nYCurPos+40)+",56,21,0,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos+339)+","+(nYCurPos+40)+",56,21,0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos+339)+","+(nYCurPos+40)+",56,21,0,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos+339)+","+(nYCurPos+40)+",56,1,10,0/,바탕,RGB[0,0,0], , , ,NONE,21,1)");
		out.println(sheet40_L5+"\r");
		out.println("^CELLLINE("+(nXCurPos+395)+","+(nYCurPos+40)+",41,21,0,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos+395)+","+(nYCurPos+40)+",41,21,0,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos+395)+","+(nYCurPos+40)+",41,21,0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos+395)+","+(nYCurPos+40)+",41,21,0,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos+395)+","+(nYCurPos+40)+",41,1,9,0/,바탕,RGB[0,0,255], , , ,NONE,21,1)");
		out.println(sheet40_N5+"\r");
		out.println("^CELLLINE("+(nXCurPos+436)+","+(nYCurPos+40)+",38,21,0,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos+436)+","+(nYCurPos+40)+",38,21,0,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos+436)+","+(nYCurPos+40)+",38,21,0,RGB[0,0,0],3)\r");
	}

	//----list 스크립트 문 출력 함수----
	private void writeScriptlist( ) throws Exception{
		//스크립트문 생성
		out.println("^CELLLINE("+(nXCurPos+108)+","+(nYCurPos)+",44,19,0,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos+108)+","+(nYCurPos)+",44,19,0,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos+108)+","+(nYCurPos)+",44,19,0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos+108)+","+(nYCurPos)+",44,19,0,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos+108)+","+(nYCurPos)+",44,1,10,0/,바탕,RGB[0,0,0], , , ,NONE,19,1)");
		out.println(sheet40_C6+"\r");
		out.println("^CELLLINE("+(nXCurPos+152)+","+(nYCurPos)+",56,19,0,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos+152)+","+(nYCurPos)+",56,19,0,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos+152)+","+(nYCurPos)+",56,19,0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos+152)+","+(nYCurPos)+",56,19,0,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos+152)+","+(nYCurPos)+",56,1,10,0/,바탕,RGB[0,0,0], , , ,NONE,19,1)");
		out.println(sheet40_D6+"\r");
		out.println("^CELLLINE("+(nXCurPos+208)+","+(nYCurPos)+",47,19,0,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos+208)+","+(nYCurPos)+",47,19,0,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos+208)+","+(nYCurPos)+",47,19,0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos+208)+","+(nYCurPos)+",47,19,0,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos+208)+","+(nYCurPos)+",47,1,10,0/,바탕,RGB[0,0,0], , , ,NONE,19,1)");
		out.println(sheet40_F6+"\r");
		out.println("^CELLLINE("+(nXCurPos+255)+","+(nYCurPos)+",45,19,0,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos+255)+","+(nYCurPos)+",45,19,0,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos+255)+","+(nYCurPos)+",45,19,0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos+255)+","+(nYCurPos)+",45,19,0,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos+255)+","+(nYCurPos)+",45,1,10,0/,바탕,RGB[0,0,0], , , ,NONE,19,1)");
		out.println(sheet40_H6+"\r");
		out.println("^CELLLINE("+(nXCurPos+300)+","+(nYCurPos)+",39,19,0,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos+300)+","+(nYCurPos)+",39,19,0,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos+300)+","+(nYCurPos)+",39,19,0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos+300)+","+(nYCurPos)+",39,19,0,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos+300)+","+(nYCurPos)+",39,1,10,0/,바탕,RGB[0,0,0], , , ,NONE,19,1)");
		out.println(sheet40_J6+"\r");
		out.println("^CELLLINE("+(nXCurPos+339)+","+(nYCurPos)+",56,19,0,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos+339)+","+(nYCurPos)+",56,19,0,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos+339)+","+(nYCurPos)+",56,19,0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos+339)+","+(nYCurPos)+",56,19,0,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos+339)+","+(nYCurPos)+",56,1,10,0/,바탕,RGB[0,0,0], , , ,NONE,19,1)");
		out.println(sheet40_L6+"\r");
		out.println("^CELLLINE("+(nXCurPos+395)+","+(nYCurPos)+",41,19,0,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos+395)+","+(nYCurPos)+",41,19,0,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos+395)+","+(nYCurPos)+",41,19,0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos+395)+","+(nYCurPos)+",41,19,0,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos+395)+","+(nYCurPos)+",41,1,9,0/,바탕,RGB[0,0,255], , , ,NONE,19,1)");
		out.println(sheet40_N6+"\r");
		out.println("^CELLLINE("+(nXCurPos+436)+","+(nYCurPos)+",38,40,0,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos+436)+","+(nYCurPos)+",38,40,0,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos+436)+","+(nYCurPos)+",38,40,0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos+436)+","+(nYCurPos)+",38,40,0,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos+436)+","+(nYCurPos)+",38,1,9,0/,바탕,RGB[0,0,255], , , ,NONE,40,1)");
		out.println(sheet40_O6+"\r");
		out.println("^CELLLINE("+(nXCurPos+108)+","+(nYCurPos+19)+",44,21,0,RGB[0,0,0],1)\r");
		out.print("^PRINT("+(nXCurPos+108)+","+(nYCurPos+19)+",44,1,10,0/,굴림체,RGB[0,0,0], , , ,NONE,21,1)");
		out.println(sheet40_C7+"\r");
		out.println("^CELLLINE("+(nXCurPos+152)+","+(nYCurPos+19)+",56,21,0,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos+152)+","+(nYCurPos+19)+",56,21,0,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos+152)+","+(nYCurPos+19)+",56,21,0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos+152)+","+(nYCurPos+19)+",56,21,0,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos+152)+","+(nYCurPos+19)+",56,1,10,0/,바탕,RGB[0,0,0], , , ,NONE,21,1)");
		out.println(sheet40_D7+"\r");
		out.println("^CELLLINE("+(nXCurPos+208)+","+(nYCurPos+19)+",47,21,0,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos+208)+","+(nYCurPos+19)+",47,21,0,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos+208)+","+(nYCurPos+19)+",47,21,0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos+208)+","+(nYCurPos+19)+",47,21,0,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos+208)+","+(nYCurPos+19)+",47,1,10,0/,바탕,RGB[0,0,0], , , ,NONE,21,1)");
		out.println(sheet40_F7+"\r");
		out.println("^CELLLINE("+(nXCurPos+255)+","+(nYCurPos+19)+",45,21,0,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos+255)+","+(nYCurPos+19)+",45,21,0,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos+255)+","+(nYCurPos+19)+",45,21,0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos+255)+","+(nYCurPos+19)+",45,21,0,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos+255)+","+(nYCurPos+19)+",45,1,10,0/,바탕,RGB[0,0,0], , , ,NONE,21,1)");
		out.println(sheet40_H7+"\r");
		out.println("^CELLLINE("+(nXCurPos+300)+","+(nYCurPos+19)+",39,21,0,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos+300)+","+(nYCurPos+19)+",39,21,0,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos+300)+","+(nYCurPos+19)+",39,21,0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos+300)+","+(nYCurPos+19)+",39,21,0,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos+300)+","+(nYCurPos+19)+",39,1,10,0/,바탕,RGB[0,0,0], , , ,NONE,21,1)");
		out.println(sheet40_J7+"\r");
		out.println("^CELLLINE("+(nXCurPos+339)+","+(nYCurPos+19)+",56,21,0,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos+339)+","+(nYCurPos+19)+",56,21,0,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos+339)+","+(nYCurPos+19)+",56,21,0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos+339)+","+(nYCurPos+19)+",56,21,0,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos+339)+","+(nYCurPos+19)+",56,1,10,0/,바탕,RGB[0,0,0], , , ,NONE,21,1)");
		out.println(sheet40_L7+"\r");
		out.println("^CELLLINE("+(nXCurPos+395)+","+(nYCurPos+19)+",41,21,0,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos+395)+","+(nYCurPos+19)+",41,21,0,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos+395)+","+(nYCurPos+19)+",41,21,0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos+395)+","+(nYCurPos+19)+",41,21,0,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos+395)+","+(nYCurPos+19)+",41,1,9,0/,바탕,RGB[0,0,255], , , ,NONE,21,1)");
		out.println(sheet40_N7+"\r");
	}

	//----sheet5_end 스크립트 문 출력 함수----
	private void writeScriptsheet5_end( ) throws Exception{
		//스크립트문 생성
	...
	private void writeScriptSheet4_foot( ) throws Exception{
		...
		out.println("^CELLLINE("+(nXCurPos+108)+","+(nYCurPos)+",100,20,1,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos+108)+","+(nYCurPos)+",100,20,0,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos+108)+","+(nYCurPos)+",100,20,0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos+108)+","+(nYCurPos)+",100,20,0,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos+108)+","+(nYCurPos)+",100,1,11,0/,굴림체,RGB[0,0,0], , , ,NONE,20,1)");
		out.println(sheet40_C10+"\r");
		out.println("^CELLLINE("+(nXCurPos+208)+","+(nYCurPos)+",47,20,1,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos+208)+","+(nYCurPos)+",47,20,0,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos+208)+","+(nYCurPos)+",47,20,0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos+208)+","+(nYCurPos)+",47,20,0,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos+208)+","+(nYCurPos)+",47,1,11,0/,굴림체,RGB[0,0,0], , , ,NONE,20,1)");
		out.println(sheet40_F10+"\r");
		out.println("^CELLLINE("+(nXCurPos+255)+","+(nYCurPos)+",45,20,1,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos+255)+","+(nYCurPos)+",45,20,0,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos+255)+","+(nYCurPos)+",45,20,0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos+255)+","+(nYCurPos)+",45,20,0,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos+255)+","+(nYCurPos)+",45,1,11,0/,굴림체,RGB[0,0,0], , , ,NONE,20,1)");
		out.println(sheet40_H10+"\r");
		out.println("^CELLLINE("+(nXCurPos+300)+","+(nYCurPos)+",67,20,1,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos+300)+","+(nYCurPos)+",67,20,0,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos+300)+","+(nYCurPos)+",67,20,0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos+300)+","+(nYCurPos)+",67,20,0,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos+300)+","+(nYCurPos)+",67,1,11,0/,굴림체,RGB[0,0,0], , , ,NONE,20,1)");
		out.println(sheet40_J10+"\r");
		out.println("^CELLLINE("+(nXCurPos+367)+","+(nYCurPos)+",107,20,1,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos+367)+","+(nYCurPos)+",107,20,0,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos+367)+","+(nYCurPos)+",107,20,0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos+367)+","+(nYCurPos)+",107,20,1,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos+367)+","+(nYCurPos)+",107,1,11,0/,굴림체,RGB[0,0,0], , , ,NONE,20,1)");
		out.println(sheet40_M10+"\r");
		...
		out.println("^CELLLINE("+(nXCurPos+108)+","+(nYCurPos+20)+",100,20,0,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos+108)+","+(nYCurPos+20)+",100,20,0,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos+108)+","+(nYCurPos+20)+",100,20,0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos+108)+","+(nYCurPos+20)+",100,20,0,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos+108)+","+(nYCurPos+20)+",100,1,11,0/,굴림체,RGB[0,0,0], , , ,NONE,20,1)");
		out.println(sheet40_C11+"\r");
		out.println("^CELLLINE("+(nXCurPos+208)+","+(nYCurPos+20)+",47,20,0,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos+208)+","+(nYCurPos+20)+",47,20,0,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos+208)+","+(nYCurPos+20)+",47,20,0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos+208)+","+(nYCurPos+20)+",47,20,0,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos+208)+","+(nYCurPos+20)+",47,1,11,0/,굴림체,RGB[0,0,0], , , ,NONE,20,1)");
		out.println(sheet40_F11+"\r");
		out.println("^CELLLINE("+(nXCurPos+255)+","+(nYCurPos+20)+",45,20,0,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos+255)+","+(nYCurPos+20)+",45,20,0,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos+255)+","+(nYCurPos+20)+",45,20,0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos+255)+","+(nYCurPos+20)+",45,20,0,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos+255)+","+(nYCurPos+20)+",45,1,11,0/,굴림체,RGB[0,0,0], , , ,NONE,20,1)");
		out.println(sheet40_H11+"\r");
		out.println("^CELLLINE("+(nXCurPos+300)+","+(nYCurPos+20)+",67,20,0,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos+300)+","+(nYCurPos+20)+",67,20,0,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos+300)+","+(nYCurPos+20)+",67,20,0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos+300)+","+(nYCurPos+20)+",67,20,0,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos+300)+","+(nYCurPos+20)+",67,1,11,0/,굴림체,RGB[0,0,0], , , ,NONE,20,1)");
		out.println(sheet40_J11+"\r");
		out.println("^CELLLINE("+(nXCurPos+367)+","+(nYCurPos+20)+",107,20,0,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos+367)+","+(nYCurPos+20)+",107,20,0,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos+367)+","+(nYCurPos+20)+",107,20,0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos+367)+","+(nYCurPos+20)+",107,20,1,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos+367)+","+(nYCurPos+20)+",107,1,11,0/,굴림체,RGB[0,0,0], , , ,NONE,20,1)");
		out.println(sheet40_M11+"\r");
		...
		out.println("^CELLLINE("+(nXCurPos+108)+","+(nYCurPos+40)+",100,20,0,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos+108)+","+(nYCurPos+40)+",100,20,1,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos+108)+","+(nYCurPos+40)+",100,20,0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos+108)+","+(nYCurPos+40)+",100,20,0,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos+108)+","+(nYCurPos+40)+",100,1,11,0/,굴림체,RGB[0,0,0], , , ,NONE,20,1)");
		out.println(sheet40_C12+"\r");
		out.println("^CELLLINE("+(nXCurPos+208)+","+(nYCurPos+40)+",47,20,0,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos+208)+","+(nYCurPos+40)+",47,20,1,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos+208)+","+(nYCurPos+40)+",47,20,0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos+208)+","+(nYCurPos+40)+",47,20,0,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos+208)+","+(nYCurPos+40)+",47,1,11,0/,굴림체,RGB[0,0,0], , , ,NONE,20,1)");
		out.println(sheet40_F12+"\r");
		out.println("^CELLLINE("+(nXCurPos+255)+","+(nYCurPos+40)+",45,20,0,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos+255)+","+(nYCurPos+40)+",45,20,1,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos+255)+","+(nYCurPos+40)+",45,20,0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos+255)+","+(nYCurPos+40)+",45,20,0,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos+255)+","+(nYCurPos+40)+",45,1,11,0/,굴림체,RGB[0,0,0], , , ,NONE,20,1)");
		out.println(sheet40_H12+"\r");
		out.println("^CELLLINE("+(nXCurPos+300)+","+(nYCurPos+40)+",67,20,0,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos+300)+","+(nYCurPos+40)+",67,20,1,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos+300)+","+(nYCurPos+40)+",67,20,0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos+300)+","+(nYCurPos+40)+",67,20,0,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos+300)+","+(nYCurPos+40)+",67,1,11,0/,굴림체,RGB[0,0,0], , , ,NONE,20,1)");
		out.println(sheet40_J12+"\r");
		out.println("^CELLLINE("+(nXCurPos+367)+","+(nYCurPos+40)+",107,20,0,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos+367)+","+(nYCurPos+40)+",107,20,1,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos+367)+","+(nYCurPos+40)+",107,20,0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos+367)+","+(nYCurPos+40)+",107,20,1,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos+367)+","+(nYCurPos+40)+",107,1,11,0/,굴림체,RGB[0,0,0], , , ,NONE,20,1)");
		out.println(sheet40_M12+"\r");
	...
	private void initConstVarient(){
		...
		sheet40_C6="강의태도";
		sheet40_C7="전문성";
		sheet40_A8="* 만족도는 '매우만족'과 '만족'을 합한 값이고, ()안의 숫자는 리커트 5점 척도임.";
		sheet40_A9="* 평가기준표";
		sheet40_A10="구  분";
		sheet40_C10="매우 우수";
		sheet40_F10="우수";
