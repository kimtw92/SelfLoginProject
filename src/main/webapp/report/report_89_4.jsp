...
class ReportHandler{
	...
	private void writeScriptquestion_list_header( ) throws Exception{
		//스크립트문 생성
		out.println("^CELLBG("+(nXCurPos)+","+(nYCurPos)+",178,40,1,RGB[255,192,203],RGB[255,192,203],0)\r");
		out.println("^CELLLINE("+(nXCurPos)+","+(nYCurPos)+",178,40,0,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos)+","+(nYCurPos)+",178,40,0,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos)+","+(nYCurPos)+",178,40,0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos)+","+(nYCurPos)+",178,40,0,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos)+","+(nYCurPos)+",178,1,12,0/,바탕,RGB[0,0,0],BOLD, , ,NONE,40,1)");
	...
	private void writeScriptquestion_list( ) throws Exception{
		...
		out.print("^PRINT("+(nXCurPos+178)+","+(nYCurPos)+",53,1,10,1/0/0,바탕,RGB[0,0,0], , , ,NONE,"+(nAutoHeight_question_list[1])+",1)");
		...
		out.print("^PRINT("+(nXCurPos+231)+","+(nYCurPos)+",45,1,10,1/0/0,바탕,RGB[0,0,0], , , ,NONE,"+(nAutoHeight_question_list[1])+",1)");
		...
		out.print("^PRINT("+(nXCurPos+276)+","+(nYCurPos)+",45,1,10,1/0/0,바탕,RGB[0,0,0], , , ,NONE,"+(nAutoHeight_question_list[1])+",1)");
		...
		out.print("^PRINT("+(nXCurPos+321)+","+(nYCurPos)+",45,1,10,1/0/0,바탕,RGB[0,0,0], , , ,NONE,"+(nAutoHeight_question_list[1])+",1)");
		...
		out.print("^PRINT("+(nXCurPos+366)+","+(nYCurPos)+",55,1,10,0/,바탕,RGB[0,0,0], , , ,NONE,"+(nAutoHeight_question_list[1])+",1)");
		...
		out.print("^PRINT("+(nXCurPos+421)+","+(nYCurPos)+",51,1,10,0/,바탕,RGB[255,0,0], , , ,NONE,"+(nAutoHeight_question_list[0])+",1)");
	...
	private void initSQLConst(){
		...
		sql_QUESTION_LIST = sql_QUESTION_LIST + "        to_char(anscnt1_rat,'90.0') as anscnt1_rat, ";
		sql_QUESTION_LIST = sql_QUESTION_LIST + "        to_char(anscnt2_rat,'90.0') as anscnt2_rat, ";
		sql_QUESTION_LIST = sql_QUESTION_LIST + "        to_char(anscnt3_rat,'90.0') as anscnt3_rat,       ";
		sql_QUESTION_LIST = sql_QUESTION_LIST + "        to_char(anscnt4_rat,'90.0') as anscnt4_rat, ";
		sql_QUESTION_LIST = sql_QUESTION_LIST + "        to_char(anscnt5_rat,'90.0') as anscnt5_rat,  ";
		...
		sql_QUESTION_LIST = sql_QUESTION_LIST + "        to_char(round((anscnt4  + anscnt5) / total_cnt *100,1),'99.0')  as rat ";
	...
	private void initConstVarient(){
		...
		sheet30_F4="불만";
		sheet30_G4="매우불만";
		sheet30_A7="*만족도는 '매우만족'과 '만족'을 합한 값이고, ()안의 숫자는 리커트 5점척도 값임.";
		sheet40_A1="   3. 강의만족도";
		sheet40_A3="교과목";
		sheet40_B3="강사명";
		sheet40_C3="100점환  산";
