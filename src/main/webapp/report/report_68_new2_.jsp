...
class ReportHandler{
	...
	private String L2_RNAME;
	private double L2_SEQNO;
	private String L2_RRESNO;
	private String L2_AGE;
	private double L2_EDUNO;
	private double L2_PACCEPT;
	private String L2_JIKNM;
	private String L2_DEPTNM;
	private String L2_SEXNM;
	...
	private void getScriptFromS1(boolean bIsFirst, boolean bIsPrint) throws Exception{
		...
		if(bIsFirst){   //밴드 최초 호출 시에만 실행되는 코드
			...
			//데이터 변수 할당
			sheet10_A1=A_GR_YEAR+". "+A_GRCODENIKNM+" "+A_GR_SEQ+"기 평가결과 보고";
			sheet10_B2=String.valueOf(A_STARTED)+" ~ "+String.valueOf(A_ENDDATE)+" (2주)";
	...
	private void getScriptFromloop2Con(boolean bIsFirst, boolean bIsLast, boolean bIsTrue, boolean bIsPrint) throws Exception{
		...
		if(!bIsLast){   //bIsLast가 false인 경우 - 조건 밴드의 수식 계산
			//데이터 변수 할당
			sheet30_D4=(long)SUM(sheet30_L5, sheet30_D4);
		}   //end if(!bIsLast)
	}
	...
	private void getScriptFromloop2(boolean bIsPrint) throws Exception{
		...
		while(L2.next()){   //자동으로 생성되는 반복 밴드의 루프문
			...
			sheet30_B5=L2_SEQNO;
			sheet30_C5=L2_EDUNO;
			sheet30_D5=L2_DEPTNM;
			sheet30_E5=L2_JIKNM;
			sheet30_F5=L2_RNAME;
			sheet30_G5=L2_SEXNM;
			sheet30_H5=L2_AGE;
			sheet30_I5=L2_PACCEPT;
	...
	private void writeScriptvoid2( ) throws Exception{
		//스크립트문 생성
		out.print("^PRINT("+(nXCurPos+20)+","+(nYCurPos)+",183,0,10,0/,돋움,RGB[0,0,0], , , ,NONE,20,1)");
	...
	private void writeScriptVoidBand305( ) throws Exception{
		...
		out.println("^CELLBG("+(nXCurPos+355)+","+(nYCurPos)+",36,20,1,RGB[230,230,250],RGB[230,230,250],0)\r");
		out.println("^CELLLINE("+(nXCurPos+355)+","+(nYCurPos)+",36,20,0,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos+355)+","+(nYCurPos)+",36,20,0,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos+355)+","+(nYCurPos)+",36,20,0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos+355)+","+(nYCurPos)+",36,20,0,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos+355)+","+(nYCurPos)+",36,1,10,0/,돋움,RGB[0,0,0], , , ,NONE,20,1)");
		out.println(sheet30_G3+"\r");
		out.println("^CELLBG("+(nXCurPos+391)+","+(nYCurPos)+",36,20,1,RGB[230,230,250],RGB[230,230,250],0)\r");
		out.println("^CELLLINE("+(nXCurPos+391)+","+(nYCurPos)+",36,20,0,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos+391)+","+(nYCurPos)+",36,20,0,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos+391)+","+(nYCurPos)+",36,20,0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos+391)+","+(nYCurPos)+",36,20,0,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos+391)+","+(nYCurPos)+",36,1,10,0/,돋움,RGB[0,0,0], , , ,NONE,20,1)");
		out.println(sheet30_H3+"\r");
		out.println("^CELLBG("+(nXCurPos+427)+","+(nYCurPos)+",36,20,1,RGB[230,230,250],RGB[230,230,250],0)\r");
		out.println("^CELLLINE("+(nXCurPos+427)+","+(nYCurPos)+",36,20,0,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos+427)+","+(nYCurPos)+",36,20,0,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos+427)+","+(nYCurPos)+",36,20,0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos+427)+","+(nYCurPos)+",36,20,0,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos+427)+","+(nYCurPos)+",36,1,10,0/,돋움,RGB[0,0,0], , , ,NONE,20,1)");
		out.println(sheet30_I3+"\r");
		out.println("^CELLBG("+(nXCurPos+463)+","+(nYCurPos)+",41,20,1,RGB[230,230,250],RGB[230,230,250],0)\r");
		out.println("^CELLLINE("+(nXCurPos+463)+","+(nYCurPos)+",41,20,0,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos+463)+","+(nYCurPos)+",41,20,0,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos+463)+","+(nYCurPos)+",41,20,0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos+463)+","+(nYCurPos)+",41,20,0,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos+463)+","+(nYCurPos)+",41,1,10,0/,돋움,RGB[0,0,0], , , ,NONE,20,1)");
	...
	private void writeScriptloop2Con( ) throws Exception{
		...
		out.println("^CELLLINE("+(nXCurPos+20)+","+(nYCurPos)+",42,20,0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos+20)+","+(nYCurPos)+",42,20,0,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos+20)+","+(nYCurPos)+",42,1,10,0/,돋움체,RGB[0,0,0], , , ,NONE,20,1)");
		...
		out.println("^CELLLINE("+(nXCurPos+100)+","+(nYCurPos)+",103,20,0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos+100)+","+(nYCurPos)+",103,20,0,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos+100)+","+(nYCurPos)+",103,1,10,5/###,### \" 명\"*,돋움체,RGB[0,0,0], , , ,NONE,20,1)");
	...
	private void writeScriptloop2( ) throws Exception{
		...
		out.println("^CELLLINE("+(nXCurPos+20)+","+(nYCurPos)+",42,20,0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos+20)+","+(nYCurPos)+",42,20,0,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos+20)+","+(nYCurPos)+",42,1,10,1/0/0,돋움체,RGB[0,0,0], , , ,NONE,20,1)");
		out.println(sheet30_B5+"\r");
		out.println("^CELLLINE("+(nXCurPos+62)+","+(nYCurPos)+",38,20,0,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos+62)+","+(nYCurPos)+",38,20,0,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos+62)+","+(nYCurPos)+",38,20,0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos+62)+","+(nYCurPos)+",38,20,0,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos+62)+","+(nYCurPos)+",38,1,10,1/0/0,돋움체,RGB[0,0,0], , , ,NONE,20,1)");
		out.println(sheet30_C5+"\r");
		out.println("^CELLLINE("+(nXCurPos+100)+","+(nYCurPos)+",103,20,0,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos+100)+","+(nYCurPos)+",103,20,0,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos+100)+","+(nYCurPos)+",103,20,0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos+100)+","+(nYCurPos)+",103,20,0,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos+100)+","+(nYCurPos)+",103,1,10,0/,돋움체,RGB[0,0,0], , , ,NONE,20,1)");
		out.println(sheet30_D5+"\r");
		out.println("^CELLLINE("+(nXCurPos+203)+","+(nYCurPos)+",103,20,0,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos+203)+","+(nYCurPos)+",103,20,0,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos+203)+","+(nYCurPos)+",103,20,0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos+203)+","+(nYCurPos)+",103,20,0,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos+203)+","+(nYCurPos)+",103,1,10,0/,돋움체,RGB[0,0,0], , , ,NONE,20,1)");
		out.println(sheet30_E5+"\r");
		out.println("^CELLLINE("+(nXCurPos+306)+","+(nYCurPos)+",49,20,0,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos+306)+","+(nYCurPos)+",49,20,0,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos+306)+","+(nYCurPos)+",49,20,0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos+306)+","+(nYCurPos)+",49,20,0,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos+306)+","+(nYCurPos)+",49,1,10,0/,돋움체,RGB[0,0,0], , , ,NONE,20,1)");
		out.println(sheet30_F5+"\r");
		out.println("^CELLLINE("+(nXCurPos+355)+","+(nYCurPos)+",36,20,0,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos+355)+","+(nYCurPos)+",36,20,0,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos+355)+","+(nYCurPos)+",36,20,0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos+355)+","+(nYCurPos)+",36,20,0,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos+355)+","+(nYCurPos)+",36,1,10,0/,돋움체,RGB[0,0,0], , , ,NONE,20,1)");
		out.println(sheet30_G5+"\r");
		out.println("^CELLLINE("+(nXCurPos+391)+","+(nYCurPos)+",36,20,0,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos+391)+","+(nYCurPos)+",36,20,0,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos+391)+","+(nYCurPos)+",36,20,0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos+391)+","+(nYCurPos)+",36,20,0,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos+391)+","+(nYCurPos)+",36,1,10,0/,돋움체,RGB[0,0,0], , , ,NONE,20,1)");
		out.println(sheet30_H5+"\r");
		out.println("^CELLLINE("+(nXCurPos+427)+","+(nYCurPos)+",36,20,0,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos+427)+","+(nYCurPos)+",36,20,0,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos+427)+","+(nYCurPos)+",36,20,0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos+427)+","+(nYCurPos)+",36,20,0,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos+427)+","+(nYCurPos)+",36,1,10,1/0/0,돋움체,RGB[0,0,0], , , ,NONE,20,1)");
	...
	private void createConnAndStateObject() throws Exception{
		...
		conn_DUNET = DriverManager.getConnection("jdbc:oracle:thin:@192.168.10.253:1521:loti","inchlms","fhxl21");stat_L2=conn_DUNET.createStatement(ResultSet.TYPE_SCROLL_INSENSITIVE,ResultSet.CONCUR_READ_ONLY);
	...
	private void initSQLConst(){
		sql_L2 = "select gr.rname, gr.seqno,  gr.rresno,  ";
		sql_L2 = sql_L2 + "decode(gr.rresno, null, '*', to_char(  to_number(substr(gr.grseq,1,4))- to_number('19'||substr(gr.rresno,1,2)) ) ) age ,  ";
		sql_L2 = sql_L2 + "gr.eduno, gr.paccept, jk.jiknm, dt.deptnm, decode(substr(gr.rresno, 7,1),'1','남', '2', '여') sexnm  ";
		sql_L2 = sql_L2 + "from tb_grresult gr, tb_dept dt, tb_jik jk  ";
		sql_L2 = sql_L2 + "where gr.rdept=dt.dept and gr.rjik=jk.jik and gr.grcode='" + p_grcode_Param + "' and gr.grseq='" + p_grseq_Param + "' and gr.seqno <=3  ";
		sql_L2 = sql_L2 + "order by gr.seqno asc";
		...
		sql_A = "select gs.grcodeniknm, substr(gs.grseq,1,4) gr_year, substr(gs.grseq,5,2) gr_seq, to_char(gs.tseat) tseat ,  ";
	...
	private void setFieldVariableFromL2() throws Exception{
		L2_RNAME=GetB(L2.getString(1));
		L2_SEQNO=L2.getDouble(2);
		L2_RRESNO=GetB(L2.getString(3));
		L2_AGE=GetB(L2.getString(4));
		L2_EDUNO=L2.getDouble(5);
		L2_PACCEPT=L2.getDouble(6);
		L2_JIKNM=GetB(L2.getString(7));
		L2_DEPTNM=GetB(L2.getString(8));
		L2_SEXNM=GetB(L2.getString(9));
	}
	...
	private void initConstVarient(){
		...
		sheet30_L5=1;
		sheet30_B4="계";
		sheet30_A6="※ 성적이 동점인 경우 인천광영시 지방공무원 평가관리규정 제21조 제2항에 의거 1순위 필답성적순,      2순위 자치활동에 공이 많은자, 3순위 연령이 많은자 순으로 결정";
	}
