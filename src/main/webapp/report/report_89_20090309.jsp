...
class ReportHandler{
	...
	private void executeSheet40( ) throws Exception{
		...
		getScriptFromVoidBand4018(true, true);    //Void 밴드 호출
	...
	private void getScriptFromquestion_list(boolean bIsPrint) throws Exception{
		...
		while(QUESTION_LIST.next()){   //자동으로 생성되는 반복 밴드의 루프문
			...
			sheet20_C5=QUESTION_LIST_ANSCNT11;
			sheet20_D5=String.valueOf(QUESTION_LIST_ANSCNT22);
			sheet20_E5=(long)QUESTION_LIST_ANSCNT33;
			sheet20_F5=String.valueOf(QUESTION_LIST_RAT);
			sheet20_C6=QUESTION_LIST_ANSCNT1_RAT;
			sheet20_D6=String.valueOf(QUESTION_LIST_ANSCNT2_RAT);
			sheet20_E6=String.valueOf(QUESTION_LIST_ANSCNT3_RAT);
	...
	private void getScriptFromlist(boolean bIsPrint) throws Exception{
		...
		while(LIST.next()){   //자동으로 생성되는 반복 밴드의 루프문
			...
			sheet30_C5=String.valueOf(LIST_SUBJ_ANS11);
			sheet30_D5=String.valueOf(LIST_SUBJ_ANS22);
			sheet30_E5=String.valueOf(LIST_SUBJ_ANS33);
			sheet30_F5=String.valueOf(LIST_SUBJ_ANS_AVG);
			sheet30_G5=String.valueOf(LIST_STIME_ANS11);
			sheet30_H5=String.valueOf(LIST_STIME_ANS22);
			sheet30_I5=String.valueOf(LIST_STIME_ANS33);
			sheet30_J5=String.valueOf(LIST_STIME_ANS_AVG);
			sheet30_K5=String.valueOf(LIST_TUTOR_ANS11);
			sheet30_L5=String.valueOf(LIST_TUTOR_ANS22);
			sheet30_M5=String.valueOf(LIST_TUTOR_ANS33);
			sheet30_N5=String.valueOf(LIST_TUTOR_ANS_AVG);
			sheet30_O5=String.valueOf(LIST_TOTAL_AVG);
			sheet30_C6=String.valueOf(LIST_SUBJ_ANS11_RAT);
			sheet30_D6=String.valueOf(LIST_SUBJ_ANS22_RAT);
			sheet30_E6=String.valueOf(LIST_SUBJ_ANS33_RAT);
			sheet30_G6=String.valueOf(LIST_STIME_ANS11_RAT);
			sheet30_H6=String.valueOf(LIST_STIME_ANS22_RAT);
			sheet30_I6=String.valueOf(LIST_STIME_ANS33_RAT);
			sheet30_K6=String.valueOf(LIST_TUTOR_ANS11_RAT);
			sheet30_L6=String.valueOf(LIST_TUTOR_ANS22_RAT);
			sheet30_M6=String.valueOf(LIST_TUTOR_ANS33_RAT);
	...
	private void getScriptFrompage2_1(boolean bIsFirst, boolean bIsPrint) throws Exception{
		...
		if(bIsFirst){   //밴드 최초 호출 시에만 실행되는 코드
			...
			//데이터 fetch
			if(QUESTION_LIST.next()){
				setFieldVariableFromQUESTION_LIST();	//ResultSet QUESTION_LIST에서 필드 값 설정
			}else{
				setFieldInitFromQUESTION_LIST();	//ResultSet QUESTION_LIST의 필드 값 초기화
			}
			...
			//데이터 변수 할당
			sheet40_A1=Double.parseDouble(Get0(QUESTION_LIST_ANSCNT1));
		}    //end if(bIsFirst)
	...
	private void getScriptFromQUESTION1(boolean bIsPrint) throws Exception{
		...
		while(QUESTION1.next()){   //자동으로 생성되는 반복 밴드의 루프문
			...
			//데이터 변수 할당
			sheet40_A4= (long)QUESTION1_QUESTION_NO + ". " + QUESTION1_QUESTION + " : " + QUESTION1_ENOUGH_RAT + " " + QUESTION1_REGULAR_RAT;
			sheet40_D4=QUESTION1_QUESTION_NO;
			sheet40_E4=QUESTION1_QUESTION;
			sheet40_F4=QUESTION1_ENOUGH_RAT;
			sheet40_G4=QUESTION1_REGULAR_RAT;

			//Auto Size Code
			nAutoHeight_QUESTION1[0]=0;
			nAutoHeight_QUESTION1[0]=getPrintHeight(sheet40_A4, charWidth, 11, 512, 22, nAutoHeight_QUESTION1[0]);
	...
	private void getScriptFromQUESTION2(boolean bIsPrint) throws Exception{
		...
		while(QUESTION2.next()){   //자동으로 생성되는 반복 밴드의 루프문
			...
			//데이터 변수 할당
			sheet40_A7= (long)QUESTION2_QUESTION_NO + ". " + QUESTION2_QUESTION + " : " + QUESTION2_ENOUGH_RAT + " " + QUESTION2_REGULAR_RAT;
			sheet40_D7=QUESTION2_QUESTION_NO;
			sheet40_E7=QUESTION2_QUESTION;
			sheet40_F7=QUESTION2_ENOUGH_RAT;
			sheet40_G7=QUESTION2_REGULAR_RAT;

			//Auto Size Code
			nAutoHeight_QUESTION2[0]=0;
			nAutoHeight_QUESTION2[0]=getPrintHeight(sheet40_A7, charWidth, 11, 512, 22, nAutoHeight_QUESTION2[0]);
	...
	private void getScriptFromESTIMATE_TUTOR(boolean bIsPrint) throws Exception{
		...
		while(LIST.next()){   //자동으로 생성되는 반복 밴드의 루프문
			...
			//데이터 변수 할당
			sheet40_A10= " ○" +LIST_SUBJNM + " (" + LIST_NAME + ")";
			sheet40_D10=LIST_SUBJNM;
			sheet40_E10=LIST_NAME;
			...
			nAutoHeight_ESTIMATE_TUTOR[0]=getPrintHeight(sheet40_A10, charWidth, 11, 512, 22, nAutoHeight_ESTIMATE_TUTOR[0]);
	...
	//----bIsPrint : 감추기 속성 설정 여부. true면 출력, false면 AI 스크립트를 생성하지 않음.
	//----nRepeatCnt : 부모 반복 밴드 수행 횟수와 연동 옵션 설정시 void 밴드가 수행할 반복 횟수 전달
	private void getScriptFromVoidBand4018(boolean bIsFirst, boolean bIsPrint) throws Exception{
		//지역 변수 선언 및 초기화
		int nBandHeight=44;    //밴드 출력 높이
	...
	private void getScriptFromJU_QUESTION_(boolean bIsPrint) throws Exception{
		...
		while(QUESTION_JU.next()){   //자동으로 생성되는 반복 밴드의 루프문
			...
			//데이터 변수 할당
			sheet40_B21=QUESTION_JU_QUESTION;

			//Auto Size Code
			nAutoHeight_JU_QUESTION_[0]=0;
			nAutoHeight_JU_QUESTION_[1]=0;
			nAutoHeight_JU_QUESTION_[0]=getPrintHeight(sheet40_B21, charWidth, 11, 484, 22, nAutoHeight_JU_QUESTION_[0]);
	...
	private void writeScriptquestion_list( ) throws Exception{
		...
		out.print("^PRINT("+(nXCurPos+339)+","+(nYCurPos)+",45,1,10,0/,바탕,RGB[255,0,0], , , ,NONE,"+(nAutoHeight_question_list[0])+",1)");
		...
		out.print("^PRINT("+(nXCurPos+294)+","+(nYCurPos+nAutoHeight_question_list[0])+",45,1,10,1/0/0,바탕,RGB[0,0,0], , , ,NONE,"+(nAutoHeight_question_list[1]-nAutoHeight_question_list[0])+",1)");
	...
	private void writeScriptlist( ) throws Exception{
		...
		out.print("^PRINT("+(nXCurPos+108)+","+(nYCurPos)+",28,1,10,0/,바탕,RGB[0,0,0], , , ,NONE,"+(nAutoHeight_list[0])+",1)");
		...
		out.print("^PRINT("+(nXCurPos+136)+","+(nYCurPos)+",28,1,10,0/,바탕,RGB[0,0,0], , , ,NONE,"+(nAutoHeight_list[0])+",1)");
		...
		out.print("^PRINT("+(nXCurPos+164)+","+(nYCurPos)+",28,1,10,0/,바탕,RGB[0,0,0], , , ,NONE,"+(nAutoHeight_list[0])+",1)");
		out.println(sheet30_E5+"\r");
		out.println("^CELLLINE("+(nXCurPos+192)+","+(nYCurPos)+",28,"+(nAutoHeight_list[0])+",0,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos+192)+","+(nYCurPos)+",28,"+(nAutoHeight_list[0])+",0,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos+192)+","+(nYCurPos)+",28,"+(nAutoHeight_list[0])+",0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos+192)+","+(nYCurPos)+",28,"+(nAutoHeight_list[0])+",0,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos+192)+","+(nYCurPos)+",28,1,10,0/,바탕,RGB[0,0,0], , , ,NONE,"+(nAutoHeight_list[0])+",1)");
		...
		out.print("^PRINT("+(nXCurPos+220)+","+(nYCurPos)+",28,1,10,0/,바탕,RGB[0,0,0], , , ,NONE,"+(nAutoHeight_list[0])+",1)");
		...
		out.print("^PRINT("+(nXCurPos+248)+","+(nYCurPos)+",28,1,10,0/,바탕,RGB[0,0,0], , , ,NONE,"+(nAutoHeight_list[0])+",1)");
		...
		out.print("^PRINT("+(nXCurPos+276)+","+(nYCurPos)+",28,1,10,0/,바탕,RGB[0,0,0], , , ,NONE,"+(nAutoHeight_list[0])+",1)");
		out.println(sheet30_I5+"\r");
		out.println("^CELLLINE("+(nXCurPos+304)+","+(nYCurPos)+",28,"+(nAutoHeight_list[0])+",0,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos+304)+","+(nYCurPos)+",28,"+(nAutoHeight_list[0])+",0,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos+304)+","+(nYCurPos)+",28,"+(nAutoHeight_list[0])+",0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos+304)+","+(nYCurPos)+",28,"+(nAutoHeight_list[0])+",0,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos+304)+","+(nYCurPos)+",28,1,10,0/,바탕,RGB[0,0,0], , , ,NONE,"+(nAutoHeight_list[0])+",1)");
		...
		out.print("^PRINT("+(nXCurPos+332)+","+(nYCurPos)+",28,1,10,0/,바탕,RGB[0,0,0], , , ,NONE,"+(nAutoHeight_list[0])+",1)");
		...
		out.print("^PRINT("+(nXCurPos+360)+","+(nYCurPos)+",28,1,10,0/,바탕,RGB[0,0,0], , , ,NONE,"+(nAutoHeight_list[0])+",1)");
		...
		out.print("^PRINT("+(nXCurPos+388)+","+(nYCurPos)+",28,1,10,0/,바탕,RGB[0,0,0], , , ,NONE,"+(nAutoHeight_list[0])+",1)");
		out.println(sheet30_M5+"\r");
		out.println("^CELLLINE("+(nXCurPos+416)+","+(nYCurPos)+",28,"+(nAutoHeight_list[0])+",0,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos+416)+","+(nYCurPos)+",28,"+(nAutoHeight_list[0])+",0,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos+416)+","+(nYCurPos)+",28,"+(nAutoHeight_list[0])+",0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos+416)+","+(nYCurPos)+",28,"+(nAutoHeight_list[0])+",0,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos+416)+","+(nYCurPos)+",28,1,10,0/,바탕,RGB[0,0,0], , , ,NONE,"+(nAutoHeight_list[0])+",1)");
		...
		out.print("^PRINT("+(nXCurPos+108)+","+(nYCurPos+nAutoHeight_list[0])+",28,1,10,0/,바탕,RGB[0,0,0], , , ,NONE,"+(nAutoHeight_list[1]-nAutoHeight_list[0])+",1)");
		...
		out.print("^PRINT("+(nXCurPos+136)+","+(nYCurPos+nAutoHeight_list[0])+",28,1,10,0/,바탕,RGB[0,0,0], , , ,NONE,"+(nAutoHeight_list[1]-nAutoHeight_list[0])+",1)");
		...
		out.print("^PRINT("+(nXCurPos+164)+","+(nYCurPos+nAutoHeight_list[0])+",28,1,10,0/,바탕,RGB[0,0,0], , , ,NONE,"+(nAutoHeight_list[1]-nAutoHeight_list[0])+",1)");
		out.println(sheet30_E6+"\r");
		out.println("^CELLLINE("+(nXCurPos+192)+","+(nYCurPos+nAutoHeight_list[0])+",28,"+(nAutoHeight_list[1]-nAutoHeight_list[0])+",0,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos+192)+","+(nYCurPos+nAutoHeight_list[0])+",28,"+(nAutoHeight_list[1]-nAutoHeight_list[0])+",0,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos+192)+","+(nYCurPos+nAutoHeight_list[0])+",28,"+(nAutoHeight_list[1]-nAutoHeight_list[0])+",0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos+192)+","+(nYCurPos+nAutoHeight_list[0])+",28,"+(nAutoHeight_list[1]-nAutoHeight_list[0])+",0,RGB[0,0,0],3)\r");
		...
		out.print("^PRINT("+(nXCurPos+220)+","+(nYCurPos+nAutoHeight_list[0])+",28,1,10,0/,바탕,RGB[0,0,0], , , ,NONE,"+(nAutoHeight_list[1]-nAutoHeight_list[0])+",1)");
		...
		out.print("^PRINT("+(nXCurPos+248)+","+(nYCurPos+nAutoHeight_list[0])+",28,1,10,0/,바탕,RGB[0,0,0], , , ,NONE,"+(nAutoHeight_list[1]-nAutoHeight_list[0])+",1)");
		...
		out.print("^PRINT("+(nXCurPos+276)+","+(nYCurPos+nAutoHeight_list[0])+",28,1,10,0/,바탕,RGB[0,0,0], , , ,NONE,"+(nAutoHeight_list[1]-nAutoHeight_list[0])+",1)");
		out.println(sheet30_I6+"\r");
		out.println("^CELLLINE("+(nXCurPos+304)+","+(nYCurPos+nAutoHeight_list[0])+",28,"+(nAutoHeight_list[1]-nAutoHeight_list[0])+",0,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos+304)+","+(nYCurPos+nAutoHeight_list[0])+",28,"+(nAutoHeight_list[1]-nAutoHeight_list[0])+",0,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos+304)+","+(nYCurPos+nAutoHeight_list[0])+",28,"+(nAutoHeight_list[1]-nAutoHeight_list[0])+",0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos+304)+","+(nYCurPos+nAutoHeight_list[0])+",28,"+(nAutoHeight_list[1]-nAutoHeight_list[0])+",0,RGB[0,0,0],3)\r");
		...
		out.print("^PRINT("+(nXCurPos+332)+","+(nYCurPos+nAutoHeight_list[0])+",28,1,10,0/,바탕,RGB[0,0,0], , , ,NONE,"+(nAutoHeight_list[1]-nAutoHeight_list[0])+",1)");
		...
		out.print("^PRINT("+(nXCurPos+360)+","+(nYCurPos+nAutoHeight_list[0])+",28,1,10,0/,바탕,RGB[0,0,0], , , ,NONE,"+(nAutoHeight_list[1]-nAutoHeight_list[0])+",1)");
		...
		out.print("^PRINT("+(nXCurPos+388)+","+(nYCurPos+nAutoHeight_list[0])+",28,1,10,0/,바탕,RGB[0,0,0], , , ,NONE,"+(nAutoHeight_list[1]-nAutoHeight_list[0])+",1)");
		out.println(sheet30_M6+"\r");
		out.println("^CELLLINE("+(nXCurPos+416)+","+(nYCurPos+nAutoHeight_list[0])+",28,"+(nAutoHeight_list[1]-nAutoHeight_list[0])+",0,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos+416)+","+(nYCurPos+nAutoHeight_list[0])+",28,"+(nAutoHeight_list[1]-nAutoHeight_list[0])+",0,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos+416)+","+(nYCurPos+nAutoHeight_list[0])+",28,"+(nAutoHeight_list[1]-nAutoHeight_list[0])+",0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos+416)+","+(nYCurPos+nAutoHeight_list[0])+",28,"+(nAutoHeight_list[1]-nAutoHeight_list[0])+",0,RGB[0,0,0],3)\r");
	}
	...
	private void initSQLConst(){
		...
		sql_QUESTION_LIST = sql_QUESTION_LIST + "        round((anscnt1 * 5 +  anscnt2 * 4 + anscnt3 * 3 + anscnt4 * 2 + anscnt5 * 1) / total_cnt *20,1)  as rat ";
		...
		sql_LIST = sql_LIST + "    (subj_ans1_rat + subj_ans2_rat) as subj_ans11_rat, ";
		sql_LIST = sql_LIST + "    (subj_ans3_rat) as subj_ans22_rat, ";
		sql_LIST = sql_LIST + "    (subj_ans4_rat + subj_ans5_rat) as subj_ans33_rat, ";
		sql_LIST = sql_LIST + "    case when subj_ans_total > 0 then round((subj_ans1 * 5 +  subj_ans2 * 4 + subj_ans3 * 3 + subj_ans4 * 2 + subj_ans5 * 1) / subj_ans_total * 20,1)  else 0 end as subj_ans_avg, ";
		sql_LIST = sql_LIST + " ";
		...
		sql_LIST = sql_LIST + "    (stime_ans1_rat + stime_ans2_rat) as stime_ans11_rat, ";
		sql_LIST = sql_LIST + "    (stime_ans3_rat) as stime_ans22_rat, ";
		sql_LIST = sql_LIST + "    (stime_ans4_rat + stime_ans5_rat) as stime_ans33_rat, ";
		sql_LIST = sql_LIST + "    case when stime_ans_total > 0 then round((stime_ans1 * 5 + stime_ans2 * 4 + stime_ans3 * 3 + stime_ans4 * 2 + stime_ans5 * 1) / stime_ans_total * 20,1) else 0 end  as stime_ans_avg, ";
		sql_LIST = sql_LIST + " ";
		...
		sql_LIST = sql_LIST + "    (tutor_ans1_rat + tutor_ans2_rat) as tutor_ans11_rat, ";
		sql_LIST = sql_LIST + "    (tutor_ans3_rat) as tutor_ans22_rat, ";
		sql_LIST = sql_LIST + "    (tutor_ans4_rat + tutor_ans5_rat) as tutor_ans33_rat, ";
		sql_LIST = sql_LIST + "     ";
		sql_LIST = sql_LIST + "    subj_ans_total,     ";
		sql_LIST = sql_LIST + "    stime_ans_total, ";
		sql_LIST = sql_LIST + "    tutor_ans_total, ";
		sql_LIST = sql_LIST + " ";
		sql_LIST = sql_LIST + "    case when tutor_ans_total > 0 then round((tutor_ans1 * 5 + tutor_ans2 * 4 + tutor_ans3 * 3 + tutor_ans4 * 2 + tutor_ans5 * 1) / tutor_ans_total * 20,1) else 0 end as tutor_ans_avg, ";
		sql_LIST = sql_LIST + "    round((case when subj_ans_total > 0 then round((subj_ans1 * 5 +  subj_ans2 * 4 + subj_ans3 * 3 + subj_ans4 * 2 + subj_ans5 * 1) / subj_ans_total * 20,1)  else 0 end  ";
		sql_LIST = sql_LIST + "    + ";
		sql_LIST = sql_LIST + "    case when stime_ans_total > 0 then round((stime_ans1 * 5 + stime_ans2 * 4 + stime_ans3 * 3 + stime_ans4 * 2 + stime_ans5 * 1) / stime_ans_total * 20,1) else 0 end ";
		sql_LIST = sql_LIST + "    + ";
		sql_LIST = sql_LIST + "    case when stime_ans_total > 0 then round((stime_ans1 * 5 + stime_ans2 * 4 + stime_ans3 * 3 + stime_ans4 * 2 + stime_ans5 * 1) / stime_ans_total * 20,1) else 0 end) / 3,1) ";
		sql_LIST = sql_LIST + "    as total_avg ";
	...
	private void setFieldVariableFromQUESTION_LIST() throws Exception{
		...
		QUESTION_LIST_RAT=QUESTION_LIST.getDouble(16);
	}
	...
	private void setFieldVariableFromLIST() throws Exception{
		...
		LIST_SUBJ_ANS11_RAT=LIST.getDouble(16);
		LIST_SUBJ_ANS22_RAT=LIST.getDouble(17);
		LIST_SUBJ_ANS33_RAT=LIST.getDouble(18);
		LIST_SUBJ_ANS_AVG=LIST.getDouble(19);
		...
		LIST_STIME_ANS11_RAT=LIST.getDouble(33);
		LIST_STIME_ANS22_RAT=LIST.getDouble(34);
		LIST_STIME_ANS33_RAT=LIST.getDouble(35);
		LIST_STIME_ANS_AVG=LIST.getDouble(36);
		...
		LIST_TUTOR_ANS11_RAT=LIST.getDouble(50);
		LIST_TUTOR_ANS22_RAT=LIST.getDouble(51);
		LIST_TUTOR_ANS33_RAT=LIST.getDouble(52);
		LIST_SUBJ_ANS_TOTAL=LIST.getDouble(53);
		LIST_STIME_ANS_TOTAL=LIST.getDouble(54);
		LIST_TUTOR_ANS_TOTAL=LIST.getDouble(55);
		LIST_TUTOR_ANS_AVG=LIST.getDouble(56);
		LIST_TOTAL_AVG=LIST.getDouble(57);
	}
	...
	private void initConstVarient(){
		...
		sheet30_M4="불만";
		sheet30_N4="점수";
		sheet40_B1=" 분야별 설문 조사 결과";
		sheet40_A3=" ① 교육성과 및 운영";
		sheet40_A6=" ② 교육시설 이용";
		sheet40_A9=" ③ 교과목 및 강사 평가";
		sheet40_A11=" \" - 강의기법 ( 만족 : \" + @LIST(SUBJ_ANS11_RAT) + \"%, 보통 : \" + @LIST(SUBJ_ANS22_RAT) + \"%, 불만: \" + @LIST(SUBJ_ANS33_RAT) + \"%, 평균 :";
		sheet40_A12=" \" - 강의태도 (만족 : \" + @LIST(STIME_ANS11_RAT) + \"%, 보통 : \" + @LIST(STIME_ANS22_RAT) + \"%, 불만: \" + @LIST(STIME_ANS33_RAT) +A11";
		sheet40_A13=" \" - 전문성 (만족 :\" + @LIST(TUTOR_ANS11_RAT)+ \"%, 보통 : \" + @LIST(TUTOR_ANS22_RAT) + \"%, 불만: \" + @LIST(TUTOR_ANS33_RAT) +A13";
		sheet40_A16=" ④ 폐지 및 신설 희망과목";
		sheet40_A18=" ⑤ 추천하고 싶은 강사";
		sheet50_A1=5;
		sheet50_B1=" 과정장 의견";
	}
