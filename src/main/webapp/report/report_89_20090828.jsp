...
class ReportHandler{
	...
	private double LIST_SUBJ_ANS11_RAT;
	private double LIST_SUBJ_ANS22_RAT;
	private double LIST_SUBJ_ANS33_RAT;
	private double LIST_STIME_ANS11_RAT;
	private double LIST_STIME_ANS22_RAT;
	private double LIST_STIME_ANS33_RAT;
	private double LIST_TUTOR_ANS11_RAT;
	private double LIST_TUTOR_ANS22_RAT;
	private double LIST_TUTOR_ANS33_RAT;
	...
	private void getScriptFromquestion_list(boolean bIsPrint) throws Exception{
		...
		while(QUESTION_LIST.next()){   //자동으로 생성되는 반복 밴드의 루프문
			...
			sheet30_C5=QUESTION_LIST_TOTAL_CNT;
			sheet30_D5=QUESTION_LIST_ANSCNT33;
			sheet30_E5=(long)QUESTION_LIST_ANSCNT22;
			sheet30_F5=QUESTION_LIST_ANSCNT11;
			sheet30_G5=QUESTION_LIST_RAT_CNT;
			sheet30_H5=QUESTION_LIST_RAT;
			sheet30_D6=String.valueOf(QUESTION_LIST_ANSCNT3_RAT);
			sheet30_E6=String.valueOf(QUESTION_LIST_ANSCNT2_RAT);
			sheet30_F6=String.valueOf(QUESTION_LIST_ANSCNT1_RAT);
	...
	private void getScriptFromlist(boolean bIsPrint) throws Exception{
		...
		while(LIST.next()){   //자동으로 생성되는 반복 밴드의 루프문
			...
			sheet40_C6=String.valueOf(LIST_TOTAL_AVG);
			sheet40_D6=String.valueOf(LIST_SUBJ_ANS33_RAT);
			sheet40_E6=String.valueOf(LIST_SUBJ_ANS22_RAT);
			sheet40_F6=String.valueOf(LIST_SUBJ_ANS11_RAT);
			sheet40_G6=String.valueOf(LIST_SUBJ_ANS_AVG);
			sheet40_H6=String.valueOf(LIST_STIME_ANS33_RAT);
			sheet40_I6=String.valueOf(LIST_STIME_ANS22_RAT);
			sheet40_J6=String.valueOf(LIST_STIME_ANS11_RAT);
			sheet40_K6=String.valueOf(LIST_STIME_ANS_AVG);
			sheet40_L6=String.valueOf(LIST_TUTOR_ANS33_RAT);
			sheet40_M6=String.valueOf(LIST_TUTOR_ANS22_RAT);
			sheet40_N6=String.valueOf(LIST_TUTOR_ANS11_RAT);
			sheet40_O6=String.valueOf(LIST_TUTOR_ANS_AVG);

			//Auto Size Code
			int nHeightTmp;
			nAutoHeight_list[0]=0;
			nAutoHeight_list[1]=0;
			nHeightTmp=getPrintHeight(sheet40_A6, charWidth, 10, 69, 48, nAutoHeight_list[0]);
			...
			nAutoHeight_list[1]=nAutoHeight_list[0]+nAutoHeight_list[1]+28;
	...
	private void writeScriptpage_2( ) throws Exception{
		//스크립트문 생성
		out.print("^PRINT("+(nXCurPos)+","+(nYCurPos)+",467,0,16,0/,바탕체,RGB[0,0,255],BOLD, , ,NONE,31,1)");
	...
	private void writeScriptquestion_list_header( ) throws Exception{
		//스크립트문 생성
		out.println("^CELLBG("+(nXCurPos)+","+(nYCurPos)+",188,40,1,RGB[255,192,203],RGB[255,192,203],0)\r");
		out.println("^CELLLINE("+(nXCurPos)+","+(nYCurPos)+",188,40,0,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos)+","+(nYCurPos)+",188,40,0,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos)+","+(nYCurPos)+",188,40,0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos)+","+(nYCurPos)+",188,40,0,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos)+","+(nYCurPos)+",188,1,12,0/,바탕,RGB[0,0,0],BOLD, , ,NONE,40,1)");
		out.println(sheet30_A3+"\r");
		out.println("^CELLBG("+(nXCurPos+188)+","+(nYCurPos)+",37,40,1,RGB[255,192,203],RGB[255,192,203],0)\r");
		out.println("^CELLLINE("+(nXCurPos+188)+","+(nYCurPos)+",37,40,0,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos+188)+","+(nYCurPos)+",37,40,0,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos+188)+","+(nYCurPos)+",37,40,0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos+188)+","+(nYCurPos)+",37,40,0,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos+188)+","+(nYCurPos)+",37,1,11,0/,굴림체,RGB[0,0,0], , , ,NONE,40,1)");
		out.println(sheet30_C3+"\r");
		out.println("^CELLBG("+(nXCurPos+225)+","+(nYCurPos)+",135,20,1,RGB[255,192,203],RGB[255,192,203],0)\r");
		out.println("^CELLLINE("+(nXCurPos+225)+","+(nYCurPos)+",135,20,0,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos+225)+","+(nYCurPos)+",135,20,0,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos+225)+","+(nYCurPos)+",135,20,0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos+225)+","+(nYCurPos)+",135,20,0,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos+225)+","+(nYCurPos)+",135,1,11,0/,굴림체,RGB[0,0,0], , , ,NONE,20,1)");
		out.println(sheet30_D3+"\r");
		out.println("^CELLBG("+(nXCurPos+360)+","+(nYCurPos)+",49,40,1,RGB[255,192,203],RGB[255,192,203],0)\r");
		out.println("^CELLLINE("+(nXCurPos+360)+","+(nYCurPos)+",49,40,0,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos+360)+","+(nYCurPos)+",49,40,0,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos+360)+","+(nYCurPos)+",49,40,0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos+360)+","+(nYCurPos)+",49,40,0,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos+360)+","+(nYCurPos)+",49,1,10,0/,바탕,RGB[0,0,0],BOLD, , ,NONE,40,1)");
		out.println(sheet30_G3+"\r");
		out.println("^CELLBG("+(nXCurPos+409)+","+(nYCurPos)+",58,40,1,RGB[255,192,203],RGB[255,192,203],0)\r");
		out.println("^CELLLINE("+(nXCurPos+409)+","+(nYCurPos)+",58,40,0,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos+409)+","+(nYCurPos)+",58,40,0,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos+409)+","+(nYCurPos)+",58,40,0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos+409)+","+(nYCurPos)+",58,40,0,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos+409)+","+(nYCurPos)+",58,1,10,0/,바탕,RGB[0,0,0],BOLD, , ,NONE,40,1)");
		out.println(sheet30_H3+"\r");
		out.println("^CELLBG("+(nXCurPos+225)+","+(nYCurPos+20)+",45,20,1,RGB[255,192,203],RGB[255,192,203],0)\r");
		out.println("^CELLLINE("+(nXCurPos+225)+","+(nYCurPos+20)+",45,20,0,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos+225)+","+(nYCurPos+20)+",45,20,0,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos+225)+","+(nYCurPos+20)+",45,20,0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos+225)+","+(nYCurPos+20)+",45,20,0,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos+225)+","+(nYCurPos+20)+",45,1,11,0/,굴림체,RGB[0,0,0], , , ,NONE,20,1)");
		out.println(sheet30_D4+"\r");
		out.println("^CELLBG("+(nXCurPos+270)+","+(nYCurPos+20)+",45,20,1,RGB[255,192,203],RGB[255,192,203],0)\r");
		out.println("^CELLLINE("+(nXCurPos+270)+","+(nYCurPos+20)+",45,20,0,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos+270)+","+(nYCurPos+20)+",45,20,0,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos+270)+","+(nYCurPos+20)+",45,20,0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos+270)+","+(nYCurPos+20)+",45,20,0,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos+270)+","+(nYCurPos+20)+",45,1,11,0/,굴림체,RGB[0,0,0], , , ,NONE,20,1)");
		out.println(sheet30_E4+"\r");
		out.println("^CELLBG("+(nXCurPos+315)+","+(nYCurPos+20)+",45,20,1,RGB[255,192,203],RGB[255,192,203],0)\r");
		out.println("^CELLLINE("+(nXCurPos+315)+","+(nYCurPos+20)+",45,20,0,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos+315)+","+(nYCurPos+20)+",45,20,0,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos+315)+","+(nYCurPos+20)+",45,20,0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos+315)+","+(nYCurPos+20)+",45,20,0,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos+315)+","+(nYCurPos+20)+",45,1,11,0/,굴림체,RGB[0,0,0], , , ,NONE,20,1)");
	...
	private void writeScriptquestion_list( ) throws Exception{
		...
		out.println("^CELLLINE("+(nXCurPos+32)+","+(nYCurPos)+",156,"+(nAutoHeight_question_list[1])+",0,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos+32)+","+(nYCurPos)+",156,"+(nAutoHeight_question_list[1])+",0,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos+32)+","+(nYCurPos)+",156,"+(nAutoHeight_question_list[1])+",0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos+32)+","+(nYCurPos)+",156,"+(nAutoHeight_question_list[1])+",0,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos+32)+","+(nYCurPos)+",156,0,10,0/,바탕,RGB[0,0,0], , , ,XL,"+(nAutoHeight_question_list[1])+",1)");
		out.println(sheet30_B5+"\r");
		out.println("^CELLLINE("+(nXCurPos+188)+","+(nYCurPos)+",37,"+(nAutoHeight_question_list[1])+",0,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos+188)+","+(nYCurPos)+",37,"+(nAutoHeight_question_list[1])+",0,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos+188)+","+(nYCurPos)+",37,"+(nAutoHeight_question_list[1])+",0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos+188)+","+(nYCurPos)+",37,"+(nAutoHeight_question_list[1])+",0,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos+188)+","+(nYCurPos)+",37,1,10,1/0/0,바탕,RGB[0,0,0], , , ,NONE,"+(nAutoHeight_question_list[1])+",1)");
		out.println(sheet30_C5+"\r");
		out.println("^CELLLINE("+(nXCurPos+225)+","+(nYCurPos)+",45,"+(nAutoHeight_question_list[0])+",0,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos+225)+","+(nYCurPos)+",45,"+(nAutoHeight_question_list[0])+",0,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos+225)+","+(nYCurPos)+",45,"+(nAutoHeight_question_list[0])+",0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos+225)+","+(nYCurPos)+",45,"+(nAutoHeight_question_list[0])+",0,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos+225)+","+(nYCurPos)+",45,1,10,1/0/0,바탕,RGB[0,0,0], , , ,NONE,"+(nAutoHeight_question_list[0])+",1)");
		out.println(sheet30_D5+"\r");
		out.println("^CELLLINE("+(nXCurPos+270)+","+(nYCurPos)+",45,"+(nAutoHeight_question_list[0])+",0,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos+270)+","+(nYCurPos)+",45,"+(nAutoHeight_question_list[0])+",0,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos+270)+","+(nYCurPos)+",45,"+(nAutoHeight_question_list[0])+",0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos+270)+","+(nYCurPos)+",45,"+(nAutoHeight_question_list[0])+",0,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos+270)+","+(nYCurPos)+",45,1,10,1/0/0,바탕,RGB[0,0,0], , , ,NONE,"+(nAutoHeight_question_list[0])+",1)");
		out.println(sheet30_E5+"\r");
		out.println("^CELLLINE("+(nXCurPos+315)+","+(nYCurPos)+",45,"+(nAutoHeight_question_list[0])+",0,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos+315)+","+(nYCurPos)+",45,"+(nAutoHeight_question_list[0])+",0,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos+315)+","+(nYCurPos)+",45,"+(nAutoHeight_question_list[0])+",0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos+315)+","+(nYCurPos)+",45,"+(nAutoHeight_question_list[0])+",0,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos+315)+","+(nYCurPos)+",45,1,10,1/0/0,바탕,RGB[0,0,0], , , ,NONE,"+(nAutoHeight_question_list[0])+",1)");
		out.println(sheet30_F5+"\r");
		out.println("^CELLLINE("+(nXCurPos+360)+","+(nYCurPos)+",49,"+(nAutoHeight_question_list[1])+",0,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos+360)+","+(nYCurPos)+",49,"+(nAutoHeight_question_list[1])+",0,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos+360)+","+(nYCurPos)+",49,"+(nAutoHeight_question_list[1])+",0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos+360)+","+(nYCurPos)+",49,"+(nAutoHeight_question_list[1])+",0,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos+360)+","+(nYCurPos)+",49,1,10,0/,바탕,RGB[0,0,255], , , ,NONE,"+(nAutoHeight_question_list[1])+",1)");
		out.println(sheet30_G5+"\r");
		out.println("^CELLLINE("+(nXCurPos+409)+","+(nYCurPos)+",58,"+(nAutoHeight_question_list[1])+",0,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos+409)+","+(nYCurPos)+",58,"+(nAutoHeight_question_list[1])+",0,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos+409)+","+(nYCurPos)+",58,"+(nAutoHeight_question_list[1])+",0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos+409)+","+(nYCurPos)+",58,"+(nAutoHeight_question_list[1])+",0,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos+409)+","+(nYCurPos)+",58,1,10,0/,바탕,RGB[255,0,0], , , ,NONE,"+(nAutoHeight_question_list[1])+",1)");
		out.println(sheet30_H5+"\r");
		out.println("^CELLLINE("+(nXCurPos+225)+","+(nYCurPos+nAutoHeight_question_list[0])+",45,"+(nAutoHeight_question_list[1]-nAutoHeight_question_list[0])+",0,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos+225)+","+(nYCurPos+nAutoHeight_question_list[0])+",45,"+(nAutoHeight_question_list[1]-nAutoHeight_question_list[0])+",0,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos+225)+","+(nYCurPos+nAutoHeight_question_list[0])+",45,"+(nAutoHeight_question_list[1]-nAutoHeight_question_list[0])+",0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos+225)+","+(nYCurPos+nAutoHeight_question_list[0])+",45,"+(nAutoHeight_question_list[1]-nAutoHeight_question_list[0])+",0,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos+225)+","+(nYCurPos+nAutoHeight_question_list[0])+",45,1,10,0/,바탕,RGB[0,0,0], , , ,NONE,"+(nAutoHeight_question_list[1]-nAutoHeight_question_list[0])+",1)");
		out.println(sheet30_D6+"\r");
		out.println("^CELLLINE("+(nXCurPos+270)+","+(nYCurPos+nAutoHeight_question_list[0])+",45,"+(nAutoHeight_question_list[1]-nAutoHeight_question_list[0])+",0,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos+270)+","+(nYCurPos+nAutoHeight_question_list[0])+",45,"+(nAutoHeight_question_list[1]-nAutoHeight_question_list[0])+",0,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos+270)+","+(nYCurPos+nAutoHeight_question_list[0])+",45,"+(nAutoHeight_question_list[1]-nAutoHeight_question_list[0])+",0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos+270)+","+(nYCurPos+nAutoHeight_question_list[0])+",45,"+(nAutoHeight_question_list[1]-nAutoHeight_question_list[0])+",0,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos+270)+","+(nYCurPos+nAutoHeight_question_list[0])+",45,1,10,0/,바탕,RGB[0,0,0], , , ,NONE,"+(nAutoHeight_question_list[1]-nAutoHeight_question_list[0])+",1)");
		out.println(sheet30_E6+"\r");
		out.println("^CELLLINE("+(nXCurPos+315)+","+(nYCurPos+nAutoHeight_question_list[0])+",45,"+(nAutoHeight_question_list[1]-nAutoHeight_question_list[0])+",0,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos+315)+","+(nYCurPos+nAutoHeight_question_list[0])+",45,"+(nAutoHeight_question_list[1]-nAutoHeight_question_list[0])+",0,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos+315)+","+(nYCurPos+nAutoHeight_question_list[0])+",45,"+(nAutoHeight_question_list[1]-nAutoHeight_question_list[0])+",0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos+315)+","+(nYCurPos+nAutoHeight_question_list[0])+",45,"+(nAutoHeight_question_list[1]-nAutoHeight_question_list[0])+",0,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos+315)+","+(nYCurPos+nAutoHeight_question_list[0])+",45,1,10,0/,바탕,RGB[0,0,0], , , ,NONE,"+(nAutoHeight_question_list[1]-nAutoHeight_question_list[0])+",1)");
	...
	private void writeScriptpage_3( ) throws Exception{
		//스크립트문 생성
		out.print("^PRINT("+(nXCurPos)+","+(nYCurPos)+",391,0,16,0/,바탕체,RGB[0,0,255],BOLD, , ,NONE,31,1)");
	...
	private void writeScriptlist_header( ) throws Exception{
		//스크립트문 생성
		out.println("^CELLBG("+(nXCurPos)+","+(nYCurPos)+",69,40,1,RGB[230,230,250],RGB[230,230,250],0)\r");
		out.println("^CELLLINE("+(nXCurPos)+","+(nYCurPos)+",69,40,0,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos)+","+(nYCurPos)+",69,40,0,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos)+","+(nYCurPos)+",69,40,0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos)+","+(nYCurPos)+",69,40,0,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos)+","+(nYCurPos)+",69,1,10,0/,바탕,RGB[0,0,0], , , ,NONE,40,1)");
		out.println(sheet40_A3+"\r");
		out.println("^CELLBG("+(nXCurPos+69)+","+(nYCurPos)+",39,70,1,RGB[230,230,250],RGB[230,230,250],0)\r");
		out.println("^CELLLINE("+(nXCurPos+69)+","+(nYCurPos)+",39,70,0,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos+69)+","+(nYCurPos)+",39,70,0,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos+69)+","+(nYCurPos)+",39,70,0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos+69)+","+(nYCurPos)+",39,70,0,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos+69)+","+(nYCurPos)+",39,1,10,0/,바탕,RGB[0,0,0], , , ,NONE,70,1)");
		out.println(sheet40_B3+"\r");
		out.println("^CELLBG("+(nXCurPos+108)+","+(nYCurPos)+",31,70,1,RGB[230,230,250],RGB[230,230,250],0)\r");
		out.println("^CELLLINE("+(nXCurPos+108)+","+(nYCurPos)+",31,70,0,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos+108)+","+(nYCurPos)+",31,70,0,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos+108)+","+(nYCurPos)+",31,70,0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos+108)+","+(nYCurPos)+",31,70,0,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos+108)+","+(nYCurPos)+",31,1,10,0/,바탕,RGB[0,0,0], , , ,NONE,70,1)");
		out.println(sheet40_C3+"\r");
		out.println("^CELLBG("+(nXCurPos+139)+","+(nYCurPos)+",112,20,1,RGB[230,230,250],RGB[230,230,250],0)\r");
		out.println("^CELLLINE("+(nXCurPos+139)+","+(nYCurPos)+",112,20,0,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos+139)+","+(nYCurPos)+",112,20,0,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos+139)+","+(nYCurPos)+",112,20,0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos+139)+","+(nYCurPos)+",112,20,0,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos+139)+","+(nYCurPos)+",112,1,10,0/,바탕,RGB[0,0,0], , , ,NONE,20,1)");
		out.println(sheet40_D3+"\r");
		out.println("^CELLBG("+(nXCurPos+251)+","+(nYCurPos)+",112,20,1,RGB[230,230,250],RGB[230,230,250],0)\r");
		out.println("^CELLLINE("+(nXCurPos+251)+","+(nYCurPos)+",112,20,0,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos+251)+","+(nYCurPos)+",112,20,0,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos+251)+","+(nYCurPos)+",112,20,0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos+251)+","+(nYCurPos)+",112,20,0,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos+251)+","+(nYCurPos)+",112,1,10,0/,바탕,RGB[0,0,0], , , ,NONE,20,1)");
		out.println(sheet40_H3+"\r");
		out.println("^CELLBG("+(nXCurPos+363)+","+(nYCurPos)+",112,20,1,RGB[230,230,250],RGB[230,230,250],0)\r");
		out.println("^CELLLINE("+(nXCurPos+363)+","+(nYCurPos)+",112,20,0,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos+363)+","+(nYCurPos)+",112,20,0,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos+363)+","+(nYCurPos)+",112,20,0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos+363)+","+(nYCurPos)+",112,20,0,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos+363)+","+(nYCurPos)+",112,1,10,0/,바탕,RGB[0,0,0], , , ,NONE,20,1)");
		out.println(sheet40_L3+"\r");
		out.println("^CELLBG("+(nXCurPos+139)+","+(nYCurPos+20)+",84,20,1,RGB[230,230,250],RGB[230,230,250],0)\r");
		out.println("^CELLLINE("+(nXCurPos+139)+","+(nYCurPos+20)+",84,20,0,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos+139)+","+(nYCurPos+20)+",84,20,0,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos+139)+","+(nYCurPos+20)+",84,20,0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos+139)+","+(nYCurPos+20)+",84,20,0,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos+139)+","+(nYCurPos+20)+",84,1,10,0/,바탕,RGB[0,0,0], , , ,NONE,20,1)");
		out.println(sheet40_D4+"\r");
		out.println("^CELLBG("+(nXCurPos+223)+","+(nYCurPos+20)+",28,50,1,RGB[230,230,250],RGB[230,230,250],0)\r");
		out.println("^CELLLINE("+(nXCurPos+223)+","+(nYCurPos+20)+",28,50,0,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos+223)+","+(nYCurPos+20)+",28,50,0,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos+223)+","+(nYCurPos+20)+",28,50,0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos+223)+","+(nYCurPos+20)+",28,50,0,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos+223)+","+(nYCurPos+20)+",28,1,10,0/,바탕,RGB[0,0,0], , , ,NONE,50,1)");
		out.println(sheet40_G4+"\r");
		out.println("^CELLBG("+(nXCurPos+251)+","+(nYCurPos+20)+",84,20,1,RGB[230,230,250],RGB[230,230,250],0)\r");
		out.println("^CELLLINE("+(nXCurPos+251)+","+(nYCurPos+20)+",84,20,0,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos+251)+","+(nYCurPos+20)+",84,20,0,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos+251)+","+(nYCurPos+20)+",84,20,0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos+251)+","+(nYCurPos+20)+",84,20,0,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos+251)+","+(nYCurPos+20)+",84,1,10,0/,바탕,RGB[0,0,0], , , ,NONE,20,1)");
		out.println(sheet40_H4+"\r");
		out.println("^CELLBG("+(nXCurPos+335)+","+(nYCurPos+20)+",28,50,1,RGB[230,230,250],RGB[230,230,250],0)\r");
		out.println("^CELLLINE("+(nXCurPos+335)+","+(nYCurPos+20)+",28,50,0,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos+335)+","+(nYCurPos+20)+",28,50,0,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos+335)+","+(nYCurPos+20)+",28,50,0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos+335)+","+(nYCurPos+20)+",28,50,0,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos+335)+","+(nYCurPos+20)+",28,1,10,0/,바탕,RGB[0,0,0], , , ,NONE,50,1)");
		out.println(sheet40_K4+"\r");
		out.println("^CELLBG("+(nXCurPos+363)+","+(nYCurPos+20)+",84,20,1,RGB[230,230,250],RGB[230,230,250],0)\r");
		out.println("^CELLLINE("+(nXCurPos+363)+","+(nYCurPos+20)+",84,20,0,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos+363)+","+(nYCurPos+20)+",84,20,0,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos+363)+","+(nYCurPos+20)+",84,20,0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos+363)+","+(nYCurPos+20)+",84,20,0,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos+363)+","+(nYCurPos+20)+",84,1,10,0/,바탕,RGB[0,0,0], , , ,NONE,20,1)");
		out.println(sheet40_L4+"\r");
		out.println("^CELLBG("+(nXCurPos+447)+","+(nYCurPos+20)+",28,50,1,RGB[230,230,250],RGB[230,230,250],0)\r");
		out.println("^CELLLINE("+(nXCurPos+447)+","+(nYCurPos+20)+",28,50,0,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos+447)+","+(nYCurPos+20)+",28,50,0,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos+447)+","+(nYCurPos+20)+",28,50,0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos+447)+","+(nYCurPos+20)+",28,50,0,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos+447)+","+(nYCurPos+20)+",28,1,10,0/,바탕,RGB[0,0,0], , , ,NONE,50,1)");
		out.println(sheet40_O4+"\r");
		out.println("^CELLBG("+(nXCurPos)+","+(nYCurPos+40)+",69,30,1,RGB[230,230,250],RGB[230,230,250],0)\r");
		out.println("^CELLLINE("+(nXCurPos)+","+(nYCurPos+40)+",69,30,0,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos)+","+(nYCurPos+40)+",69,30,0,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos)+","+(nYCurPos+40)+",69,30,0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos)+","+(nYCurPos+40)+",69,30,0,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos)+","+(nYCurPos+40)+",69,1,10,1/0/0,바탕,RGB[0,0,0], , , ,NONE,30,1)");
		out.println(sheet40_A5+"\r");
		out.println("^CELLBG("+(nXCurPos+139)+","+(nYCurPos+40)+",28,30,1,RGB[230,230,250],RGB[230,230,250],0)\r");
		out.println("^CELLLINE("+(nXCurPos+139)+","+(nYCurPos+40)+",28,30,0,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos+139)+","+(nYCurPos+40)+",28,30,0,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos+139)+","+(nYCurPos+40)+",28,30,0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos+139)+","+(nYCurPos+40)+",28,30,0,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos+139)+","+(nYCurPos+40)+",28,1,10,0/,바탕,RGB[0,0,0], , , ,NONE,30,1)");
		out.println(sheet40_D5+"\r");
		out.println("^CELLBG("+(nXCurPos+167)+","+(nYCurPos+40)+",28,30,1,RGB[230,230,250],RGB[230,230,250],0)\r");
		out.println("^CELLLINE("+(nXCurPos+167)+","+(nYCurPos+40)+",28,30,0,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos+167)+","+(nYCurPos+40)+",28,30,0,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos+167)+","+(nYCurPos+40)+",28,30,0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos+167)+","+(nYCurPos+40)+",28,30,0,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos+167)+","+(nYCurPos+40)+",28,1,10,0/,바탕,RGB[0,0,0], , , ,NONE,30,1)");
		out.println(sheet40_E5+"\r");
		out.println("^CELLBG("+(nXCurPos+195)+","+(nYCurPos+40)+",28,30,1,RGB[230,230,250],RGB[230,230,250],0)\r");
		out.println("^CELLLINE("+(nXCurPos+195)+","+(nYCurPos+40)+",28,30,0,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos+195)+","+(nYCurPos+40)+",28,30,0,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos+195)+","+(nYCurPos+40)+",28,30,0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos+195)+","+(nYCurPos+40)+",28,30,0,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos+195)+","+(nYCurPos+40)+",28,1,10,0/,바탕,RGB[0,0,0], , , ,NONE,30,1)");
		out.println(sheet40_F5+"\r");
		out.println("^CELLBG("+(nXCurPos+251)+","+(nYCurPos+40)+",28,30,1,RGB[230,230,250],RGB[230,230,250],0)\r");
		out.println("^CELLLINE("+(nXCurPos+251)+","+(nYCurPos+40)+",28,30,0,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos+251)+","+(nYCurPos+40)+",28,30,0,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos+251)+","+(nYCurPos+40)+",28,30,0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos+251)+","+(nYCurPos+40)+",28,30,0,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos+251)+","+(nYCurPos+40)+",28,1,10,0/,바탕,RGB[0,0,0], , , ,NONE,30,1)");
		out.println(sheet40_H5+"\r");
		out.println("^CELLBG("+(nXCurPos+279)+","+(nYCurPos+40)+",28,30,1,RGB[230,230,250],RGB[230,230,250],0)\r");
		out.println("^CELLLINE("+(nXCurPos+279)+","+(nYCurPos+40)+",28,30,0,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos+279)+","+(nYCurPos+40)+",28,30,0,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos+279)+","+(nYCurPos+40)+",28,30,0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos+279)+","+(nYCurPos+40)+",28,30,0,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos+279)+","+(nYCurPos+40)+",28,1,10,0/,바탕,RGB[0,0,0], , , ,NONE,30,1)");
		out.println(sheet40_I5+"\r");
		out.println("^CELLBG("+(nXCurPos+307)+","+(nYCurPos+40)+",28,30,1,RGB[230,230,250],RGB[230,230,250],0)\r");
		out.println("^CELLLINE("+(nXCurPos+307)+","+(nYCurPos+40)+",28,30,0,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos+307)+","+(nYCurPos+40)+",28,30,0,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos+307)+","+(nYCurPos+40)+",28,30,0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos+307)+","+(nYCurPos+40)+",28,30,0,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos+307)+","+(nYCurPos+40)+",28,1,10,0/,바탕,RGB[0,0,0], , , ,NONE,30,1)");
		out.println(sheet40_J5+"\r");
		out.println("^CELLBG("+(nXCurPos+363)+","+(nYCurPos+40)+",28,30,1,RGB[230,230,250],RGB[230,230,250],0)\r");
		out.println("^CELLLINE("+(nXCurPos+363)+","+(nYCurPos+40)+",28,30,0,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos+363)+","+(nYCurPos+40)+",28,30,0,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos+363)+","+(nYCurPos+40)+",28,30,0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos+363)+","+(nYCurPos+40)+",28,30,0,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos+363)+","+(nYCurPos+40)+",28,1,10,0/,바탕,RGB[0,0,0], , , ,NONE,30,1)");
		out.println(sheet40_L5+"\r");
		out.println("^CELLBG("+(nXCurPos+391)+","+(nYCurPos+40)+",28,30,1,RGB[230,230,250],RGB[230,230,250],0)\r");
		out.println("^CELLLINE("+(nXCurPos+391)+","+(nYCurPos+40)+",28,30,0,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos+391)+","+(nYCurPos+40)+",28,30,0,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos+391)+","+(nYCurPos+40)+",28,30,0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos+391)+","+(nYCurPos+40)+",28,30,0,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos+391)+","+(nYCurPos+40)+",28,1,10,0/,바탕,RGB[0,0,0], , , ,NONE,30,1)");
		out.println(sheet40_M5+"\r");
		out.println("^CELLBG("+(nXCurPos+419)+","+(nYCurPos+40)+",28,30,1,RGB[230,230,250],RGB[230,230,250],0)\r");
		out.println("^CELLLINE("+(nXCurPos+419)+","+(nYCurPos+40)+",28,30,0,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos+419)+","+(nYCurPos+40)+",28,30,0,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos+419)+","+(nYCurPos+40)+",28,30,0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos+419)+","+(nYCurPos+40)+",28,30,0,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos+419)+","+(nYCurPos+40)+",28,1,10,0/,바탕,RGB[0,0,0], , , ,NONE,30,1)");
	...
	private void writeScriptlist( ) throws Exception{
		...
		out.println("^CELLLINE("+(nXCurPos+108)+","+(nYCurPos)+",31,"+(nAutoHeight_list[1])+",0,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos+108)+","+(nYCurPos)+",31,"+(nAutoHeight_list[1])+",0,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos+108)+","+(nYCurPos)+",31,"+(nAutoHeight_list[1])+",0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos+108)+","+(nYCurPos)+",31,"+(nAutoHeight_list[1])+",0,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos+108)+","+(nYCurPos)+",31,1,10,0/,바탕,RGB[255,0,0], , , ,NONE,"+(nAutoHeight_list[1])+",1)");
		out.println(sheet40_C6+"\r");
		out.println("^CELLLINE("+(nXCurPos+139)+","+(nYCurPos)+",28,"+(nAutoHeight_list[1])+",0,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos+139)+","+(nYCurPos)+",28,"+(nAutoHeight_list[1])+",0,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos+139)+","+(nYCurPos)+",28,"+(nAutoHeight_list[1])+",0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos+139)+","+(nYCurPos)+",28,"+(nAutoHeight_list[1])+",0,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos+139)+","+(nYCurPos)+",28,1,10,0/,바탕,RGB[0,0,0], , , ,NONE,"+(nAutoHeight_list[1])+",1)");
		out.println(sheet40_D6+"\r");
		out.println("^CELLLINE("+(nXCurPos+167)+","+(nYCurPos)+",28,"+(nAutoHeight_list[1])+",0,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos+167)+","+(nYCurPos)+",28,"+(nAutoHeight_list[1])+",0,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos+167)+","+(nYCurPos)+",28,"+(nAutoHeight_list[1])+",0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos+167)+","+(nYCurPos)+",28,"+(nAutoHeight_list[1])+",0,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos+167)+","+(nYCurPos)+",28,1,10,0/,바탕,RGB[0,0,0], , , ,NONE,"+(nAutoHeight_list[1])+",1)");
		out.println(sheet40_E6+"\r");
		out.println("^CELLLINE("+(nXCurPos+195)+","+(nYCurPos)+",28,"+(nAutoHeight_list[1])+",0,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos+195)+","+(nYCurPos)+",28,"+(nAutoHeight_list[1])+",0,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos+195)+","+(nYCurPos)+",28,"+(nAutoHeight_list[1])+",0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos+195)+","+(nYCurPos)+",28,"+(nAutoHeight_list[1])+",0,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos+195)+","+(nYCurPos)+",28,1,10,0/,바탕,RGB[0,0,0], , , ,NONE,"+(nAutoHeight_list[1])+",1)");
		out.println(sheet40_F6+"\r");
		out.println("^CELLLINE("+(nXCurPos+223)+","+(nYCurPos)+",28,"+(nAutoHeight_list[1])+",0,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos+223)+","+(nYCurPos)+",28,"+(nAutoHeight_list[1])+",0,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos+223)+","+(nYCurPos)+",28,"+(nAutoHeight_list[1])+",0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos+223)+","+(nYCurPos)+",28,"+(nAutoHeight_list[1])+",0,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos+223)+","+(nYCurPos)+",28,1,9,0/,바탕,RGB[0,0,255], , , ,NONE,"+(nAutoHeight_list[1])+",1)");
		out.println(sheet40_G6+"\r");
		out.println("^CELLLINE("+(nXCurPos+251)+","+(nYCurPos)+",28,"+(nAutoHeight_list[1])+",0,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos+251)+","+(nYCurPos)+",28,"+(nAutoHeight_list[1])+",0,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos+251)+","+(nYCurPos)+",28,"+(nAutoHeight_list[1])+",0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos+251)+","+(nYCurPos)+",28,"+(nAutoHeight_list[1])+",0,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos+251)+","+(nYCurPos)+",28,1,10,0/,바탕,RGB[0,0,0], , , ,NONE,"+(nAutoHeight_list[1])+",1)");
		out.println(sheet40_H6+"\r");
		out.println("^CELLLINE("+(nXCurPos+279)+","+(nYCurPos)+",28,"+(nAutoHeight_list[1])+",0,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos+279)+","+(nYCurPos)+",28,"+(nAutoHeight_list[1])+",0,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos+279)+","+(nYCurPos)+",28,"+(nAutoHeight_list[1])+",0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos+279)+","+(nYCurPos)+",28,"+(nAutoHeight_list[1])+",0,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos+279)+","+(nYCurPos)+",28,1,10,0/,바탕,RGB[0,0,0], , , ,NONE,"+(nAutoHeight_list[1])+",1)");
		out.println(sheet40_I6+"\r");
		out.println("^CELLLINE("+(nXCurPos+307)+","+(nYCurPos)+",28,"+(nAutoHeight_list[1])+",0,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos+307)+","+(nYCurPos)+",28,"+(nAutoHeight_list[1])+",0,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos+307)+","+(nYCurPos)+",28,"+(nAutoHeight_list[1])+",0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos+307)+","+(nYCurPos)+",28,"+(nAutoHeight_list[1])+",0,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos+307)+","+(nYCurPos)+",28,1,10,0/,바탕,RGB[0,0,0], , , ,NONE,"+(nAutoHeight_list[1])+",1)");
		out.println(sheet40_J6+"\r");
		out.println("^CELLLINE("+(nXCurPos+335)+","+(nYCurPos)+",28,"+(nAutoHeight_list[1])+",0,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos+335)+","+(nYCurPos)+",28,"+(nAutoHeight_list[1])+",0,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos+335)+","+(nYCurPos)+",28,"+(nAutoHeight_list[1])+",0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos+335)+","+(nYCurPos)+",28,"+(nAutoHeight_list[1])+",0,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos+335)+","+(nYCurPos)+",28,1,9,0/,바탕,RGB[0,0,255], , , ,NONE,"+(nAutoHeight_list[1])+",1)");
		out.println(sheet40_K6+"\r");
		out.println("^CELLLINE("+(nXCurPos+363)+","+(nYCurPos)+",28,"+(nAutoHeight_list[1])+",0,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos+363)+","+(nYCurPos)+",28,"+(nAutoHeight_list[1])+",0,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos+363)+","+(nYCurPos)+",28,"+(nAutoHeight_list[1])+",0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos+363)+","+(nYCurPos)+",28,"+(nAutoHeight_list[1])+",0,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos+363)+","+(nYCurPos)+",28,1,10,0/,바탕,RGB[0,0,0], , , ,NONE,"+(nAutoHeight_list[1])+",1)");
		out.println(sheet40_L6+"\r");
		out.println("^CELLLINE("+(nXCurPos+391)+","+(nYCurPos)+",28,"+(nAutoHeight_list[1])+",0,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos+391)+","+(nYCurPos)+",28,"+(nAutoHeight_list[1])+",0,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos+391)+","+(nYCurPos)+",28,"+(nAutoHeight_list[1])+",0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos+391)+","+(nYCurPos)+",28,"+(nAutoHeight_list[1])+",0,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos+391)+","+(nYCurPos)+",28,1,10,0/,바탕,RGB[0,0,0], , , ,NONE,"+(nAutoHeight_list[1])+",1)");
		out.println(sheet40_M6+"\r");
		out.println("^CELLLINE("+(nXCurPos+419)+","+(nYCurPos)+",28,"+(nAutoHeight_list[1])+",0,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos+419)+","+(nYCurPos)+",28,"+(nAutoHeight_list[1])+",0,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos+419)+","+(nYCurPos)+",28,"+(nAutoHeight_list[1])+",0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos+419)+","+(nYCurPos)+",28,"+(nAutoHeight_list[1])+",0,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos+419)+","+(nYCurPos)+",28,1,10,0/,바탕,RGB[0,0,0], , , ,NONE,"+(nAutoHeight_list[1])+",1)");
		out.println(sheet40_N6+"\r");
		out.println("^CELLLINE("+(nXCurPos+447)+","+(nYCurPos)+",28,"+(nAutoHeight_list[1])+",0,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos+447)+","+(nYCurPos)+",28,"+(nAutoHeight_list[1])+",0,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos+447)+","+(nYCurPos)+",28,"+(nAutoHeight_list[1])+",0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos+447)+","+(nYCurPos)+",28,"+(nAutoHeight_list[1])+",0,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos+447)+","+(nYCurPos)+",28,1,9,0/,바탕,RGB[0,0,255], , , ,NONE,"+(nAutoHeight_list[1])+",1)");
	...
	private void writeScriptVoidBand405( ) throws Exception{
		//스크립트문 생성
		out.print("^PRINT("+(nXCurPos)+","+(nYCurPos+20)+",475,1,11,0/,굴림체,RGB[0,0,0], , , ,NONE,20,1)");
	...
	private void writeScriptSheet4_foot( ) throws Exception{
		//스크립트문 생성
		out.println("^CELLLINE("+(nXCurPos)+","+(nYCurPos)+",108,20,1,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos)+","+(nYCurPos)+",108,20,0,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos)+","+(nYCurPos)+",108,20,1,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos)+","+(nYCurPos)+",108,20,0,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos)+","+(nYCurPos)+",108,1,11,0/,굴림체,RGB[0,0,0], , , ,NONE,20,1)");
		out.println(sheet40_A10+"\r");
		out.println("^CELLLINE("+(nXCurPos+108)+","+(nYCurPos)+",87,20,1,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos+108)+","+(nYCurPos)+",87,20,0,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos+108)+","+(nYCurPos)+",87,20,0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos+108)+","+(nYCurPos)+",87,20,0,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos+108)+","+(nYCurPos)+",87,1,11,0/,굴림체,RGB[0,0,0], , , ,NONE,20,1)");
		out.println(sheet40_C10+"\r");
		out.println("^CELLLINE("+(nXCurPos+195)+","+(nYCurPos)+",56,20,1,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos+195)+","+(nYCurPos)+",56,20,0,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos+195)+","+(nYCurPos)+",56,20,0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos+195)+","+(nYCurPos)+",56,20,0,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos+195)+","+(nYCurPos)+",56,1,11,0/,굴림체,RGB[0,0,0], , , ,NONE,20,1)");
		out.println(sheet40_F10+"\r");
		out.println("^CELLLINE("+(nXCurPos+251)+","+(nYCurPos)+",56,20,1,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos+251)+","+(nYCurPos)+",56,20,0,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos+251)+","+(nYCurPos)+",56,20,0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos+251)+","+(nYCurPos)+",56,20,0,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos+251)+","+(nYCurPos)+",56,1,11,0/,굴림체,RGB[0,0,0], , , ,NONE,20,1)");
		out.println(sheet40_H10+"\r");
		out.println("^CELLLINE("+(nXCurPos+307)+","+(nYCurPos)+",56,20,1,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos+307)+","+(nYCurPos)+",56,20,0,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos+307)+","+(nYCurPos)+",56,20,0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos+307)+","+(nYCurPos)+",56,20,0,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos+307)+","+(nYCurPos)+",56,1,11,0/,굴림체,RGB[0,0,0], , , ,NONE,20,1)");
		out.println(sheet40_J10+"\r");
		out.println("^CELLLINE("+(nXCurPos+363)+","+(nYCurPos)+",112,20,1,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos+363)+","+(nYCurPos)+",112,20,0,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos+363)+","+(nYCurPos)+",112,20,0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos+363)+","+(nYCurPos)+",112,20,1,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos+363)+","+(nYCurPos)+",112,1,11,0/,굴림체,RGB[0,0,0], , , ,NONE,20,1)");
		out.println(sheet40_L10+"\r");
		out.println("^CELLLINE("+(nXCurPos)+","+(nYCurPos+20)+",108,20,0,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos)+","+(nYCurPos+20)+",108,20,0,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos)+","+(nYCurPos+20)+",108,20,1,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos)+","+(nYCurPos+20)+",108,20,0,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos)+","+(nYCurPos+20)+",108,1,11,0/,굴림체,RGB[0,0,0], , , ,NONE,20,1)");
		out.println(sheet40_A11+"\r");
		out.println("^CELLLINE("+(nXCurPos+108)+","+(nYCurPos+20)+",87,20,0,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos+108)+","+(nYCurPos+20)+",87,20,0,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos+108)+","+(nYCurPos+20)+",87,20,0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos+108)+","+(nYCurPos+20)+",87,20,0,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos+108)+","+(nYCurPos+20)+",87,1,11,0/,굴림체,RGB[0,0,0], , , ,NONE,20,1)");
		out.println(sheet40_C11+"\r");
		out.println("^CELLLINE("+(nXCurPos+195)+","+(nYCurPos+20)+",56,20,0,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos+195)+","+(nYCurPos+20)+",56,20,0,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos+195)+","+(nYCurPos+20)+",56,20,0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos+195)+","+(nYCurPos+20)+",56,20,0,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos+195)+","+(nYCurPos+20)+",56,1,11,0/,굴림체,RGB[0,0,0], , , ,NONE,20,1)");
		out.println(sheet40_F11+"\r");
		out.println("^CELLLINE("+(nXCurPos+251)+","+(nYCurPos+20)+",56,20,0,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos+251)+","+(nYCurPos+20)+",56,20,0,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos+251)+","+(nYCurPos+20)+",56,20,0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos+251)+","+(nYCurPos+20)+",56,20,0,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos+251)+","+(nYCurPos+20)+",56,1,11,0/,굴림체,RGB[0,0,0], , , ,NONE,20,1)");
		out.println(sheet40_H11+"\r");
		out.println("^CELLLINE("+(nXCurPos+307)+","+(nYCurPos+20)+",56,20,0,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos+307)+","+(nYCurPos+20)+",56,20,0,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos+307)+","+(nYCurPos+20)+",56,20,0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos+307)+","+(nYCurPos+20)+",56,20,0,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos+307)+","+(nYCurPos+20)+",56,1,11,0/,굴림체,RGB[0,0,0], , , ,NONE,20,1)");
		out.println(sheet40_J11+"\r");
		out.println("^CELLLINE("+(nXCurPos+363)+","+(nYCurPos+20)+",112,20,0,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos+363)+","+(nYCurPos+20)+",112,20,0,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos+363)+","+(nYCurPos+20)+",112,20,0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos+363)+","+(nYCurPos+20)+",112,20,1,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos+363)+","+(nYCurPos+20)+",112,1,11,0/,굴림체,RGB[0,0,0], , , ,NONE,20,1)");
		out.println(sheet40_L11+"\r");
		out.println("^CELLLINE("+(nXCurPos)+","+(nYCurPos+40)+",108,20,0,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos)+","+(nYCurPos+40)+",108,20,1,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos)+","+(nYCurPos+40)+",108,20,1,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos)+","+(nYCurPos+40)+",108,20,0,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos)+","+(nYCurPos+40)+",108,1,11,0/,굴림체,RGB[0,0,0], , , ,NONE,20,1)");
		out.println(sheet40_A12+"\r");
		out.println("^CELLLINE("+(nXCurPos+108)+","+(nYCurPos+40)+",87,20,0,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos+108)+","+(nYCurPos+40)+",87,20,1,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos+108)+","+(nYCurPos+40)+",87,20,0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos+108)+","+(nYCurPos+40)+",87,20,0,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos+108)+","+(nYCurPos+40)+",87,1,11,0/,굴림체,RGB[0,0,0], , , ,NONE,20,1)");
		out.println(sheet40_C12+"\r");
		out.println("^CELLLINE("+(nXCurPos+195)+","+(nYCurPos+40)+",56,20,0,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos+195)+","+(nYCurPos+40)+",56,20,1,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos+195)+","+(nYCurPos+40)+",56,20,0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos+195)+","+(nYCurPos+40)+",56,20,0,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos+195)+","+(nYCurPos+40)+",56,1,11,0/,굴림체,RGB[0,0,0], , , ,NONE,20,1)");
		out.println(sheet40_F12+"\r");
		out.println("^CELLLINE("+(nXCurPos+251)+","+(nYCurPos+40)+",56,20,0,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos+251)+","+(nYCurPos+40)+",56,20,1,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos+251)+","+(nYCurPos+40)+",56,20,0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos+251)+","+(nYCurPos+40)+",56,20,0,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos+251)+","+(nYCurPos+40)+",56,1,11,0/,굴림체,RGB[0,0,0], , , ,NONE,20,1)");
		out.println(sheet40_H12+"\r");
		out.println("^CELLLINE("+(nXCurPos+307)+","+(nYCurPos+40)+",56,20,0,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos+307)+","+(nYCurPos+40)+",56,20,1,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos+307)+","+(nYCurPos+40)+",56,20,0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos+307)+","+(nYCurPos+40)+",56,20,0,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos+307)+","+(nYCurPos+40)+",56,1,11,0/,굴림체,RGB[0,0,0], , , ,NONE,20,1)");
		out.println(sheet40_J12+"\r");
		out.println("^CELLLINE("+(nXCurPos+363)+","+(nYCurPos+40)+",112,20,0,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos+363)+","+(nYCurPos+40)+",112,20,1,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos+363)+","+(nYCurPos+40)+",112,20,0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos+363)+","+(nYCurPos+40)+",112,20,1,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos+363)+","+(nYCurPos+40)+",112,1,11,0/,굴림체,RGB[0,0,0], , , ,NONE,20,1)");
		out.println(sheet40_L12+"\r");
		out.print("^PRINT("+(nXCurPos)+","+(nYCurPos+60)+",475,1,10,0/,굴림체,RGB[0,0,0], , , ,NONE,20,1)");
	...
	private void initSQLConst(){
		...
		sql_LIST = sql_LIST + "    SUBJ_ANS11, ";
		sql_LIST = sql_LIST + "    SUBJ_ANS22, ";
		sql_LIST = sql_LIST + "    SUBJ_ANS33, ";
		sql_LIST = sql_LIST + "    SUBJ_ANS_TOTAL,            ";
		sql_LIST = sql_LIST + "    STIME_ANS11, ";
		sql_LIST = sql_LIST + "    STIME_ANS22, ";
		sql_LIST = sql_LIST + "    STIME_ANS33,     ";
		sql_LIST = sql_LIST + "    STIME_ANS_TOTAL,             ";
		sql_LIST = sql_LIST + "    TUTOR_ANS11, ";
		sql_LIST = sql_LIST + "    TUTOR_ANS22, ";
		sql_LIST = sql_LIST + "    TUTOR_ANS33, ";
		sql_LIST = sql_LIST + "    TUTOR_ANS_TOTAL,             ";
		sql_LIST = sql_LIST + "    SUBJ_ANS11_RAT AS SUBJ_ANS11_RAT, ";
		sql_LIST = sql_LIST + "    SUBJ_ANS22_RAT AS SUBJ_ANS22_RAT, ";
		sql_LIST = sql_LIST + "    SUBJ_ANS33_RAT AS SUBJ_ANS33_RAT,             ";
		sql_LIST = sql_LIST + "    STIME_ANS11_RAT AS STIME_ANS11_RAT, ";
		sql_LIST = sql_LIST + "    STIME_ANS22_RAT AS STIME_ANS22_RAT, ";
		sql_LIST = sql_LIST + "    STIME_ANS33_RAT AS STIME_ANS33_RAT,                     ";
		sql_LIST = sql_LIST + "    TUTOR_ANS11_RAT AS TUTOR_ANS11_RAT, ";
		sql_LIST = sql_LIST + "    TUTOR_ANS22_RAT AS TUTOR_ANS22_RAT, ";
		sql_LIST = sql_LIST + "    TUTOR_ANS33_RAT AS TUTOR_ANS33_RAT, ";
		sql_LIST = sql_LIST + "    CASE WHEN SUBJ_ANS_TOTAL > 0 THEN ROUND((SUBJ_ANS1 * 1 +  SUBJ_ANS2 * 2 + SUBJ_ANS3 * 3 + SUBJ_ANS4 * 4 + SUBJ_ANS5 * 5) / SUBJ_ANS_TOTAL,1)  ELSE 0 END AS SUBJ_ANS_AVG, ";
		sql_LIST = sql_LIST + "    CASE WHEN STIME_ANS_TOTAL > 0 THEN ROUND((STIME_ANS1 * 1 + STIME_ANS2 * 2 + STIME_ANS3 * 3 + STIME_ANS4 * 4 + STIME_ANS5 * 5) / STIME_ANS_TOTAL,1) ELSE 0 END  AS STIME_ANS_AVG, ";
		sql_LIST = sql_LIST + "    CASE WHEN TUTOR_ANS_TOTAL > 0 THEN ROUND((TUTOR_ANS1 * 1 + TUTOR_ANS2 * 2 + TUTOR_ANS3 * 3 + TUTOR_ANS4 * 4 + TUTOR_ANS5 * 5) / TUTOR_ANS_TOTAL,1) ELSE 0 END AS TUTOR_ANS_AVG, ";
	...
	private void setFieldVariableFromLIST() throws Exception{
		...
		LIST_SUBJ_ANS11=LIST.getDouble(5);
		LIST_SUBJ_ANS22=LIST.getDouble(6);
		LIST_SUBJ_ANS33=LIST.getDouble(7);
		LIST_SUBJ_ANS_TOTAL=LIST.getDouble(8);
		LIST_STIME_ANS11=LIST.getDouble(9);
		LIST_STIME_ANS22=LIST.getDouble(10);
		LIST_STIME_ANS33=LIST.getDouble(11);
		LIST_STIME_ANS_TOTAL=LIST.getDouble(12);
		LIST_TUTOR_ANS11=LIST.getDouble(13);
		LIST_TUTOR_ANS22=LIST.getDouble(14);
		LIST_TUTOR_ANS33=LIST.getDouble(15);
		LIST_TUTOR_ANS_TOTAL=LIST.getDouble(16);
		LIST_SUBJ_ANS11_RAT=LIST.getDouble(17);
		LIST_SUBJ_ANS22_RAT=LIST.getDouble(18);
		LIST_SUBJ_ANS33_RAT=LIST.getDouble(19);
		LIST_STIME_ANS11_RAT=LIST.getDouble(20);
		LIST_STIME_ANS22_RAT=LIST.getDouble(21);
		LIST_STIME_ANS33_RAT=LIST.getDouble(22);
		LIST_TUTOR_ANS11_RAT=LIST.getDouble(23);
		LIST_TUTOR_ANS22_RAT=LIST.getDouble(24);
		LIST_TUTOR_ANS33_RAT=LIST.getDouble(25);
		LIST_SUBJ_ANS_AVG=LIST.getDouble(26);
		LIST_STIME_ANS_AVG=LIST.getDouble(27);
		LIST_TUTOR_ANS_AVG=LIST.getDouble(28);
		LIST_TOTAL_AVG=LIST.getDouble(29);
	}
	...
	private void setFieldInitFromLIST(){
		...
		LIST_SUBJ_ANS11_RAT=0;
		LIST_SUBJ_ANS22_RAT=0;
		LIST_SUBJ_ANS33_RAT=0;
		LIST_STIME_ANS11_RAT=0;
		LIST_STIME_ANS22_RAT=0;
		LIST_STIME_ANS33_RAT=0;
		LIST_TUTOR_ANS11_RAT=0;
		LIST_TUTOR_ANS22_RAT=0;
		LIST_TUTOR_ANS33_RAT=0;
		LIST_SUBJ_ANS_AVG=0;
	...
	private void setFieldVariableFromQUESTION_LIST() throws Exception{
		...
		QUESTION_LIST_ANSCNT1_RAT=QUESTION_LIST.getDouble(13);
		QUESTION_LIST_ANSCNT2_RAT=QUESTION_LIST.getDouble(14);
		QUESTION_LIST_ANSCNT3_RAT=QUESTION_LIST.getDouble(15);
		QUESTION_LIST_RAT_CNT=GetB(QUESTION_LIST.getString(16));
		QUESTION_LIST_RAT=GetB(QUESTION_LIST.getString(17));
	}
	...
	private void initConstVarient(){
		...
		sheet40_J12="40~59점";
		sheet40_L12="40점 미만";
		sheet40_A13="* 자료 : 교육과정 평가 매뉴얼, 행정안전부 지방행정연수원, 2008, 68쪽 내용을 참고해서 작성";
		sheet50_A1=5;
		sheet50_B1=" 기타 의견";
