...
class ReportHandler{
	...
	private void getScriptFromQUESTION1(boolean bIsPrint) throws Exception{
		...
		while(QUESTION1.next()){   //자동으로 생성되는 반복 밴드의 루프문
			...
			nAutoHeight_QUESTION1[0]=getPrintHeight(sheet40_A4, charWidth, 11, 513, 22, nAutoHeight_QUESTION1[0]);
	...
	private void getScriptFromQUESTION2(boolean bIsPrint) throws Exception{
		...
		while(QUESTION2.next()){   //자동으로 생성되는 반복 밴드의 루프문
			...
			nAutoHeight_QUESTION2[0]=getPrintHeight(sheet40_A7, charWidth, 11, 513, 22, nAutoHeight_QUESTION2[0]);
	...
	private void getScriptFromESTIMATE_TUTOR(boolean bIsPrint) throws Exception{
		...
		while(LIST.next()){   //자동으로 생성되는 반복 밴드의 루프문
			...
			sheet40_A11= " - 강의기법 ( 만족 : " + LIST_SUBJ_ANS11_RAT + ", 보통 : " + LIST_SUBJ_ANS22_RAT + ", 미흡 : " + LIST_SUBJ_ANS33_RAT + ", 평균: " + LIST_SUBJ_ANS_AVG + ")";
			sheet40_D11=LIST_SUBJ_ANS11_RAT;
			sheet40_E11=LIST_SUBJ_ANS22_RAT;
			sheet40_F11=LIST_SUBJ_ANS33_RAT;
			sheet40_G11=LIST_SUBJ_ANS_AVG;
			sheet40_A12= " - 강의태도 (만족 : " + LIST_STIME_ANS11_RAT + ", 보통 : " + LIST_STIME_ANS22_RAT + ", 미흡: " + LIST_STIME_ANS33_RAT + ", 평균: " + LIST_STIME_ANS_AVG + " )";
			sheet40_D12=LIST_STIME_ANS11_RAT;
			sheet40_E12=LIST_STIME_ANS22_RAT;
			sheet40_F12=LIST_STIME_ANS33_RAT;
			sheet40_G12=LIST_STIME_ANS_AVG;
			sheet40_A13= " - 전문성 ( 만족 :" + LIST_TUTOR_ANS11_RAT + ", 보통 :" + LIST_TUTOR_ANS22_RAT+ ", 미흡 : " + LIST_TUTOR_ANS33_RAT + ", 평균: " + LIST_TUTOR_ANS_AVG + ")";
			sheet40_D13=LIST_TUTOR_ANS11_RAT;
			sheet40_E13=LIST_TUTOR_ANS22_RAT;
			sheet40_F13=LIST_TUTOR_ANS33_RAT;
			sheet40_G13=LIST_TUTOR_ANS_AVG;
			...
			nAutoHeight_ESTIMATE_TUTOR[0]=getPrintHeight(sheet40_A10, charWidth, 11, 513, 22, nAutoHeight_ESTIMATE_TUTOR[0]);
			nAutoHeight_ESTIMATE_TUTOR[3]=getPrintHeight(sheet40_A13, charWidth, 11, 513, 44, nAutoHeight_ESTIMATE_TUTOR[3]);
	...
	private void getScriptFromJU_QUESTION_(boolean bIsPrint) throws Exception{
		...
		while(QUESTION_JU.next()){   //자동으로 생성되는 반복 밴드의 루프문
			...
			nAutoHeight_JU_QUESTION_[0]=getPrintHeight(sheet40_B21, charWidth, 11, 485, 22, nAutoHeight_JU_QUESTION_[0]);
	...
	private void writeScriptpage2_1( ) throws Exception{
		...
		out.print("^PRINT("+(nXCurPos+28)+","+(nYCurPos)+",485,0,20,0/,돋움,RGB[0,0,255],BOLD, , ,NONE,30,1)");
	...
	private void writeScriptHEADER_QUESTION1( ) throws Exception{
		//스크립트문 생성
		out.print("^PRINT("+(nXCurPos)+","+(nYCurPos)+",513,0,15,0/,바탕체,RGB[0,0,255],BOLD, , ,NONE,22,1)");
	...
	private void writeScriptQUESTION1( ) throws Exception{
		//스크립트문 생성
		out.print("^PRINT("+(nXCurPos)+","+(nYCurPos)+",513,0,11,0/,바탕체,RGB[0,0,0], , , ,XL,"+(nAutoHeight_QUESTION1[0])+",1)");
	...
	private void writeScriptHEADER_QUESTION2( ) throws Exception{
		//스크립트문 생성
		out.print("^PRINT("+(nXCurPos)+","+(nYCurPos+22)+",513,0,15,0/,바탕체,RGB[0,0,255],BOLD, , ,NONE,22,1)");
	...
	private void writeScriptQUESTION2( ) throws Exception{
		//스크립트문 생성
		out.print("^PRINT("+(nXCurPos)+","+(nYCurPos)+",513,0,11,0/,바탕체,RGB[0,0,0], , , ,XL,"+(nAutoHeight_QUESTION2[0])+",1)");
	...
	private void writeScriptESTIMATE_TUTOR( ) throws Exception{
		//스크립트문 생성
		out.print("^PRINT("+(nXCurPos)+","+(nYCurPos)+",513,0,11,0/,굴림체,RGB[0,0,0], , , ,XL,"+(nAutoHeight_ESTIMATE_TUTOR[0])+",1)");
		out.println(sheet40_A10+"\r");
		out.print("^PRINT("+(nXCurPos)+","+(nYCurPos+nAutoHeight_ESTIMATE_TUTOR[0])+",513,0,11,0/,굴림체,RGB[0,0,0], , , ,NONE,"+(nAutoHeight_ESTIMATE_TUTOR[1]-nAutoHeight_ESTIMATE_TUTOR[0])+",1)");
		out.println(sheet40_A11+"\r");
		out.print("^PRINT("+(nXCurPos)+","+(nYCurPos+nAutoHeight_ESTIMATE_TUTOR[1])+",513,0,11,0/,굴림체,RGB[0,0,0], , , ,NONE,"+(nAutoHeight_ESTIMATE_TUTOR[2]-nAutoHeight_ESTIMATE_TUTOR[1])+",1)");
		out.println(sheet40_A12+"\r");
		out.print("^PRINT("+(nXCurPos)+","+(nYCurPos+nAutoHeight_ESTIMATE_TUTOR[2])+",513,0,11,0/,굴림체,RGB[0,0,0], , , ,XL,"+(nAutoHeight_ESTIMATE_TUTOR[3]-nAutoHeight_ESTIMATE_TUTOR[2])+",1)");
	...
	private void writeScriptNONE_QUESTION( ) throws Exception{
		...
		out.print("^PRINT("+(nXCurPos)+","+(nYCurPos+66)+",513,0,15,0/,바탕체,RGB[0,0,255],BOLD, , ,NONE,22,1)");
	...
	private void writeScriptJU_QUESTION_( ) throws Exception{
		//스크립트문 생성
		out.print("^PRINT("+(nXCurPos+28)+","+(nYCurPos)+",485,0,11,0/,굴림체,RGB[0,0,0], , , ,XL,"+(nAutoHeight_JU_QUESTION_[0])+",1)");
