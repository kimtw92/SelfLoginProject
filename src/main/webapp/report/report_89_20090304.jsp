...
class ReportHandler{
	...
	String sheet20_G7;
	String sheet20_A9;
	int[] nAutoHeight_ESTIMATE_TUTOR=new int[5];
	String sheet20_A10;
	String sheet20_D10;
	String sheet20_E10;
	String sheet20_A11;
	...
	String sheet20_A18;
	String sheet20_A20;
	int[] nAutoHeight_JU_QUESTION_=new int[2];
	String sheet20_B21;
	String sheet20_A24;
	String sheet20_B25;
	...
	private void executeSheet20( ) throws Exception{
		...
		getScriptFromQUESTION2(true);    //반복 밴드 호출
		getScriptFromHEADER_QUESTION3(true, true);    //Void 밴드 호출
		getScriptFromHEADER_QUESTION5(true, true);    //Void 밴드 호출
		getScriptFromESTIMATE_TUTOR(true);    //반복 밴드 호출
		getScriptFromNONE_QUESTION(true, true);    //Void 밴드 호출
		getScriptFromVoidBand2018(true, true);    //Void 밴드 호출
		getScriptFromJU_QUESTION_(true);    //반복 밴드 호출
		getScriptFromVoidBand2020(true, true);    //Void 밴드 호출
	...
	//-----QUESTION2 RepeatBand Start-----
	//-----소속 쉬트 : SHEET=Sheet2   FRAME=Frame0
	//-----밴드 이름 : QUESTION2
	//-----밴드 종류 : 반복 밴드
	//-----bIsPrint : 감추기 속성 설정 여부 true면 출력, false면 스크립트를 생성하지 않음
	private void getScriptFromQUESTION2(boolean bIsPrint) throws Exception{
		//지역 변수 선언 및 초기화
		int nBandHeight=22;    //밴드 출력 높이
		boolean bIsFirst=true;
		//폰트명 : 바탕체
		...
		while(QUESTION2.next()){   //자동으로 생성되는 반복 밴드의 루프문
			...
			nBandHeight=nAutoHeight_QUESTION2[0];   //밴드 출력 높이 설정
	...
	//-----ESTIMATE_TUTOR RepeatBand Start-----
	//-----소속 쉬트 : SHEET=Sheet2   FRAME=Frame0
	//-----밴드 이름 : ESTIMATE_TUTOR
	//-----밴드 종류 : 반복 밴드
	//-----bIsPrint : 감추기 속성 설정 여부 true면 출력, false면 스크립트를 생성하지 않음
	private void getScriptFromESTIMATE_TUTOR(boolean bIsPrint) throws Exception{
		//지역 변수 선언 및 초기화
		int nBandHeight=110;    //밴드 출력 높이
		boolean bIsFirst=true;
		//폰트명 : 굴림체
		//폰트 사이즈 : 11
		//각 문자별 폭을 할당할 배열 선언
		...
		while(LIST.next()){   //자동으로 생성되는 반복 밴드의 루프문
			...
			//데이터 변수 할당
			sheet20_A10= " ○" +LIST_SUBJNM + " (" + LIST_NAME + ")";
			sheet20_D10=LIST_SUBJNM;
			sheet20_E10=LIST_NAME;
			sheet20_A11= " - 교육내용 ( 매우우수 : " + LIST_SUBJ_ANS1_RAT + "%, 우수 : " + LIST_SUBJ_ANS2_RAT + "%, 보통 : " + LIST_SUBJ_ANS3_RAT + "%, 미흡: " + LIST_SUBJ_ANS4_RAT + "% )";
			sheet20_D11=LIST_SUBJ_ANS1_RAT;
			sheet20_E11=LIST_SUBJ_ANS2_RAT;
			sheet20_F11=LIST_SUBJ_ANS3_RAT;
			sheet20_G11=LIST_SUBJ_ANS4_RAT;
			sheet20_A12= " - 시간배정 (적정 : " + LIST_STIME_ANS1_RAT + "%, 연장 : " + LIST_STIME_ANS2_RAT + "%, 단축: " + LIST_STIME_ANS3_RAT + "%)";
			sheet20_D12=LIST_STIME_ANS1_RAT;
			sheet20_E12=LIST_STIME_ANS2_RAT;
			sheet20_F12=LIST_STIME_ANS3_RAT;
			sheet20_A13= " - 강사평가 ( 매우우수 :" + LIST_TUTOR_ANS1_RAT + "%, 우수 :" + LIST_TUTOR_ANS2_RAT+ "%, 보통 : " + LIST_TUTOR_ANS3_RAT + "%, 미흡: " + LIST_TUTOR_ANS4_RAT + "%)";
			sheet20_D13=LIST_TUTOR_ANS1_RAT;
			sheet20_E13=LIST_TUTOR_ANS2_RAT;
			sheet20_F13=LIST_TUTOR_ANS3_RAT;
			sheet20_G13=LIST_TUTOR_ANS4_RAT;

			//Auto Size Code
			nAutoHeight_ESTIMATE_TUTOR[0]=0;
			nAutoHeight_ESTIMATE_TUTOR[1]=0;
			nAutoHeight_ESTIMATE_TUTOR[2]=0;
			nAutoHeight_ESTIMATE_TUTOR[3]=0;
			nAutoHeight_ESTIMATE_TUTOR[4]=0;
			nAutoHeight_ESTIMATE_TUTOR[0]=getPrintHeight(sheet20_A10, charWidth, 11, 512, 22, nAutoHeight_ESTIMATE_TUTOR[0]);
			nAutoHeight_ESTIMATE_TUTOR[3]=getPrintHeight(sheet20_A13, charWidth, 11, 512, 22, nAutoHeight_ESTIMATE_TUTOR[3]);
			nAutoHeight_ESTIMATE_TUTOR[0]=nAutoHeight_ESTIMATE_TUTOR[0]+22;
			nAutoHeight_ESTIMATE_TUTOR[1]=nAutoHeight_ESTIMATE_TUTOR[0]+nAutoHeight_ESTIMATE_TUTOR[1]+22;
			nAutoHeight_ESTIMATE_TUTOR[2]=nAutoHeight_ESTIMATE_TUTOR[1]+nAutoHeight_ESTIMATE_TUTOR[2]+22;
			nAutoHeight_ESTIMATE_TUTOR[3]=nAutoHeight_ESTIMATE_TUTOR[2]+nAutoHeight_ESTIMATE_TUTOR[3]+22;
			nAutoHeight_ESTIMATE_TUTOR[4]=nAutoHeight_ESTIMATE_TUTOR[3]+nAutoHeight_ESTIMATE_TUTOR[4]+22;
			nBandHeight=nAutoHeight_ESTIMATE_TUTOR[4];   //밴드 출력 높이 설정
	...
	//----bIsPrint : 감추기 속성 설정 여부. true면 출력, false면 AI 스크립트를 생성하지 않음.
	//----nRepeatCnt : 부모 반복 밴드 수행 횟수와 연동 옵션 설정시 void 밴드가 수행할 반복 횟수 전달
	private void getScriptFromNONE_QUESTION(boolean bIsFirst, boolean bIsPrint) throws Exception{
		//지역 변수 선언 및 초기화
	...
	//----bIsPrint : 감추기 속성 설정 여부. true면 출력, false면 AI 스크립트를 생성하지 않음.
	//----nRepeatCnt : 부모 반복 밴드 수행 횟수와 연동 옵션 설정시 void 밴드가 수행할 반복 횟수 전달
	private void getScriptFromVoidBand2018(boolean bIsFirst, boolean bIsPrint) throws Exception{
		//지역 변수 선언 및 초기화
		int nBandHeight=44;    //밴드 출력 높이
	...
	private void getScriptFromJU_QUESTION_(boolean bIsPrint) throws Exception{
		...
		while(QUESTION_JU.next()){   //자동으로 생성되는 반복 밴드의 루프문
			...
			//데이터 변수 할당
			sheet20_B21=QUESTION_JU_QUESTION;

			//Auto Size Code
			nAutoHeight_JU_QUESTION_[0]=0;
			nAutoHeight_JU_QUESTION_[1]=0;
			nAutoHeight_JU_QUESTION_[0]=getPrintHeight(sheet20_B21, charWidth, 11, 484, 22, nAutoHeight_JU_QUESTION_[0]);
			nAutoHeight_JU_QUESTION_[0]=nAutoHeight_JU_QUESTION_[0]+22;
			nAutoHeight_JU_QUESTION_[1]=nAutoHeight_JU_QUESTION_[0]+nAutoHeight_JU_QUESTION_[1]+5;
			nBandHeight=nAutoHeight_JU_QUESTION_[1];   //밴드 출력 높이 설정
	...
	//----bIsPrint : 감추기 속성 설정 여부. true면 출력, false면 AI 스크립트를 생성하지 않음.
	//----nRepeatCnt : 부모 반복 밴드 수행 횟수와 연동 옵션 설정시 void 밴드가 수행할 반복 횟수 전달
	private void getScriptFromVoidBand2020(boolean bIsFirst, boolean bIsPrint) throws Exception{
		//지역 변수 선언 및 초기화
		int nBandHeight=44;    //밴드 출력 높이
	...
	private void writeScriptpage2_1( ) throws Exception{
		...
		out.print("^PRINT("+(nXCurPos+28)+","+(nYCurPos)+",484,0,20,0/,돋움,RGB[0,0,255],BOLD, , ,NONE,30,1)");
	...
	//----ESTIMATE_TUTOR 스크립트 문 출력 함수----
	private void writeScriptESTIMATE_TUTOR( ) throws Exception{
		//스크립트문 생성
		out.print("^PRINT("+(nXCurPos)+","+(nYCurPos)+",512,0,11,0/,굴림체,RGB[0,0,0], , , ,XL,"+(nAutoHeight_ESTIMATE_TUTOR[0])+",1)");
		out.println(sheet20_A10+"\r");
		out.print("^PRINT("+(nXCurPos)+","+(nYCurPos+nAutoHeight_ESTIMATE_TUTOR[0])+",512,0,11,0/,굴림체,RGB[0,0,0], , , ,NONE,"+(nAutoHeight_ESTIMATE_TUTOR[1]-nAutoHeight_ESTIMATE_TUTOR[0])+",1)");
		out.println(sheet20_A11+"\r");
		out.print("^PRINT("+(nXCurPos)+","+(nYCurPos+nAutoHeight_ESTIMATE_TUTOR[1])+",512,0,11,0/,굴림체,RGB[0,0,0], , , ,NONE,"+(nAutoHeight_ESTIMATE_TUTOR[2]-nAutoHeight_ESTIMATE_TUTOR[1])+",1)");
		out.println(sheet20_A12+"\r");
		out.print("^PRINT("+(nXCurPos)+","+(nYCurPos+nAutoHeight_ESTIMATE_TUTOR[2])+",512,0,11,0/,굴림체,RGB[0,0,0], , , ,XL,"+(nAutoHeight_ESTIMATE_TUTOR[3]-nAutoHeight_ESTIMATE_TUTOR[2])+",1)");
		out.println(sheet20_A13+"\r");
	}

	//----NONE_QUESTION 스크립트 문 출력 함수----
	private void writeScriptNONE_QUESTION( ) throws Exception{
		//스크립트문 생성
		out.print("^PRINT("+(nXCurPos)+","+(nYCurPos+22)+",512,0,15,0/,바탕체,RGB[0,0,255],BOLD, , ,NONE,22,1)");
	...
	//----VoidBand2018 스크립트 문 출력 함수----
	private void writeScriptVoidBand2018( ) throws Exception{
		//스크립트문 생성
		out.print("^PRINT("+(nXCurPos)+","+(nYCurPos+22)+",512,0,15,0/,바탕,RGB[0,0,255],BOLD, , ,NONE,22,1)");
	...
	private void writeScriptJU_QUESTION_( ) throws Exception{
		//스크립트문 생성
		out.print("^PRINT("+(nXCurPos+28)+","+(nYCurPos)+",484,0,11,0/,굴림체,RGB[0,0,0], , , ,XL,"+(nAutoHeight_JU_QUESTION_[0])+",1)");
		out.println(sheet20_B21+"\r");
	}

	//----VoidBand2020 스크립트 문 출력 함수----
	private void writeScriptVoidBand2020( ) throws Exception{
		//스크립트문 생성
		out.print("^PRINT("+(nXCurPos)+","+(nYCurPos+22)+",512,0,15,0/,바탕체,RGB[0,0,255],BOLD, , ,NONE,22,1)");
	...
	private void initSQLConst(){
		...
		sql_LIST = sql_LIST + "  round(((select round((nvl(sum(decode(ans_no,1,1,0)),0)+nvl(sum(decode(ans_no,2,1,0)),0))/decode(count(ans_no),0,1,count(ans_no))*100,2) from tb_grinq_answer where question_no = a.question_no and title_no = a.title_no and set_no = a.set_no and ans_no !=0)+(select round((nvl(sum(decode(ans_no,1,1,0)),0)+nvl(sum(decode(ans_no,2,1,0)),0))/decode(count(ans_no),0,1,count(ans_no))*100,2) from tb_grinq_answer where question_no = a.question_no -2 and title_no = a.title_no and set_no = a.set_no and ans_no !=0))/2, 2)||'%' as tutor_rat ";
		...
		sql_QUESTION1 = sql_QUESTION1 + "    AND a.question_no <= (decode(c.question_comm_gubun,5,5,3,4,5)) ";
		...
		sql_QUESTION2 = sql_QUESTION2 + "    between (decode(c.question_comm_gubun,5,6,3,5,6)) ";
	...
	private void initConstVarient(){
		...
		sheet10_A26="계";
		sheet20_A1=4;
		sheet20_B1=" 분야별 설문 조사 결과";
		sheet20_A3=" ① 교육성과 및 운영";
		sheet20_A6=" ② 교육시설 이용";
		sheet20_A9=" ③ 교과목 및 강사 평가";
		sheet20_A16=" ④ 폐지 및 신설 희망과목";
		sheet20_A18=" ⑤ 추천하고 싶은 강사";
		sheet20_A20=" - 주관식에 대한 질문입니다.";
