...
class ReportHandler{
	...
	private double QUESTION_LIST_ANSCNT4_RAT;
	private double QUESTION_LIST_ANSCNT5_RAT;
	...
	private double LIST_TOTAL_ANS_AVG;
	private double LIST_TOTAL_AVG;
	...
	private void executeSheet30( ) throws Exception{
		...
		getScriptFrompage_3_note(true, true);    //Void 밴드 호출
	...
	private void executeSheet40( ) throws Exception{
		...
		getScriptFrompage_4_note1(true, true);    //Void 밴드 호출
	...
	private void getScriptFromquestion_list(boolean bIsPrint) throws Exception{
		...
		while(QUESTION_LIST.next()){   //자동으로 생성되는 반복 밴드의 루프문
			...
			sheet30_C5=QUESTION_LIST_ANSCNT5_RAT;
			sheet30_D5=QUESTION_LIST_ANSCNT4_RAT;
			sheet30_E5=QUESTION_LIST_ANSCNT3_RAT;
			sheet30_F5=QUESTION_LIST_ANSCNT2_RAT;
			sheet30_G5=QUESTION_LIST_ANSCNT1_RAT;
			sheet30_H5=QUESTION_LIST_RAT;
			...
			nHeightTmp=getPrintHeight(sheet30_B5, charWidth, 10, 227, 38, nAutoHeight_question_list[0]);
			...
			nAutoHeight_question_list[1]=nAutoHeight_question_list[0]+nAutoHeight_question_list[1]+18;
	...
	//----bIsPrint : 감추기 속성 설정 여부. true면 출력, false면 AI 스크립트를 생성하지 않음.
	//----nRepeatCnt : 부모 반복 밴드 수행 횟수와 연동 옵션 설정시 void 밴드가 수행할 반복 횟수 전달
	private void getScriptFrompage_3_note(boolean bIsFirst, boolean bIsPrint) throws Exception{
		//지역 변수 선언 및 초기화
		int nBandHeight=20;    //밴드 출력 높이
	...
	private void getScriptFromlist(boolean bIsPrint) throws Exception{
		...
		while(LIST.next()){   //자동으로 생성되는 반복 밴드의 루프문
			...
			sheet40_D5=String.valueOf(LIST_SUBJ_ANS5);
			sheet40_E5=String.valueOf(LIST_SUBJ_ANS4);
			sheet40_F5=String.valueOf(LIST_SUBJ_ANS3);
			sheet40_G5=String.valueOf(LIST_SUBJ_ANS2);
			sheet40_H5=String.valueOf(LIST_SUBJ_ANS1);
			sheet40_I5=String.valueOf(LIST_SUBJ_ANS_AVG);
			sheet40_J5=String.valueOf(LIST_TOTAL_AVG);
			sheet40_D6=String.valueOf(LIST_STIME_ANS5);
			sheet40_E6=String.valueOf(LIST_STIME_ANS4);
			sheet40_F6=String.valueOf(LIST_STIME_ANS3);
			sheet40_G6=String.valueOf(LIST_STIME_ANS2);
			sheet40_H6=String.valueOf(LIST_STIME_ANS1);
			sheet40_I6=String.valueOf(LIST_STIME_ANS_AVG);
			sheet40_D7=String.valueOf(LIST_TUTOR_ANS5);
			sheet40_E7=String.valueOf(LIST_TUTOR_ANS4);
			sheet40_F7=String.valueOf(LIST_TUTOR_ANS3);
			sheet40_G7=String.valueOf(LIST_TUTOR_ANS2);
			sheet40_H7=String.valueOf(LIST_TUTOR_ANS1);
			sheet40_I7=String.valueOf(LIST_TUTOR_ANS_AVG);
			sheet40_J7=String.valueOf(LIST_TOTAL_ANS_AVG);
			...
			nHeightTmp=getPrintHeight(sheet40_A5, charWidth, 10, 147, 61, nAutoHeight_list[0]);
			...
			nAutoHeight_list[2]=nAutoHeight_list[1]+nAutoHeight_list[2]+21;
	...
	//----bIsPrint : 감추기 속성 설정 여부. true면 출력, false면 AI 스크립트를 생성하지 않음.
	//----nRepeatCnt : 부모 반복 밴드 수행 횟수와 연동 옵션 설정시 void 밴드가 수행할 반복 횟수 전달
	private void getScriptFrompage_4_note1(boolean bIsFirst, boolean bIsPrint) throws Exception{
		//지역 변수 선언 및 초기화
		int nBandHeight=20;    //밴드 출력 높이
	...
	private void writeScriptpage1( ) throws Exception{
		...
		out.print("^PRINT("+(nXCurPos+108)+","+(nYCurPos+216)+",366,0,13,0/,바탕체,RGB[0,0,0], , , ,NONE,25,1)");
		...
		out.println("^CELLLINE("+(nXCurPos+70)+","+(nYCurPos+419)+",57,40,1,RGB[0,0,0],0)\r");
		...
		out.print("^PRINT("+(nXCurPos+70)+","+(nYCurPos+419)+",57,1,11,0/,바탕,RGB[0,0,0],BOLD, , ,NONE,40,1)");
		out.println(sheet10_C18+"\r");
		out.println("^CELLBG("+(nXCurPos+127)+","+(nYCurPos+419)+",52,40,1,RGB[247,89,251],RGB[247,89,251],0)\r");
		out.println("^CELLLINE("+(nXCurPos+127)+","+(nYCurPos+419)+",52,40,1,RGB[0,0,0],0)\r");
		...
		out.print("^PRINT("+(nXCurPos+127)+","+(nYCurPos+419)+",52,1,11,0/,바탕,RGB[0,0,0],BOLD, , ,NONE,40,1)");
		out.println(sheet10_E18+"\r");
		out.println("^CELLBG("+(nXCurPos+179)+","+(nYCurPos+419)+",224,20,1,RGB[247,89,251],RGB[247,89,251],0)\r");
		out.println("^CELLLINE("+(nXCurPos+179)+","+(nYCurPos+419)+",224,20,1,RGB[0,0,0],0)\r");
		...
		out.print("^PRINT("+(nXCurPos+179)+","+(nYCurPos+419)+",224,1,11,0/,바탕,RGB[0,0,0],BOLD, , ,NONE,20,1)");
		out.println(sheet10_F18+"\r");
		out.println("^CELLBG("+(nXCurPos+403)+","+(nYCurPos+419)+",71,40,1,RGB[247,89,251],RGB[247,89,251],0)\r");
		out.println("^CELLLINE("+(nXCurPos+403)+","+(nYCurPos+419)+",71,40,1,RGB[0,0,0],0)\r");
		...
		out.println("^CELLLINE("+(nXCurPos+403)+","+(nYCurPos+419)+",71,40,1,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos+403)+","+(nYCurPos+419)+",71,1,11,0/,바탕,RGB[0,0,0],BOLD, , ,NONE,40,1)");
		...
		out.print("^PRINT("+(nXCurPos+179)+","+(nYCurPos+439)+",54,1,11,0/,바탕,RGB[0,0,0],BOLD, , ,NONE,20,1)");
		...
		out.print("^PRINT("+(nXCurPos+233)+","+(nYCurPos+439)+",54,1,11,0/,바탕,RGB[0,0,0],BOLD, , ,NONE,20,1)");
		...
		out.print("^PRINT("+(nXCurPos+287)+","+(nYCurPos+439)+",54,1,11,0/,바탕,RGB[0,0,0],BOLD, , ,NONE,20,1)");
		out.println(sheet10_H19+"\r");
		out.println("^CELLBG("+(nXCurPos+341)+","+(nYCurPos+439)+",62,20,1,RGB[247,89,251],RGB[247,89,251],0)\r");
		out.print("^PRINT("+(nXCurPos+341)+","+(nYCurPos+439)+",62,1,11,0/,바탕,RGB[0,0,0],BOLD, , ,NONE,20,1)");
		...
		out.print("^PRINT("+(nXCurPos+70)+","+(nYCurPos+459)+",57,1,11,0/,굴림체,RGB[0,0,0], , , ,NONE,20,1)");
		...
		out.println("^CELLLINE("+(nXCurPos+403)+","+(nYCurPos+459)+",71,20,1,RGB[0,0,0],3)\r");
		...
		out.println("^CELLLINE("+(nXCurPos+70)+","+(nYCurPos+479)+",57,20,1,RGB[0,0,0],1)\r");
		...
		out.println("^CELLLINE("+(nXCurPos+127)+","+(nYCurPos+479)+",52,20,1,RGB[0,0,0],1)\r");
		...
		out.println("^CELLLINE("+(nXCurPos+179)+","+(nYCurPos+479)+",54,20,1,RGB[0,0,0],1)\r");
		...
		out.println("^CELLLINE("+(nXCurPos+233)+","+(nYCurPos+479)+",54,20,1,RGB[0,0,0],1)\r");
		...
		out.println("^CELLLINE("+(nXCurPos+287)+","+(nYCurPos+479)+",54,20,1,RGB[0,0,0],1)\r");
		...
		out.println("^CELLLINE("+(nXCurPos+341)+","+(nYCurPos+479)+",62,20,1,RGB[0,0,0],1)\r");
		...
		out.println("^CELLLINE("+(nXCurPos+403)+","+(nYCurPos+479)+",71,20,1,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos+403)+","+(nYCurPos+479)+",71,20,0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos+403)+","+(nYCurPos+479)+",71,20,1,RGB[0,0,0],3)\r");
		...
		out.println("^CELLLINE("+(nXCurPos)+","+(nYCurPos+572)+",108,20,1,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos)+","+(nYCurPos+572)+",108,20,0,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos)+","+(nYCurPos+572)+",108,20,1,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos)+","+(nYCurPos+572)+",108,20,0,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos)+","+(nYCurPos+572)+",108,1,11,0/,바탕,RGB[0,0,0],BOLD, , ,NONE,20,1)");
		out.println(sheet10_A25+"\r");
		out.println("^CELLBG("+(nXCurPos+108)+","+(nYCurPos+572)+",71,20,1,RGB[247,89,251],RGB[247,89,251],0)\r");
		out.println("^CELLLINE("+(nXCurPos+108)+","+(nYCurPos+572)+",71,20,1,RGB[0,0,0],0)\r");
		...
		out.print("^PRINT("+(nXCurPos+108)+","+(nYCurPos+572)+",71,1,11,0/,바탕,RGB[0,0,0],BOLD, , ,NONE,20,1)");
		out.println(sheet10_D25+"\r");
		out.println("^CELLBG("+(nXCurPos+179)+","+(nYCurPos+572)+",108,20,1,RGB[247,89,251],RGB[247,89,251],0)\r");
		out.println("^CELLLINE("+(nXCurPos+179)+","+(nYCurPos+572)+",108,20,1,RGB[0,0,0],0)\r");
		...
		out.print("^PRINT("+(nXCurPos+179)+","+(nYCurPos+572)+",108,1,11,0/,바탕,RGB[0,0,0],BOLD, , ,NONE,20,1)");
		out.println(sheet10_F25+"\r");
		out.println("^CELLBG("+(nXCurPos+287)+","+(nYCurPos+572)+",187,20,1,RGB[247,89,251],RGB[247,89,251],0)\r");
		out.println("^CELLLINE("+(nXCurPos+287)+","+(nYCurPos+572)+",187,20,1,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos+287)+","+(nYCurPos+572)+",187,20,0,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos+287)+","+(nYCurPos+572)+",187,20,0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos+287)+","+(nYCurPos+572)+",187,20,1,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos+287)+","+(nYCurPos+572)+",187,1,11,0/,바탕,RGB[0,0,0],BOLD, , ,NONE,20,1)");
	...
	private void writeScriptcon( ) throws Exception{
		...
		out.print("^PRINT("+(nXCurPos+108)+","+(nYCurPos)+",71,1,11,1/0/0,굴림체,RGB[0,0,0], , , ,NONE,20,1)");
		...
		out.print("^PRINT("+(nXCurPos+179)+","+(nYCurPos)+",108,1,11,1/0/0,굴림체,RGB[0,0,0], , , ,NONE,20,1)");
		out.println(sheet10_F26+"\r");
		out.println("^CELLLINE("+(nXCurPos+287)+","+(nYCurPos)+",187,20,0,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos+287)+","+(nYCurPos)+",187,20,0,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos+287)+","+(nYCurPos)+",187,20,0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos+287)+","+(nYCurPos)+",187,20,1,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos+287)+","+(nYCurPos)+",187,1,11,1/0/0,굴림체,RGB[0,0,0], , , ,NONE,20,1)");
	...
	private void writeScriptline( ) throws Exception{
		//스크립트문 생성
		out.println("^CELLLINE("+(nXCurPos)+","+(nYCurPos)+",108,20,0,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos)+","+(nYCurPos)+",108,20,1,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos)+","+(nYCurPos)+",108,20,1,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos)+","+(nYCurPos)+",108,20,0,RGB[0,0,0],3)\r");
		out.println("^CELLLINE("+(nXCurPos+108)+","+(nYCurPos)+",71,20,0,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos+108)+","+(nYCurPos)+",71,20,1,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos+108)+","+(nYCurPos)+",71,20,0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos+108)+","+(nYCurPos)+",71,20,0,RGB[0,0,0],3)\r");
		out.println("^CELLLINE("+(nXCurPos+179)+","+(nYCurPos)+",108,20,0,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos+179)+","+(nYCurPos)+",108,20,1,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos+179)+","+(nYCurPos)+",108,20,0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos+179)+","+(nYCurPos)+",108,20,0,RGB[0,0,0],3)\r");
		out.println("^CELLLINE("+(nXCurPos+287)+","+(nYCurPos)+",187,20,0,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos+287)+","+(nYCurPos)+",187,20,1,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos+287)+","+(nYCurPos)+",187,20,0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos+287)+","+(nYCurPos)+",187,20,1,RGB[0,0,0],3)\r");
	}
	...
	private void writeScriptquestion_list_header( ) throws Exception{
		//스크립트문 생성
		out.println("^CELLBG("+(nXCurPos)+","+(nYCurPos)+",259,20,1,RGB[255,192,203],RGB[255,192,203],0)\r");
		out.println("^CELLLINE("+(nXCurPos)+","+(nYCurPos)+",259,20,0,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos)+","+(nYCurPos)+",259,20,0,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos)+","+(nYCurPos)+",259,20,0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos)+","+(nYCurPos)+",259,20,0,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos)+","+(nYCurPos)+",259,1,12,0/,바탕,RGB[0,0,0],BOLD, , ,NONE,20,1)");
		out.println(sheet30_A3+"\r");
		out.println("^CELLBG("+(nXCurPos+259)+","+(nYCurPos)+",170,20,1,RGB[255,192,203],RGB[255,192,203],0)\r");
		out.println("^CELLLINE("+(nXCurPos+259)+","+(nYCurPos)+",170,20,0,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos+259)+","+(nYCurPos)+",170,20,0,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos+259)+","+(nYCurPos)+",170,20,0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos+259)+","+(nYCurPos)+",170,20,0,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos+259)+","+(nYCurPos)+",170,1,10,0/,굴림체,RGB[0,0,0], , , ,NONE,20,1)");
		out.println(sheet30_C3+"\r");
		out.println("^CELLBG("+(nXCurPos+429)+","+(nYCurPos)+",43,40,1,RGB[255,192,203],RGB[255,192,203],0)\r");
		out.println("^CELLLINE("+(nXCurPos+429)+","+(nYCurPos)+",43,40,0,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos+429)+","+(nYCurPos)+",43,40,0,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos+429)+","+(nYCurPos)+",43,40,0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos+429)+","+(nYCurPos)+",43,40,0,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos+429)+","+(nYCurPos)+",43,1,10,0/,바탕,RGB[0,0,0],BOLD, , ,NONE,40,1)");
		out.println(sheet30_H3+"\r");
		out.println("^CELLBG("+(nXCurPos)+","+(nYCurPos+20)+",259,20,1,RGB[255,192,203],RGB[255,192,203],0)\r");
		out.println("^CELLLINE("+(nXCurPos)+","+(nYCurPos+20)+",259,20,0,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos)+","+(nYCurPos+20)+",259,20,0,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos)+","+(nYCurPos+20)+",259,20,0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos)+","+(nYCurPos+20)+",259,20,0,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos)+","+(nYCurPos+20)+",259,1,12,1/0/0,바탕,RGB[0,0,0],BOLD, , ,NONE,20,1)");
		out.println(sheet30_A4+"\r");
		out.println("^CELLBG("+(nXCurPos+259)+","+(nYCurPos+20)+",33,20,1,RGB[255,192,203],RGB[255,192,203],0)\r");
		out.println("^CELLLINE("+(nXCurPos+259)+","+(nYCurPos+20)+",33,20,0,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos+259)+","+(nYCurPos+20)+",33,20,0,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos+259)+","+(nYCurPos+20)+",33,20,0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos+259)+","+(nYCurPos+20)+",33,20,0,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos+259)+","+(nYCurPos+20)+",33,1,10,0/,굴림체,RGB[0,0,0], , , ,NONE,20,1)");
		out.println(sheet30_C4+"\r");
		out.println("^CELLBG("+(nXCurPos+292)+","+(nYCurPos+20)+",33,20,1,RGB[255,192,203],RGB[255,192,203],0)\r");
		out.println("^CELLLINE("+(nXCurPos+292)+","+(nYCurPos+20)+",33,20,0,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos+292)+","+(nYCurPos+20)+",33,20,0,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos+292)+","+(nYCurPos+20)+",33,20,0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos+292)+","+(nYCurPos+20)+",33,20,0,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos+292)+","+(nYCurPos+20)+",33,1,10,0/,굴림체,RGB[0,0,0], , , ,NONE,20,1)");
		out.println(sheet30_D4+"\r");
		out.println("^CELLBG("+(nXCurPos+325)+","+(nYCurPos+20)+",34,20,1,RGB[255,192,203],RGB[255,192,203],0)\r");
		out.println("^CELLLINE("+(nXCurPos+325)+","+(nYCurPos+20)+",34,20,0,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos+325)+","+(nYCurPos+20)+",34,20,0,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos+325)+","+(nYCurPos+20)+",34,20,0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos+325)+","+(nYCurPos+20)+",34,20,0,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos+325)+","+(nYCurPos+20)+",34,1,10,0/,굴림체,RGB[0,0,0], , , ,NONE,20,1)");
		out.println(sheet30_E4+"\r");
		out.println("^CELLBG("+(nXCurPos+359)+","+(nYCurPos+20)+",35,20,1,RGB[255,192,203],RGB[255,192,203],0)\r");
		out.println("^CELLLINE("+(nXCurPos+359)+","+(nYCurPos+20)+",35,20,0,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos+359)+","+(nYCurPos+20)+",35,20,0,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos+359)+","+(nYCurPos+20)+",35,20,0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos+359)+","+(nYCurPos+20)+",35,20,0,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos+359)+","+(nYCurPos+20)+",35,1,10,0/,굴림체,RGB[0,0,0], , , ,NONE,20,1)");
		out.println(sheet30_F4+"\r");
		out.println("^CELLBG("+(nXCurPos+394)+","+(nYCurPos+20)+",35,20,1,RGB[255,192,203],RGB[255,192,203],0)\r");
		out.println("^CELLLINE("+(nXCurPos+394)+","+(nYCurPos+20)+",35,20,0,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos+394)+","+(nYCurPos+20)+",35,20,0,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos+394)+","+(nYCurPos+20)+",35,20,0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos+394)+","+(nYCurPos+20)+",35,20,0,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos+394)+","+(nYCurPos+20)+",35,1,10,0/,굴림체,RGB[0,0,0], , , ,NONE,20,1)");
	...
	private void writeScriptquestion_list( ) throws Exception{
		...
		out.print("^PRINT("+(nXCurPos)+","+(nYCurPos)+",32,1,10,1/0/0,바탕,RGB[0,0,0], , , ,NONE,"+(nAutoHeight_question_list[1])+",1)");
		out.println(sheet30_A5+"\r");
		out.println("^CELLLINE("+(nXCurPos+32)+","+(nYCurPos)+",227,"+(nAutoHeight_question_list[1])+",0,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos+32)+","+(nYCurPos)+",227,"+(nAutoHeight_question_list[1])+",0,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos+32)+","+(nYCurPos)+",227,"+(nAutoHeight_question_list[1])+",0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos+32)+","+(nYCurPos)+",227,"+(nAutoHeight_question_list[1])+",0,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos+32)+","+(nYCurPos)+",227,0,10,0/,바탕,RGB[0,0,0], , , ,XL,"+(nAutoHeight_question_list[1])+",1)");
		out.println(sheet30_B5+"\r");
		out.println("^CELLLINE("+(nXCurPos+259)+","+(nYCurPos)+",33,"+(nAutoHeight_question_list[1])+",0,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos+259)+","+(nYCurPos)+",33,"+(nAutoHeight_question_list[1])+",0,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos+259)+","+(nYCurPos)+",33,"+(nAutoHeight_question_list[1])+",0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos+259)+","+(nYCurPos)+",33,"+(nAutoHeight_question_list[1])+",0,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos+259)+","+(nYCurPos)+",33,1,10,1/0/0,바탕,RGB[0,0,0], , , ,NONE,"+(nAutoHeight_question_list[1])+",1)");
		out.println(sheet30_C5+"\r");
		out.println("^CELLLINE("+(nXCurPos+292)+","+(nYCurPos)+",33,"+(nAutoHeight_question_list[1])+",0,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos+292)+","+(nYCurPos)+",33,"+(nAutoHeight_question_list[1])+",0,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos+292)+","+(nYCurPos)+",33,"+(nAutoHeight_question_list[1])+",0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos+292)+","+(nYCurPos)+",33,"+(nAutoHeight_question_list[1])+",0,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos+292)+","+(nYCurPos)+",33,1,10,1/0/0,바탕,RGB[0,0,0], , , ,NONE,"+(nAutoHeight_question_list[1])+",1)");
		out.println(sheet30_D5+"\r");
		out.println("^CELLLINE("+(nXCurPos+325)+","+(nYCurPos)+",34,"+(nAutoHeight_question_list[1])+",0,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos+325)+","+(nYCurPos)+",34,"+(nAutoHeight_question_list[1])+",0,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos+325)+","+(nYCurPos)+",34,"+(nAutoHeight_question_list[1])+",0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos+325)+","+(nYCurPos)+",34,"+(nAutoHeight_question_list[1])+",0,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos+325)+","+(nYCurPos)+",34,1,10,1/0/0,바탕,RGB[0,0,0], , , ,NONE,"+(nAutoHeight_question_list[1])+",1)");
		out.println(sheet30_E5+"\r");
		out.println("^CELLLINE("+(nXCurPos+359)+","+(nYCurPos)+",35,"+(nAutoHeight_question_list[1])+",0,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos+359)+","+(nYCurPos)+",35,"+(nAutoHeight_question_list[1])+",0,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos+359)+","+(nYCurPos)+",35,"+(nAutoHeight_question_list[1])+",0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos+359)+","+(nYCurPos)+",35,"+(nAutoHeight_question_list[1])+",0,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos+359)+","+(nYCurPos)+",35,1,10,1/0/0,바탕,RGB[0,0,0], , , ,NONE,"+(nAutoHeight_question_list[1])+",1)");
		out.println(sheet30_F5+"\r");
		out.println("^CELLLINE("+(nXCurPos+394)+","+(nYCurPos)+",35,"+(nAutoHeight_question_list[1])+",0,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos+394)+","+(nYCurPos)+",35,"+(nAutoHeight_question_list[1])+",0,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos+394)+","+(nYCurPos)+",35,"+(nAutoHeight_question_list[1])+",0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos+394)+","+(nYCurPos)+",35,"+(nAutoHeight_question_list[1])+",0,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos+394)+","+(nYCurPos)+",35,1,10,1/0/0,바탕,RGB[0,0,0], , , ,NONE,"+(nAutoHeight_question_list[1])+",1)");
		out.println(sheet30_G5+"\r");
		out.println("^CELLLINE("+(nXCurPos+429)+","+(nYCurPos)+",43,"+(nAutoHeight_question_list[0])+",0,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos+429)+","+(nYCurPos)+",43,"+(nAutoHeight_question_list[0])+",0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos+429)+","+(nYCurPos)+",43,"+(nAutoHeight_question_list[0])+",0,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos+429)+","+(nYCurPos)+",43,1,10,0/,바탕,RGB[255,0,0], , , ,NONE,"+(nAutoHeight_question_list[0])+",1)");
		out.println(sheet30_H5+"\r");
		out.println("^CELLLINE("+(nXCurPos+429)+","+(nYCurPos+nAutoHeight_question_list[0])+",43,"+(nAutoHeight_question_list[1]-nAutoHeight_question_list[0])+",0,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos+429)+","+(nYCurPos+nAutoHeight_question_list[0])+",43,"+(nAutoHeight_question_list[1]-nAutoHeight_question_list[0])+",0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos+429)+","+(nYCurPos+nAutoHeight_question_list[0])+",43,"+(nAutoHeight_question_list[1]-nAutoHeight_question_list[0])+",0,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos+429)+","+(nYCurPos+nAutoHeight_question_list[0])+",43,1,11,0/,굴림체,RGB[0,0,0], , , ,NONE,"+(nAutoHeight_question_list[1]-nAutoHeight_question_list[0])+",1)");
		out.println(sheet30_H6+"\r");
	}

	//----page_3_note 스크립트 문 출력 함수----
	private void writeScriptpage_3_note( ) throws Exception{
		//스크립트문 생성
		out.print("^PRINT("+(nXCurPos)+","+(nYCurPos)+",472,0,10,0/,굴림체,RGB[0,0,0], , , ,NONE,20,1)");
	...
	private void writeScriptpage_3( ) throws Exception{
		//스크립트문 생성
		out.print("^PRINT("+(nXCurPos)+","+(nYCurPos)+",375,0,16,0/,바탕체,RGB[0,0,255],BOLD, , ,NONE,31,1)");
	...
	private void writeScriptlist_header( ) throws Exception{
		//스크립트문 생성
		out.println("^CELLBG("+(nXCurPos)+","+(nYCurPos)+",147,20,1,RGB[230,230,250],RGB[230,230,250],0)\r");
		out.println("^CELLLINE("+(nXCurPos)+","+(nYCurPos)+",147,20,0,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos)+","+(nYCurPos)+",147,20,0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos)+","+(nYCurPos)+",147,20,0,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos)+","+(nYCurPos)+",147,1,10,0/,바탕,RGB[0,0,0], , , ,NONE,20,1)");
		out.println(sheet40_A3+"\r");
		out.println("^CELLBG("+(nXCurPos+147)+","+(nYCurPos)+",39,41,1,RGB[230,230,250],RGB[230,230,250],0)\r");
		out.println("^CELLLINE("+(nXCurPos+147)+","+(nYCurPos)+",39,41,0,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos+147)+","+(nYCurPos)+",39,41,0,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos+147)+","+(nYCurPos)+",39,41,0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos+147)+","+(nYCurPos)+",39,41,0,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos+147)+","+(nYCurPos)+",39,1,10,0/,바탕,RGB[0,0,0], , , ,NONE,41,1)");
		out.println(sheet40_B3+"\r");
		out.println("^CELLBG("+(nXCurPos+186)+","+(nYCurPos)+",46,41,1,RGB[230,230,250],RGB[230,230,250],0)\r");
		out.println("^CELLLINE("+(nXCurPos+186)+","+(nYCurPos)+",46,41,0,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos+186)+","+(nYCurPos)+",46,41,0,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos+186)+","+(nYCurPos)+",46,41,0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos+186)+","+(nYCurPos)+",46,41,0,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos+186)+","+(nYCurPos)+",46,1,10,0/,바탕,RGB[0,0,0], , , ,NONE,41,1)");
		out.println(sheet40_C3+"\r");
		out.println("^CELLBG("+(nXCurPos+232)+","+(nYCurPos)+",143,20,1,RGB[230,230,250],RGB[230,230,250],0)\r");
		out.println("^CELLLINE("+(nXCurPos+232)+","+(nYCurPos)+",143,20,0,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos+232)+","+(nYCurPos)+",143,20,0,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos+232)+","+(nYCurPos)+",143,20,0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos+232)+","+(nYCurPos)+",143,20,0,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos+232)+","+(nYCurPos)+",143,1,10,0/,바탕,RGB[0,0,0], , , ,NONE,20,1)");
		out.println(sheet40_D3+"\r");
		out.println("^CELLBG("+(nXCurPos+375)+","+(nYCurPos)+",38,41,1,RGB[230,230,250],RGB[230,230,250],0)\r");
		out.println("^CELLLINE("+(nXCurPos+375)+","+(nYCurPos)+",38,41,0,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos+375)+","+(nYCurPos)+",38,41,0,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos+375)+","+(nYCurPos)+",38,41,0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos+375)+","+(nYCurPos)+",38,41,0,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos+375)+","+(nYCurPos)+",38,1,10,0/,바탕,RGB[0,0,0], , , ,NONE,41,1)");
		out.println(sheet40_I3+"\r");
		out.println("^CELLBG("+(nXCurPos+413)+","+(nYCurPos)+",54,41,1,RGB[230,230,250],RGB[230,230,250],0)\r");
		out.println("^CELLLINE("+(nXCurPos+413)+","+(nYCurPos)+",54,41,0,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos+413)+","+(nYCurPos)+",54,41,0,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos+413)+","+(nYCurPos)+",54,41,0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos+413)+","+(nYCurPos)+",54,41,0,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos+413)+","+(nYCurPos)+",54,1,10,0/,바탕,RGB[0,0,0], , , ,NONE,41,1)");
		out.println(sheet40_J3+"\r");
		out.println("^CELLBG("+(nXCurPos)+","+(nYCurPos+20)+",147,21,1,RGB[230,230,250],RGB[230,230,250],0)\r");
		out.println("^CELLLINE("+(nXCurPos)+","+(nYCurPos+20)+",147,21,0,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos)+","+(nYCurPos+20)+",147,21,0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos)+","+(nYCurPos+20)+",147,21,0,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos)+","+(nYCurPos+20)+",147,1,10,1/0/0,바탕,RGB[0,0,0], , , ,NONE,21,1)");
		out.println(sheet40_A4+"\r");
		out.println("^CELLBG("+(nXCurPos+232)+","+(nYCurPos+20)+",31,21,1,RGB[230,230,250],RGB[230,230,250],0)\r");
		out.println("^CELLLINE("+(nXCurPos+232)+","+(nYCurPos+20)+",31,21,0,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos+232)+","+(nYCurPos+20)+",31,21,0,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos+232)+","+(nYCurPos+20)+",31,21,0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos+232)+","+(nYCurPos+20)+",31,21,0,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos+232)+","+(nYCurPos+20)+",31,1,10,0/,바탕,RGB[0,0,0], , , ,NONE,21,1)");
		out.println(sheet40_D4+"\r");
		out.println("^CELLBG("+(nXCurPos+263)+","+(nYCurPos+20)+",28,21,1,RGB[230,230,250],RGB[230,230,250],0)\r");
		out.println("^CELLLINE("+(nXCurPos+263)+","+(nYCurPos+20)+",28,21,0,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos+263)+","+(nYCurPos+20)+",28,21,0,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos+263)+","+(nYCurPos+20)+",28,21,0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos+263)+","+(nYCurPos+20)+",28,21,0,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos+263)+","+(nYCurPos+20)+",28,1,10,0/,바탕,RGB[0,0,0], , , ,NONE,21,1)");
		out.println(sheet40_E4+"\r");
		out.println("^CELLBG("+(nXCurPos+291)+","+(nYCurPos+20)+",28,21,1,RGB[230,230,250],RGB[230,230,250],0)\r");
		out.println("^CELLLINE("+(nXCurPos+291)+","+(nYCurPos+20)+",28,21,0,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos+291)+","+(nYCurPos+20)+",28,21,0,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos+291)+","+(nYCurPos+20)+",28,21,0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos+291)+","+(nYCurPos+20)+",28,21,0,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos+291)+","+(nYCurPos+20)+",28,1,10,0/,바탕,RGB[0,0,0], , , ,NONE,21,1)");
		out.println(sheet40_F4+"\r");
		out.println("^CELLBG("+(nXCurPos+319)+","+(nYCurPos+20)+",28,21,1,RGB[230,230,250],RGB[230,230,250],0)\r");
		out.println("^CELLLINE("+(nXCurPos+319)+","+(nYCurPos+20)+",28,21,0,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos+319)+","+(nYCurPos+20)+",28,21,0,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos+319)+","+(nYCurPos+20)+",28,21,0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos+319)+","+(nYCurPos+20)+",28,21,0,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos+319)+","+(nYCurPos+20)+",28,1,10,0/,바탕,RGB[0,0,0], , , ,NONE,21,1)");
		out.println(sheet40_G4+"\r");
		out.println("^CELLBG("+(nXCurPos+347)+","+(nYCurPos+20)+",28,21,1,RGB[230,230,250],RGB[230,230,250],0)\r");
		out.println("^CELLLINE("+(nXCurPos+347)+","+(nYCurPos+20)+",28,21,0,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos+347)+","+(nYCurPos+20)+",28,21,0,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos+347)+","+(nYCurPos+20)+",28,21,0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos+347)+","+(nYCurPos+20)+",28,21,0,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos+347)+","+(nYCurPos+20)+",28,1,10,0/,바탕,RGB[0,0,0], , , ,NONE,21,1)");
	...
	private void writeScriptlist( ) throws Exception{
		//스크립트문 생성
		out.println("^CELLLINE("+(nXCurPos)+","+(nYCurPos)+",147,"+(nAutoHeight_list[2])+",0,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos)+","+(nYCurPos)+",147,"+(nAutoHeight_list[2])+",0,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos)+","+(nYCurPos)+",147,"+(nAutoHeight_list[2])+",0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos)+","+(nYCurPos)+",147,"+(nAutoHeight_list[2])+",0,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos)+","+(nYCurPos)+",147,0,10,0/,바탕,RGB[0,0,0], , , ,XL,"+(nAutoHeight_list[2])+",1)");
		out.println(sheet40_A5+"\r");
		out.println("^CELLLINE("+(nXCurPos+147)+","+(nYCurPos)+",39,"+(nAutoHeight_list[2])+",0,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos+147)+","+(nYCurPos)+",39,"+(nAutoHeight_list[2])+",0,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos+147)+","+(nYCurPos)+",39,"+(nAutoHeight_list[2])+",0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos+147)+","+(nYCurPos)+",39,"+(nAutoHeight_list[2])+",0,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos+147)+","+(nYCurPos)+",39,1,10,0/,바탕,RGB[0,0,0], , , ,NONE,"+(nAutoHeight_list[2])+",1)");
		out.println(sheet40_B5+"\r");
		out.println("^CELLLINE("+(nXCurPos+186)+","+(nYCurPos)+",46,"+(nAutoHeight_list[0])+",0,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos+186)+","+(nYCurPos)+",46,"+(nAutoHeight_list[0])+",0,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos+186)+","+(nYCurPos)+",46,"+(nAutoHeight_list[0])+",0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos+186)+","+(nYCurPos)+",46,"+(nAutoHeight_list[0])+",0,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos+186)+","+(nYCurPos)+",46,1,10,0/,굴림체,RGB[0,0,0], , , ,NONE,"+(nAutoHeight_list[0])+",1)");
		out.println(sheet40_C5+"\r");
		out.println("^CELLLINE("+(nXCurPos+232)+","+(nYCurPos)+",31,"+(nAutoHeight_list[0])+",0,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos+232)+","+(nYCurPos)+",31,"+(nAutoHeight_list[0])+",0,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos+232)+","+(nYCurPos)+",31,"+(nAutoHeight_list[0])+",0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos+232)+","+(nYCurPos)+",31,"+(nAutoHeight_list[0])+",0,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos+232)+","+(nYCurPos)+",31,1,10,0/,바탕,RGB[0,0,0], , , ,NONE,"+(nAutoHeight_list[0])+",1)");
		out.println(sheet40_D5+"\r");
		out.println("^CELLLINE("+(nXCurPos+263)+","+(nYCurPos)+",28,"+(nAutoHeight_list[0])+",0,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos+263)+","+(nYCurPos)+",28,"+(nAutoHeight_list[0])+",0,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos+263)+","+(nYCurPos)+",28,"+(nAutoHeight_list[0])+",0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos+263)+","+(nYCurPos)+",28,"+(nAutoHeight_list[0])+",0,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos+263)+","+(nYCurPos)+",28,1,10,0/,바탕,RGB[0,0,0], , , ,NONE,"+(nAutoHeight_list[0])+",1)");
		out.println(sheet40_E5+"\r");
		out.println("^CELLLINE("+(nXCurPos+291)+","+(nYCurPos)+",28,"+(nAutoHeight_list[0])+",0,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos+291)+","+(nYCurPos)+",28,"+(nAutoHeight_list[0])+",0,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos+291)+","+(nYCurPos)+",28,"+(nAutoHeight_list[0])+",0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos+291)+","+(nYCurPos)+",28,"+(nAutoHeight_list[0])+",0,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos+291)+","+(nYCurPos)+",28,1,10,0/,바탕,RGB[0,0,0], , , ,NONE,"+(nAutoHeight_list[0])+",1)");
		out.println(sheet40_F5+"\r");
		out.println("^CELLLINE("+(nXCurPos+319)+","+(nYCurPos)+",28,"+(nAutoHeight_list[0])+",0,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos+319)+","+(nYCurPos)+",28,"+(nAutoHeight_list[0])+",0,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos+319)+","+(nYCurPos)+",28,"+(nAutoHeight_list[0])+",0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos+319)+","+(nYCurPos)+",28,"+(nAutoHeight_list[0])+",0,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos+319)+","+(nYCurPos)+",28,1,10,0/,바탕,RGB[0,0,0], , , ,NONE,"+(nAutoHeight_list[0])+",1)");
		out.println(sheet40_G5+"\r");
		out.println("^CELLLINE("+(nXCurPos+347)+","+(nYCurPos)+",28,"+(nAutoHeight_list[0])+",0,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos+347)+","+(nYCurPos)+",28,"+(nAutoHeight_list[0])+",0,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos+347)+","+(nYCurPos)+",28,"+(nAutoHeight_list[0])+",0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos+347)+","+(nYCurPos)+",28,"+(nAutoHeight_list[0])+",0,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos+347)+","+(nYCurPos)+",28,1,10,0/,바탕,RGB[0,0,0], , , ,NONE,"+(nAutoHeight_list[0])+",1)");
		out.println(sheet40_H5+"\r");
		out.println("^CELLLINE("+(nXCurPos+375)+","+(nYCurPos)+",38,"+(nAutoHeight_list[0])+",0,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos+375)+","+(nYCurPos)+",38,"+(nAutoHeight_list[0])+",0,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos+375)+","+(nYCurPos)+",38,"+(nAutoHeight_list[0])+",0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos+375)+","+(nYCurPos)+",38,"+(nAutoHeight_list[0])+",0,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos+375)+","+(nYCurPos)+",38,1,10,0/,바탕,RGB[0,0,0], , , ,NONE,"+(nAutoHeight_list[0])+",1)");
		out.println(sheet40_I5+"\r");
		out.println("^CELLLINE("+(nXCurPos+413)+","+(nYCurPos)+",54,"+(nAutoHeight_list[1])+",0,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos+413)+","+(nYCurPos)+",54,"+(nAutoHeight_list[1])+",0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos+413)+","+(nYCurPos)+",54,"+(nAutoHeight_list[1])+",0,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos+413)+","+(nYCurPos)+",54,1,10,0/,바탕,RGB[255,0,0], , , ,NONE,"+(nAutoHeight_list[1])+",1)");
		out.println(sheet40_J5+"\r");
		out.println("^CELLLINE("+(nXCurPos+186)+","+(nYCurPos+nAutoHeight_list[0])+",46,"+(nAutoHeight_list[1]-nAutoHeight_list[0])+",0,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos+186)+","+(nYCurPos+nAutoHeight_list[0])+",46,"+(nAutoHeight_list[1]-nAutoHeight_list[0])+",0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos+186)+","+(nYCurPos+nAutoHeight_list[0])+",46,"+(nAutoHeight_list[1]-nAutoHeight_list[0])+",0,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos+186)+","+(nYCurPos+nAutoHeight_list[0])+",46,1,10,0/,굴림체,RGB[0,0,0], , , ,NONE,"+(nAutoHeight_list[1]-nAutoHeight_list[0])+",1)");
		out.println(sheet40_C6+"\r");
		out.println("^CELLLINE("+(nXCurPos+232)+","+(nYCurPos+nAutoHeight_list[0])+",31,"+(nAutoHeight_list[1]-nAutoHeight_list[0])+",0,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos+232)+","+(nYCurPos+nAutoHeight_list[0])+",31,"+(nAutoHeight_list[1]-nAutoHeight_list[0])+",0,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos+232)+","+(nYCurPos+nAutoHeight_list[0])+",31,"+(nAutoHeight_list[1]-nAutoHeight_list[0])+",0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos+232)+","+(nYCurPos+nAutoHeight_list[0])+",31,"+(nAutoHeight_list[1]-nAutoHeight_list[0])+",0,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos+232)+","+(nYCurPos+nAutoHeight_list[0])+",31,1,10,0/,바탕,RGB[0,0,0], , , ,NONE,"+(nAutoHeight_list[1]-nAutoHeight_list[0])+",1)");
		out.println(sheet40_D6+"\r");
		out.println("^CELLLINE("+(nXCurPos+263)+","+(nYCurPos+nAutoHeight_list[0])+",28,"+(nAutoHeight_list[1]-nAutoHeight_list[0])+",0,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos+263)+","+(nYCurPos+nAutoHeight_list[0])+",28,"+(nAutoHeight_list[1]-nAutoHeight_list[0])+",0,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos+263)+","+(nYCurPos+nAutoHeight_list[0])+",28,"+(nAutoHeight_list[1]-nAutoHeight_list[0])+",0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos+263)+","+(nYCurPos+nAutoHeight_list[0])+",28,"+(nAutoHeight_list[1]-nAutoHeight_list[0])+",0,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos+263)+","+(nYCurPos+nAutoHeight_list[0])+",28,1,10,0/,바탕,RGB[0,0,0], , , ,NONE,"+(nAutoHeight_list[1]-nAutoHeight_list[0])+",1)");
		out.println(sheet40_E6+"\r");
		out.println("^CELLLINE("+(nXCurPos+291)+","+(nYCurPos+nAutoHeight_list[0])+",28,"+(nAutoHeight_list[1]-nAutoHeight_list[0])+",0,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos+291)+","+(nYCurPos+nAutoHeight_list[0])+",28,"+(nAutoHeight_list[1]-nAutoHeight_list[0])+",0,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos+291)+","+(nYCurPos+nAutoHeight_list[0])+",28,"+(nAutoHeight_list[1]-nAutoHeight_list[0])+",0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos+291)+","+(nYCurPos+nAutoHeight_list[0])+",28,"+(nAutoHeight_list[1]-nAutoHeight_list[0])+",0,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos+291)+","+(nYCurPos+nAutoHeight_list[0])+",28,1,10,0/,바탕,RGB[0,0,0], , , ,NONE,"+(nAutoHeight_list[1]-nAutoHeight_list[0])+",1)");
		out.println(sheet40_F6+"\r");
		out.println("^CELLLINE("+(nXCurPos+319)+","+(nYCurPos+nAutoHeight_list[0])+",28,"+(nAutoHeight_list[1]-nAutoHeight_list[0])+",0,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos+319)+","+(nYCurPos+nAutoHeight_list[0])+",28,"+(nAutoHeight_list[1]-nAutoHeight_list[0])+",0,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos+319)+","+(nYCurPos+nAutoHeight_list[0])+",28,"+(nAutoHeight_list[1]-nAutoHeight_list[0])+",0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos+319)+","+(nYCurPos+nAutoHeight_list[0])+",28,"+(nAutoHeight_list[1]-nAutoHeight_list[0])+",0,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos+319)+","+(nYCurPos+nAutoHeight_list[0])+",28,1,10,0/,바탕,RGB[0,0,0], , , ,NONE,"+(nAutoHeight_list[1]-nAutoHeight_list[0])+",1)");
		out.println(sheet40_G6+"\r");
		out.println("^CELLLINE("+(nXCurPos+347)+","+(nYCurPos+nAutoHeight_list[0])+",28,"+(nAutoHeight_list[1]-nAutoHeight_list[0])+",0,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos+347)+","+(nYCurPos+nAutoHeight_list[0])+",28,"+(nAutoHeight_list[1]-nAutoHeight_list[0])+",0,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos+347)+","+(nYCurPos+nAutoHeight_list[0])+",28,"+(nAutoHeight_list[1]-nAutoHeight_list[0])+",0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos+347)+","+(nYCurPos+nAutoHeight_list[0])+",28,"+(nAutoHeight_list[1]-nAutoHeight_list[0])+",0,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos+347)+","+(nYCurPos+nAutoHeight_list[0])+",28,1,10,0/,바탕,RGB[0,0,0], , , ,NONE,"+(nAutoHeight_list[1]-nAutoHeight_list[0])+",1)");
		out.println(sheet40_H6+"\r");
		out.println("^CELLLINE("+(nXCurPos+375)+","+(nYCurPos+nAutoHeight_list[0])+",38,"+(nAutoHeight_list[1]-nAutoHeight_list[0])+",0,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos+375)+","+(nYCurPos+nAutoHeight_list[0])+",38,"+(nAutoHeight_list[1]-nAutoHeight_list[0])+",0,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos+375)+","+(nYCurPos+nAutoHeight_list[0])+",38,"+(nAutoHeight_list[1]-nAutoHeight_list[0])+",0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos+375)+","+(nYCurPos+nAutoHeight_list[0])+",38,"+(nAutoHeight_list[1]-nAutoHeight_list[0])+",0,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos+375)+","+(nYCurPos+nAutoHeight_list[0])+",38,1,10,0/,바탕,RGB[0,0,0], , , ,NONE,"+(nAutoHeight_list[1]-nAutoHeight_list[0])+",1)");
		out.println(sheet40_I6+"\r");
		out.println("^CELLLINE("+(nXCurPos+186)+","+(nYCurPos+nAutoHeight_list[1])+",46,"+(nAutoHeight_list[2]-nAutoHeight_list[1])+",0,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos+186)+","+(nYCurPos+nAutoHeight_list[1])+",46,"+(nAutoHeight_list[2]-nAutoHeight_list[1])+",0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos+186)+","+(nYCurPos+nAutoHeight_list[1])+",46,"+(nAutoHeight_list[2]-nAutoHeight_list[1])+",0,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos+186)+","+(nYCurPos+nAutoHeight_list[1])+",46,1,10,0/,굴림체,RGB[0,0,0], , , ,NONE,"+(nAutoHeight_list[2]-nAutoHeight_list[1])+",1)");
		out.println(sheet40_C7+"\r");
		out.println("^CELLLINE("+(nXCurPos+232)+","+(nYCurPos+nAutoHeight_list[1])+",31,"+(nAutoHeight_list[2]-nAutoHeight_list[1])+",0,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos+232)+","+(nYCurPos+nAutoHeight_list[1])+",31,"+(nAutoHeight_list[2]-nAutoHeight_list[1])+",0,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos+232)+","+(nYCurPos+nAutoHeight_list[1])+",31,"+(nAutoHeight_list[2]-nAutoHeight_list[1])+",0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos+232)+","+(nYCurPos+nAutoHeight_list[1])+",31,"+(nAutoHeight_list[2]-nAutoHeight_list[1])+",0,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos+232)+","+(nYCurPos+nAutoHeight_list[1])+",31,1,10,0/,바탕,RGB[0,0,0], , , ,NONE,"+(nAutoHeight_list[2]-nAutoHeight_list[1])+",1)");
		out.println(sheet40_D7+"\r");
		out.println("^CELLLINE("+(nXCurPos+263)+","+(nYCurPos+nAutoHeight_list[1])+",28,"+(nAutoHeight_list[2]-nAutoHeight_list[1])+",0,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos+263)+","+(nYCurPos+nAutoHeight_list[1])+",28,"+(nAutoHeight_list[2]-nAutoHeight_list[1])+",0,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos+263)+","+(nYCurPos+nAutoHeight_list[1])+",28,"+(nAutoHeight_list[2]-nAutoHeight_list[1])+",0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos+263)+","+(nYCurPos+nAutoHeight_list[1])+",28,"+(nAutoHeight_list[2]-nAutoHeight_list[1])+",0,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos+263)+","+(nYCurPos+nAutoHeight_list[1])+",28,1,10,0/,바탕,RGB[0,0,0], , , ,NONE,"+(nAutoHeight_list[2]-nAutoHeight_list[1])+",1)");
		out.println(sheet40_E7+"\r");
		out.println("^CELLLINE("+(nXCurPos+291)+","+(nYCurPos+nAutoHeight_list[1])+",28,"+(nAutoHeight_list[2]-nAutoHeight_list[1])+",0,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos+291)+","+(nYCurPos+nAutoHeight_list[1])+",28,"+(nAutoHeight_list[2]-nAutoHeight_list[1])+",0,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos+291)+","+(nYCurPos+nAutoHeight_list[1])+",28,"+(nAutoHeight_list[2]-nAutoHeight_list[1])+",0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos+291)+","+(nYCurPos+nAutoHeight_list[1])+",28,"+(nAutoHeight_list[2]-nAutoHeight_list[1])+",0,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos+291)+","+(nYCurPos+nAutoHeight_list[1])+",28,1,10,0/,바탕,RGB[0,0,0], , , ,NONE,"+(nAutoHeight_list[2]-nAutoHeight_list[1])+",1)");
		out.println(sheet40_F7+"\r");
		out.println("^CELLLINE("+(nXCurPos+319)+","+(nYCurPos+nAutoHeight_list[1])+",28,"+(nAutoHeight_list[2]-nAutoHeight_list[1])+",0,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos+319)+","+(nYCurPos+nAutoHeight_list[1])+",28,"+(nAutoHeight_list[2]-nAutoHeight_list[1])+",0,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos+319)+","+(nYCurPos+nAutoHeight_list[1])+",28,"+(nAutoHeight_list[2]-nAutoHeight_list[1])+",0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos+319)+","+(nYCurPos+nAutoHeight_list[1])+",28,"+(nAutoHeight_list[2]-nAutoHeight_list[1])+",0,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos+319)+","+(nYCurPos+nAutoHeight_list[1])+",28,1,10,0/,바탕,RGB[0,0,0], , , ,NONE,"+(nAutoHeight_list[2]-nAutoHeight_list[1])+",1)");
		out.println(sheet40_G7+"\r");
		out.println("^CELLLINE("+(nXCurPos+347)+","+(nYCurPos+nAutoHeight_list[1])+",28,"+(nAutoHeight_list[2]-nAutoHeight_list[1])+",0,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos+347)+","+(nYCurPos+nAutoHeight_list[1])+",28,"+(nAutoHeight_list[2]-nAutoHeight_list[1])+",0,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos+347)+","+(nYCurPos+nAutoHeight_list[1])+",28,"+(nAutoHeight_list[2]-nAutoHeight_list[1])+",0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos+347)+","+(nYCurPos+nAutoHeight_list[1])+",28,"+(nAutoHeight_list[2]-nAutoHeight_list[1])+",0,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos+347)+","+(nYCurPos+nAutoHeight_list[1])+",28,1,10,0/,바탕,RGB[0,0,0], , , ,NONE,"+(nAutoHeight_list[2]-nAutoHeight_list[1])+",1)");
		out.println(sheet40_H7+"\r");
		out.println("^CELLLINE("+(nXCurPos+375)+","+(nYCurPos+nAutoHeight_list[1])+",38,"+(nAutoHeight_list[2]-nAutoHeight_list[1])+",0,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos+375)+","+(nYCurPos+nAutoHeight_list[1])+",38,"+(nAutoHeight_list[2]-nAutoHeight_list[1])+",0,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos+375)+","+(nYCurPos+nAutoHeight_list[1])+",38,"+(nAutoHeight_list[2]-nAutoHeight_list[1])+",0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos+375)+","+(nYCurPos+nAutoHeight_list[1])+",38,"+(nAutoHeight_list[2]-nAutoHeight_list[1])+",0,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos+375)+","+(nYCurPos+nAutoHeight_list[1])+",38,1,10,0/,바탕,RGB[0,0,0], , , ,NONE,"+(nAutoHeight_list[2]-nAutoHeight_list[1])+",1)");
		out.println(sheet40_I7+"\r");
		out.println("^CELLLINE("+(nXCurPos+413)+","+(nYCurPos+nAutoHeight_list[1])+",54,"+(nAutoHeight_list[2]-nAutoHeight_list[1])+",0,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos+413)+","+(nYCurPos+nAutoHeight_list[1])+",54,"+(nAutoHeight_list[2]-nAutoHeight_list[1])+",0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos+413)+","+(nYCurPos+nAutoHeight_list[1])+",54,"+(nAutoHeight_list[2]-nAutoHeight_list[1])+",0,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos+413)+","+(nYCurPos+nAutoHeight_list[1])+",54,1,9,0/,바탕,RGB[0,0,255], , , ,NONE,"+(nAutoHeight_list[2]-nAutoHeight_list[1])+",1)");
		out.println(sheet40_J7+"\r");
	}

	//----page_4_note1 스크립트 문 출력 함수----
	private void writeScriptpage_4_note1( ) throws Exception{
		//스크립트문 생성
		out.print("^PRINT("+(nXCurPos)+","+(nYCurPos)+",467,0,10,0/,굴림체,RGB[0,0,0], , , ,NONE,20,1)");
	...
	private void writeScriptVoidBand405( ) throws Exception{
		//스크립트문 생성
		out.print("^PRINT("+(nXCurPos)+","+(nYCurPos)+",467,1,11,0/,굴림체,RGB[0,0,0], , , ,NONE,20,1)");
	...
	private void writeScriptSheet4_foot( ) throws Exception{
		//스크립트문 생성
		out.println("^CELLLINE("+(nXCurPos)+","+(nYCurPos)+",147,20,1,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos)+","+(nYCurPos)+",147,20,0,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos)+","+(nYCurPos)+",147,20,1,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos)+","+(nYCurPos)+",147,20,0,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos)+","+(nYCurPos)+",147,1,11,0/,굴림체,RGB[0,0,0], , , ,NONE,20,1)");
		out.println(sheet40_A10+"\r");
		out.println("^CELLLINE("+(nXCurPos+147)+","+(nYCurPos)+",85,20,1,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos+147)+","+(nYCurPos)+",85,20,0,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos+147)+","+(nYCurPos)+",85,20,0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos+147)+","+(nYCurPos)+",85,20,0,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos+147)+","+(nYCurPos)+",85,1,11,0/,굴림체,RGB[0,0,0], , , ,NONE,20,1)");
		out.println(sheet40_B10+"\r");
		out.println("^CELLLINE("+(nXCurPos+232)+","+(nYCurPos)+",59,20,1,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos+232)+","+(nYCurPos)+",59,20,0,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos+232)+","+(nYCurPos)+",59,20,0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos+232)+","+(nYCurPos)+",59,20,0,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos+232)+","+(nYCurPos)+",59,1,11,0/,굴림체,RGB[0,0,0], , , ,NONE,20,1)");
		out.println(sheet40_D10+"\r");
		out.println("^CELLLINE("+(nXCurPos+291)+","+(nYCurPos)+",56,20,1,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos+291)+","+(nYCurPos)+",56,20,0,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos+291)+","+(nYCurPos)+",56,20,0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos+291)+","+(nYCurPos)+",56,20,0,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos+291)+","+(nYCurPos)+",56,1,11,0/,굴림체,RGB[0,0,0], , , ,NONE,20,1)");
		out.println(sheet40_F10+"\r");
		out.println("^CELLLINE("+(nXCurPos+347)+","+(nYCurPos)+",66,20,1,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos+347)+","+(nYCurPos)+",66,20,0,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos+347)+","+(nYCurPos)+",66,20,0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos+347)+","+(nYCurPos)+",66,20,0,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos+347)+","+(nYCurPos)+",66,1,11,0/,굴림체,RGB[0,0,0], , , ,NONE,20,1)");
		out.println(sheet40_H10+"\r");
		out.println("^CELLLINE("+(nXCurPos+413)+","+(nYCurPos)+",54,20,1,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos+413)+","+(nYCurPos)+",54,20,0,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos+413)+","+(nYCurPos)+",54,20,0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos+413)+","+(nYCurPos)+",54,20,0,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos+413)+","+(nYCurPos)+",54,1,11,0/,굴림체,RGB[0,0,0], , , ,NONE,20,1)");
		out.println(sheet40_J10+"\r");
		out.println("^CELLLINE("+(nXCurPos)+","+(nYCurPos+20)+",147,20,0,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos)+","+(nYCurPos+20)+",147,20,0,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos)+","+(nYCurPos+20)+",147,20,1,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos)+","+(nYCurPos+20)+",147,20,0,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos)+","+(nYCurPos+20)+",147,1,11,0/,굴림체,RGB[0,0,0], , , ,NONE,20,1)");
		out.println(sheet40_A11+"\r");
		out.println("^CELLLINE("+(nXCurPos+147)+","+(nYCurPos+20)+",85,20,0,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos+147)+","+(nYCurPos+20)+",85,20,0,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos+147)+","+(nYCurPos+20)+",85,20,0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos+147)+","+(nYCurPos+20)+",85,20,0,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos+147)+","+(nYCurPos+20)+",85,1,11,0/,굴림체,RGB[0,0,0], , , ,NONE,20,1)");
		out.println(sheet40_B11+"\r");
		out.println("^CELLLINE("+(nXCurPos+232)+","+(nYCurPos+20)+",59,20,0,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos+232)+","+(nYCurPos+20)+",59,20,0,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos+232)+","+(nYCurPos+20)+",59,20,0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos+232)+","+(nYCurPos+20)+",59,20,0,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos+232)+","+(nYCurPos+20)+",59,1,11,0/,굴림체,RGB[0,0,0], , , ,NONE,20,1)");
		out.println(sheet40_D11+"\r");
		out.println("^CELLLINE("+(nXCurPos+291)+","+(nYCurPos+20)+",56,20,0,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos+291)+","+(nYCurPos+20)+",56,20,0,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos+291)+","+(nYCurPos+20)+",56,20,0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos+291)+","+(nYCurPos+20)+",56,20,0,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos+291)+","+(nYCurPos+20)+",56,1,11,0/,굴림체,RGB[0,0,0], , , ,NONE,20,1)");
		out.println(sheet40_F11+"\r");
		out.println("^CELLLINE("+(nXCurPos+347)+","+(nYCurPos+20)+",66,20,0,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos+347)+","+(nYCurPos+20)+",66,20,0,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos+347)+","+(nYCurPos+20)+",66,20,0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos+347)+","+(nYCurPos+20)+",66,20,0,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos+347)+","+(nYCurPos+20)+",66,1,11,0/,굴림체,RGB[0,0,0], , , ,NONE,20,1)");
		out.println(sheet40_H11+"\r");
		out.println("^CELLLINE("+(nXCurPos+413)+","+(nYCurPos+20)+",54,20,0,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos+413)+","+(nYCurPos+20)+",54,20,0,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos+413)+","+(nYCurPos+20)+",54,20,0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos+413)+","+(nYCurPos+20)+",54,20,0,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos+413)+","+(nYCurPos+20)+",54,1,11,0/,굴림체,RGB[0,0,0], , , ,NONE,20,1)");
		out.println(sheet40_J11+"\r");
		out.println("^CELLLINE("+(nXCurPos)+","+(nYCurPos+40)+",147,20,0,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos)+","+(nYCurPos+40)+",147,20,1,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos)+","+(nYCurPos+40)+",147,20,1,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos)+","+(nYCurPos+40)+",147,20,0,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos)+","+(nYCurPos+40)+",147,1,11,0/,굴림체,RGB[0,0,0], , , ,NONE,20,1)");
		out.println(sheet40_A12+"\r");
		out.println("^CELLLINE("+(nXCurPos+147)+","+(nYCurPos+40)+",85,20,0,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos+147)+","+(nYCurPos+40)+",85,20,1,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos+147)+","+(nYCurPos+40)+",85,20,0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos+147)+","+(nYCurPos+40)+",85,20,0,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos+147)+","+(nYCurPos+40)+",85,1,11,0/,굴림체,RGB[0,0,0], , , ,NONE,20,1)");
		out.println(sheet40_B12+"\r");
		out.println("^CELLLINE("+(nXCurPos+232)+","+(nYCurPos+40)+",59,20,0,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos+232)+","+(nYCurPos+40)+",59,20,1,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos+232)+","+(nYCurPos+40)+",59,20,0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos+232)+","+(nYCurPos+40)+",59,20,0,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos+232)+","+(nYCurPos+40)+",59,1,11,0/,굴림체,RGB[0,0,0], , , ,NONE,20,1)");
		out.println(sheet40_D12+"\r");
		out.println("^CELLLINE("+(nXCurPos+291)+","+(nYCurPos+40)+",56,20,0,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos+291)+","+(nYCurPos+40)+",56,20,1,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos+291)+","+(nYCurPos+40)+",56,20,0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos+291)+","+(nYCurPos+40)+",56,20,0,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos+291)+","+(nYCurPos+40)+",56,1,11,0/,굴림체,RGB[0,0,0], , , ,NONE,20,1)");
		out.println(sheet40_F12+"\r");
		out.println("^CELLLINE("+(nXCurPos+347)+","+(nYCurPos+40)+",66,20,0,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos+347)+","+(nYCurPos+40)+",66,20,1,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos+347)+","+(nYCurPos+40)+",66,20,0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos+347)+","+(nYCurPos+40)+",66,20,0,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos+347)+","+(nYCurPos+40)+",66,1,11,0/,굴림체,RGB[0,0,0], , , ,NONE,20,1)");
		out.println(sheet40_H12+"\r");
		out.println("^CELLLINE("+(nXCurPos+413)+","+(nYCurPos+40)+",54,20,0,RGB[0,0,0],0)\r");
		out.println("^CELLLINE("+(nXCurPos+413)+","+(nYCurPos+40)+",54,20,1,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos+413)+","+(nYCurPos+40)+",54,20,0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos+413)+","+(nYCurPos+40)+",54,20,0,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos+413)+","+(nYCurPos+40)+",54,1,11,0/,굴림체,RGB[0,0,0], , , ,NONE,20,1)");
		out.println(sheet40_J12+"\r");
		out.print("^PRINT("+(nXCurPos)+","+(nYCurPos+60)+",467,1,10,0/,굴림체,RGB[0,0,0], , , ,NONE,20,1)");
	...
	private void initSQLConst(){
		...
		sql_QUESTION_LIST = sql_QUESTION_LIST + "        anscnt1_rat, ";
		sql_QUESTION_LIST = sql_QUESTION_LIST + "        anscnt2_rat, ";
		sql_QUESTION_LIST = sql_QUESTION_LIST + "        anscnt3_rat,       ";
		sql_QUESTION_LIST = sql_QUESTION_LIST + "        anscnt4_rat, ";
		sql_QUESTION_LIST = sql_QUESTION_LIST + "        anscnt5_rat,  ";
		sql_QUESTION_LIST = sql_QUESTION_LIST + "        to_char(round((anscnt1 * 1 +  anscnt2 * 2 + anscnt3 * 3 + anscnt4 * 4 + anscnt5 * 5) / total_cnt,1),'9.0')  as rat_cnt, ";
		sql_QUESTION_LIST = sql_QUESTION_LIST + "        to_char(round((anscnt1 * 1 +  anscnt2 * 2 + anscnt3 * 3 + anscnt4 * 4 + anscnt5 * 5) / total_cnt *20,1),'99.0')  as rat ";
		...
		sql_LIST = sql_LIST + "    ROUND(SUBJ_ANS1/ TUTOR_ANS_TOTAL*100,1) AS SUBJ_ANS1, ";
		sql_LIST = sql_LIST + "    ROUND(SUBJ_ANS2/ TUTOR_ANS_TOTAL*100,1) AS SUBJ_ANS2, ";
		sql_LIST = sql_LIST + "    ROUND(SUBJ_ANS3/ TUTOR_ANS_TOTAL*100,1) AS SUBJ_ANS3, ";
		sql_LIST = sql_LIST + "    ROUND(SUBJ_ANS4/ TUTOR_ANS_TOTAL*100,1) AS SUBJ_ANS4, ";
		sql_LIST = sql_LIST + "    ROUND(SUBJ_ANS5/ TUTOR_ANS_TOTAL*100,1) AS SUBJ_ANS5, ";
		sql_LIST = sql_LIST + "    SUBJ_ANS_TOTAL,            ";
		sql_LIST = sql_LIST + "    ROUND(STIME_ANS1/ TUTOR_ANS_TOTAL*100,1) AS STIME_ANS1, ";
		sql_LIST = sql_LIST + "    ROUND(STIME_ANS2/ TUTOR_ANS_TOTAL*100,1) AS STIME_ANS2, ";
		sql_LIST = sql_LIST + "    ROUND(STIME_ANS3/ TUTOR_ANS_TOTAL*100,1) AS STIME_ANS3,     ";
		sql_LIST = sql_LIST + "    ROUND(STIME_ANS4/ TUTOR_ANS_TOTAL*100,1) AS STIME_ANS4,   ";
		sql_LIST = sql_LIST + "    ROUND(STIME_ANS5/ TUTOR_ANS_TOTAL*100,1) AS STIME_ANS5,   ";
		sql_LIST = sql_LIST + "    STIME_ANS_TOTAL,             ";
		sql_LIST = sql_LIST + "    ROUND(TUTOR_ANS1/ TUTOR_ANS_TOTAL*100,1) AS TUTOR_ANS1, ";
		sql_LIST = sql_LIST + "    ROUND(TUTOR_ANS2/ TUTOR_ANS_TOTAL*100,1) AS TUTOR_ANS2, ";
		sql_LIST = sql_LIST + "    ROUND(TUTOR_ANS3/ TUTOR_ANS_TOTAL*100,1) AS TUTOR_ANS3, ";
		sql_LIST = sql_LIST + "    ROUND(TUTOR_ANS4/ TUTOR_ANS_TOTAL*100,1) AS TUTOR_ANS4, ";
		sql_LIST = sql_LIST + "    ROUND(TUTOR_ANS5/ TUTOR_ANS_TOTAL*100,1) AS TUTOR_ANS5, ";
		...
		sql_LIST = sql_LIST + " ";
		sql_LIST = sql_LIST + "ROUND((ROUND((SUBJ_ANS1 * 1 +  SUBJ_ANS2 * 2 + SUBJ_ANS3 * 3 + SUBJ_ANS4 * 4 + SUBJ_ANS5 * 5) / SUBJ_ANS_TOTAL,1) + ROUND((STIME_ANS1 * 1 + STIME_ANS2 * 2 + STIME_ANS3 * 3 + STIME_ANS4 * 4 + STIME_ANS5 * 5) / STIME_ANS_TOTAL,1) + ROUND((TUTOR_ANS1 * 1 + TUTOR_ANS2 * 2 + TUTOR_ANS3 * 3 + TUTOR_ANS4 * 4 + TUTOR_ANS5 * 5) / TUTOR_ANS_TOTAL,1))/3,1) AS TOTAL_ANS_AVG, ";
		sql_LIST = sql_LIST + " ";
		...
		sql_LIST = sql_LIST + "    CASE WHEN TUTOR_ANS_TOTAL > 0 THEN ROUND((TUTOR_ANS1 * 1 + TUTOR_ANS2 * 2 + TUTOR_ANS3 * 3 + TUTOR_ANS4 * 4 + TUTOR_ANS5 * 5) / TUTOR_ANS_TOTAL * 20,1) ELSE 0 END) / 3,1) AS TOTAL_AVG     ";
		sql_LIST = sql_LIST + " ";
	...
	private void setFieldVariableFromQUESTION_LIST() throws Exception{
		...
		QUESTION_LIST_ANSCNT1_RAT=QUESTION_LIST.getDouble(10);
		QUESTION_LIST_ANSCNT2_RAT=QUESTION_LIST.getDouble(11);
		QUESTION_LIST_ANSCNT3_RAT=QUESTION_LIST.getDouble(12);
		QUESTION_LIST_ANSCNT4_RAT=QUESTION_LIST.getDouble(13);
		QUESTION_LIST_ANSCNT5_RAT=QUESTION_LIST.getDouble(14);
	...
	private void setFieldInitFromQUESTION_LIST(){
		...
		QUESTION_LIST_ANSCNT4_RAT=0;
		QUESTION_LIST_ANSCNT5_RAT=0;
	...
	private void setFieldVariableFromLIST() throws Exception{
		...
		LIST_SUBJ_ANS_AVG=LIST.getDouble(23);
		LIST_STIME_ANS_AVG=LIST.getDouble(24);
		LIST_TUTOR_ANS_AVG=LIST.getDouble(25);
		LIST_TOTAL_ANS_AVG=LIST.getDouble(26);
		LIST_TOTAL_AVG=LIST.getDouble(27);
	}
	...
	private void initConstVarient(){
		...
		sheet30_F4="불만";
		sheet30_G4="매우불만";
		sheet30_A7="*만족도는 '매우만족'과 '만족'을 합산한 값이고, ()안의 숫자는 리커트 5점척도 값임.";
		sheet40_A1="   3. 강의만족도";
		sheet40_A3="교과목";
		sheet40_B3="강사명";
		sheet40_C3="측정항목";
		...
		sheet40_C6="강의태도";
		sheet40_C7="전문성";
		sheet40_A8="*만족도는 '매우만족'과 '만족'을 합산한 값이고, ()안의 숫자는 리커트 5점척도 값임.";
		sheet40_A9="* 평가기준표";
		sheet40_A10="구  분";
		sheet40_B10="매우우수";
		sheet40_D10="우수";
		...
		sheet40_H11="2.9~2.0";
		sheet40_J11="2.0 미만";
		sheet40_A12="만족율(매우만족+만족)";
		sheet40_B12="88점 이상";
		sheet40_D12="87~76%";
		sheet40_F12="75~60%";
		sheet40_H12="59~40%";
		sheet40_J12="40% 미만";
		sheet40_A13="* 자료 : 행정안전부 지방행정연수원 교육과정 평가 매뉴얼, 2008, 68쪽 내용을 참고해서 작성";
		sheet50_A1=5;
		sheet50_B1=" 기타 의견";
		sheet50_B2="① 교육과정운영 관련 의견";
		sheet50_B6="② 교과목 및 강사 관련 의견";
		sheet50_A10=6;
		sheet50_B10=" 과정장 의견";
	}
