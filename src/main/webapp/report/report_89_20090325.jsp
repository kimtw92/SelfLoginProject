...
class ReportHandler{
	...
	private void executeSheet40( ) throws Exception{
		...
		getScriptFromVoidBand4011(true, true);    //Void 밴드 호출
		getScriptFromJU_QUESTION_(true);    //반복 밴드 호출
	...
	private void getScriptFromquestion_list(boolean bIsPrint) throws Exception{
		...
		while(QUESTION_LIST.next()){   //자동으로 생성되는 반복 밴드의 루프문
			...
			sheet20_C5=QUESTION_LIST_TOTAL_CNT;
			sheet20_D5=QUESTION_LIST_ANSCNT33;
			sheet20_E5=(long)QUESTION_LIST_ANSCNT22;
			sheet20_F5=QUESTION_LIST_ANSCNT11;
			sheet20_G5=QUESTION_LIST_RAT_CNT;
			sheet20_H5=QUESTION_LIST_RAT;
			sheet20_D6=QUESTION_LIST_ANSCNT3_RAT;
			sheet20_E6=QUESTION_LIST_ANSCNT2_RAT;
			sheet20_F6=QUESTION_LIST_ANSCNT1_RAT;

			//Auto Size Code
			int nHeightTmp;
			nAutoHeight_question_list[0]=0;
			nAutoHeight_question_list[1]=0;
			nHeightTmp=getPrintHeight(sheet20_B5, charWidth, 10, 156, 40, nAutoHeight_question_list[0]);
	...
	private void getScriptFromlist(boolean bIsPrint) throws Exception{
		...
		while(LIST.next()){   //자동으로 생성되는 반복 밴드의 루프문
			...
			sheet30_C6=LIST_TOTAL_AVG;
			sheet30_D6=LIST_SUBJ_ANS33_RAT;
			sheet30_E6=LIST_SUBJ_ANS22_RAT;
			sheet30_F6=LIST_SUBJ_ANS11_RAT;
			sheet30_G6=LIST_SUBJ_ANS_AVG;
			sheet30_H6=LIST_STIME_ANS33_RAT;
			sheet30_I6=LIST_STIME_ANS22_RAT;
			sheet30_J6=LIST_STIME_ANS11_RAT;
			sheet30_K6=LIST_STIME_ANS_AVG;
			sheet30_L6=LIST_TUTOR_ANS33_RAT;
			sheet30_M6=LIST_TUTOR_ANS22_RAT;
			sheet30_N6=LIST_TUTOR_ANS11_RAT;
			sheet30_O6=LIST_TUTOR_ANS_AVG;

			//Auto Size Code
			int nHeightTmp;
			nAutoHeight_list[0]=0;
			nAutoHeight_list[1]=0;
			nHeightTmp=getPrintHeight(sheet30_A6, charWidth, 10, 69, 56, nAutoHeight_list[0]);
	...
	private void getScriptFromQUESTION1(boolean bIsPrint) throws Exception{
		...
		while(QUESTION2.next()){   //자동으로 생성되는 반복 밴드의 루프문
			...
			//데이터 변수 할당
			sheet40_A4= QUESTION2_QUESTION + " (" + QUESTION2_SUB_CNT1_ANS + ":" + QUESTION2_SUB_CNT1_RAT + ", " + QUESTION2_SUB_CNT2_ANS + ":" + QUESTION2_SUB_CNT2_RAT + ", " + QUESTION2_SUB_CNT3_ANS + ":" + QUESTION2_SUB_CNT3_RAT + ", " + QUESTION2_SUB_CNT4_ANS + ":" + QUESTION2_SUB_CNT4_RAT + ", " + QUESTION2_SUB_CNT5_ANS + ":" + QUESTION2_SUB_CNT5_RAT + ")";
			sheet40_D4=QUESTION2_QUESTION;
	...
	//----bIsPrint : 감추기 속성 설정 여부. true면 출력, false면 AI 스크립트를 생성하지 않음.
	//----nRepeatCnt : 부모 반복 밴드 수행 횟수와 연동 옵션 설정시 void 밴드가 수행할 반복 횟수 전달
	private void getScriptFromVoidBand4011(boolean bIsFirst, boolean bIsPrint) throws Exception{
		//지역 변수 선언 및 초기화
		int nBandHeight=181;    //밴드 출력 높이
	...
	//-----JU_QUESTION_ RepeatBand Start-----
	//-----소속 쉬트 : SHEET=Sheet4   FRAME=Frame0
	//-----밴드 이름 : JU_QUESTION_
	//-----밴드 종류 : 반복 밴드
	//-----bIsPrint : 감추기 속성 설정 여부 true면 출력, false면 스크립트를 생성하지 않음
	private void getScriptFromJU_QUESTION_(boolean bIsPrint) throws Exception{
		//지역 변수 선언 및 초기화
		...
		//DataSet 객체 생성
		//ResultSet QUESTION_JU 객체의 생성
		if(QUESTION_JU==null){
			QUESTION_JU = stat_QUESTION_JU.executeQuery(sql_QUESTION_JU);
		}else{
			QUESTION_JU.beforeFirst();
		}

		while(QUESTION_JU.next()){   //자동으로 생성되는 반복 밴드의 루프문
			//데이터 fetch
			setFieldVariableFromQUESTION_JU();	//RecordSet QUESTION_JU에서 필드 값 설정

			if(bIsFirst){   //밴드 호출 후 루프 내에서 한번 만 실행되는 코드
			}   //end if(bIsFirst)

			//데이터 변수 할당
			sheet40_B13=QUESTION_JU_QUESTION;
	...
	private void writeScriptpage1( ) throws Exception{
		...
		out.print("^PRINT("+(nXCurPos+127)+","+(nYCurPos+459)+",62,1,11,1/0/0,굴림체,RGB[0,0,0], , , ,NONE,20,1)");
		...
		out.print("^PRINT("+(nXCurPos+189)+","+(nYCurPos+459)+",54,1,11,1/0/0,굴림체,RGB[0,0,0], , , ,NONE,20,1)");
		...
		out.print("^PRINT("+(nXCurPos+243)+","+(nYCurPos+459)+",54,1,11,1/0/0,굴림체,RGB[0,0,0], , , ,NONE,20,1)");
		...
		out.print("^PRINT("+(nXCurPos+297)+","+(nYCurPos+459)+",54,1,11,1/0/0,굴림체,RGB[0,0,0], , , ,NONE,20,1)");
		...
		out.print("^PRINT("+(nXCurPos+351)+","+(nYCurPos+459)+",62,1,11,1/0/0,굴림체,RGB[0,0,0], , , ,NONE,20,1)");
		...
		out.print("^PRINT("+(nXCurPos+413)+","+(nYCurPos+459)+",63,1,11,1/0/0,굴림체,RGB[0,0,0], , , ,NONE,20,1)");
		...
		out.print("^PRINT("+(nXCurPos+127)+","+(nYCurPos+479)+",62,1,11,1/0/0,굴림체,RGB[0,0,0], , , ,NONE,20,1)");
		...
		out.print("^PRINT("+(nXCurPos+189)+","+(nYCurPos+479)+",54,1,11,1/0/0,굴림체,RGB[0,0,0], , , ,NONE,20,1)");
		...
		out.print("^PRINT("+(nXCurPos+243)+","+(nYCurPos+479)+",54,1,11,1/0/0,굴림체,RGB[0,0,0], , , ,NONE,20,1)");
		...
		out.print("^PRINT("+(nXCurPos+297)+","+(nYCurPos+479)+",54,1,11,1/0/0,굴림체,RGB[0,0,0], , , ,NONE,20,1)");
		...
		out.print("^PRINT("+(nXCurPos+351)+","+(nYCurPos+479)+",62,1,11,1/0/0,굴림체,RGB[0,0,0], , , ,NONE,20,1)");
		...
		out.print("^PRINT("+(nXCurPos+413)+","+(nYCurPos+479)+",63,1,11,1/0/0,굴림체,RGB[0,0,0], , , ,NONE,20,1)");
	...
	private void writeScriptlist( ) throws Exception{
		...
		out.println(sheet30_O6+"\r");
	}

	//----VoidBand400 스크립트 문 출력 함수----
	private void writeScriptVoidBand400( ) throws Exception{
		//스크립트문 생성
		...
		out.print("^PRINT("+(nXCurPos)+","+(nYCurPos+48)+",476,0,15,0/,굴림체,RGB[0,0,255],BOLD, , ,NONE,27,1)");
	...
	//----VoidBand4011 스크립트 문 출력 함수----
	private void writeScriptVoidBand4011( ) throws Exception{
		//스크립트문 생성
		out.print("^PRINT("+(nXCurPos)+","+(nYCurPos+40)+",476,0,15,0/,굴림체,RGB[0,0,255],BOLD, , ,NONE,27,1)");
		out.println(sheet40_A7+"\r");
		out.print("^PRINT("+(nXCurPos)+","+(nYCurPos+107)+",476,0,15,0/,굴림체,RGB[0,0,255],BOLD, , ,NONE,27,1)");
		out.println(sheet40_A10+"\r");
		out.print("^PRINT("+(nXCurPos)+","+(nYCurPos+154)+",476,0,15,0/,굴림체,RGB[0,0,255],BOLD, , ,NONE,27,1)");
		out.println(sheet40_A12+"\r");
	}

	//----JU_QUESTION_ 스크립트 문 출력 함수----
	private void writeScriptJU_QUESTION_( ) throws Exception{
		//스크립트문 생성
		out.print("^PRINT("+(nXCurPos+33)+","+(nYCurPos)+",443,0,11,0/,굴림체,RGB[0,0,0], , , ,NONE,20,1)");
		out.println(sheet40_B13+"\r");
	}
	...
	private void initConstVarient(){
		...
		sheet40_B1="기타 사항";
		sheet40_A3="① 교육생 기본사항";
		sheet40_A7="② 폐지 및 신설 희망과목";
		sheet40_A10="③ 추천하고 싶은 강사";
		sheet40_A12="- 주관식에 관한 질문입니다.";
		sheet50_A1=4;
		sheet50_B1=" 과정장 의견";
	}
