...
class ReportHandler{
	...
	private void getScriptFromheader(boolean bIsFirst, boolean bIsPrint) throws Exception{
		if(bIsFirst){   //밴드 최초 호출 시에만 실행되는 코드
			...
			//데이터 변수 할당
			sheet10_A1= p_year_Param + "년 인원통계";
		}   //end if(bIsFirst)
	...
	private void initSQLConst(){
		...
		sql_totsum = sql_totsum + "sum(decode(e.tlevel, 'A', 1, 'A1', 1, 'B', 1, 'C1', 1, 'C2', 1, 'D', 1, 'Z', 0)) as TUTOR_TOTAL_CNT , ";
		...
		sql_totsum = sql_totsum + "group by a.grcode, a.gubun, a.gubunnm, a.grcodenm, a.grseq_cnt, a.tutor_total_cnt, a.a_cnt , a.a1_cnt ";
		sql_totsum = sql_totsum + ", a.b_cnt , a.c1_cnt , a.c2_cnt , a.c3_cnt , a.z_cnt )";
		...
		sql_master = sql_master + "sum(decode(e.tlevel, 'A', 1, 'A1', 1, 'B', 1, 'C1', 1, 'C2', 1, 'D', 1, 'Z', 0)) as TUTOR_TOTAL_CNT , ";
		...
		sql_master = sql_master + "group by a.grcode, a.gubun, a.gubunnm, a.grcodenm, a.grseq_cnt ";
		sql_master = sql_master + ", a.tutor_total_cnt , a.a_cnt , a.a1_cnt ";
		sql_master = sql_master + ", a.b_cnt , a.c1_cnt , a.c2_cnt , a.c3_cnt , a.z_cnt ) ";
		sql_master = sql_master + "GROUP BY gubunnm, gubun";
	}

	private void initSQLdetailVarient(){
		sql_detail = "select a.grcodenm ";
		...
		sql_detail = sql_detail + "sum(decode(e.tlevel, 'A', 1, 'A1', 1, 'B', 1, 'C1', 1, 'C2', 1, 'D', 1, 'Z', 0)) as TUTOR_TOTAL_CNT , ";
		...
		sql_detail = sql_detail + "group by a.grcode, a.gubun, a.gubunnm, a.grcodenm, a.grseq_cnt ";
		sql_detail = sql_detail + ", a.tutor_total_cnt , a.a_cnt , a.a1_cnt ";
		sql_detail = sql_detail + ", a.b_cnt , a.c1_cnt , a.c2_cnt , a.c3_cnt , a.z_cnt";
	}
	...
	private void setFieldVariableFromdetail() throws Exception{
		...
		detail_A_CNT=detail.getDouble(5);
		detail_A1_CNT=detail.getDouble(6);
		detail_B_CNT=detail.getDouble(7);
		detail_C1_CNT=detail.getDouble(8);
		detail_C2_CNT=detail.getDouble(9);
		detail_C3_CNT=detail.getDouble(10);
		detail_Z_CNT=detail.getDouble(11);
		detail_GRCODE=GetB(detail.getString(12));
		detail_GUBUN=GetB(detail.getString(13));
		detail_GUBUNNM=GetB(detail.getString(14));
	}
