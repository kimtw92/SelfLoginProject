...
class ReportHandler{
	...
	private void getScriptFromheader03(boolean bIsFirst, boolean bIsPrint) throws Exception{
		...
		if(bIsFirst){   //밴드 최초 호출 시에만 실행되는 코드
			...
			//데이터 변수 할당
			sheet30_C3=getAfterDay(10);
			sheet30_D3=getAfterDay(11);
			sheet30_E3=getAfterDay(12);
			sheet30_F3=getAfterDay(13);
			sheet30_G3=getAfterDay(14);
			sheet30_C4=getAfterWeek(10);
			sheet30_D4=getAfterWeek(11);
			sheet30_E4=getAfterWeek(12);
			sheet30_F4=getAfterWeek(13);
			sheet30_G4=getAfterWeek(14);
		}   //end if(bIsFirst)
	...
	private void getScriptFromlist03(boolean bIsPrint) throws Exception{
		...
		while(name_list.next()){   //자동으로 생성되는 반복 밴드의 루프문
			...
			//데이터 변수 할당
			sheet30_A5=name_list_NO;
			sheet30_B5=name_list_NAME;
	...
	private void getScriptFromheader04(boolean bIsFirst, boolean bIsPrint) throws Exception{
		...
		if(bIsFirst){   //밴드 최초 호출 시에만 실행되는 코드
			...
			//데이터 변수 할당
			sheet40_C3=getAfterDay(15);
			sheet40_D3=getAfterDay(16);
			sheet40_E3=getAfterDay(17);
			sheet40_F3=getAfterDay(18);
			sheet40_G3=getAfterDay(19);
			sheet40_C4=getAfterWeek(15);
			sheet40_D4=getAfterWeek(16);
			sheet40_E4=getAfterWeek(17);
			sheet40_F4=getAfterWeek(18);
			sheet40_G4=getAfterWeek(19);
		}   //end if(bIsFirst)
	...
	private void getScriptFromlist04(boolean bIsPrint) throws Exception{
		...
		while(name_list.next()){   //자동으로 생성되는 반복 밴드의 루프문
			...
			//데이터 변수 할당
			sheet40_A5=name_list_NO;
			sheet40_B5=name_list_NAME;
	...
	private void getScriptFromheader05(boolean bIsFirst, boolean bIsPrint) throws Exception{
		...
		if(bIsFirst){   //밴드 최초 호출 시에만 실행되는 코드
			...
			//데이터 변수 할당
			sheet50_C3=getAfterDay(20);
			sheet50_D3=getAfterDay(21);
			sheet50_E3=getAfterDay(22);
			sheet50_F3=getAfterDay(23);
			sheet50_G3=getAfterDay(24);
			sheet50_C4=getAfterWeek(20);
			sheet50_D4=getAfterWeek(21);
			sheet50_E4=getAfterWeek(22);
			sheet50_F4=getAfterWeek(23);
			sheet50_G4=getAfterWeek(24);
		}   //end if(bIsFirst)
	...
	private void getScriptFromlist05(boolean bIsPrint) throws Exception{
		...
		while(name_list.next()){   //자동으로 생성되는 반복 밴드의 루프문
			...
			//데이터 변수 할당
			sheet50_A5=name_list_NO;
			sheet50_B5=name_list_NAME;
	...
	private void getScriptFromheader06(boolean bIsFirst, boolean bIsPrint) throws Exception{
		...
		if(bIsFirst){   //밴드 최초 호출 시에만 실행되는 코드
			...
			//데이터 변수 할당
			sheet60_C3=getAfterDay(25);
			sheet60_D3=getAfterDay(26);
			sheet60_E3=getAfterDay(27);
			sheet60_F3=getAfterDay(28);
			sheet60_G3=getAfterDay(29);
			sheet60_C4=getAfterWeek(25);
			sheet60_D4=getAfterWeek(26);
			sheet60_E4=getAfterWeek(27);
			sheet60_F4=getAfterWeek(28);
			sheet60_G4=getAfterWeek(29);
		}   //end if(bIsFirst)
	...
	private void getScriptFromlist06(boolean bIsPrint) throws Exception{
		...
		while(name_list.next()){   //자동으로 생성되는 반복 밴드의 루프문
			...
			//데이터 변수 할당
			sheet60_A5=name_list_NO;
			sheet60_B5=name_list_NAME;
	...
	private void writeScriptheader05( ) throws Exception{
		...
		out.println("^CELLLINE("+(nXCurPos+149)+","+(nYCurPos+16)+",71,16,0,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos+149)+","+(nYCurPos+16)+",71,1,10,0/,돋움체,RGB[0,0,0], , , ,NONE,16,1)");
		out.println(sheet50_C4+"\r");
		out.println("^CELLBG("+(nXCurPos+220)+","+(nYCurPos+16)+",71,16,1,RGB[230,230,250],RGB[230,230,250],0)\r");
		out.println("^CELLLINE("+(nXCurPos+220)+","+(nYCurPos+16)+",71,16,0,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos+220)+","+(nYCurPos+16)+",71,16,0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos+220)+","+(nYCurPos+16)+",71,16,0,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos+220)+","+(nYCurPos+16)+",71,1,10,0/,돋움체,RGB[0,0,0], , , ,NONE,16,1)");
		out.println(sheet50_D4+"\r");
		out.println("^CELLBG("+(nXCurPos+291)+","+(nYCurPos+16)+",71,16,1,RGB[230,230,250],RGB[230,230,250],0)\r");
		out.println("^CELLLINE("+(nXCurPos+291)+","+(nYCurPos+16)+",71,16,0,RGB[0,0,0],1)\r");
		out.println("^CELLLINE("+(nXCurPos+291)+","+(nYCurPos+16)+",71,16,0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos+291)+","+(nYCurPos+16)+",71,16,0,RGB[0,0,0],3)\r");
