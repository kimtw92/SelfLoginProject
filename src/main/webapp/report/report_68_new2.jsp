...
class ReportHandler{
	...
	private void writeScriptloop2( ) throws Exception{
		...
		out.println("^CELLLINE("+(nXCurPos+427)+","+(nYCurPos)+",36,20,0,RGB[0,0,0],2)\r");
		out.println("^CELLLINE("+(nXCurPos+427)+","+(nYCurPos)+",36,20,0,RGB[0,0,0],3)\r");
		out.print("^PRINT("+(nXCurPos+427)+","+(nYCurPos)+",36,1,10,1/0/1,돋움체,RGB[0,0,0], , , ,NONE,20,1)");
	...
	private void writeScriptvoid3( ) throws Exception{
		//스크립트문 생성
		out.print("^PRINT("+(nXCurPos)+","+(nYCurPos)+",504,0,10,0/,돋움체,RGB[0,0,0], , , ,NONE,62,1)");
	...
	private void initConstVarient(){
		...
		sheet30_L5=1;
		sheet30_B4="계";
		sheet30_A6="※ 성적이 동점인 경우 인천광역시 지방공무원 교육훈련 평가관리 지침 제8조 제2항에 의거 1순위 근태    성적이 우수한자, 2순위 강사 평가 성적이 우수한자, 3순위 자치활동에 공이 많은자, 4순위 연구과제";
		sheet30_A6=sheet30_A6 + "   평가 성적이 우수한자, 5순위 연장이 많은자 순으로 평가";
	}
