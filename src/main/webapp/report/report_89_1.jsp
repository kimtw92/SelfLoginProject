...
class ReportHandler{
	...
	private void getScriptFromquestion_list(boolean bIsPrint) throws Exception{
		...
		while(QUESTION_LIST.next()){   //자동으로 생성되는 반복 밴드의 루프문
			...
			sheet30_C5=String.valueOf(QUESTION_LIST_ANSCNT3_RAT);
			sheet30_D5=String.valueOf(QUESTION_LIST_ANSCNT3_RAT);
			sheet30_E5=String.valueOf(QUESTION_LIST_ANSCNT2_RAT);
			sheet30_F5=String.valueOf(QUESTION_LIST_ANSCNT1_RAT);
			sheet30_G5=String.valueOf(QUESTION_LIST_ANSCNT1_RAT);
	...
	private void writeScriptquestion_list( ) throws Exception{
		...
		out.print("^PRINT("+(nXCurPos+178)+","+(nYCurPos)+",53,1,10,0/,바탕,RGB[0,0,0], , , ,NONE,"+(nAutoHeight_question_list[1])+",1)");
		...
		out.print("^PRINT("+(nXCurPos+231)+","+(nYCurPos)+",45,1,10,0/,바탕,RGB[0,0,0], , , ,NONE,"+(nAutoHeight_question_list[1])+",1)");
		...
		out.print("^PRINT("+(nXCurPos+276)+","+(nYCurPos)+",45,1,10,0/,바탕,RGB[0,0,0], , , ,NONE,"+(nAutoHeight_question_list[1])+",1)");
		...
		out.print("^PRINT("+(nXCurPos+321)+","+(nYCurPos)+",45,1,10,0/,바탕,RGB[0,0,0], , , ,NONE,"+(nAutoHeight_question_list[1])+",1)");
