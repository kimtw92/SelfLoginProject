...
class ReportHandler{
	...
	private void initSQLConst(){
		...
		sql_totSum = sql_totSum + "SELECT d.gr_point as gr_point ";
		...
		sql_totSum = sql_totSum + "GROUP BY d.gr_point, a.grcode ) a";
		sql_master = "SELECT nvl(a.gr_point,10) gr_point ";
		...
		sql_master = sql_master + "SELECT d.gr_point as gr_point ";
		...
		sql_master = sql_master + "GROUP BY d.gr_point, a.grcode ) a  ";
		sql_master = sql_master + "GROUP BY a.gr_point";
	}

	private void initSQLdetailVarient(){
		sql_detail = "SELECT d.gr_point as gr_point ";
		...
		sql_detail = sql_detail + "AND nvl(d.gr_point,10) = '" + master_GR_POINT + "' ";
		sql_detail = sql_detail + "AND to_char(a.enddate,'yyyymm') between '" + p_startmonth_Param + "' AND '" + p_endmonth_Param + "'  ";
		sql_detail = sql_detail + "GROUP BY d.gr_point, a.grcode";
	}
	...
	private void setFieldVariableFromdetail() throws Exception{
		...
		detail_GRSEQ_CNT=detail.getDouble(4);
