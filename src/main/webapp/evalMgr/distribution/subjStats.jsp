...
<%
	...
	if(!requestMap.getString("commGrcode").equals("") && !requestMap.getString("commGrseq").equals("") && !requestMap.getString("commSubj").equals("")){ 
		param   ="p_grcode="+requestMap.getString("commGrcode")+"&p_grseq="+requestMap.getString("commGrseq")+"&p_selsubj_cnt=0&p_selsubj="+requestMap.getString("commSubj");
	}
%>
    ...
    <tr>
        ...
        <td colspan="2" valign="top" class="leftMenuBg">
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0" class="contentsSubTitleTable">
				<tr>
					<td height="20">
						<img src="/images/bullet003.gif" width="11" height="11" align="bottom">&nbsp;<strong>과목별</strong>
					</td>
				</tr>
			</table>
			<!--// subTitle -->
...
<!--
	...
	function report_dis1() {
		embedAI("AIREPORT", "http://<%= Constants.AIREPORT_URL %>/report/report_59.jsp?<%=param%>");
  	}
//-->
</script>