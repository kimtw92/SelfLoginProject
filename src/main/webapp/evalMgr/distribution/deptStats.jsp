...
<%  
// prgnm : 평가담당자 > 평가통계관리 > 성적분포도 > 직급/기관/연령별
// date : 2008-07-31
// auth : CHJ
%>
...
<%
	...
	if(!requestMap.getString("commGrcode").equals("") && !requestMap.getString("commGrseq").equals("") && !requestMap.getString("commSubj").equals("")){ 
		param   ="p_grcode="+requestMap.getString("commGrcode")+"&p_grseq="+requestMap.getString("commGrseq")+"&p_selsubj_cnt=0&p_selsubj="+requestMap.getString("commSubj")+"&p_title="+requestMap.getString("title");
	}
%>
    ...
    <tr>
        ...
        <td colspan="2" valign="top" class="leftMenuBg">
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0" class="contentsSubTitleTable">
				<tr>
					<td height="20">
						<img src="/images/bullet003.gif" width="11" height="11" align="bottom">&nbsp;<strong>직급/기관/연령별</strong>
					</td>
				</tr>
			</table>
			<!--// subTitle -->
...
<!--
	...
	<%=(String)request.getAttribute("reportStr")%>
	
	function report_dis1() {
		embedAI("AIREPORT", "http://<%= Constants.AIREPORT_URL %>/report/report_60.jsp?<%=param%>");
  	}
//-->
</script>