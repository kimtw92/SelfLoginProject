...
<%
	...
	if(!requestMap.getString("commGrcode").equals("") && !requestMap.getString("commGrseq").equals("") && !requestMap.getString("commSubj").equals("") && !requestMap.getString("ptype").equals("")){
		DataMap paramMap=(DataMap)request.getAttribute("resultMap");		
		param   ="p_grcode="+requestMap.getString("commGrcode")+"&p_grseq="+requestMap.getString("commGrseq");
		param +="&p_subj="+requestMap.getString("commSubj")+"&p_ptype="+requestMap.getString("ptype")+"&p_title="+paramMap.getString("a_title");
		param +="&p_totaledu="+paramMap.getString("totaledu")+"&p_tot_point="+paramMap.getString("tot_point");
		param +="&p_avgpoint="+paramMap.getString("v_avgpoint")+"&p_ptype_nm="+paramMap.getString("a_ptype_nm");
	}	
%>
...
<!--
	...
	function report_dis1() {
		embedAI('AIREPORT', "http://<%= Constants.AIREPORT_URL %>/report/report_55.jsp?<%=param%>");
	}
//-->
</script>
    ...
    <tr>
        ...
        <td colspan="2" valign="top" class="leftMenuBg">
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0" class="contentsSubTitleTable">
				<tr>
					<td height="20">
						<img src="/images/bullet003.gif" width="11" height="11" align="bottom">&nbsp;<strong>평가결과분석</strong>
					</td>
				</tr>
			</table>
			<!--// subTitle -->
			...
			<tr>
				<td>
					...
					<tr>
						...
						<td width="100" class="btnr" colspan="2" align="center" rowspan="3">
					...
					<tr>
						...
						<td>
							<select name="ptype">
								...
								<option value="T">최종</option>
								<option value="1">상시1회</option>
								<option value="2">상시2회</option>
								<option value="3">상시3회</option>
								<option value="4">상시4회</option>
								<option value="5">상시5회</option>
							</select>
						</td>							
						<td></td>
						<td></td>
...
<!--
	...
	<%=requestMap.getString("reportString")%>
//-->
</script>