...
function fnUpload(){
	if(confirm("업로드 하시겠습니까 ?")){
		$("mode").value = "reportFileUploadExec";
		pform.action = "/subjMgr/report.do?mode=reportFileUploadExec";
		pform.submit();
	}
}
...
<input type="hidden" name="luserno" id="luserno" 	value="<%= fileMap.getString("luserno") %>">
...
<input type="hidden" name="dates" 	id="dates"		value="<%= requestMap.getString("dates") %>">
