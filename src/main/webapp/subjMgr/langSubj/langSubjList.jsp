...
<%
	...
	if(listMap.keySize("grcode") > 0){		
		for(int i=0; i < listMap.keySize("grcode"); i++){
			...
			param = "'" + listMap.getString("grcode", i) + "','" + listMap.getString("grseq", i) + "','" + listMap.getString("subj", i) + "'";
			
			sbListHtml.append("<tr bgcolor=\"#FFFFFF\" height=\"25\">");
			sbListHtml.append("	<td align=\"center\" class=\"tableline11\">" + (i+1) + "</td>");
			sbListHtml.append("	<td align=\"left\" class=\"tableline_left\">" + listMap.getString("lecnm", i) + "</td>");
			sbListHtml.append("	<td align=\"center\" class=\"tableline11\">" + listMap.getString("stuCount", i) + "</td>");
			sbListHtml.append("	<td align=\"center\" class=\"tableline21\">");
			sbListHtml.append("		<input type=\"button\" value=\"점수입력\" onclick=\"fnForm(" + param + ");\" class=\"boardbtn1\">");
...
function fnForm(grCode, grSeq, subj){
	...
	if( $F("commYear") != "" &&
		...
		pform.action = "langSubj.do" + param;
		pform.submit();
	}else{
		alert("검색 조건을 모두 선택해야 합니다.");
	}
    ...
    <tr>
        ...
        <td colspan="2" valign="top" class="leftMenuBg">
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0" class="contentsSubTitleTable">			
				<tr>
					<td height="20">
						<img src="/images/bullet003.gif"  align="bottom">&nbsp;<strong>어학점수 리스트</strong>
					</td>
				</tr>
			</table>
			<!--[e] subTitle -->
					...
					<td>
						...
						<table width="100%" border="0" cellspacing="0" cellpadding="0">
							...
							<tr height="30" bgcolor="#5071B4">
								...
								<td width="100" align="center" class="tableline11 white"><strong>수강생</strong></td>
								<td width="100" align="center" class="tableline21 white"><strong>어학점수 입력</strong></td>
							</tr>
