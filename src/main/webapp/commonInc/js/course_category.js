...
function fnGoTimeTableByAdmin(){
	location.href = "/courseMgr/timeTable.do?mode=list&menuId=2-1-3";
}
...
function fnGoTutorSetting(){
	location.href = "/tutorMgr/tclass.do?mode=list&menuId=2-1-2";
}
...
function fnGoStudyStaTotalByAdmin(){
	location.href = "/courseMgr/studySta.do?mode=total_list&menuId=2-3-3";
}
// 사이버학습현황(시스템 관리자)
