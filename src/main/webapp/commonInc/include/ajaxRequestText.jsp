...
//out.println(excutePost("http://incheon.cyberkma.or.kr/ssoidchk.asp", paramURL));
out.println(excutePost("http://incheon.kacnet.co.kr/report/ssoidchk.php", paramURL));
/*
* 상단 2개의 URL은 과거 SSO 연동 최종수정일이 2017-01-19일자임
* 다락원 2018-11-15 이진형 수정/추가*/
//out.println(excutePost("https://lms.darakwon.co.kr/incheon/sso.asp", paramURL));
