      ...
      <!-- suvNavi -->
          ...
          <p class="title"><img src="../images/M1/sub_title.gif" alt="마이페이지"></p>
                <div class="sn">
                  <ul>
                        ...
                        <li><a href="Mypage03.jsp" class="on">수료내역</a></li>
                        <li><a href="Mypage04.jsp">개인정보</a></li>
                        <li><a href="Mypage06.jsp">회원탈퇴</a></li>
                    </ul>
                </div>
            </div>
            <!-- //suvNavi -->
        ...
        <div id="contnets_area">
          <div class="sub_visual"><img src="../images/common/sub_visual1.jpg" alt="인재원 소개 인천광역시 인재개발원에 대한 소개 및 시설정보를 제공합니다."></div>
            <div class="local">
              <h2>수료내역</h2>
                <div class="navi"><img src="../images/common/icon_home.gif" alt="home"> &gt; 마이페이지 &gt; <span>수료내역</span></div>
            </div>
            <div class="contnets">
            <!-- contnet -->
