      ...
      <!-- suvNavi -->
        ...
        <div id="contnets_area">
          <div class="sub_visual"><img src="../images/common/sub_visual1.jpg" alt="인재원 소개 인천광역시 인재개발원에 대한 소개 및 시설정보를 제공합니다."></div>
            <div class="local">
              <h2>교육신청 및 취소</h2>
                <div class="navi"><img src="../images/common/icon_home.gif" alt="home"> &gt; 마이페이지 &gt; 교육신청 및 취소 &gt; <span>교육신청이력</span></div>
            </div>
            <div class="contnets">
            <!-- contnet -->
            ...
            <div class="mytab01">
              <ul>
                <li><a href="Mypage02.jsp"><img src="../images/M1/2tab01.gif" alt="교육신청"/></a></li><li><a href="Mypage02_02.jsp"><img src="../images/M1/2tab02_on.gif" alt="교육신청이력"/></a></li>
              </ul>
              </div>
