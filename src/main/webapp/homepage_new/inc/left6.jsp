...
if(mode.equals("eduinfo7-1")){   
	...
	num = 6;
}else if(mode.equals("lawsList") || mode.equals("lawsView") || mode.equals("cyberList") || mode.equals("cyberView")){  
	num = 7;
          ...
          <p class="title"><img src="/homepage_new/images/M6/sub_title.gif" alt="인재개발원 소개"></p>
                <div class="sn">
                  <ul>
						...
						<% if (num == 7) { %>
                        	<ul>
                            	<li><a href="javascript:fnGoMenu('7','lawsList');">공무원</a></li>
                                <li><a href="javascript:fnGoMenu('7','cyberList');">시민</a></li>
                            </ul>
						<% } %>
