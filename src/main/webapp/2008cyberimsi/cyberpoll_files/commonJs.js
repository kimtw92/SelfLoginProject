...
function searchZip(){
/*우편 번호 검색시 필요한 값 ->
	0. 리턴받을 우편번호 인풋박스 ex:)<input type="hidden" name="zipCodeName1" value="pform.homePost1">
	1. 리턴받을 주소 인풋박스 ex:) <input type="hidden" name="zipAddr" value="pform.homeAddr">
	위의 히든 박스네임을 꼭 지켜주어야한다. 
 */
