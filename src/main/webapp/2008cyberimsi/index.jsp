...
<script type="text/javascript" language="javascript"
	src="/commonInc/js/<%= skinDir %>/gnbMenu.js"></script>
<script type="text/javascript" language="javascript"
...
<script type="text/javascript" language="javascript"
	src="/commonInc/inno/InnoDS.js"></script>

<!-- 추가 -->
<!-- <script type="text/javascript" src="/share/js/common.js"></script> -->
<script type="text/javascript" language="javascript"
	src="/commonInc/js/commonJs.js"></script>
<script type="text/javascript" language="javascript"
	src="/homepage_new/js/navigation.js"></script>
<script type="text/javascript" language="javascript"
	src="/commonInc/js/zoominout.js"></script>
...
function popupEduInfo() {
if(<%=loginInfo.isLogin()%> == true) {
		window.open("/homepage/index.do?mode=eduInfo","eduInfo","scrollbars=no,resizable=no,width=660,height=600").focus();
	} else {
		alert("로그인후 사용하실수 있습니다.");
	}
...
function popupGrcodeList() { 
	...
	== true) {
			popWin('/commonInc/popup.do?mode=grcodelist', 'newpopup', '720',
					'550', 'yes', 'yes');
		} else {
			alert("로그인후 이용 가능합니다.");
		}
...
<body bgcolor="#ffffff" leftmargin="0" topmargin="0" marginwidth="0"
	marginheight="0" id="zoom" style="overflow-x: hidden;">
	<div id="wrap">
		<!-- header-->
		<div id="header">
			<div class="header">
				<div class="toparea">
					<h1>
						<a href="/">인천광역시 인재개발원</a>
					</h1>
					<div id="menu">
						<dl class="gnb01">
							<dd>
								<a href="http://www.facebook.com/cyberincheon" target="_blank"
									class="link_area1"><img src="/images/fc.gif" border="0"
							...
							<dd>
								<a href="#" class="link_area3"> <iframe
										src="http://www.facebook.com/plugins/like.php?href=http%3A%2F%2Fwww.facebook.com%2Fcyberincheon&send=false&layout=button_count&width=180&show_faces=false&action=like&colorscheme=light&font=arial&height=21"
							...
							<dd>
								<a href="javascript:yangZoom();" class="font_basic">기본</a>
							</dd>
							<dd>
								<a href="javascript:zoomIn();" class="font_up">글자크게</a>
							</dd>
							<dd>
								<a href="javascript:zoomOut();" class="font_down">글자작게</a>
							</dd>
							<dd>
								<a href="/homepage/index.do?mode=sitemap" class="sitemap">sitemap</a>
							</dd>
							<dd>
								<a href="/foreign/english/index.html" class="english">English</a>
							</dd>
							<dd>
								<a href="http://www.cyber.incheon.kr/" target="_blank"
									class="cyberedu">인천시민 사이버교육</a>
							</dd>
						</dl>
						...
						<div id="TopMenu">
							<div id="TopMenuSub">
								<ul>
									<li class="menu1"><a href="javascript:fnGoMenu(1,'main');"><img
											id="menu1Btn" src="/homepage_new/images/main/menua_off.jpg"
											alt="마이페이지" /></a>
									...
									<li class="menu2"><a
										href="javascript:fnGoMenu(2,'eduinfo2-1');"><img
											src="/homepage_new/images/main/menub_off.jpg" alt="교육과정" /></a>
										<div class="TopSubMenu">
											<ul>
												<li class="first"><a
													href="javascript:fnGoMenu(2,'eduinfo2-1');">입교안내</a></li>
									...
									<li class="menu3"><a
										href="javascript:fnGoMenu(4,'attendList');"><img
											src="/homepage_new/images/main/menuc_off.jpg" alt="교육신청" /></a>
										<div class="TopSubMenu">
											<ul>
												<li class="first"><a href="javascript:fnGoMenu(4,'attendList');">집합교육 신청 및 취소</a></li>
												<li class="first0"><a href="javascript:popupEduInfo();">사이버외국어교육</a></li>
												<li class="first1"><a href="http://incheon.nhi.go.kr/">사이버전문교육</a></li>
											</ul>
										</div></li>
									<li class="menu4"><a
										href="javascript:fnGoMenu(5,'requestList')"><img
											src="/homepage_new/images/main/menud_off.jpg" alt="참여공간" /></a>
										<div class="TopSubMenu">
											<ul>
												<li class="first"><a
													href="javascript:fnGoMenu(5,'requestList');">묻고답하기</a></li>
												<li><a href="javascript:fnGoMenu(5,'webzine');">포토갤러리</a></li>
												<li><a href="javascript:fnGoMenu(6,'eduinfo6-1');">E-book</a></li>
											</ul>
										</div></li>
									<li class="menu5"><a
										href="/homepage/renewal.do?mode=eduinfo8-1"><img
											src="/homepage_new/images/main/menue_off.jpg" alt="교육지원" /></a>
										<div class="TopSubMenu">
											<ul>
												<li class="first"><a
													href="/homepage/renewal.do?mode=eduinfo8-1" title="분야별교육안내">분야별교육안내</a></li>
												<li><a href="javascript:fnGoMenu(5,'faqList');">자주하는질문</a></li>
												<li><a
													href="javascript:fnGoMenu(5,'educationDataList');">자료실</a></li>
												<li><a href="/homepage/renewal.do?mode=eduinfotel">과정별
														안내전화</a></li>
									...
									<li class="menu6"><a
										href="javascript:fnGoMenu('7','eduinfo7-1');"><img
											src="/homepage_new/images/main/menuf_off.jpg" alt="인재개발원 소개" /></a>
										<div class="TopSubMenu">
											<ul>
				...
				<div class="visual">
					<img src="/images/main/main_view.jpg" alt="새로운 인천, 행복한 시민"
						width="990" height="252" />
				</div>
				<!-- 공지 -->
				<div class="box_layer">
					<dl>
						<dd>
							<div class="schedule">
								<marquee scrolldelay="150"><%=weekListHtml%></marquee>
							</div>
						</dd>
					</dl>
				</div>
				...
				<div class="box_layer2">
					<dl class="box1">
						...
						%>
						<dd>
							<a href="/down/1_1.pdf" target="_blank">교육훈련계획</a>
						</dd>
						<dd>
							<a href="/down/02.hwp">교육인정시간 기준</a>
						</dd>
						<dd>
							<a href="/down/03.hwp">사이버교육 운영지침</a>
						</dd>
						<dd>
							<a href="/down/04.hwp">사이버과정별 안내서</a>
						</dd>
						<%
							} else {
						%>
						<dd>
							<a href="javascript:alert('로그인후 이용 가능합니다.');">교육훈련계획</a>
						</dd>
						<dd>
							<a href="javascript:alert('로그인후 이용 가능합니다.');">교육인정시간 기준</a>
						</dd>
						<dd>
							<a href="javascript:alert('로그인후 이용 가능합니다.');">사이버교육 운영지침</a>
						</dd>
						<dd>
							<a href="/down/04.hwp">사이버과정별 안내서</a>
						</dd>
				...
				<div class="box_layer3">
					<dl>
						...
						<dd>
							<input class="input02" type="text" id="keyword" name="keyword"
								style="width: 185px" />
						</dd>
						<dd>
							<a href="javascript:doSearch($F('search'));"><img
								src="../images/main/search02.gif" alt="search" /></a>
						</dd>
					</dl>
				</div>
			</div>
		...
		<hr />
		<form name="frmSSO"
			action="http://www.dongabiz.com/ASP/Incheon/SSOlogin.php"
			method="post" target="_blank">
			<!--필수-->
			<input type="hidden" name="depcode" value="Incheon01">
			<!-- 고정값. depcode 값 -->
			<input type="hidden" name="depkey" value="ekqkcs3ks0ldxjqkw1">
			<!-- 고정값. depkey 값 -->

			<input type="hidden" name="name" value="<%=loginInfo.getSessName()%>">
			<!-- 이름 -->
			<input type="hidden" name="userkey1"
				value="<%=loginInfo.getSessUserId()%>">
			<!-- User Number -->
			<!--필수-->
		</form>

		<form id="globalForwardPage" name="globalForwardPage"
			target='globalForward' method="POST"
			action="http://b2b.global21.co.kr/incheon/sso_processExe.asp">
			<input type="hidden" id="login_id" name="login_id"
				value="<%=loginInfo.getSessUserId()%>" /> <input type="hidden"
				id="login_pass" name="login_pass" />
		</form>
		<iframe name="globalForward" id="globalForward" frameborder=0
			style='display: none;'></iframe>

		<form id="forwardPage" name="forwardPage" method="post" action="">
			<input type="hidden" name="kvt" value="" /> <input type="hidden"
				name="anm" value="" /> <input type="hidden" name="pkey" value="" />
		</form>
		...
		<div class="main_wrap">
			...
			<div id="container">
				<div id="aside">
					...
					<!-- //login -->
					<div class="goto1">
						<a href="javascript:popupEduInfo();"><img
							src="../images/main/ich_baner_03.jpg" alt="사이버 어학센터" /></a> <a
							href="javascript:popupGrcodeList();"><img
							src="../images/main/ich_baner_06_4.jpg" alt="신규자과정" /></a> <a
							href="/homepage/introduce.do?mode=eduinfo7-6-4" target="_blank"><img
							src="../images/main/ich_baner_06_3.jpg" alt="시설대여안내" /></a>
				...
				<a href="javascript:move_cyber_mobile();"><img src="../images/main/ich_baner_06.jpg" alt="사이버교육센터 모바일"/></a -->
					...
					<div class="ptab">
						<ul>
							<li id="li_tabmenu1_atea"><img id="tabmenu1"
								src="../images/main/tab01_on.gif" alt="교육안내"
								style="cursor: hand" onClick="tabmenu(1, 'tabmenu1');" /></li>
							<li id="li_tabmenu2_atea"><img id="tabmenu2"
								src="../images/main/tab02.gif" alt="시설안내" style="cursor: hand"
								onClick="tabmenu(1, 'tabmenu2');" /></li>
						</ul>
					</div>
					<div id="info_1">
				...
				<form id="pform" name="pform" method="post">
					<div id="content">
						...
						<div id="notice">
							<div id="tablist_area">
								<span><img id="tabmenu3"
									src="../images/main/notice_tab1_on.gif" alt="공지사항"
									style="cursor: hand" onClick="tabmenu(2, 'tabmenu3');" /></span> <span><img
									id="tabmenu4" src="../images/main/notice_tab2.gif" alt="집합교육"
									style="cursor: hand" onClick="tabmenu(2, 'tabmenu4');" /></span> <span><img
									id="tabmenu5" src="../images/main/notice_tab3.gif" alt="사이버교육"
									style="cursor: hand" onClick="tabmenu(2, 'tabmenu5');" /></span>
							</div>
							<div id="tab1c1_area">
								<ul>
									<%=sbListHtml%>
							...
							<div id="more_1">
								<a href="/homepage/support.do?mode=noticeList"><img
									src="../images/main/more.gif" alt="더보기"></a>
							</div>

							<div id="tab1c2_area" style="display: none;"
								class="board_tab board_scroll">
								<table summary="집합교육 과정명별 신청기간, 인원, 이수시간, 교육시간 입니다.">
									...
									<thead>
										<tr>
											<th><p>
													<img src="/images/main/board_tit1.gif" alt="과정명" />
												</p></th>
											<th><p>
													<img src="/images/main/board_tit2.gif" alt="신청기간" />
												</p></th>
											<th><p>
													<img src="/images/main/board_tit3.gif" alt="인원" />
												</p></th>
											<th><p>
													<img src="/images/main/board_tit4.gif" alt="이수시간" />
												</p></th>
											<th><p class="bgn">
													<img src="/images/main/board_tit5.gif" alt="교육기간" />
												</p></th>
										</tr>
									</thead>
									<tbody>
							...
							<div id="more_2" style="display: none;">
								<a href="/homepage/infomation.do?mode=eduinfo2-3"><img
									src="../images/main/more.gif" alt="더보기"></a>
							</div>

							<div id="tab1c3_area" style="display: none;"
								class="board_tab board_scroll">
								<table summary="집합교육 과정명별 신청기간, 인원, 이수시간, 교육시간 입니다.">
									<caption>집합교육 과정</caption>
									<colgroup>
							...
							<div id="more_3" style="display: none;">
								<a href="/homepage/course.do?mode=eduinfo3-3"><img
									src="../images/main/more.gif" alt="더보기"></a>
							</div>
						</div>
						<!-- Notice End -->
						...
						<div class="month_tab">
							<div class="month01">
								<span class="title_m">이달의 학습</span><span id="month" class="tab1">
									<%
										int month = Integer.parseInt(requestMap.getString("month"));
									%> <a id="num_1" href="javascript:showMonthTab('1');"
									<%if (month == 1) {%> class="on" <%}%>>1월</a> <a id="num_2"
									href="javascript:showMonthTab('2');" <%if (month == 2) {%>
									class="on" <%}%>>2월</a> <a id="num_3"
									href="javascript:showMonthTab('3');" <%if (month == 3) {%>
									class="on" <%}%>>3월</a> <a id="num_4"
									href="javascript:showMonthTab('4');" <%if (month == 4) {%>
									class="on" <%}%>>4월</a> <a id="num_5"
									href="javascript:showMonthTab('5');" <%if (month == 5) {%>
									class="on" <%}%>>5월</a> <a id="num_6"
									href="javascript:showMonthTab('6');" <%if (month == 6) {%>
									class="on" <%}%>>6월</a> <a id="num_7"
									href="javascript:showMonthTab('7');" <%if (month == 7) {%>
									class="on" <%}%>>7월</a> <a id="num_8"
									href="javascript:showMonthTab('8');" <%if (month == 8) {%>
									class="on" <%}%>>8월</a> <a id="num_9"
									href="javascript:showMonthTab('9');" <%if (month == 9) {%>
									class="on" <%}%>>9월</a> <a id="num_10"
									href="javascript:showMonthTab('10');" <%if (month == 10) {%>
									class="on" <%}%>>10월</a> <a id="num_11"
									href="javascript:showMonthTab('11');" <%if (month == 11) {%>
									class="on" <%}%>>11월</a> <a id="num_12"
									href="javascript:showMonthTab('12');" <%if (month == 12) {%>
									class="on" <%}%>>12월</a>
								</span>
							</div>
							<div class="scrolling">
					...
					<div id="banner">
						<div class="btn01">
							<ul>
								...
								<li><img id="popupLeft" style="cursor: hand"
									src="/homepage_new/images/main/arrow01.gif" alt="왼쪽 클릭버튼" /></li>
								<li><img id="popupStart" style="cursor: hand"
									src="/homepage_new/images/main/arrow04.gif" alt="정지버튼" /></li>
								<li><img id="popupRight" style="cursor: hand"
									src="/homepage_new/images/main/arrow03.gif" alt="오른쪽 클릭버튼" /></li>
							</ul>
						</div>
						...
						<div class="popbox">
							<div class="popscreen">
								<div class="pic">
									...
									<a href="<%=linkUrl%>"
										<%if (popupZoneListMap.getString("linkYn", i).equals("Y")) {%>
										target="<%=popupZoneListMap.getString("linkTarget", i)%>"
										<%}%>><img id="pop<%=i%>" <%if (i != 0) {%>
										style="display: none" <%}%>
										src="/pds/popupZone/<%=popupZoneListMap.getString("fileName", i)%>"
										title="<%=popupZoneListMap.getString("fileAlt", i)%>" alt='.' /></a>
									<%
										}
										}
									%>
								...
								<div class="popbtn">
									<ul>
										...
										%>
										<li><img id="popbtn<%=i%>"
											src="../images/main/pno0<%=i + 1%><%if (i == 0) {%>_on<%}%>.gif" /></li>
										<%
											}
											}
										%>
						...
						<div class="banner1">
							<a href="/homepage/support.do?mode=faqView&fno=60"
								target="_blank"><img src="../images/main/ban08_1.gif"
								alt="필수조치사항" /></a>
						</div>
						...
						<div class="ttab">
							<ul>
								<li><img id="tabmenu6" style="cursor: hand"
									src="../images/main/ttab01_on.gif" alt="오늘의 한마디"
									onClick="tabmenu(3, 'tabmenu6');" /></li -->
								<li><img id="tabmenu7" style="cursor: hand"
									src="../images/main/ttab02.gif" alt="포토갤러리"
									onClick="tabmenu(3, 'tabmenu7');" /></li>
				...
				<div id="winglish_area02">
					<dl>
						<iframe src="http://www.winglish.com/study/openfree/main/incheon_main_ch.asp" width="100%" height="66" frameborder="0" scrolling="no" name="winch">윈글리쉬 데이타 불러오기</iframe>
							...
							<a href="http://m.hrd.incheon.go.kr/index.do?mode=index"
								target="_blank"><img src="/images/qrbarcode.jpg"
								alt="인재개발원 모바일 QR바코드" width="130" height="130" /></a>
						</div>
					...
					<div class="wrap_right">
						...
						<div id="quick_menu">
							<p>
								<img src="../images/common/quick_title.gif" alt="메뉴 바로가기">
							</p>
							<ul>
								<li><a
									href='javascript:popWin("/homepage/studyhelp/learning_guide01.html","ddd","820","515","no","no")'><img
										src="../images/common/quick_menu1.gif" alt="학습도우미"></a></li>
								<li><a href="/homepage/infomation.do?mode=eduinfo2-3"><img
										src="../images/common/quick_menu2.gif" alt="연간교육인정"></a></li>
								<li><a href="/homepage/support.do?mode=faqList"><img
										src="../images/common/quick_menu3.gif" alt="자주하는 질문"></a></li>
								<li><a
									href="javascript:popWin('http://152.99.42.151:81/','ccc','658','540','yes','yes')"><img
										src="../images/common/quick_menu4.gif" alt="PC 원격지원"></a></li>
								<li><a href="/homepage/introduce.do?mode=eduinfo7-7"><img
										src="../images/common/quick_menu5.gif" alt="찾아오시는길"></a></li>
								<li><a href="javascript:move_cyber();"><img
										src="../images/common/quick_menu6.gif" alt="인천시민사이버교육센터"></a></li>
								<li><a href="http://www.logodi.go.kr/competency/ic"
									target="_blank"><img src="../images/common/quick_menu7.gif"
										alt="역량 시스템"></a></li>
							</ul>
							<p>
								<a href="#"><img src="../images/common/quick_bt.gif"
									alt="페이지 상단으로 이동"></a>
							</p>
						</div>
						<script type="text/javascript">
							initMoving(document.getElementById("quick_menu"),
									1, 1, 1)
						</script>
						<!-- 퀵메뉴 -->
					</div>
		...
		function fillup() {
			if (iedom) {
				cross_slide = document.getElementById ? document
						.getElementById("rollingBanner1")
						: document.all.rollingBanner1
				cross_slide2 = document.getElementById ? document
						.getElementById("rollingBanner2")
						: document.all.rollingBanner2
	...
	<div id="bn"
		style="position: relative; width: 600; height: 55; overflow: hidden;">
		<br> <br>
		<div class="bs"
			style="position: relative; width: 600; height: 55; background-color: #ffffff"
			onMouseover="copyspeed=0" onMouseout="copyspeed=slidespeed">
			<div id="rollingBanner1" style="position: absolute; left: 0; top: 0"></div>
			<div id="rollingBanner2"
				style="position: relative; left: -1000; top: 0"></div>
		</div>
	</div>
	...
	<div id="footer">
		<div class="fo">
			...
			<ul>
				<li class="fir"><a
					href="/homepage/introduce.do?mode=eduinfo7-7">찾아오시는길(셔틀버스이용안내)</a></li>
				<li><a href="/homepage/index.do?mode=worktel">업무별연락처</a></li>
				<li><a href="/homepage/index.do?mode=policy" class="bold">개인정보처리방침</a></li>
				<li class="end"><a href="/homepage/index.do?mode=spam">이메일
						무단수집거부</a></li>
				<li class="add" style="width: 670px;">22711 인천광역시 서구 심곡로 98 /
					교육안내 032)440-7656, 사이버교육 안내 440-7673, 시설안내 440-7632 / FAX
					(032)440-8795<br /> 홈페이지에 게시된 이메일주소가 자동 수집되는 것을 거부하며, 위반시 정보통신
					관련법령에 의해 처벌됩니다.<br /> Copyright@2007 인천광역시인재개발원, All rights
					Reserved. 이 사이트의 콘텐츠를 무단 사용할 수 없습니다.
				</li>
			</ul>
		</div>
	</div>
	...
	<script type="text/javascript"
		src="https://supdate.nprotect.net/nprotect2007/keycrypt/hrdincheon/npkfx.js"></script>
...
<%!public static boolean isNew(String regday, int interval) {
		...
		try {
			...
			diffDay = Math
					.abs((int) ((current.getTime() - regdate.getTime()) / 1000.0 / 60.0 / 60.0 / 24.0));
