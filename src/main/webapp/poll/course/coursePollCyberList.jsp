...
<%
	...
	for(int i=0; i < listMap.keySize("grcode"); i++){
		...
		//미응시
		tmpStr = "<input type='button' value='조회' onclick=\"go_notApply('"+listMap.getString("grcode", i)+"', '"+listMap.getString("grseq", i)+"', '"+listMap.getString("titleNo", i)+"');\" class='boardbtn1'>";
		listStr.append("\n	<td>" + tmpStr + "</td>");
		...
		//설문분석
		tmpStr = "<input type='button' value='설문분석' onclick=\"go_modify('"+listMap.getString("grcode", i)+"', '"+listMap.getString("grseq", i)+"', '"+listMap.getString("titleNo", i)+"');\" class='boardbtn1'>";
		listStr.append("\n	<td>" + tmpStr + "</td>");
		...
		//비고
		tmpStr = "<input type='button' value='수정' onclick=\"go_modify('"+listMap.getString("grcode", i)+"', '"+listMap.getString("grseq", i)+"', '"+listMap.getString("titleNo", i)+"');\" class='boardbtn1'>";
		tmpStr += "<input type='button' value='삭제' onclick=\"go_delete('"+listMap.getString("grcode", i)+"', '"+listMap.getString("grseq", i)+"', '"+listMap.getString("titleNo", i)+"');\" class='boardbtn1'>";
...
//미응시 조회
function go_notApply(grcode, grseq, titleNo){
...
function go_add(){
	...
	if( $F("grcode") == "" || $F("grseq") == "" ){
		alert("기수 또는 과정을 먼저선택하시고 검색후 추가해주세요.");
		return;
	}
...
//수정
function go_modify(grcode, grseq, titleNo){
...
//삭제
function go_delete(grcode, grseq, titleNo){
					...
					<td>
						...
						<table class="search01">
							<tr>
								...
								<td width="80" class="btnr" rowspan="2">
