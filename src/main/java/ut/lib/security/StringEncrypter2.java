...
public class StringEncrypter2 {
	 ...
	 * @throws Exception
	 */
	public StringEncrypter2(String key, String initialVector) throws Exception {
	...
	public String encrypt(String value) throws Exception {
		...
		return Base64Encoder2.encode(encryptedValue);
	}
	...
	public String decrypt(String value) throws Exception {
		...
		byte[] encryptedValue = Base64Encoder2.decode(value);
