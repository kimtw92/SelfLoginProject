...
@Controller
public class MovieController_ extends BaseController {
	...
	@RequestMapping(value="/movieMgr/movieUse.do")
	...
	@RequestMapping(value="/movieMgr/movieUse.do", params="mode=list")
	public String list(
				@ModelAttribute("cm") CommonMap cm
				, Model model
			) throws BizException{
	...
	@RequestMapping(value="/movieMgr/movieUse.do", params="mode=divForm")
	...
	@RequestMapping(value="/movieMgr/movieUse.do", params="mode=divExec")
	...
	@RequestMapping(value="/movieMgr/movieUse.do", params="mode=subjList")
	...
	@RequestMapping(value="/movieMgr/movieUse.do", params="mode=subjForm")
	...
	@RequestMapping(value="/movieMgr/movieUse.do", params="mode=subjExec")
	...
	@RequestMapping(value="/movieMgr/movieUse.do", params="mode=contList")
	...
	@RequestMapping(value="/movieMgr/movieUse.do", params="mode=contForm")
	...
	@RequestMapping(value="/movieMgr/movieUse.do", params="mode=contExec")
	...
	@RequestMapping(value="/movieMgr/movieUse.do", params="mode=contView")
	...
	public void contList_(
			Model model
			, DataMap requestMap) throws BizException {
		
		//페이징 파라미터
		if (requestMap.getString("currPage").equals(""))	requestMap.setInt("currPage", 1);  //페이지
		if (requestMap.getString("rowSize").equals(""))		requestMap.setInt("rowSize", 99999);  //페이지당 보여줄 갯수
		if (requestMap.getString("pageSize").equals("")) 	requestMap.setInt("pageSize", 20); //페이지 블럭 갯수
		
		if("movList".equals(requestMap.getString("mode")) || "movList2".equals(requestMap.getString("mode"))) {
			//사용자단의 경우 - 분류 리스트 필요
			DataMap divListMap 	= movieService.selectDivList(requestMap);
			model.addAttribute("DIV_LIST_DATA", divListMap);
		}
	...
	@RequestMapping(value="/movieMgr/movieUse.do", params="mode=movList")
	...
	@RequestMapping(value="/movieMgr/movieUse.do", params="mode=movList2")
	public String movList2(
			@ModelAttribute("cm") CommonMap cm
			, Model model
			) throws BizException{
		...
		return findView(requestMap.getString("mode"), "/movieMgr/movie/movList2");
	}
	
	@RequestMapping(value="/movieMgr/movieUse.do", params="mode=movView")
	...
	@RequestMapping(value="/movieMgr/movieUse.do", params="mode=movViewLec")
	...
	@RequestMapping(value="/movieMgr/movieUse.do", params="mode=updateCmiTime")
